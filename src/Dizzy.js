...
function Dizzy(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#90CAF9" offset={0.3346} />
        <stop stopColor="#42A5F5" offset={1} />
      </linearGradient>
      <path
        d="m55.89 14.08c-27.84 0-50.04 17.41-51.65 38.49-0.55 7.08-0.44 13.94 3.48 20.29 1.13 1.84 4.69 4.57 8.1 2.67 2.38-1.33 3.63-5.16 2.48-7.76-12.36-27.88 18.99-54.13 60.54-46.64 6.48 1.17 7.17 1.12 7.53-0.12 0.47-1.69-16.18-6.93-30.48-6.93z"
        fill="url(#d)"
      />
      <linearGradient
        id="c"
        ...
        y1={110.19}
        y2={110.19}
        gradientTransform="matrix(-1 0 0 -1 189.08 190.57)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#42A5F5" offset={0} />
        <stop stopColor="#90CAF9" offset={0.6654} />
      </linearGradient>
      <path
        d="m72.11 111.43c27.84 0 50.04-17.41 51.65-38.49 0.54-7.07 0.44-13.94-3.49-20.29-1.13-1.84-4.69-4.57-8.1-2.67-2.38 1.33-3.63 5.16-2.48 7.76 12.36 27.87-18.99 54.13-60.54 46.64-6.48-1.17-7.17-1.12-7.53 0.12-0.46 1.69 16.19 6.93 30.49 6.93z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <linearGradient
        ...
        y1={34.92}
        y2={73.854}
        gradientTransform="matrix(.9793 .2025 -.2025 .9793 25.189 27.354)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFEB3B" offset={0.3018} />
        <stop stopColor="#FBC02D" offset={0.8872} />
