...
function Sunglasses(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m21.12 51.95c-0.1 1.6-0.74 3.08-2.31 3.37-0.18 0.03-0.36 0.05-0.54 0.05-1.36 0-2.58-0.97-2.84-2.36-0.56-2.98 0.09-5.77 1.82-7.86 1.62-1.96 4.02-3.08 6.58-3.08 1.6 0 3.01 0.99 3.01 2.58 0 1.88-1.5 2.67-3.01 3.2-1.41 0.51-2.59 2.16-2.71 4.1z"
        fill="#858585"
      />
      <path
        d="m84.7 51.95c-0.1 1.6-0.74 3.08-2.31 3.37-0.18 0.03-0.36 0.05-0.54 0.05-1.36 0-2.58-0.97-2.84-2.36-0.56-2.98 0.09-5.77 1.82-7.86 1.62-1.96 4.02-3.08 6.58-3.08 1.6 0 3.01 0.99 3.01 2.58 0 1.88-1.5 2.67-3.01 3.2-1.4 0.51-2.59 2.16-2.71 4.1z"
        fill="#858585"
      />
      <path
        d="m64 93.81c-11.51 0-19.73-5.97-22.2-9.74-0.95-1.45-1.14-3.03-0.5-4.22 0.48-0.9 1.36-1.41 2.42-1.41 0.35 0 0.72 0.06 1.09 0.18 5.8 1.82 12.45 2.78 19.24 2.78 6.74 0 13.37-0.96 19.16-2.78 0.37-0.12 0.74-0.18 1.09-0.18 1.05 0 1.93 0.51 2.41 1.41 0.64 1.19 0.45 2.76-0.5 4.22-2.48 3.76-10.7 9.74-22.21 9.74z"
        fill="#242424"
      />
    </svg>
  );
