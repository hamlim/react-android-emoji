  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#eee" offset={0.5893} />
        <stop stopColor="#E1E1E1" offset={0.9791} />
      ...
      >
        ...
        <stop stopColor="#4FC3F7" offset={0.5582} />
      ...
      <g opacity={0.2}>
        <path
          d="m117 71v48h3c0.55 0 1 0.45 1 1v1h-114v-1c0-0.55 0.45-1 1-1h3v-48h106m3-3h-112v48c-2.21 0-4 1.79-4 4v4h120v-4c0-2.21-1.79-4-4-4v-48z"
          fill="#424242"
        />
      </g>
      ...
      />
      <path
        d="M64,13v26c0,1.05,0.19,2.06,0.52,3h54.95c0.33-0.94,0.52-1.95,0.52-3V13c0-1.05-0.19-2.06-0.52-3 H64.52C64.19,10.94,64,11.95,64,13z"
        fill="#fff"
      />
      <path
        d="m64.52 42c0.4 1.12 1.01 2.13 1.78 3 1.65 1.84 4.03 3 6.69 3h38c2.66 0 5.05-1.16 6.69-3 0.78-0.87 1.39-1.88 1.78-3h-54.94z"
        fill="#0089DA"
      />
      <path
        d="m117.69 7c-1.65-1.84-4.03-3-6.69-3h-38c-2.66 0-5.05 1.16-6.69 3-0.78 0.87-1.39 1.88-1.78 3h54.95c-0.4-1.12-1.01-2.13-1.79-3z"
        fill="#0FAC34"
      />
      <g fill="#0FAC34">
      ...
      <g opacity={0.2}>
        <path
          d="m121 55v16h-114v-16h114m0-3h-114c-1.66 0-3 1.34-3 3v16c0 1.66 1.34 3 3 3h114c1.66 0 3-1.34 3-3v-16c0-1.66-1.34-3-3-3z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m111 7c1.69 0 3.32 0.73 4.46 2 0.53 0.59 0.93 1.26 1.19 2 0.23 0.66 0.35 1.33 0.35 2v26c0 0.67-0.12 1.34-0.35 2-0.26 0.74-0.66 1.41-1.19 2-1.14 1.27-2.77 2-4.46 2h-38c-1.69 0-3.32-0.73-4.46-2-0.53-0.59-0.93-1.26-1.19-2-0.23-0.66-0.35-1.33-0.35-2v-26c0-0.67 0.12-1.34 0.35-2 0.26-0.74 0.66-1.41 1.19-2 1.14-1.27 2.77-2 4.46-2h38m0-3h-38c-2.66 0-5.05 1.16-6.69 3-0.78 0.87-1.39 1.88-1.78 3-0.34 0.94-0.53 1.95-0.53 3v26c0 1.05 0.19 2.06 0.52 3 0.4 1.12 1.01 2.13 1.78 3 1.65 1.84 4.03 3 6.69 3h38c2.66 0 5.05-1.16 6.69-3 0.78-0.87 1.39-1.88 1.78-3 0.33-0.94 0.52-1.95 0.52-3v-26c0-1.05-0.19-2.06-0.52-3-0.4-1.12-1.01-2.13-1.78-3-1.63-1.84-4.02-3-6.68-3z"
          fill="#424242"
        />
      </g>
      <rect x={63.5} y={74} width={1} height={42} fill="#eee" opacity={0.3} />
    </svg>
  );
}
