  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#ECEFF0" offset={0.2327} />
        <stop stopColor="#D0D8DC" offset={0.654} />
      </radialGradient>
      <path
        d="m111.18 19.46c0-13.87-8.03-15.46-12.66-15.46s-12.66 1.59-12.66 15.46c0 6.97 4.82 10.84 4.82 16.22 0 4.65-1.61 8.59-4.98 12.05-3.62 3.72-9.19 13.35-9.19 19.45 0 19.13 7.23 39.52 9.92 46.46 0.58 1.49 2.11 2.47 3.82 2.47h16.53c1.71 0 3.24-0.99 3.82-2.47 2.69-6.94 9.92-27.32 9.92-46.46 0-5.64-5.97-15.97-9.51-19.95-2.76-3.1-4.63-7.54-4.63-11.55 0-5.29 4.8-9.09 4.8-16.22z"
        fill="url(#g)"
      />
      <defs>
        <path
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#757576" offset={0} />
        <stop stopColor="#434343" offset={1} />
      </radialGradient>
      <circle cx={45.48} cy={86} r={38} fill="url(#j)" />
      <g fill="#212121">
        <circle cx={35.08} cy={80.16} r={6.65} />
        <circle cx={55.88} cy={80.16} r={6.65} />
        <circle cx={45.07} cy={97.54} r={6.65} />
      </g>
      <g opacity={0.2}>
        <path
          d="m45.48 51c19.3 0 35 15.7 35 35s-15.7 35-35 35-35-15.7-35-35 15.7-35 35-35m0-3c-20.99 0-38 17.01-38 38s17.01 38 38 38 38-17.01 38-38-17.01-38-38-38z"
          fill="#eee"
        />
      </g>
    </svg>
