...
function Clock130(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m63.71 63.88 0.34 0.22c1.76 1.15 4.11 0.65 5.26-1.11l11.77-18.09c1.15-1.76 0.65-4.11-1.11-5.26l-0.34-0.22c-1.76-1.15-4.11-0.65-5.26 1.11l-11.77 18.09c-1.15 1.76-0.65 4.11 1.11 5.26z"
        fill="#424242"
      />
