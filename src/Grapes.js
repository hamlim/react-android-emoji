...
function Grapes(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g opacity={0.2}>
        <path
          d="m48.29 24.63c2.21 0 4.37 0.46 6.41 1.38 7.91 3.54 11.46 12.86 7.91 20.76-2.53 5.64-8.16 9.29-14.35 9.29-2.21 0-4.37-0.46-6.41-1.38-7.91-3.54-11.46-12.86-7.91-20.76 2.53-5.64 8.16-9.29 14.35-9.29m0-3c-7.15 0-13.97 4.12-17.09 11.07-4.22 9.43 0 20.5 9.43 24.73 2.48 1.11 5.08 1.64 7.64 1.64 7.15 0 13.97-4.12 17.09-11.07 4.22-9.43 0-20.5-9.43-24.73-2.49-1.11-5.09-1.64-7.64-1.64z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#9B3AAB" offset={0.0061452} />
        <stop stopColor="#9434A7" offset={0.2662} />
        <stop stopColor="#80259C" offset={0.6473} />
        <stop stopColor="#68128F" offset={1} />
      </radialGradient>
      <circle cx={66.9} cy={100.08} r={14.9} fill="url(#b)" />
      <g opacity={0.2}>
        <path
          d="m66.91 85.18v3c1.33 0 2.64 0.22 3.91 0.67 3 1.04 5.42 3.2 6.8 6.06s1.57 6.09 0.53 9.09c-1.66 4.78-6.18 7.99-11.24 7.99-1.33 0-2.64-0.22-3.91-0.67-3-1.04-5.42-3.2-6.8-6.06s-1.57-6.09-0.53-9.09c1.66-4.78 6.18-7.99 11.24-7.99v-3m-0.01 0c-6.16 0-11.93 3.86-14.07 10.01-2.7 7.77 1.4 16.27 9.18 18.97 1.62 0.56 3.27 0.83 4.9 0.83 6.16 0 11.93-3.86 14.07-10.01 2.7-7.77-1.4-16.27-9.18-18.97-1.62-0.57-3.27-0.83-4.9-0.83z"
          fill="#424242"
        />
      </g>
      <radialGradient
