...
function Pleading(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="M63,118.89C35.07,118.89,5,101.4,5,63S35.07,7.11,63,7.11c15.48,0,29.81,5.12,40.36,14.43 C114.9,31.72,121,46.06,121,63c0,16.86-6.1,31.17-17.64,41.39C92.78,113.74,78.45,118.89,63,118.89z"
        fill="url(#c)"
      />
      <path
        d="m63 9.11c14.99 0 28.86 4.95 39.03 13.93 11.1 9.79 16.97 23.61 16.97 39.96 0 16.27-5.87 30.07-16.97 39.89-10.21 9.03-24.07 14-39.03 14-15.04 0-28.9-4.91-39.04-13.82-11.1-9.75-16.96-23.61-16.96-40.07 0-16.54 5.86-30.42 16.96-40.15 10.11-8.86 23.97-13.74 39.04-13.74m0-4c-31.15 0-60 20-60 57.89 0 37.68 28.85 57.89 60 57.89s60-20.73 60-57.89c0-37.37-28.85-57.89-60-57.89z"
        fill="#EB8F00"
      />
      <radialGradient
        id="b"
      ...
      <circle cx={27.25} cy={78.16} r={17.5} fill="url(#b)" opacity={0.8} />
      <radialGradient
        id="a"
        cx={100.77}
        cy={72.699}
      ...
      <circle cx={100.75} cy={78.16} r={17.5} fill="url(#a)" opacity={0.8} />
      <circle cx={39} cy={59.06} r={19.38} fill="#fff" />
      <path
        d="m39 41.68c9.58 0 17.38 7.8 17.38 17.38s-7.8 17.38-17.38 17.38-17.38-7.8-17.38-17.38 7.8-17.38 17.38-17.38m0-4c-11.81 0-21.38 9.57-21.38 21.38s9.57 21.38 21.38 21.38 21.38-9.57 21.38-21.38-9.57-21.38-21.38-21.38z"
        fill="#EB8F00"
      />
      ...
      <path
        d="m89 41.68c9.58 0 17.38 7.8 17.38 17.38s-7.8 17.38-17.38 17.38-17.38-7.8-17.38-17.38 7.8-17.38 17.38-17.38m0-4c-11.81 0-21.38 9.57-21.38 21.38s9.57 21.38 21.38 21.38 21.38-9.57 21.38-21.38-9.57-21.38-21.38-21.38z"
        fill="#EB8F00"
      />
      ...
      <path
        d="m62.67 81.05c-12.72 0-24.54-1.07-34.4-2.89-2.45-0.45-4.61 1.7-4.11 4.13 3.28 16.04 19.07 29.21 38.5 29.21 21.27 0 35.58-13.6 38.55-29.27 0.46-2.42-1.7-4.53-4.12-4.08-9.87 1.83-21.7 2.9-34.42 2.9z"
        fill="none"
      />
      <g
        fill="#EB8F00"
