...
function Ocean(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#039BE5" offset={0.1502} />
        <stop stopColor="#81D4FA" offset={0.8024} />
      </linearGradient>
      <path
        d="m100.26 65.5c-0.35-3.74-6.86-10.12-17.63-3.43-19.41 12.06-11.94 38.01-3.89 45.29 9.93 8.98 23.17 13.43 45.59 9.91l-0.29-25.54s-4.13 8.32-20.05 8.32c-11.29 0-22.95-7.05-22.95-17.9 0-13.12 10.35-16 14.11-14.82 2.19 0.69 0.36 1.1 0.31 3.44v0.09c1.7 0.95 5.29-0.14 4.8-5.36z"
        fill="url(#h)"
      />
      <path
        d="m101 53.5c5.33 4.5 8 12.67 1.17 17.83-1.67 1.26-4.67 1.41-6.61 0.41 0.5 2.55 3.18 4.13 7.48 4.18 5.96 0.08 11.91-8.49 9.71-14.92-3.25-9.5-12.75-14.75-23.75-13-2.41 0.38-4.62 0.98-6.67 1.75 8-2.25 15.31 0.91 18.67 3.75z"
        fill="#E1F5FE"
      />
      <linearGradient
        id="g"
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#81D4FA" offset={0.1969} />
        <stop stopColor="#29B6F6" offset={0.614} />
      </linearGradient>
      <path
        d="m80.34 29.72c-1.63-9.95-18.74-17.42-34.04-8.87-28.44 15.88-24.05 54.23-10.76 70.18 15.3 18.36 62.19 28.93 82.2 5.07-4.83 4.22-13.35 8.12-28.41 8.12-19.8 0-44.78-16.88-44.78-43.66 0-24.59 22.17-37.48 28.79-35.26 2.26 0.76 1.48 1.48 0.46 3.02 2-1.37 4.82-1.79 6.54 1.4z"
        fill="url(#d)"
      />
      <linearGradient
        id="c"
      ...
      <path
        d="m80.39 29.79c-0.02-0.03-0.03-0.05-0.05-0.08 0.01 0.03 0.01 0.06 0.02 0.1l0.03-0.02z"
        fill="url(#c)"
      />
      <path
        d="M53.63,5.25c6.14,0.16,12.31-0.46,17.9,1.94c3.98,1.71,7.91,3.67,11.13,6.49 c3.22,2.81,5.7,7.97,6.16,12.11c0.65,5.9-4.68,12.72-10.9,12.51c-2.08-0.07-4.02-0.92-5.26-2.29c1.03,3.86,4.23,7.98,11.34,7.98 c6,0,13.15-5.9,11.94-15.16C94,14,79.5,4.09,55.86,4.09c-7.57,0-14.76,1.9-21.25,5.3C40.93,6.89,49.45,5.14,53.63,5.25z"
        fill="#E1F5FE"
      />
      <linearGradient
        id="b"
