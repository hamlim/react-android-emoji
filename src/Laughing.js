...
function Laughing(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="M116.72,61.38V46.49H10.24v14.89C26.61,71,44.6,76.35,63.48,76.35 S100.34,71,116.72,61.38z"
        clipPath="url(#a)"
        fill="#fff"
      />
      <path
      ...
      <g clipPath="url(#a)">
        <defs>
          <path
            id="c"
            d="m10.24 46.49v14.89c16.38 9.62 34.36 14.97 53.24 14.97s36.86-5.35 53.24-14.97v-14.89h-106.48zm53.24 39.93c-11.78 0-22.05 6.42-27.53 15.95 7.12 3.89 16.83 6.29 27.53 6.29 10.71 0 20.41-2.4 27.53-6.29-5.48-9.53-15.75-15.95-27.53-15.95z"
          />
        </defs>
        <clipPath id="b">
          <use xlinkHref="#c" />
        ...
        <g clipPath="url(#b)">
          <path
            d="m106.79 63.09c0.07 0 0.14 0.07 0.14 0.12-1.68 8.85-6.6 16.96-13.85 22.84-7.97 6.46-18.21 9.88-29.63 9.88-10.46 0-20.64-3.45-28.67-9.72-7.72-6.03-12.96-14.19-14.76-23.02 0.01-0.02 0.07-0.1 0.18-0.1h0.01c12.86 2.38 27.82 3.64 43.26 3.64s30.41-1.26 43.28-3.65c0.01 0.01 0.03 0.01 0.04 0.01m0-4.21c-0.27 0-0.54 0.02-0.81 0.08-12.18 2.26-26.79 3.58-42.51 3.58-15.71 0-30.31-1.32-42.49-3.57-0.27-0.05-0.54-0.08-0.81-0.08-2.67 0-4.83 2.44-4.27 5.18 4.04 19.81 23.55 36.08 47.55 36.08 26.27 0 43.94-16.8 47.61-36.15 0.52-2.72-1.63-5.12-4.27-5.12z"
            fill="#EB8F00"
          />
        </g>
      </g>
      <path
        d="m30.19 46.05 12.17-2.36-12.55-5.21c-0.14-0.07-0.28-0.15-0.42-0.23-2.61-1.6-3.06-4.89-0.72-6.93 1.81-1.58 4.76-1.6 6.88-0.3 4.98 3.05 16.7 10.24 21.27 13.04 0.82 0.5 0.7 1.58-0.22 1.93l-22.91 8.6c-0.15 0.06-0.32 0.11-0.48 0.16-3.03 0.84-6.32-0.89-6.79-3.78-0.35-2.2 1.35-4.25 3.77-4.92z"
        fill="#242424"
      />
      <path
        d="m97.81 45.8-12.17-2.36 12.55-5.21c0.14-0.07 0.28-0.15 0.42-0.23 2.61-1.6 3.06-4.89 0.72-6.93-1.81-1.58-4.76-1.6-6.88-0.3-4.98 3.05-16.7 10.24-21.27 13.04-0.82 0.5-0.7 1.58 0.22 1.93l22.91 8.6c0.15 0.06 0.32 0.11 0.48 0.16 3.03 0.84 6.32-0.89 6.79-3.78 0.35-2.2-1.35-4.25-3.77-4.92z"
        fill="#242424"
      />
    </svg>
  );
