...
function Unamused(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("path", {
      d:
        "m86.94 30.44c-0.04-0.02-0.09-0.03-0.13-0.05-2.09-0.68-1.74-3.88 0.69-3.6 1.89 0.25 3.8 0.8 5.64 1.66 5.05 2.33 8.82 6.54 10.58 11.1 0.85 2.29-2.19 3.42-3.33 1.54-2.97-4.74-7.75-8.68-13.45-10.65z",
      fill: "#EB8F00",
      stroke: "#EB8F00",
      strokeMiterlimit: 10
    }),
    _react2.default.createElement("path", {
      d:
        "m40.74 30.44c0.04-0.02 0.09-0.03 0.13-0.05 2.09-0.68 1.74-3.88-0.69-3.6-1.89 0.25-3.8 0.8-5.64 1.66-5.05 2.33-8.82 6.54-10.58 11.1-0.85 2.29 2.19 3.42 3.33 1.54 2.97-4.74 7.75-8.68 13.45-10.65z",
      fill: "#EB8F00",
      stroke: "#EB8F00",
      strokeMiterlimit: 10
    }),
    _react2.default.createElement("path", {
      d:
        "m65.53 84.86c10.11 2.06 16.25 8.78 17.74 12.53 0.58 1.45 0.46 2.87-0.32 3.79-0.59 0.7-1.45 0.99-2.37 0.81-0.31-0.06-0.62-0.18-0.92-0.35-4.77-2.63-10.44-4.67-16.39-5.88-5.92-1.21-11.91-1.55-17.32-1-0.35 0.04-0.68 0.02-0.99-0.04-0.92-0.19-1.6-0.8-1.87-1.67-0.35-1.16 0.1-2.51 1.2-3.61 2.85-2.87 11.13-6.64 21.24-4.58z",
      fill: "#242424"
    }),
    _react2.default.createElement("line", {
      x1: 25,
    ...
    _react2.default.createElement("path", {
      d:
        "m43.21 52.58c-3.63 0-6.93 2.53-6.93 6.72s3.3 6.72 6.93 6.72 6.93-2.53 6.93-6.72-3.3-6.72-6.93-6.72z",
      fill: "#242424"
    }),
    _react2.default.createElement("line", {
      x1: 76,
    ...
    _react2.default.createElement("path", {
      d:
        "m94.21 52.58c-3.63 0-6.93 2.53-6.93 6.72s3.3 6.72 6.93 6.72 6.93-2.53 6.93-6.72-3.3-6.72-6.93-6.72z",
      fill: "#242424"
    })
  );
}

exports.default = Unamused;
