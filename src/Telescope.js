...
function Telescope(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g opacity={0.2}>
        <path
          d="m43.98 98.12 18.82 6.54-0.63 1.81-18.82-6.54 0.63-1.81m-0.61-1.28-1.29 3.69 20.71 7.2 1.29-3.69-20.71-7.2z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m84.91 98.12 0.63 1.8-18.82 6.54-0.63-1.81 18.82-6.53m0.62-1.28-20.71 7.2 1.29 3.69 20.71-7.2-1.29-3.69z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#E57373" offset={0.0044248} />
        <stop stopColor="#EF5350" offset={0.5604} />
        <stop stopColor="#F44336" offset={1} />
      </radialGradient>
      <path
        d="m63.98 62.36c-2.17 0-3.93 1.75-3.93 3.92v53.79c0 2.16 1.76 3.93 3.93 3.93s3.92-1.76 3.92-3.93v-53.78c0.01-2.17-1.75-3.93-3.92-3.93z"
        fill="url(#h)"
      />
      <g opacity={0.2}>
        <path
          d="m63.98 64.36c1.06 0 1.92 0.86 1.92 1.92v53.79c0 1.06-0.86 1.93-1.92 1.93s-1.93-0.86-1.93-1.93v-53.78c0.01-1.06 0.87-1.93 1.93-1.93m0-2c-2.17 0-3.93 1.75-3.93 3.92v53.79c0 2.16 1.76 3.93 3.93 3.93s3.92-1.76 3.92-3.93v-53.78c0.01-2.17-1.75-3.93-3.92-3.93z"
          fill="#424242"
        />
      </g>
      <polygon points="78.62 72.52 78.62 72.52 78.62 72.52" fill="#B0BEC5" />
      <radialGradient
        id="g"
        cx={16.333}
        cy={53.804}
      ...
      >
        ...
        <stop stopColor="#BDBDBD" offset={0.5269} />
      ...
      >
        ...
        <stop stopColor="#E6E6E6" offset={0.6921} />
        <stop stopColor="#E0E0E0" offset={1} />
      </radialGradient>
      <path
        d="m34.09 67.68-6.4-15.33c-0.41-0.99 0.01-2.13 0.98-2.61l33.08-16.3c1.05-0.52 2.32-0.04 2.78 1.04l8.18 19.57c0.45 1.08-0.1 2.32-1.21 2.7l-34.87 12.07c-1.01 0.35-2.12-0.15-2.54-1.14z"
        fill="url(#f)"
      />
      <radialGradient
        id="e"
      ...
      <path
        d="m117.12 41.08-12.15-29.07c-0.45-1.07-1.7-1.55-2.74-1.05l-47.2 22.27c-0.98 0.46-1.43 1.62-1.01 2.62l10.32 24.69c0.42 1 1.55 1.5 2.57 1.13l49.03-17.9c1.09-0.39 1.63-1.62 1.18-2.69z"
        fill="url(#e)"
      />
      <radialGradient
        id="d"
      ...
      <path
        d="m54.5 37.03-25.84 12.74c-0.96 0.47-1.39 1.62-0.98 2.61l6.4 15.34c0.41 0.99 1.53 1.49 2.54 1.14l27.23-9.42-9.35-22.41z"
        fill="url(#b)"
      />
      <linearGradient
        id="n"
      ...
      <path
        d="m99.53 12.24-44.5 21.01c-0.98 0.46-1.43 1.62-1.01 2.62l10.32 24.71c0.42 1 1.55 1.5 2.57 1.13l46.22-16.88-13.6-32.59z"
        fill="url(#n)"
      />
      <g opacity={0.2}>
        <path
          d="m117.12 41.08-12.15-29.07c-0.33-0.78-1.08-1.25-1.88-1.25-0.29 0-0.59 0.06-0.87 0.2l-47.2 22.27c-0.98 0.46-1.43 1.62-1.01 2.62l0.48 1.15-25.83 12.74c-0.96 0.47-1.39 1.62-0.98 2.61l0.25 0.59-23.57 9.85 5.91 14.14 23.58-9.84 0.25 0.59c0.32 0.78 1.08 1.25 1.88 1.25 0.22 0 0.45-0.04 0.66-0.11l27.23-9.42 0.48 1.15c0.32 0.78 1.08 1.25 1.88 1.25 0.23 0 0.47-0.04 0.7-0.12l49.03-17.9c1.07-0.4 1.61-1.63 1.16-2.7zm-53.26 18.32-1.16-2.77-28.86 10.45-1.16-2.77-20.8 8.69-3.6-8.61 20.81-8.69-1.15-2.77 27.72-13.17-1.16-2.76 48.1-22.91 11.37 27.2-50.11 18.11z"
          fill="#424242"
        />
      </g>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#EF9A9A" offset={0} />
        <stop stopColor="#EF5350" offset={1} />
      </radialGradient>
      <path
        d="m10.47 77.41-6.31-15.1c-0.43-1.04 0.06-2.23 1.09-2.66l5.68-2.37c1.04-0.43 2.23 0.06 2.66 1.09l6.31 15.1c0.43 1.04-0.06 2.23-1.09 2.66l-5.68 2.37c-1.04 0.43-2.23-0.06-2.66-1.09z"
        fill="url(#m)"
      />
      <radialGradient
        id="l"
      ...
      <path
        d="m114.41 47.85-16.15-38.66c-0.43-1.04 0.06-2.23 1.09-2.66l5.68-2.37c1.04-0.43 2.23 0.06 2.66 1.09l16.16 38.67c0.43 1.04-0.06 2.23-1.09 2.66l-5.68 2.37c-1.05 0.43-2.24-0.06-2.67-1.1z"
        fill="url(#l)"
      />
      <g opacity={0.2}>
        <path
          d="m105.81 4 0.03 2.02 16.14 38.71-5.72 2.35-16.14-38.71 5.68-2.37h0.01v-2m0 0c-0.26 0-0.53 0.05-0.78 0.16l-5.68 2.37c-1.04 0.43-1.53 1.62-1.09 2.66l16.16 38.67c0.33 0.78 1.08 1.25 1.88 1.25 0.26 0 0.53-0.05 0.78-0.16l5.68-2.37c1.04-0.43 1.53-1.62 1.09-2.66l-16.16-38.67c-0.33-0.78-1.09-1.25-1.88-1.25z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m11.71 57.12 0.03 2.02 6.29 15.14-5.72 2.35-6.29-15.14 5.68-2.37h0.01v-2m0 0c-0.26 0-0.53 0.05-0.78 0.16l-5.68 2.37c-1.04 0.43-1.53 1.62-1.09 2.66l6.31 15.1c0.33 0.78 1.08 1.25 1.88 1.25 0.26 0 0.53-0.05 0.78-0.16l5.68-2.37c1.04-0.43 1.53-1.62 1.09-2.66l-6.31-15.1c-0.33-0.78-1.08-1.25-1.88-1.25z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFC107" offset={0.0044248} />
        <stop stopColor="#FFA000" offset={1} />
      </radialGradient>
      <ellipse cx={64} cy={63.32} rx={9} ry={9} fill="url(#j)" />
      <radialGradient
        id="i"
        cx={63.805}
        cy={52.806}
      ...
      >
        ...
        <stop stopColor="#FFCA28" offset={0.9912} />
      </radialGradient>
      <circle cx={64} cy={63.32} r={4} fill="url(#i)" />
      <g opacity={0.2}>
        <path
          d="m64 56.32c3.86 0 7 3.14 7 7s-3.14 7-7 7-7-3.14-7-7 3.14-7 7-7m0-2c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9z"
          fill="#424242"
        />
      </g>
    </svg>
