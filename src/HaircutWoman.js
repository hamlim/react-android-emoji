...
function HaircutWoman(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <defs>
        <rect id="h" x={3} y={4} width={120} height={120} />
      </defs>
      <clipPath id="b">
        <use xlinkHref="#h" />
      </clipPath>
      ...
      >
        <stop stopColor="#E0E0E0" offset={0.1779} />
        <stop stopColor="#9E9E9E" offset={0.7551} />
      </linearGradient>
      <path
        d="m54.43 47.28 38.43 0.24c2.52 0.02 4.73-1.31 5.97-3.31l5.13 0.03 0.03-4.11-4.11-0.03-37.94-0.24c-4.12-0.02-7.49 3.3-7.51 7.42z"
        clipPath="url(#b)"
        fill="url(#g)"
      />
      <g clipPath="url(#b)" fill="#DD5322">
        <rect
      ...
      <g clipPath="url(#b)">
        <defs>
          <path
            id="f"
            d="m95.07 30.8 0.01 5.13c-2 1.23-3.35 3.43-3.34 5.95l0.06 38.43c4.12-0.01 7.46-3.35 7.45-7.47l-0.06-37.94-0.01-4.11-4.11 0.01z"
          />
        </defs>
        <clipPath id="a">
          <use xlinkHref="#f" />
      ...
      <g clipPath="url(#b)">
        ...
        <path
          d="m-7.37 130.5v-9.44c0-16.24 25.36-23.53 50.5-23.56h0.13c25.03 0 50.37 8.09 50.37 23.56v9.44h-101z"
          fill="url(#e)"
        />
        <path
          d="m43.27 99c12.9 0 25.42 2.19 34.36 6 6.62 2.83 14.51 7.91 14.51 16.05v7.95h-98v-7.94c0-15.2 24.61-22.03 49-22.06h0.13m0-3h-0.13c-25.49 0.03-52 7.28-52 25.06v10.94h104v-10.94c-0.01-16.76-26.27-25.06-51.87-25.06z"
          fill="#009984"
        />
        <path
          d="m42.31 107.23c-4 0-7.26-3.22-7.26-7.17v-8.98h16.16v8.98c0 3.96-3.25 7.17-7.26 7.17h-1.64z"
          fill="#E59600"
        />
        <path
          d="m50.22 92.08v7.98c0 3.4-2.81 6.17-6.26 6.17h-1.65c-3.45 0-6.26-2.77-6.26-6.17v-7.98h14.17m2-2h-18.16v9.98c0 4.51 3.7 8.17 8.26 8.17h1.65c4.56 0 8.26-3.66 8.26-8.17v-9.98h-0.01z"
          fill="#D18100"
        />
        <path
          d="m15.81 72.26c-5.36 0-9.71-4.67-9.71-10.41s4.36-10.41 9.71-10.41h54.65c5.36 0 9.71 4.67 9.71 10.41s-4.36 10.41-9.71 10.41h-54.65z"
          fill="#E59600"
        />
        <path
          d="m70.46 52.43c4.8 0 8.71 4.22 8.71 9.41s-3.91 9.41-8.71 9.41h-54.65c-4.8 0-8.71-4.22-8.71-9.41s3.91-9.41 8.71-9.41h54.65m0-2h-54.65c-5.89 0-10.71 5.14-10.71 11.41 0 6.28 4.82 11.41 10.71 11.41h54.65c5.89 0 10.71-5.14 10.71-11.41s-4.82-11.41-10.71-11.41z"
          fill="#D18100"
        />
        <linearGradient
          id="d"
      ...
      <g clipPath="url(#b)">
        ...
        <path
          d="m85.17 45.67c-3.09-1.17-5.33-6.11-5.46-6.41-1.37-15.17-8.71-35.09-36.71-35.24v-0.02h0.13s-0.13 0-0.13 0v0.02c-45 0.24-36.07 52.14-36.07 52.14s5.13 8.99 5.13 8.81c-0.16-7.25 2.76-20.09 4.81-25.55 1.04-2.76 3.9-4.56 6.8-4.03 4.45 0.81 11.55 1.61 19.38 1.61h0.08s0.06 0.2 0.08 0.2c7.83 0 14.92-0.9 19.37-1.71 2.9-0.53 5.76 1.13 6.79 3.88 2.06 5.47 4.96 18.33 4.8 25.58 0 0.16 3.96-6.79 4.9-8.44l0.06 0.04s4.74-0.23 8.7-3.06c3.5-2.5 6-6.83 6-6.83s-4.01 0.77-8.66-0.99z"
          fill="url(#j)"
        />
      </g>
      <g clipPath="url(#b)">
        <path
          d="m80.67 53.62c2.2-0.83 3.83-1.43 5.42-2.56 0.64-0.45 1.24-0.99 1.8-1.55-1.17-0.21-2.45-0.53-3.78-1.03-1.34-0.51-2.51-1.41-3.49-2.44 0 0-0.22-0.33-0.55-0.84 0.02 3.75-0.25 6.87-0.48 8.81 0.35-0.13 0.71-0.25 1.08-0.39z"
          fill="none"
        />
        <path
          d="m76.74 39.64c0.02 0.04 0.04 0.1 0.07 0.15 0-0.05-0.01-0.1-0.01-0.15h-0.06z"
          fill="#3F2720"
        />
        <path
          d="m76.33 54.93 0.1 0.06c0-0.03 0.01-0.05 0.01-0.08-0.07 0.01-0.11 0.02-0.11 0.02z"
          fill="#3F2720"
        />
        <path
        ...
        />
        <path
          d="m76.4 55.16c-0.02 0.04-2.46 4.58-2.49 4.65 0.2 1.89 0.31 3.65 0.27 5.17 0.08 0 3.96-6.81 4.89-8.45l-2.65-1.54c0 0.05-0.01 0.12-0.02 0.17z"
          fill="#3F2720"
        />
        <path
          d="m79.79 39.26c-1.38-15.17-8.54-35.09-36.64-35.24v-0.02h-0.02s-0.01 0-0.02 0v0.02c-45.43 0.24-36.12 52.14-36.12 52.14s5 8.82 5.1 8.82c-0.03-1.48 0.07-3.2 0.26-5.03-0.12-0.29-2.46-4.75-2.48-4.79-0.24-1.6-0.93-6.98-0.55-13.56 0.41-7.04 2.17-16.97 8.22-24.24 5.66-6.8 14.27-10.36 25.56-10.36h0.04v0.02 0.01c11.32 0.06 19.93 3.54 25.6 10.35 5.35 6.42 7.41 14.91 8.06 22.26l2.98-0.41c-0.01 0 0 0.02 0.01 0.03z"
          fill="#3F2720"
        />
        <path
          d="m79.79 39.26c0-0.01-0.01-0.03-0.01-0.03l-2.98 0.41c0 0.05 0.01 0.1 0.01 0.15 0.49 1.11 2.32 3.97 3.26 5.4-0.01-1.85-0.1-3.85-0.28-5.93z"
          fill="#3F2720"
        />
        <path
          d="m79.58 54c-1.49 0.5-2.78 0.81-3.14 0.9 0 0.03-0.01 0.06-0.01 0.08l2.65 1.54c0.13-0.22 0.2-0.36 0.2-0.36s0.14-0.78 0.3-2.16z"
          fill="#3F2720"
        />
      </g>
      <g clipPath="url(#b)">
        ...
        <path
          ...
          fill="#DD5322"
        />
        <circle cx={95.55} cy={43.04} r={1.65} fill="#6E6E6E" />
      </g>
      <g clipPath="url(#b)" opacity={0.2}>
        <path
