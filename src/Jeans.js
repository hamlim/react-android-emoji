...
function Jeans(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#42A5F5" offset={0.2143} />
        <stop stopColor="#4BAAF6" offset={0.334} />
        <stop stopColor="#64B6F8" offset={0.5315} />
        <stop stopColor="#73BDF9" offset={0.6278} />
        <stop stopColor="#70BBF9" offset={0.7494} />
        <stop stopColor="#66B7F8" offset={0.8446} />
        <stop stopColor="#55AFF7" offset={0.9307} />
        <stop stopColor="#42A5F5" offset={1} />
      </linearGradient>
      <path
        d="m95.59 62.55-0.03-0.21-3.58-42.49c-0.92-7.23-6.97-12.27-14.92-11.28l-1.16 0.15c-5.59 0.7-10.06 4.21-11.9 8.75-1.84-4.54-6.3-8.05-11.9-8.75l-1.17-0.15c-7.94-0.99-13.99 4.05-14.92 11.28l-3.58 42.49-0.03 0.21-5.4 56.64c-0.15 1.39 0.93 2.62 2.39 2.76l18.48 1.95c1.47 0.14 2.77-0.88 2.92-2.26l7.04-53.52c0.17-0.63 0.32-1.28 0.4-1.96l5.77-37.27 5.75 37.27c0.09 0.67 0.23 1.32 0.4 1.96l7.04 53.52c0.15 1.39 1.45 2.4 2.92 2.26l18.48-1.95c1.47-0.14 2.54-1.37 2.39-2.76l-5.39-56.64z"
        fill="url(#c)"
      />
      <path
        d="m92.57 24.38-0.88-12.51-0.43-7.87h-54.68l-0.3 8-0.71 12.32c-1.2 8.35 8.05 17.17 28.35 17.17s29.82-8.78 28.65-17.11z"
        fill="#42A5F5"
      />
      <path
        d="m63.93 34.77c-5.41 0-10.17-0.8-12.9-3.68 1.75 4.2 6.86 7.25 12.9 7.25s11.15-3.04 12.9-7.25c-2.74 2.88-7.49 3.68-12.9 3.68z"
        fill="#1E88E5"
      />
      <defs>
        <path
          id="b"
          d="m92.57 24.38-0.88-12.51-0.43-7.87h-54.68l-0.3 8-0.71 12.32c-1.2 8.35 5.13 15.74 14.69 15.74 0 0 8.11 1.44 13.66 1.44s13.95-1.43 13.95-1.43c9.55 0 15.87-7.36 14.7-15.69z"
        />
      </defs>
      <clipPath id="a">
        <use xlinkHref="#b" />
      ...
      <g clipPath="url(#a)">
        <path
          d="m45.55 1.78c0.15 9.18-1.98 23.9-15.03 20.65-1.87-0.47-2.67 2.43-0.8 2.89 6.21 1.55 13.67-1.28 16.26-7.23 2.16-4.96 2.65-10.93 2.56-16.31-0.03-1.93-3.03-1.93-2.99 0z"
          fill="#1E88E5"
        />
      </g>
      <path
        d="m95.68 15.95h-63.51c-1.13 0-2.05-0.92-2.05-2.05s0.92-2.05 2.05-2.05h63.51c1.13 0 2.05 0.92 2.05 2.05s-0.92 2.05-2.05 2.05z"
        clipPath="url(#a)"
        fill="#1E88E5"
      />
      <g clipPath="url(#a)">
        <path
          d="m79.41 1.78c-0.09 5.37 0.4 11.34 2.56 16.31 2.6 5.96 10.05 8.78 16.26 7.23 1.87-0.47 1.08-3.36-0.8-2.89-13.02 3.25-15.17-11.47-15.02-20.65 0.03-1.93-2.97-1.93-3 0z"
          fill="#1E88E5"
        />
      </g>
      <path
        d="m68.72 36.5h-0.17c-0.83 0-1.5-0.67-1.5-1.5v-20.72c0-0.83 0.67-1.5 1.5-1.5h0.17c0.83 0 1.5 0.67 1.5 1.5v20.72c0 0.83-0.67 1.5-1.5 1.5z"
        clipPath="url(#a)"
        fill="#1E88E5"
      />
      <path
        d="m60.78 36.67h-0.17c-0.83 0-1.5-0.67-1.5-1.5v-33.67c0-0.83 0.67-1.5 1.5-1.5h0.17c0.83 0 1.5 0.67 1.5 1.5v33.67c0 0.83-0.67 1.5-1.5 1.5z"
        clipPath="url(#a)"
        fill="#1E88E5"
      />
