...
function FaceWithHeadBandage(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#F6A323" offset={0.5664} />
      ...
      />
      <path
        d="m65.33 84.65c11.32 1.92 18.39 9.17 20.19 13.28 0.7 1.59 0.62 3.17-0.21 4.23-0.62 0.8-1.58 1.16-2.61 0.98-0.35-0.06-0.69-0.18-1.04-0.35-5.4-2.75-11.78-4.81-18.44-5.94-6.63-1.13-13.3-1.29-19.29-0.47-0.38 0.05-0.75 0.05-1.1-0.01-1.03-0.18-1.81-0.83-2.14-1.79-0.43-1.27 0.02-2.79 1.2-4.06 3.06-3.29 12.13-7.79 23.44-5.87z"
        fill="#242424"
      />
      <path
        d="m82.77 54.69c4.19 0 8 3.54 8 9.42s-3.81 9.42-8 9.42-8-3.54-8-9.42 3.81-9.42 8-9.42z"
        fill="#242424"
      />
      <path
        d="m45.23 54.69c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42 8-3.54 8-9.42-3.81-9.42-8-9.42z"
        fill="#242424"
      />
      <path
        d="M8.49,44.03c2.64-10.73,15.15-24.09,19.1-24.9L71.54,8.68c5.28,0.23,13.47,0.69,19.04,7 L8.49,44.03z"
        fill="#fff"
      />
      <path
        d="m71.73 10.69c4.17 0.19 10.25 0.58 15.04 4.19l-75.06 25.92c1.34-3.16 3.43-6.65 6.08-10.11 4.76-6.21 8.99-9.32 10.19-9.6l0.12-0.02 43.63-10.38m-0.38-4.02-44.17 10.5c-5.67 1.16-20.56 18.16-21.17 29.83l87.83-30.33c-6.16-9.34-16.74-9.75-22.49-10z"
        fill="#B3B3B3"
      />
      <path
        d="M6.16,76.54c-2.03-5.98-2.06-17.37,0.08-22.92l81.34-41.49c6.76,1.74,14.08,4.42,18.97,10.53 L6.16,76.54z"
        fill="#fff"
      />
      <path
        d="m87.82 14.25c5.49 1.47 11.26 3.62 15.55 7.84l-95.94 51.5c-1.15-5.54-1.04-13.95 0.43-18.55l79.96-40.79m-0.47-4.25-82.67 42.17c-2.89 6.34-2.67 21.33 0.5 27.17l104.33-56c-5.33-8.17-14.16-11.34-22.16-13.34z"
        fill="#B3B3B3"
      />
      <path
        d="M6.37,54.81C5.94,44.62,9.84,36.86,12.46,34.4l92.75-13.47c5.94,4,11.39,9.02,13.82,22.79 L6.37,54.81z"
        fill="#fff"
      />
      <path
        d="m104.73 23.01c5.16 3.57 9.58 7.95 11.93 18.93l-108.32 10.66c0.16-7.91 2.99-14 5.07-16.32l91.32-13.27m0.95-4.18-94.08 13.67c-3.5 2.75-8.25 12.33-7.09 24.5l116.83-11.5c-2.33-16-8.33-21.83-15.66-26.67z"
        fill="#B3B3B3"
      />
    </svg>
  );
...
export default FaceWithHeadBandage;
