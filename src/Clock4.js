...
function Clock4(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m63.97 63.81-0.19 0.35c-1.01 1.84-0.33 4.15 1.51 5.16l18.93 10.37c1.84 1.01 4.15 0.33 5.16-1.51l0.19-0.35c1.01-1.84 0.33-4.15-1.51-5.16l-18.93-10.37c-1.84-1.01-4.15-0.33-5.16 1.51z"
        fill="#424242"
      />
