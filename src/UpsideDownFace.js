...
function UpsideDownFace(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m63.97 41.36c11.99 0 20.58 6.22 23.16 10.15 0.99 1.52 1.52 3.4 0.52 4.4-2.15 2.15-11.27-3.94-23.68-3.94s-21.72 5.84-23.62 3.94c-0.99-0.99-0.47-2.88 0.52-4.4 2.58-3.93 11.11-10.15 23.1-10.15z"
        fill="#242424"
      />
      <path
        d="m45.23 96.12c-4.19 0-8-3.54-8-9.42 0-5.87 3.81-9.42 8-9.42s8 3.54 8 9.42c0 5.87-3.81 9.42-8 9.42z"
        fill="#242424"
      />
      <path
        d="m82.77 96.12c4.19 0 8-3.54 8-9.42 0-5.87-3.81-9.42-8-9.42s-8 3.54-8 9.42c0 5.87 3.81 9.42 8 9.42z"
        fill="#242424"
      />
    </svg>
  );
