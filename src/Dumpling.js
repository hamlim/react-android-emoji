...
function Dumpling(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#FBEBDA" offset={0} />
        <stop stopColor="#D5BFA8" offset={0.9147} />
        <stop stopColor="#D1BBA3" offset={1} />
      </linearGradient>
      <path
        d="m56.1 30.33c5.99 3.99 13.98-2 15.97-7.99 1.35-4.05 2.21-8.56 1.72-13.22-0.49 0.31-0.98 0.63-1.47 0.98-5.49 3.99-11.4 4.08-22.05 2.75 0 0-1.92-0.4-4.18 0.32 1.79 6.65 4.14 12.96 10.01 17.16z"
        fill="url(#h)"
      />
      <linearGradient
        id="g"
      ...
      <path
        d="m47.11 35.32c2.52-5.89-1.33-12.48-5.6-18.6-0.13 0.2-0.27 0.4-0.39 0.63-3.24 5.74-2.33 10.82-8.82 14.81-4.81 2.96-10.52 3.91-14.08 7.69 10 6.9 24.23 9.45 28.89-4.53z"
        fill="url(#g)"
      />
      <linearGradient
        id="f"
      ...
      <path
        d="m19.16 47.17c-1.35-0.27-2.62-0.55-3.84-0.95 0.17 4.38 5.12 12.11 0.59 16.64-3.02 3.02-6.94 6.14-8.97 9.14h15.21c15.98-4 5.99-19.84-2.99-24.83z"
        fill="url(#f)"
      />
      <linearGradient
        id="e"
      ...
      >
        <stop stopColor="#FBEBDA" offset={0} />
        <stop stopColor="#F4E4D2" offset={0.0759} />
        <stop stopColor="#D5C3AF" offset={0.4702} />
        <stop stopColor="#C1AE99" offset={0.7923} />
        <stop stopColor="#BAA791" offset={1} />
      </linearGradient>
      <path
        d="m29.14 89.23c0-8.56-14.66-5.39-23.25-11.22 0.08 0.24 0.17 0.49 0.29 0.74 2.75 5.74 11.26 9.3 12.48 21.96s1.11 7.84 1.09 8.54c5.17-4.53 9.39-14.87 9.39-20.02z"
        fill="url(#e)"
      />
      <linearGradient
        id="d"
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F2E3D2" offset={0} />
        <stop stopColor="#EEDFCE" offset={0.2302} />
        <stop stopColor="#E3D3C1" offset={0.4796} />
        <stop stopColor="#CFBEAB" offset={0.738} />
        <stop stopColor="#B5A28D" offset={1} />
      </linearGradient>
      <path
        d="m77.16 34.53c-12.1 1.78-23.9 11.13-30.4 21.14-8.57 13.2-8.87 30.02 2.3 41.83 1.79 1.89 5.59 4.31 7.95 5.62 4.74-2.5 6.41-4.15 21.67-17.01 11.12-9.36 14.16-15.31 18.52-20.34 7.57-8.74 9.77-15.75 11.85-17.65-8.1-8.07-20.86-15.21-31.89-13.59z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      >
        <stop stopColor="#FBEBDA" offset={0} />
        <stop stopColor="#F6E6D4" offset={0.214} />
        <stop stopColor="#E9D7C3" offset={0.5013} />
        <stop stopColor="#D4BEA7" offset={0.829} />
        <stop stopColor="#D1BBA3" offset={0.8697} />
      </linearGradient>
      <path d="m14.46 227.71" fill="url(#b)" />
      <linearGradient
        id="a"
        x1={63.718}
        x2={90.952}
