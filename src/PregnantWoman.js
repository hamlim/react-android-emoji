  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#h)">
        ...
        <g clipPath="url(#d)">
          <path
            d="m48.8 48.9c2.69 2.83 8.02 4.12 11.04 1.14 1.15-1.13 0.12-2.08-1.26-1.24-2.24 1.35-6.57 0.42-8.26-1.36-1.11-1.17-2.63 0.29-1.52 1.46z"
            fill="#1A1717"
          />
        </g>
        <ellipse
        ...
        />
        <path
          d="m57.3 35.81c-1.81 0.54-2.24-0.64-1.65-1.61 0.44-0.71 1.53-1.31 3.65-0.92 2 0.37 2.83 1.51 3.37 2.21 0.54 0.69 0.48 1.39 0.03 1.45-0.63 0.09-3.17-1.8-5.4-1.13z"
          fill="#1A1717"
        />
        <radialGradient
          id="c"
        ...
        <path
          d="m77.27 60.28 10.52-0.85c4.27-0.35 7.69-3.68 8.14-7.94l0.56-5.24s1.5-8.34-0.59-24.08c-1.54-11.65-9.77-19.59-24.8-17.65-12.09 1.57-20.79 8.02-20.81 20.08 0 0.33 3.46 5.73 20.12 9.07 9.26 1.85 6.86 26.61 6.86 26.61z"
          fill="url(#c)"
        />
        <defs>
          <path
            id="b"
            d="m77.27 60.28 10.52-0.85c4.27-0.35 7.69-3.68 8.14-7.94l0.56-5.24s1.5-8.34-0.59-24.08c-1.54-11.65-9.77-19.59-24.8-17.65-12.18 1.58-20.78 8.12-20.78 20.2 0 0.29 2.83 2.08 2.83 2.08l9.86-3.55 19.52 6.63-1.15 27.06-4.05 0.27-0.06 3.07z"
          />
        </defs>
        <clipPath id="a">
          <use xlinkHref="#b" />
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#650099" stopOpacity={0.5} offset={0.1522} />
          <stop stopColor="#7600B3" stopOpacity={0} offset={0.7368} />
        </linearGradient>
        <path
          d="m40.79 131.75 16.82-3.56c14.59-3.09 25.45-15.34 26.76-30.2l1.42-16.12-10.03-2.55-4.48 23.42-34.63 9.22 4.14 19.79z"
          fill="url(#n)"
        />
        <linearGradient
          id="m"
        ...
        >
          ...
          <stop stopColor="#70534A" offset={0.9991} />
        </linearGradient>
        <polygon
        ...
        <path
          d="m37.57 109.98c0.77 4.09 6.76 3.8 11.59 2.76l26.19-5.23-4.46-11-24.48 6.53c-4.82 1.05-9.55 3.16-8.84 6.94z"
          fill="url(#k)"
        />
        <linearGradient
          id="j"
