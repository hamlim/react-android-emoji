...
function Emoji0x2b06(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="M37,47.37l23.99-24c1.59-1.82,4.43-1.82,6.02,0l23.99,24c2.26,2.59,0.43,6.63-3.01,6.63H74 c-1.1,0-2,0.9-2,2v46c0,2.21-1.79,4-4,4h-8c-2.21,0-4-1.79-4-4V56c0-1.1-0.9-2-2-2H40.01C36.57,54,34.73,49.95,37,47.37z"
        fill="#FAFAFA"
      />
    </svg>
  );
