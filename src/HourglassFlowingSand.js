...
function HourglassFlowingSand(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m56.31 59.58c1.57 0.67 1.61 3.21 0.05 3.93-5.14 2.39-30.07 12.39-30.07 48.79l-0.16 6.72 75.75 0.13-0.05-6.78c0-37.1-25.08-46.31-30.25-48.72-1.55-0.72-1.52-3.26 0.05-3.93 5.13-2.2 29.63-12.65 29.63-45.39l0.63-5.7-75.76-0.12 0.66 5.97c0 31.72 24.37 42.89 29.52 45.1z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFCA7B" offset={0} />
        <stop stopColor="#FFA726" offset={0.2539} />
        <stop stopColor="#FFCC80" offset={0.4688} />
        <stop stopColor="#FFC875" offset={0.6586} />
        <stop stopColor="#FFA726" offset={0.8665} />
      </linearGradient>
      <path
        d="M95.85,109.3C94,100.63,90.93,95,83.04,95H66.79l-0.01-34.35 c0-8.93,22.91-11.52,22.91-24.07l-50.95,0.03c0,12.1,22.75,15.28,22.75,24.13L61.52,95H45.64c-7.95,0-11.05,5.72-12.84,14.48 l-2.19,10.46l67.56,0.18L95.85,109.3z"
        fill="url(#a)"
      />
      <g opacity={0.2}>
        <path
      ...
      <g opacity={0.2}>
        <path
          d="m102.98 7c1.67 0 3.02 1.36 3.02 3.02 0 1.67-1.36 3.02-3.02 3.02h-77.96c-1.67 0-3.02-1.36-3.02-3.02s1.36-3.02 3.02-3.02h77.96m0-3h-77.96c-3.32 0-6.02 2.7-6.02 6.02 0 3.33 2.7 6.02 6.02 6.02h77.96c3.33 0 6.02-2.7 6.02-6.02s-2.7-6.02-6.02-6.02z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
...
export default HourglassFlowingSand;
