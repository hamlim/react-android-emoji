  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <radialGradient
        ...
        cy={19.548}
        r={45.821}
        gradientTransform="matrix(.7192 .6948 -.752 .7783 16.666 -.5331)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FAFAFA" stopOpacity={0} offset={0.4067} />
        <stop stopColor="#212121" stopOpacity={0.5} offset={0.9457} />
      </radialGradient>
      <path
        d="m10 75.64 19.11 9.03c3.63 0.96 7.45-0.69 9.21-3.98 0.9-1.69 1.5-3.52 1.78-5.41l-0.86-38.42c0-27.56 10.66-33.26 7.67-32.74-3.11 0.55-8.21 5.18-10.22 7.71l-5.04 5.36c-2.74 3.45-5.4 3.73-9.54 2.16l-8.03-3.06c-2.66-1.01-5.51 0.94-5.49 3.76l-4.58 47.47c-0.18 3.77 2.31 7.15 5.99 8.12z"
        fill="url(#e)"
        opacity={0.4}
      />
      <radialGradient
        ...
        cy={19.548}
        r={45.821}
        gradientTransform="matrix(-.7192 .6948 .752 .7783 172.15 -59.254)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FAFAFA" stopOpacity={0} offset={0.4067} />
        <stop stopColor="#212121" stopOpacity={0.5} offset={0.9457} />
      ...
      <path
        d="m118.03 75.64-19.11 9.03c-3.63 0.96-7.45-0.69-9.21-3.98-0.9-1.69-1.5-3.52-1.78-5.41l0.86-38.42c0-27.56-10.66-33.27-7.67-32.74 3.12 0.55 8.22 5.18 10.22 7.71l5.04 5.36c2.74 3.45 5.4 3.73 9.54 2.16l8.03-3.06c2.66-1.01 5.51 0.94 5.49 3.76l4.58 47.48c0.19 3.76-2.31 7.14-5.99 8.11z"
        fill="url(#d)"
        opacity={0.4}
      />
      <g opacity={0.2}>
        <path
          d="m64 35.51c11.48 0 19.76 0.21 23.31 0.32 0.13 3.02 0.24 7.55 0.24 8.18 0 1.2-0.15 7.26-0.27 10.84-3.4 0.25-11.41 0.73-23.1 0.73-9.89 0-18.24-0.36-23.15-0.71-0.08-2.1-0.14-4.04-0.19-5.79-0.04-1.84-0.07-3.49-0.07-4.9 0-0.82 0.01-1.65 0.02-2.47 0.03-1.89 0.1-3.86 0.2-5.89 3.54-0.11 11.75-0.31 23.01-0.31m0-2c-12.2 0-21.36 0.24-24.89 0.37-0.15 2.56-0.26 5.17-0.31 7.8-0.01 0.83-0.02 1.67-0.02 2.5 0 1.48 0.02 3.15 0.07 4.95 0.06 2.32 0.14 4.87 0.26 7.59 3.49 0.31 12.54 0.86 25.08 0.86 12.84 0 21.79-0.58 25.04-0.88 0.12-2.72 0.34-11.16 0.34-12.69 0-0.77-0.18-7.56-0.34-10.12-3.37-0.13-12.67-0.38-25.23-0.38z"
          fill="#424242"
        />
      </g>
      <defs>
        <path
          id="c"
          d="m76.16 123.87h-24.05c-4.46 0-8.07-3.58-8.07-8 0 0-5.2-51.97-5.2-71.8 0-15.08 1.48-29.86 6.57-36.4 1.21-1.56 1.16-3.57 3.75-3.57 6.56 0 14.89 11.9 14.89 11.9s7.83-11.9 14.74-11.9c2.04 0 2.86 1.79 3.85 3.58 3.9 7.03 6.97 25.68 6.97 36.4 0 19.99-5.37 71.8-5.37 71.8 0 4.41-3.62 7.99-8.08 7.99z"
        />
      </defs>
      <clipPath id="a">
        <use xlinkHref="#c" />
      ...
      <path
        d="m82.16 3.39s-8.51 4.11-16.27 15.12c-6.7 9.5-12.5 21.79-12.5 21.79"
        clipPath="url(#a)"
        fill="none"
        stroke="#FFCA28"
        strokeLinecap="round"
      ...
      />
      <path
        d="m44.39 1.39s8.51 4.11 16.27 15.12c0.89 1.27 1.77 2.58 2.62 3.91"
        clipPath="url(#a)"
        fill="none"
        stroke="#FFCA28"
        strokeLinecap="round"
