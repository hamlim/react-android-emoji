...
function Clock1030(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m63.78 64.16 0.2-0.35c1.05-1.82 0.42-4.14-1.4-5.19l-18.7-10.77c-1.82-1.05-4.14-0.42-5.19 1.4l-0.2 0.35c-1.05 1.82-0.42 4.14 1.4 5.19l18.7 10.77c1.81 1.04 4.14 0.42 5.19-1.4z"
        fill="#424242"
      />
