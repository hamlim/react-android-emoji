...
function Monocle(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="M64,119.92c-27.95,0-58.02-17.5-58.02-55.92S36.05,8.08,64,8.08 c15.49,0,29.83,5.13,40.38,14.44c11.55,10.19,17.65,24.53,17.65,41.48c0,16.87-6.1,31.19-17.65,41.41 C93.8,114.76,79.46,119.92,64,119.92z"
        fill="url(#a)"
      />
      <path
        d="m64 10.08c15 0 28.87 4.95 39.05 13.94 11.1 9.8 16.97 23.62 16.97 39.98 0 16.28-5.87 30.08-16.98 39.91-10.21 9.03-24.08 14.01-39.05 14.01-15.04 0-28.92-4.91-39.06-13.83-11.09-9.76-16.95-23.62-16.95-40.09 0-16.55 5.87-30.44 16.96-40.17 10.11-8.86 23.99-13.75 39.06-13.75m0-4c-31.16 0-60.02 20.02-60.02 57.92 0 37.7 28.86 57.92 60.02 57.92s60.02-20.73 60.02-57.92c0-37.39-28.86-57.92-60.02-57.92z"
        fill="#EB8F00"
      />
      <path
        d="m46.94 41.88"
      ...
      />
      <path
        d="m43.98 91.28c1.78-1.98 6.57-4.33 13.33-4.16 8.88 0.22 13.74 4.2 13.74 4.2 2.89 2.44 1.59 6.13-1.52 5.77-4.98-0.58-4.74-1.51-13.68-1.67-6.51-0.11-9.62 0.9-9.9 0.91-1.77 0.06-2.5-0.56-2.84-1.78-0.28-1.02 0.01-2.3 0.87-3.27z"
        fill="#242424"
      />
      <path
        d="m82.32 43.78c4.42 0 8.45 3.74 8.45 9.94s-4.02 9.94-8.45 9.94c-4.42 0-8.45-3.74-8.45-9.94s4.03-9.94 8.45-9.94z"
        fill="#303030"
      />
      <path
        d="m37.23 45.49c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42 8-3.54 8-9.42-3.81-9.42-8-9.42z"
        fill="#242424"
      />
      <circle
        cx={79.56}
      ...
      />
      <path
        d="m106.49 49.88h-5.56v9h5.56c2.69 0 5.44-1.66 5.44-4.35v-0.37c0-2.7-2.75-4.28-5.44-4.28zm-0.47 7.71c-1.9 0-3.45-1.49-3.45-3.33s1.54-3.33 3.45-3.33 3.45 1.49 3.45 3.33-1.54 3.33-3.45 3.33z"
        fill="#404040"
      />
      <path
        d="m94.82 52.46c-0.36-3.77-2.1-7.3-4.87-9.68-2.76-2.38-6.38-3.68-10.03-3.66-3.65-0.03-7.29 1.19-10.09 3.53-2.82 2.32-4.57 5.85-4.93 9.62-0.02 0.26-0.26 0.45-0.52 0.43-0.24-0.02-0.42-0.22-0.43-0.45-0.09-2.01 0.29-4.07 1.05-5.98 0.79-1.91 2.01-3.64 3.53-5.07 3.04-2.88 7.26-4.33 11.4-4.32 4.15 0.01 8.35 1.56 11.34 4.48 1.49 1.45 2.68 3.2 3.46 5.1 0.75 1.92 1.12 3.97 1.03 5.98-0.01 0.26-0.23 0.46-0.49 0.45-0.24-0.01-0.43-0.19-0.45-0.43z"
        fill="#fff"
      />
      <path
        d="m106.13 70.75h-0.05c-0.28 0-0.5-0.22-0.5-0.5v-4.62c0-0.28 0.22-0.5 0.5-0.5h0.05c0.28 0 0.5 0.22 0.5 0.5v4.62c0 0.28-0.23 0.5-0.5 0.5z"
        fill="#404040"
      />
      <path
        d="m106.13 78.44h-0.05c-0.28 0-0.5-0.22-0.5-0.5v-4.62c0-0.28 0.22-0.5 0.5-0.5h0.05c0.28 0 0.5 0.22 0.5 0.5v4.62c0 0.28-0.23 0.5-0.5 0.5z"
        fill="#404040"
      />
      <path
        d="m106.13 86.14h-0.05c-0.28 0-0.5-0.22-0.5-0.5v-4.62c0-0.28 0.22-0.5 0.5-0.5h0.05c0.28 0 0.5 0.22 0.5 0.5v4.62c0 0.27-0.23 0.5-0.5 0.5z"
        fill="#404040"
      />
      <path
        d="m106.13 93.83h-0.05c-0.28 0-0.5-0.22-0.5-0.5v-4.63c0-0.28 0.22-0.5 0.5-0.5h0.05c0.28 0 0.5 0.22 0.5 0.5v4.62c0 0.28-0.23 0.51-0.5 0.51z"
        fill="#404040"
      />
      <path
        d="m106.13 101.52h-0.05c-0.28 0-0.5-0.22-0.5-0.5v-4.62c0-0.28 0.22-0.5 0.5-0.5h0.05c0.28 0 0.5 0.22 0.5 0.5v4.62c0 0.27-0.23 0.5-0.5 0.5z"
        fill="#404040"
      />
      <path
        d="m106.13 109.21h-0.05c-0.28 0-0.5-0.23-0.5-0.5v-4.62c0-0.27 0.22-0.5 0.5-0.5h0.05c0.28 0 0.5 0.23 0.5 0.5v4.62c0 0.27-0.23 0.5-0.5 0.5z"
        fill="#404040"
      />
      <path
        d="m106.13 116.9h-0.05c-0.28 0-0.5-0.23-0.5-0.5v-4.62c0-0.27 0.22-0.5 0.5-0.5h0.05c0.28 0 0.5 0.23 0.5 0.5v4.62c0 0.28-0.23 0.5-0.5 0.5z"
        fill="#404040"
      />
      <path
        d="m106.13 62.65h-0.05c-0.28 0-0.5-0.23-0.5-0.5v-4.62c0-0.27 0.22-0.5 0.5-0.5h0.05c0.28 0 0.5 0.23 0.5 0.5v4.62c0 0.27-0.23 0.5-0.5 0.5z"
        fill="#404040"
      />
      <circle
        cx={106.1}
