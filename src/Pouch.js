...
function Pouch(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m123.41 91.39c-0.88-8.62-7.4-40.78-55.87-40.78-48.49 0-54.95 32.29-55.81 40.93-0.13 1.3 0.2 7.6 0.93 8.68l12.5 15.3c0.91 2.01 2.91 3.31 5.11 3.31l29.65-0.79c5.36-0.14 10.73-0.14 16.09 0l28.84 0.78c2.21 0 4.22-1.3 5.12-3.32l12.52-15.44c0.72-1.07 1.05-7.37 0.92-8.67z"
        fill="#FFF59D"
      />
      <path
        d="m13.43 102.51c1.07 0 1.96 0.8 2.07 1.87 0.06 0.56-0.1 1.1-0.45 1.54s-0.85 0.71-1.4 0.77c-0.08 0.01-0.15 0.01-0.23 0.01-1.07 0-1.96-0.8-2.07-1.87-0.12-1.15 0.71-2.18 1.85-2.3 0.08-0.02 0.16-0.02 0.23-0.02m0-3c-0.18 0-0.37 0.01-0.55 0.03-2.8 0.3-4.82 2.81-4.51 5.61 0.28 2.61 2.49 4.54 5.06 4.54 0.18 0 0.37-0.01 0.55-0.03 2.8-0.3 4.82-2.81 4.51-5.61-0.28-2.61-2.49-4.54-5.06-4.54z"
        fill="#00ACC1"
      />
      <radialGradient
        id="h"
      ...
      >
        <stop stopColor="#FFD54F" offset={0.1721} />
        <stop stopColor="#FFC107" offset={0.6868} />
      </radialGradient>
      <path
        d="m118.41 96.56c-0.88-8.62-2.4-38.78-50.87-38.78-48.49 0-49.95 30.29-50.81 38.93-0.13 1.3-4.8 2.6-4.07 3.68l12.5 20.3c0.91 2.01 2.91 3.31 5.11 3.31l29.65-0.79c5.36-0.14 10.73-0.14 16.09 0l28.84 0.78c2.21 0 4.22-1.3 5.12-3.32l12.52-20.44c0.72-1.07-3.95-2.37-4.08-3.67z"
        fill="url(#h)"
      />
      <path
        d="m-91.91 54.81c-9.74-1.22-22.91-0.05-30.7 6.84-4.49 3.97-6.11 11.66-2.12 16.59 3.05 3.77 7.54 4.07 12.24 2.56 8.31-2.67 17.25-11.06 19.89-16.17 0.72-1.4 0.28-2.72-0.61-3.58-1.1-0.26-2.35-0.43-3.68-0.5-0.34 0.24-0.65 0.58-0.89 1.05-2.09 4.05-3.88 5.48-7.63 7.92-2.54 1.65-8.91 5.2-11.3 1.62-0.78-1.17-0.97-2.26-0.72-3.27 1.18-4.8 12.47-7.75 20.55-7.32 1.14-0.81 2.69-0.46 3.68 0.5 0.37 0.09 0.72 0.18 1.05 0.29 3.66 1.22 0.24-6.53 0.24-6.53z"
        fill="#BA68C8"
      />
      <path
        d="m-97.78 61.61c-2.09 4.05-3.88 5.48-7.63 7.92-2.54 1.65-8.91 5.2-11.3 1.62-0.78-1.17-0.97-2.26-0.72-3.27-2.72 4.77-0.03 10.93 4.95 12.92 8.31-2.67 17.25-11.06 19.89-16.17 0.72-1.4 0.28-2.72-0.61-3.58-1.1-0.26-2.35-0.43-3.68-0.5-0.35 0.25-0.65 0.59-0.9 1.06z"
        fill="#AB47BC"
      />
      <path
        d="m-96.88 60.56c1.34 0.07 2.58 0.24 3.68 0.5-0.99-0.96-2.54-1.32-3.68-0.5z"
        fill="#BA68C8"
      />
      <radialGradient
        id="g"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#DCE775" offset={0.2793} />
        <stop stopColor="#CDDC39" offset={1} />
      </radialGradient>
      <path
        d="m-7.06 112.31-1.8-17.07c-2.82-26.75-17.24-47.04-43.46-47.11l-19.55-0.01c-26.4-0.07-38.4 20.37-41.14 47.31l-1.72 16.92c-0.63 6.23 4.13 11.65 10.23 11.65h87.2c6.13 0 10.9-5.45 10.24-11.69z"
        fill="url(#g)"
      />
      <defs>
        <path
          id="f"
          d="m-17.29 124h-87.2c-6.1 0-10.86-5.42-10.23-11.65l1.72-16.92c2.73-26.94 14.74-47.38 41.14-47.31h19.55c26.22 0.07 40.64 20.37 43.46 47.11l1.8 17.07c0.65 6.25-4.12 11.7-10.24 11.7z"
        />
      </defs>
      <clipPath id="b">
        <use xlinkHref="#f" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#C0CA33" stopOpacity={0} offset={0.2793} />
        <stop stopColor="#AFB42B" offset={1} />
      </linearGradient>
      <path
        d="m-115.92 67.04v11.41c1.06 1.14 2.39 2.05 3.92 2.56-1.53-0.51-2.86-1.41-3.92-2.56v5.72h110v-17.13h-110z"
        clipPath="url(#b)"
        fill="url(#e)"
      />
      <rect
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F57C00" stopOpacity={0} offset={0} />
        <stop stopColor="#FF6F00" stopOpacity={0.4} offset={1} />
      </linearGradient>
      <path
        d="m28 125s-19-12.13-19-27.08 12.92-27.08 12.92-27.08l1.46 2.34c9.71 15.55 11.43 34.8 4.62 51.82z"
        clipPath="url(#a)"
        fill="url(#c)"
      />
      <linearGradient
      ...
      <path
        d="m106.67 125s19-12.13 19-27.08-12.92-27.08-12.92-27.08l-1.46 2.34c-9.72 15.55-11.43 34.8-4.62 51.82z"
        clipPath="url(#a)"
        fill="url(#i)"
      />
    </svg>
