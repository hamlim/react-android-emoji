  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <circle
        ...
        strokeWidth={3}
      />
      <circle cx={37.45} cy={36} r={6.25} fill="#fff" />
      <circle
        cx={90.55}
        cy={36}
        r={10.96}
        ...
        strokeWidth={3}
      />
      <circle cx={90.55} cy={36} r={6.25} fill="#fff" />
      <linearGradient
        id="b"
        x1={64}
        x2={64}
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#E6A500" offset={0} />
        <stop stopColor="#EAAC0D" offset={0.0775} />
        <stop stopColor="#F3BE2D" offset={0.3025} />
        <stop stopColor="#FACB44" offset={0.5196} />
        <stop stopColor="#FED252" offset={0.723} />
        <stop stopColor="#FFD557" offset={0.899} />
      </linearGradient>
      <path
        d="m64 101.46c-23.42 0-38.55-14.1-38.55-35.91 0-22.88 15.13-37.67 38.55-37.67s38.55 14.79 38.55 37.67c0 21.82-15.13 35.91-38.55 35.91z"
        fill="url(#b)"
      />
      <path
        d="m64 29.39c22.51 0 37.05 14.2 37.05 36.17 0 21.23-14.2 34.41-37.05 34.41s-37.05-13.19-37.05-34.42c0-21.97 14.54-36.16 37.05-36.16m0-3c-25.6 0-40.05 17.05-40.05 39.17s14.9 37.41 40.05 37.41 40.05-15.29 40.05-37.41-14.45-39.17-40.05-39.17z"
        fill="#E68D00"
      />
      <line
        x1={64}
      ...
      />
      <g fill="#404040">
        <ellipse cx={44.5} cy={57.77} rx={6.2} ry={7.02} />
        <ellipse cx={83.5} cy={57.77} rx={6.2} ry={7.02} />
      </g>
      <g fill="#fff">
        <ellipse cx={54.07} cy={79.59} rx={12.57} ry={11.69} />
        <ellipse cx={73.93} cy={79.59} rx={12.57} ry={11.69} />
      </g>
      <linearGradient
        id="a"
        x1={64}
      ...
      <path
        d="m64 75.49c3.03 0 5.8-3.14 7.5-5.64 0.84-1.23-0.04-2.86-1.53-2.86h-11.93c-1.49 0-2.38 1.62-1.53 2.86 1.69 2.5 4.46 5.64 7.49 5.64z"
        fill="url(#a)"
      />
      <line
        x1={55.79}
