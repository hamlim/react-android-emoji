  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#7CB342" offset={0} />
        <stop stopColor="#52882D" offset={0.546} />
      ...
      <path
        ...
        strokeWidth={2.848}
      />
      <ellipse cx={11.64} cy={39.07} rx={2.44} ry={1.48} />
      <linearGradient
        id="f"
        x1={46.207}
        x2={63.31}
      ...
      <path
        d="m60.67 80.25c-6.76-9.58-8.02-28.7-7.42-33.69 0.36-1.16 0.58-2.36 0.59-3.58 0.07-7.83-5.74-14.4-13.31-15.63-1.51-1.28-3.46-2.07-5.61-2.09-2.02-0.02-3.89 0.66-5.38 1.79l-4.97-0.05c-8.73-0.07-16.25 6.95-16.01 15.6 0.44 15.62 19.68 13.55 27.62 15.19-2.76 50.46 32.71 34.12 24.49 22.46z"
        fill="url(#a)"
      />
      <linearGradient
        id="ab"
      ...
      <defs>
        <path
          id="aa"
          d="M58.32,75.98c-6.76-9.58-5.67-24.43-5.07-29.42c0.36-1.16,0.58-2.36,0.59-3.58 c0.07-7.83-5.74-14.4-13.31-15.63c-1.51-1.28-3.46-2.07-5.61-2.09c-2.02-0.02-3.89,0.66-5.38,1.79L24.57,27 C15.84,26.93,8.32,33.95,8.56,42.6C9,58.22,28.24,56.15,36.18,57.79C33.8,96.95,73.17,99,73.17,99S66.54,87.64,58.32,75.98z"
        />
      </defs>
      <clipPath>
        <use xlinkHref="#aa" />
      ...
      />
      <path
        d="m77.92 57c-3.5-0.75-18.37-4.08-30.75 4.25-13.75 9.25-10.43 24.03-9.3 27.87 2.81 9.58 12.1 15.12 21.68 17.96 6.71 1.99 13.57 2.66 18.45 2.45 6.35-0.27 14.08-1.3 20.95-3.04 8.94-2.26 16.44-5.71 17.58-10.2 1.24-4.94 1.85-30.62-38.61-39.29z"
        fill="#33691E"
      />
      <linearGradient
        id="z"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#579155" offset={0} />
        <stop stopColor="#6BA139" offset={1} />
      </linearGradient>
      <path
        d="m43.62 71.65s6.77-19.86 36.38-15.31c31.65 4.87 35.02 26.66 34.81 34.88-0.22 8.78-21.67 13.53-35.72 14.19-14.04 0.65-48.85-5.24-35.47-33.76z"
        fill="url(#z)"
      />
      <defs>
        <path
          id="y"
          d="m43.62 71.65s7.97-20.43 37.39-14.85c32.65 6.2 34 26.19 33.79 34.42-0.22 8.78-21.67 13.53-35.72 14.19-14.03 0.65-48.84-5.24-35.46-33.76z"
        />
      </defs>
      <clipPath id="x">
        <use xlinkHref="#y" />
      ...
      <g clipPath="url(#x)">
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#2E7D32" offset={0} />
        ...
        <path
          d="m54.79 55.97c-0.21-0.61-0.91-0.92-1.56-0.72-0.65 0.21-1.02 0.87-0.81 1.47 1.15 3.38 2.59 6.65 4.31 9.78 0.75-0.34 1.51-0.68 2.27-1-1.67-3.05-3.09-6.23-4.21-9.53z"
          fill="url(#v)"
        />
        <linearGradient
          id="u"
        ...
        <path
          d="m60.17 67.53c-0.76 0.32-1.52 0.65-2.28 0.99 1.3 2.17 2.73 4.27 4.29 6.3 0.41-0.81 0.83-1.61 1.24-2.42-1.16-1.57-2.25-3.2-3.25-4.87z"
          fill="url(#u)"
        />
        <linearGradient
          id="t"
        ...
        <path
          d="m77.61 70.75c-0.07 0.44-0.16 0.88-0.23 1.31-0.06 0.41-0.35 0.76-0.74 0.92l9.29 6.19c0.04 0.02 0.09 0.05 0.13 0.08l-0.03-2.9-8.42-5.6z"
          fill="url(#t)"
        />
        <linearGradient
          id="r"
        ...
        <path
          d="m112.02 59.47c-0.24-0.44-0.76-0.68-1.29-0.59l-1.17 0.19h-0.02c-0.67 0.12-1.13 0.71-1.03 1.34 0.01 0.07 0.03 0.14 0.06 0.21-3.01 2.84-6.16 5.57-9.4 8.18 0.41 0.68 0.82 1.36 1.22 2.04 3.97-3.18 7.78-6.52 11.4-10.03 0.39-0.35 0.48-0.9 0.23-1.34z"
          fill="url(#r)"
        />
        <linearGradient
          id="q"
        ...
        <path
          d="m88.51 76.69 0.03 2.78c0.19-0.1 0.35-0.2 0.47-0.28 3.23-2.15 6.37-4.42 9.43-6.8-0.41-0.68-0.81-1.36-1.22-2.04-2.83 2.2-5.74 4.32-8.71 6.34z"
          fill="url(#q)"
        />
        <linearGradient
          id="p"
        ...
        <path
          d="m77.38 72.06c0.07-0.44 0.16-0.88 0.23-1.31l-0.47-0.31c-0.55-0.37-1.33-0.24-1.74 0.28-0.41 0.53-0.29 1.25 0.26 1.62l0.97 0.65c0.39-0.17 0.68-0.52 0.75-0.93z"
          fill="url(#p)"
        />
        <linearGradient
          id="o"
        ...
        <path
          d="m38.27 77.83c-0.35 0.28-0.68 0.55-1.01 0.71-0.61 0.3-0.87 1-0.56 1.57 0.25 0.46 0.79 0.69 1.31 0.6 0.12-0.02 0.24-0.06 0.35-0.11 0.59-0.29 1.07-0.67 1.55-1.05 5.49-4.39 11.52-8.08 17.98-11.01-0.4-0.67-0.79-1.34-1.16-2.02-6.61 3-12.8 6.78-18.46 11.31z"
          fill="url(#o)"
        />
        <linearGradient
          id="n"
        ...
        <path
          d="m59 65.5c-0.76 0.32-1.52 0.66-2.27 1 0.37 0.68 0.76 1.36 1.16 2.02 0.75-0.34 1.51-0.67 2.28-0.99-0.41-0.66-0.79-1.34-1.17-2.03z"
          fill="url(#n)"
        />
        <linearGradient
          id="m"
        ...
        <path
          d="m64 76.06c-0.45 0.08-0.92-0.08-1.2-0.43-0.21-0.26-0.41-0.54-0.61-0.8-5.13 10.13-9.8 20.55-13.92 31.03-0.24 0.61 0.09 1.27 0.73 1.47 0.21 0.07 0.42 0.08 0.63 0.04 0.43-0.07 0.81-0.35 0.97-0.76 4.07-10.35 8.68-20.63 13.74-30.64-0.02 0.01-0.04 0.02-0.06 0.02-0.1 0.03-0.19 0.06-0.28 0.07z"
          fill="url(#m)"
        />
        <linearGradient
          id="l"
        ...
        <path
          d="m64.24 73.5c-0.28-0.36-0.54-0.73-0.81-1.1-0.42 0.81-0.83 1.61-1.24 2.42 0.21 0.27 0.4 0.54 0.61 0.8 0.28 0.35 0.75 0.51 1.2 0.43 0.09-0.02 0.18-0.04 0.27-0.08 0.02-0.01 0.04-0.02 0.06-0.02 0.51-1.01 1.03-2.02 1.55-3.02-0.55 0.19-1.1 0.37-1.64 0.57z"
          fill="url(#l)"
        />
        <linearGradient
          id="k"
        ...
        <path
          d="m87.62 79.72c-0.7 0.04-1.23-0.25-1.56-0.47l0.35 31.17c0.01 0.64 0.57 1.14 1.25 1.12 0.06 0 0.13-0.01 0.19-0.02 0.6-0.1 1.05-0.6 1.04-1.18l-0.34-30.88c-0.19 0.1-0.42 0.19-0.69 0.23-0.08 0.02-0.16 0.03-0.24 0.03z"
          fill="url(#k)"
        />
        <linearGradient
          id="j"
        ...
        <path
          d="m87.6 77.3c-0.02 0.01-0.05 0.03-0.08 0.05-0.05-0.03-0.1-0.07-0.13-0.08l-1.38-0.92 0.03 2.9c0.33 0.22 0.87 0.52 1.56 0.47 0.08-0.01 0.16-0.01 0.24-0.03 0.26-0.05 0.49-0.13 0.69-0.23l-0.03-2.78c-0.29 0.21-0.59 0.42-0.9 0.62z"
          fill="url(#j)"
        />
        <linearGradient
          id="i"
        ...
        <path
          d="m113.43 99.82c0.24 0.48 0.79 0.73 1.33 0.63 0.11-0.02 0.21-0.05 0.32-0.1 0.62-0.28 0.9-0.98 0.61-1.55-4.69-9.47-9.84-18.84-15.29-27.96-0.65 0.52-1.3 1.03-1.95 1.54 5.34 8.96 10.38 18.16 14.98 27.44z"
          fill="url(#i)"
        />
        <linearGradient
          id="h"
        ...
        <path
          d="m97.22 70.35c0.41 0.68 0.82 1.36 1.22 2.04 0.65-0.51 1.31-1.02 1.95-1.54-0.41-0.68-0.81-1.36-1.22-2.04-0.64 0.52-1.29 1.03-1.95 1.54z"
          fill="url(#h)"
        />
      </g>
    </svg>
