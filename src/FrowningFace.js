...
function FrowningFace(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m34.37 91.74c6.4-11.11 19.88-15.68 29.63-15.68 9.76 0 23.23 4.57 29.63 15.68 0.91 1.57 3.47 0.89 3.18-0.91-2.46-14.98-19.04-23.45-32.81-23.95-14.6-0.53-29.93 9.83-32.81 23.95-0.35 1.77 2.28 2.49 3.18 0.91z"
        fill="#242424"
      />
      <path
        d="m82.77 37.36c4.19 0 8 3.54 8 9.42s-3.81 9.42-8 9.42-8-3.54-8-9.42 3.81-9.42 8-9.42z"
        fill="#242424"
      />
      <path
        d="m45.23 37.36c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42 8-3.54 8-9.42-3.81-9.42-8-9.42z"
        fill="#242424"
      />
    </svg>
  );
