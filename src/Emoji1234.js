...
function Emoji1234(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("path", {
        d:
          "m94.01 71.44c1.07 0 1.94 0.87 1.94 1.94v17.07c0 1.07 0.87 1.94 1.94 1.94h0.17c1.07 0 1.94 0.87 1.94 1.94v0.48c0 1.07-0.87 1.94-1.94 1.94h-0.17c-1.07 0-1.94 0.87-1.94 1.94v3.37c0 1.07-0.87 1.94-1.94 1.94h-1.55c-1.07 0-1.94-0.87-1.94-1.94v-3.37c0-1.07-0.87-1.94-1.94-1.94h-10.28c-1.04 0-1.89-0.81-1.94-1.85l-0.04-0.85c-0.02-0.4 0.09-0.8 0.3-1.14l13.14-20.59c0.36-0.56 0.97-0.9 1.64-0.9h2.61m-8.5 20.97h3.06c1.07 0 1.94-0.87 1.94-1.94v-11.65l-0.4 0.72-6.24 9.91c-0.81 1.28 0.12 2.96 1.64 2.96m8.5-23.95h-2.61c-1.7 0-3.25 0.85-4.16 2.28l-13.14 20.59c-0.55 0.87-0.82 1.87-0.77 2.89l0.04 0.85c0.12 2.64 2.29 4.71 4.93 4.71h9.21v2.31c0 2.72 2.22 4.94 4.94 4.94h1.55c2.72 0 4.94-2.22 4.94-4.94v-2.39c2.3-0.42 4.05-2.44 4.05-4.86v-0.48c0-2.42-1.75-4.44-4.05-4.86v-16.1c0.01-2.72-2.2-4.94-4.93-4.94z",
        fill: "#424242"
      })
    ),
    _react2.default.createElement("path", {
      d:
        "m39.45 56.67h-1.53c-1.07 0-1.94-0.87-1.94-1.94v-21.51c0-1.33-1.31-2.27-2.57-1.84l-2.85 0.97c-1.25 0.44-2.56-0.5-2.56-1.83v-0.5c0-0.81 0.51-1.54 1.27-1.82l11.43-4.2h0.69v30.73c0 1.07-0.86 1.94-1.94 1.94z",
      fill: "#FAFAFA"
    }),
    _react2.default.createElement("path", {
      d:
        "m98.06 57.01h-18.01c-1.07 0-1.94-0.87-1.94-1.94v-1.04c0-0.49 0.18-0.95 0.51-1.31l10.33-11.27c1.57-1.74 2.68-3.2 3.34-4.37s1-2.34 1-3.52c0-1.55-0.44-2.8-1.31-3.76s-2.05-1.43-3.52-1.43c-1.76 0-3.12 0.54-4.09 1.61-0.69 0.76-1.13 1.72-1.33 2.88-0.16 0.9-0.98 1.53-1.89 1.53h-1.53c-1.2 0-2.15-1.09-1.92-2.28 0.22-1.1 0.6-2.12 1.14-3.08 0.9-1.59 2.19-2.82 3.87-3.7s3.61-1.32 5.8-1.32c3.16 0 5.65 0.79 7.48 2.38s2.74 3.78 2.74 6.59c0 1.62-0.46 3.33-1.38 5.11s-2.42 3.81-4.51 6.07l-4.91 5.26c-1.16 1.24-0.28 3.26 1.42 3.26h8.71c1.07 0 1.94 0.87 1.94 1.94v0.46c0 1.06-0.87 1.93-1.94 1.93z",
      fill: "#FAFAFA"
    }),
    _react2.default.createElement("path", {
      d:
        "m34.74 86.73c0-1.07 0.87-1.94 1.94-1.94h1.37c1.67-0.01 2.99-0.45 3.97-1.3s1.46-2.08 1.46-3.69c0-1.55-0.41-2.75-1.22-3.61s-2.05-1.29-3.72-1.29c-1.46 0-2.66 0.42-3.6 1.26-0.59 0.53-0.99 1.16-1.21 1.89-0.25 0.83-0.99 1.41-1.86 1.41h-1.55c-1.25 0-2.24-1.19-1.89-2.39 0.22-0.76 0.55-1.48 1-2.17 0.89-1.37 2.12-2.44 3.71-3.21s3.37-1.15 5.33-1.15c3.25 0 5.8 0.82 7.66 2.45s2.78 3.9 2.78 6.81c0 1.46-0.47 2.84-1.4 4.13-0.34 0.47-0.72 0.9-1.13 1.28-0.91 0.85-0.82 2.26 0.16 3.03 0.56 0.43 1.03 0.93 1.43 1.49 0.93 1.31 1.4 2.88 1.4 4.7 0 2.92-1 5.25-3.01 6.98s-4.64 2.59-7.9 2.59c-3.13 0-5.69-0.84-7.69-2.5-1.41-1.17-2.32-2.62-2.73-4.34-0.29-1.19 0.68-2.32 1.9-2.32h1.59c0.87 0 1.63 0.59 1.86 1.43 0.22 0.8 0.64 1.49 1.26 2.06 0.96 0.89 2.25 1.34 3.88 1.34 1.68 0 3.01-0.45 3.98-1.34s1.45-2.19 1.45-3.89c0-1.71-0.51-3.03-1.52-3.96-1.01-0.92-2.52-1.39-4.52-1.39h-1.26c-1.07 0-1.94-0.87-1.94-1.94v-0.42z",
      fill: "#FAFAFA"
    }),
    _react2.default.createElement("path", {
      d:
        "m97.89 92.39h0.17c1.07 0 1.94 0.87 1.94 1.94v0.48c0 1.07-0.87 1.94-1.94 1.94h-0.17c-1.07 0-1.94 0.87-1.94 1.94v3.37c0 1.07-0.87 1.94-1.94 1.94h-1.55c-1.07 0-1.94-0.87-1.94-1.94v-3.37c0-1.07-0.87-1.94-1.94-1.94h-10.28c-1.04 0-1.89-0.81-1.94-1.85l-0.04-0.85c-0.02-0.4 0.09-0.8 0.3-1.14l13.14-20.59c0.36-0.56 0.97-0.9 1.64-0.9h2.61c1.07 0 1.94 0.87 1.94 1.94v17.07c0 1.1 0.87 1.96 1.94 1.96zm-12.38 0h3.06c1.07 0 1.94-0.87 1.94-1.94v-11.65l-0.4 0.72-6.24 9.91c-0.81 1.28 0.12 2.96 1.64 2.96z",
      fill: "#FAFAFA"
    })
  );
}

exports.default = Emoji1234;
