  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <radialGradient
        ...
        cy={9.9542}
        r={115.5}
        gradientTransform="matrix(-.0021809 .9906 -.4419 -.00095467 52.461 -37.036)"
      ...
      <radialGradient
        ...
        fx={55.192}
        fy={229.54}
        gradientTransform="matrix(-.0067217 .9851 -.3362 .0036853 142.3 4.0201)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <path
        d="m54.66 84.22c-2.01 0-3.74-0.67-5-1.95-1.37-1.39-2.11-3.4-2.08-5.67l-0.8-20.98c0.05-4.17 3.82-7.64 8.4-7.66 2.36 0 4.49 0.87 6.04 2.44 1.39 1.41 2.15 3.25 2.12 5.18l-1.29 20.83c-0.06 4.61-3.08 7.79-7.36 7.81h-0.03z"
        fill="url(#c)"
      />
      <path
        d="m55.21 46.46v3c1.92 0 3.67 0.71 4.94 1.99 1.09 1.11 1.69 2.54 1.69 4.04l-1.29 20.82c0 0.05 0 0.1-0.01 0.15-0.04 3.1-1.86 6.23-5.89 6.25-1.63 0-2.95-0.51-3.93-1.5-1.09-1.1-1.67-2.73-1.65-4.6v-0.15l-0.79-20.82c0.08-3.4 3.16-6.17 6.91-6.18l0.02-3m0 0h-0.04c-5.4 0.02-9.83 4.15-9.9 9.21l0.8 20.91c-0.06 5.05 3.21 9.14 8.58 9.14h0.04c5.4-0.02 8.79-4.15 8.85-9.21l1.3-20.91c0.07-5.06-4.24-9.14-9.63-9.14z"
        fill="#4A2F27"
      />
      <radialGradient
        id="b"
      ...
      <path
        d="m37.49 82.85c-3.95 0-6.94-2.83-7.42-7.05l-3.03-17.2c-0.21-1.89 0.37-3.86 1.65-5.45 1.41-1.75 3.56-2.89 5.91-3.13 0.31-0.03 0.63-0.05 0.94-0.05 4.36 0 7.99 3.03 8.45 7.05l0.91 17.02c0.28 2.44-0.28 4.62-1.57 6.22-1.17 1.45-2.87 2.33-4.91 2.54-0.32 0.04-0.63 0.05-0.93 0.05z"
        fill="url(#b)"
      />
      <path
        d="m35.53 51.49c3.56 0 6.54 2.42 6.95 5.64l0.92 17.01c0 0.06 0.01 0.12 0.02 0.18 0.22 1.95-0.22 3.73-1.26 5.02-0.91 1.13-2.26 1.82-3.9 1.98-0.26 0.03-0.52 0.04-0.77 0.04-3.2 0-5.53-2.24-5.93-5.72l-0.03-0.18-3-17.01c-0.16-1.55 0.31-3.09 1.32-4.35 1.16-1.44 2.94-2.38 4.89-2.58 0.27-0.02 0.53-0.03 0.79-0.03m0-3c-0.36 0-0.72 0.02-1.09 0.05-5.5 0.56-9.48 5.18-8.88 10.33l3.02 17.11c0.55 4.81 3.98 8.37 8.91 8.37 0.35 0 0.71-0.02 1.07-0.05 5.5-0.56 8.43-5.18 7.84-10.33l-0.92-17.11c-0.56-4.81-4.9-8.37-9.95-8.37z"
        fill="#4A2F27"
      />
      <radialGradient
        id="a"
        ...
        cy={492.74}
        r={80.744}
        gradientTransform="matrix(-.7863 .2317 .2647 .8812 1.8741 -398.11)"
        gradientUnits="userSpaceOnUse"
      >
