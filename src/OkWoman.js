...
function OkWoman(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m20.43 118.09v9.89h87.14v-9.89c0-15.17-21.39-20.7-43.24-20.68-21.72 0.03-43.9 4.62-43.9 20.68z"
        clipPath="url(#a)"
        fill="url(#e)"
        stroke="#009984"
        strokeLinecap="round"
      ...
      <g clipPath="url(#a)">
        <defs>
          <rect id="j" width={128} height={128} />
        </defs>
        <clipPath id="i">
          <use xlinkHref="#j" />
        </clipPath>
      ...
      <g clipPath="url(#a)">
        <defs>
          <rect id="t" width={128} height={128} />
        </defs>
        <clipPath id="s">
          <use xlinkHref="#t" />
        </clipPath>
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m31.88 94.97c-7.14-9.52-7.08-19.3-7.08-19.3l-9.33-3.33 8.45 36.45h26.88l-8.88-8.79s-8.67-3.2-10.04-5.03z"
          fill="url(#d)"
        />
        <linearGradient
          id="r"
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m96.54 94.97c7.14-9.52 7.08-19.3 7.08-19.3l9.33-3.33-8.45 36.45h-26.89l8.89-8.79s8.67-3.2 10.04-5.03z"
          fill="url(#b)"
        />
        <linearGradient
          id="p"
          ...
          y1={19.874}
          y2={19.874}
          gradientTransform="matrix(-1 0 0 1 186.89 0)"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FFB300" offset={0} />
          <stop stopColor="#FFCA28" offset={0.4007} />
        ...
        <path
          d="m98.16 34.43c-1.37 0-1.9-0.31-1.97-0.4-1.57-9.51-7.62-14.06-8.31-14.55-0.82-0.58-1.64-1.96-2.43-3.29-1.02-1.71-1.98-3.33-3.27-3.94l-0.59-0.34c-3.81-2.17-6.56-3.73-11.01-4.1-2.69-0.12-3.33-1.19-3.58-1.99-0.04-0.11-0.04-0.18-0.03-0.19 0.01 0 0.33-0.31 1.83-0.31 4.86 0.03 7.88 0.77 16.25 3.94 5.68 2.15 10.47 5.08 13.14 8.03 5.26 5.82 7.11 12.41 7.08 13.31-0.09 2.37-4.19 3.83-7.11 3.83z"
          fill="url(#p)"
        />
        <path
