...
function OpenMouth(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m84 87.92c0 8.16-8.95 12.96-20 12.96s-20-4.79-20-12.96 8.95-17.04 20-17.04 20 8.87 20 17.04z"
        fill="#242424"
      />
      <path
        d="m83.76 38.05c3.69 0 7.04 4.33 7.04 11.5s-3.35 11.5-7.04 11.5-7.04-4.33-7.04-11.5 3.36-11.5 7.04-11.5z"
        fill="#242424"
      />
      <path
        d="m44.22 38.05c-3.69 0-7.04 4.33-7.04 11.5s3.35 11.5 7.04 11.5 7.04-4.33 7.04-11.5-3.35-11.5-7.04-11.5z"
        fill="#242424"
      />
    </svg>
  );
