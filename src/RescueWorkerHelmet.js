...
function RescueWorkerHelmet(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m20.58 59.36 87.42 0.28v14.36c0 23.16-17.58 42-39.2 42h-9.44c-21.58 0-39.14-18.78-39.2-41.89l0.42-14.75m-7.78-8.03-0.63 22.67c0 27.61 21.13 50 47.2 50h9.44c26.07 0 47.2-22.39 47.2-50v-22.33l-103.21-0.34z"
        fill="url(#j)"
      />
      <path
        d="m71.57 124h-15.14c-4.66 0-8.43-3.77-8.43-8.43v-0.57c0-1.66 1.34-3 3-3h26c1.66 0 3 1.34 3 3v0.57c0 4.66-3.77 8.43-8.43 8.43z"
        fill="#8D6E63"
      />
      <ellipse cx={64.11} cy={63.33} rx={60} ry={16.67} fill="#C62828" />
      <ellipse cx={64.11} cy={60.3} rx={60} ry={16.67} fill="#E53935" />
      <defs>
        <path
          id="d"
          d="m117.68 53.81c-0.88-17.96-13.61-48.13-52.52-48.9 0 0-0.73-0.02-1.05-0.02s-1.05 0.02-1.05 0.02c-38.9 0.77-51.63 30.94-52.51 48.9 0 14.06 107.13 14.06 107.13 0z"
        />
      </defs>
      <linearGradient
        id="a"
      ...
      <path
        d="m76.21 58.7h-24.19c-1.47 0-2.67-1.2-2.67-2.67v-49.36c0-1.47 1.2-2.67 2.67-2.67h24.19c1.47 0 2.67 1.2 2.67 2.67v49.36c0 1.47-1.2 2.67-2.67 2.67z"
        fill="url(#h)"
      />
      <path
        d="m56 55.36v-38c0-1.66 1.34-3 3-3h10c1.66 0 3 1.34 3 3v38.01c0 1.66-1.34 3-3 3h-10c-1.66-0.01-3-1.35-3-3.01z"
        fill="#fff"
      />
      <ellipse cx={64.11} cy={63.33} rx={60} ry={16.67} fill="#C62828" />
      <ellipse cx={64.11} cy={60.3} rx={60} ry={16.67} fill="#E53935" />
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#EF5350" offset={0.3232} />
        <stop stopColor="#E53935" offset={1} />
      </radialGradient>
      <ellipse cx={64.11} cy={60.3} rx={60} ry={16.67} fill="url(#i)" />
      <defs>
        <path
          id="b"
          d="m117.68 53.81c-0.88-17.96-13.61-48.13-52.52-48.9 0 0-0.73-0.02-1.05-0.02s-1.05 0.02-1.05 0.02c-38.9 0.77-51.63 30.94-52.51 48.9 0 14.06 107.13 14.06 107.13 0z"
...
export default RescueWorkerHelmet;
