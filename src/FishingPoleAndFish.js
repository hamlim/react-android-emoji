  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        >
          <stop stopColor="#64B5F6" offset={0.0114} />
          <stop stopColor="#2196F3" offset={0.9881} />
        </linearGradient>
        <path
          d="m32.72 123.85-4.42-1.91c-3.5-1.52-7.31-2.15-11.12-1.86l-3.42 0.27c-1.07 0.08-1.76-1.13-1.17-2.07 2.58-4.14 8.39-12.4 13.16-11.54 4.78 0.87 7.63 10.73 8.74 15.53 0.26 1.08-0.79 2.01-1.77 1.58z"
          fill="url(#g)"
        />
        <g opacity={0.2}>
          <path
            d="m25.05 108.68c0.12 0 0.24 0.01 0.35 0.03 2.34 0.42 4.99 5.38 6.85 12.76l-3.16-1.37c-3.21-1.39-6.6-2.09-10.09-2.09-0.66 0-1.32 0.03-1.97 0.08l-2.04 0.16c3.86-5.93 7.67-9.57 10.06-9.57m0-2c-4.62 0-10 7.67-12.45 11.6-0.57 0.91 0.06 2.08 1.07 2.08h0.1l3.42-0.27c0.61-0.05 1.21-0.07 1.82-0.07 3.19 0 6.35 0.65 9.3 1.93l4.42 1.91c0.17 0.07 0.34 0.11 0.5 0.11 0.8 0 1.49-0.79 1.28-1.69-1.11-4.8-3.96-14.66-8.74-15.53-0.24-0.05-0.48-0.07-0.72-0.07z"
            fill="#444"
          />
        </g>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#64B5F6" offset={0.0031888} />
          <stop stopColor="#2196F3" offset={0.7129} />
        </linearGradient>
        <path
          d="m38.83 106.39-4.69-0.85 17.29-36.2 10.5 6.36c1.15 0.7 1.65 2.22 1.16 3.59-0.93 2.63-2.54 7.01-4.38 11.04-2.51 5.46-12.02 17.48-19.88 16.06z"
          fill="url(#f)"
        />
        <linearGradient
          id="e"
        ...
        <radialGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#BBDEFB" offset={0.3579} />
          <stop stopColor="#64B5F6" offset={0.7143} />
        </radialGradient>
        <path
          d="m41.2 50.85-5.61 2.76-4.12-4.53s-17.81 3.76-21.15 22.19c-4.87 26.88 14.8 40.57 14.8 40.57s25.84-5.1 30.78-32.31c3.39-18.77-14.7-28.68-14.7-28.68z"
          fill="url(#d)"
        />
        <defs>
          <path
            id="c"
            d="m41.2 50.85-5.71 3.07-4.02-4.83s-17.81 3.76-21.15 22.19c-4.87 26.88 14.8 40.57 14.8 40.57s25.84-5.1 30.78-32.31c3.39-18.78-14.7-28.69-14.7-28.69z"
          />
        </defs>
        <clipPath id="b">
          <use xlinkHref="#c" />
        ...
        <radialGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#E3F2FD" offset={0.4351} />
          <stop stopColor="#90CAF9" offset={0.9562} />
        </radialGradient>
        <path
          d="m27.56 113.8c3.37 7.92-36.31-5.24-36.31-5.24l12.03-66.39 33.42 3.32 12.14 4.34s8.09 15.26-12.61 21.99c-17.8 5.79-13.2 31.33-8.67 41.98z"
          clipPath="url(#b)"
          fill="url(#m)"
        />
        <ellipse
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m95.91 108.92-14.82 10.65c-1.25 0.9-2.99 0.61-3.89-0.64l-0.67-0.93c-0.9-1.25-0.61-2.99 0.64-3.89l14.82-10.65c1.25-0.9 2.99-0.61 3.89 0.64l0.67 0.93c0.89 1.26 0.61 3-0.64 3.89z"
          fill="#FFD54F"
        />
        <g opacity={0.2}>
          <path
...
export default FishingPoleAndFish;
