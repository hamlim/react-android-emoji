...
function Chicken(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#F73D41" offset={0.4563} />
        <stop stopColor="#F43C40" offset={0.56} />
        <stop stopColor="#EA3A3D" offset={0.6449} />
        <stop stopColor="#D83539" offset={0.7232} />
        <stop stopColor="#C02F32" offset={0.7975} />
        <stop stopColor="#A1272A" offset={0.869} />
        <stop stopColor="#7C1E20" offset={0.9374} />
        <stop stopColor="#541415" offset={0.9973} />
      </linearGradient>
      <path
      ...
      />
      <path
        d="m67.19 98.21s-2.19 8.78-3.2 11.92c-0.98 3.05-6.89 5.67-12.31 5.43-3.88-0.18-5.47 0.31-6.03 2.6s0.43 1.65 0.43 1.65 1.81-1.04 3.02-0.94c2.34 0.18 1.72 0.71 4.11 0.35 2.23-0.33 2.09-0.82 2.09-0.82s-1.39 1.72-0.47 3.36 1.17 1.36 1.17 1.36 0.11-2.34 2.46-2.89 3.39-1.65 3.39-1.65 3.39-1.4 5.22 0.24 2.95 1.67 4.13 1.53 3.45 2.06 3.45 2.06 0.92-3.48-2.74-4.96c-2.58-1.04-5.1-4.14-4.24-7.09s5.32-11.07 5.32-11.07l-5.8-1.08z"
        fill="#F7931E"
        stroke="#8C6239"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <linearGradient
        ...
        y1={28.256}
        y2={62.877}
        gradientTransform="matrix(.996 .0889 -.0889 .996 4.9164 10.478)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#fff" offset={0.2337} />
        <stop stopColor="#BDBDBD" offset={1} />
      ...
      <path
        d="m43.96 52.76c0.07 0.45-0.05 33.6 32.94 25.84 0 0 3.95 2.53 9.53 1.03 3.53-0.95 23.69-13.31-15.29-30.66-20.05-8.91-26.03-3.83-27.18 3.79z"
        fill="url(#b)"
      />
      <path
        d="m30.47 30.87c-3.05 0-5.54-2.48-5.54-5.54s2.48-5.54 5.54-5.54c3.05 0 5.54 2.48 5.54 5.54s-2.49 5.54-5.54 5.54z"
        fill="#fff"
      />
      <path
        d="m30.47 20.55c2.64 0 4.79 2.14 4.79 4.79s-2.14 4.79-4.79 4.79c-2.64 0-4.79-2.14-4.79-4.79s2.14-4.79 4.79-4.79m0-1.5c-3.47 0-6.29 2.82-6.29 6.29s2.82 6.29 6.29 6.29 6.29-2.82 6.29-6.29-2.83-6.29-6.29-6.29z"
        fill="#999"
      />
      <circle cx={30.33} cy={25.33} r={1.5} />
      <path
        d="m11.97 29.1c0.83-0.09 2.09-0.11 3.83 0.18 3.57 0.59 5.85 1.18 5.85 1.18s0.25-1.56 0.14-3.23c-3.09-1.17-6.84-0.3-9.82 1.87z"
        fill="#F15A24"
      />
      <g opacity={0.2}>
        <path
          d="m18.83 27.71c0.69 0 1.36 0.09 1.99 0.26 0.01 0.46-0.01 0.9-0.04 1.26-1.02-0.23-2.68-0.58-4.81-0.93-0.09-0.01-0.18-0.03-0.27-0.04 1.04-0.36 2.1-0.55 3.13-0.55m0-1c-2.34 0-4.79 0.88-6.86 2.39 0.32-0.03 0.7-0.06 1.15-0.06 0.72 0 1.61 0.06 2.68 0.24 3.57 0.59 5.85 1.18 5.85 1.18s0.25-1.56 0.14-3.23c-0.94-0.35-1.94-0.52-2.96-0.52z"
          fill="#8C6239"
        />
      </g>
      <path
        d="m17.37 23.57c-5.57 2.17-6.57 5.76-6.57 5.76s0.39-0.15 1.17-0.23c2.98-2.17 6.73-3.04 9.82-1.87-0.16-2.37-1.05-4.97-4.42-3.66z"
        fill="#FFA726"
      />
      <g opacity={0.2}>
        <path
      ...
      <linearGradient
        ...
        y1={29.589}
        y2={46.086}
        gradientTransform="matrix(.9885 .151 -.151 .9885 5.6934 -3.2194)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F73D41" offset={0.4563} />
        <stop stopColor="#F43C40" offset={0.56} />
