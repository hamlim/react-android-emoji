...
function RepeatOne(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("path", {
        d:
          "m114.8 54.71c0-0.01-0.02-0.02-0.02-0.03l-14.78 13.32c-0.45 10.49-7.18 12-12 12h-13.17c0.76 2.54 1.17 5.22 1.17 8s-0.41 5.46-1.17 8h13.17c15.46 0 28-14.33 28-32 0-3.23-0.42-6.35-1.2-9.29z"
      }),
      _react2.default.createElement("path", {
        d:
          "m114.63 36.99-24-23.99c-2.58-2.27-6.63-0.43-6.63 3.01v13.99c0 1.1-0.9 2-2 2h-34c-15.46 0-28 14.33-28 32 0 3.23 0.42 6.35 1.2 9.29 0 0.01 0.02 0.02 0.02 0.03l0.09-0.08c3.02-5.97 8.2-10.66 14.5-13.07l0.19-0.17c0.45-10.49 7.18-12 12-12h34c1.1 0 2 0.9 2 2v13.99c0 3.44 4.05 5.27 6.63 3.01l24-23.99c1.83-1.59 1.83-4.43 0-6.02z"
      })
    ),
    _react2.default.createElement("path", {
      d:
        "m46.7 63.42c-13.02 0-23.57 10.55-23.57 23.57s10.55 23.57 23.57 23.57 23.57-10.55 23.57-23.57-10.55-23.57-23.57-23.57zm5.29 42.23c0 0.54-0.44 0.98-0.98 0.98h-6.65c-0.54 0-0.98-0.44-0.98-0.98v-25.13c0-0.65-0.63-1.13-1.26-0.94l-5.94 1.74c-0.63 0.18-1.26-0.29-1.26-0.94v-4.51c0-0.42 0.27-0.79 0.66-0.93l15.12-4.98c0.64-0.21 1.29 0.26 1.29 0.93v34.76z",
      fill: "#FAFAFA"
    })
  );
}
