...
function Sunflower(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g opacity={0.2}>
        <path
          d="m65.34 81.86v39.92h-3.86v-39.92h3.86m2.1-2.1h-8.07v44.13h8.07v-44.13z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      <defs>
        <circle id="b" cx={63.41} cy={53.4} r={23.93} />
      </defs>
      <clipPath id="a">
        <use xlinkHref="#b" />
      </clipPath>
      <g clipPath="url(#a)" fill="#5D4037">
        <rect
      ...
      <path
        d="m67.48 112.53s3.76 6.63 16.63 4c8.18-1.67 19-13.96 19-13.96s-11.69-6.49-23.65-2.89c-8.68 2.61-11.43 9.96-11.98 12.85z"
        fill="#7CB342"
      />
      <g opacity={0.2}>
        <path
      ...
      <path
        d="m59.16 112.53s-3.75 6.62-16.61 3.99c-8.17-1.67-18.98-13.95-18.98-13.95s11.67-6.48 23.62-2.88c8.67 2.61 11.41 9.96 11.97 12.84z"
        fill="#7CB342"
      />
      <g opacity={0.2}>
        <path
          d="m39.56 98.6v3.09c2.37 0 4.63 0.32 6.74 0.96 6.28 1.89 8.64 6.7 9.45 9.11-1.05 0.92-3.33 2.29-7.54 2.29-1.55 0-3.24-0.19-5.04-0.55-4.42-0.9-10.42-6.02-14.3-9.84 2.66-0.95 6.48-1.96 10.68-1.96l0.01-3.1m0 0c-8.83 0-15.98 3.97-15.98 3.97s10.81 12.28 18.98 13.95c2.13 0.43 4.01 0.62 5.66 0.62 8.33 0 10.95-4.61 10.95-4.61-0.56-2.89-3.3-10.23-11.97-12.84-2.6-0.78-5.19-1.09-7.64-1.09z"
          fill="#424242"
        />
      </g>
    </svg>
