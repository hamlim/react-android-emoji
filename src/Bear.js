...
function Bear(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#916747" offset={0} />
        <stop stopColor="#946A48" offset={0.1477} />
        <stop stopColor="#9F734C" offset={0.274} />
        <stop stopColor="#A97C50" offset={0.3484} />
      </linearGradient>
      <circle
        cx={22.92}
        cy={24.8}
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#7D593D" offset={0.0011772} />
        <stop stopColor="#896242" offset={0.1846} />
        <stop stopColor="#A87B4F" offset={0.513} />
        <stop stopColor="#A97C50" offset={0.5247} />
      </linearGradient>
      <path
        d="m64 120.66c-46.7 0-56.5-24.26-56.5-44.61 0-15.76 5.39-31.72 14.78-43.77 7.42-9.53 20.68-20.87 41.72-20.87s34.3 11.35 41.72 20.87c9.4 12.06 14.78 28.01 14.78 43.77 0 20.35-9.8 44.61-56.5 44.61z"
        fill="url(#b)"
      />
      <path
        d="m64 12.91c20.44 0 33.33 11.03 40.54 20.29 9.19 11.79 14.46 27.41 14.46 42.85 0 35.63-29.91 43.11-55 43.11s-55-7.48-55-43.11c0-15.44 5.27-31.06 14.47-42.85 7.2-9.26 20.09-20.29 40.53-20.29m0-3c-37.07 0-58 35.15-58 66.14s21.58 46.11 58 46.11 58-15.11 58-46.11-20.93-66.14-58-66.14z"
        fill="#8B5E3C"
      />
      <g fill="#404040">
      ...
      <path
        d="m72.96 71h-17.92c-10.34 0-18.81 8.66-18.81 19s8.46 19 18.81 19h17.91c10.34 0 18.81-8.66 18.81-19s-8.46-19-18.8-19z"
        fill="#E6A965"
      />
      <linearGradient
        id="a"
