...
function Disappointed(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("path", {
        d:
          "m74.41 67.7c-1.61 1.49-1.36 4.01 0.51 5.34 2.37 1.69 5.81 3.75 9.68 4.8 3.87 1.06 7.87 1.04 10.77 0.79 2.28-0.2 3.78-2.24 3.15-4.34-0.51-1.69-2.24-2.83-4.07-2.67-2.19 0.2-5.22 0.23-8-0.53-2.79-0.76-5.37-2.33-7.16-3.62-1.51-1.08-3.59-0.97-4.88 0.23z"
      }),
      _react2.default.createElement("path", {
        d:
          "m53.59 67.7c1.61 1.49 1.36 4.01-0.51 5.34-2.37 1.69-5.81 3.75-9.68 4.8-3.87 1.06-7.87 1.04-10.77 0.79-2.28-0.2-3.78-2.24-3.15-4.34 0.51-1.69 2.24-2.83 4.07-2.67 2.19 0.2 5.22 0.23 8-0.53 2.79-0.76 5.37-2.33 7.16-3.62 1.51-1.08 3.59-0.97 4.88 0.23z"
      })
    )
  );
}

exports.default = Disappointed;
