...
function FastForward(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g fill="#FAFAFA">
        <path d="M24,64V38.34c0-1.79,1.69-2.91,3.05-2.03l38.93,25.66c1.37,0.9,1.37,3.16,0,4.05L27.05,91.69 C25.69,92.58,24,91.45,24,89.66V64z" />
        <path d="M64,64V38.34c0-1.79,1.73-2.91,3.12-2.03l39.83,25.66c1.4,0.9,1.4,3.16,0,4.05L67.12,91.69 C65.73,92.58,64,91.45,64,89.66V64z" />
      </g>
    </svg>
  );
}
