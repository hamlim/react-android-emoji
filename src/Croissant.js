...
function Croissant(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m115.57 38.31c-0.65-0.28-1.31-0.36-1.92-0.1-1.88 0.77-3.32 4.8-4.51 6.41-1.7 2.31-3.63 4.45-5.74 6.39-0.59 0.54-6.05 5.42-6.57 4.99 1.01 0.84 2.08 1.62 3.19 2.33 0.19-0.07 0.39-0.14 0.58-0.23 7.72-3.44 16.44-11.13 14.97-19.79z"
        fill="#B05E19"
      />
      <radialGradient
        id="g"
        ...
        cy={50.585}
        r={15.5}
        gradientTransform="translate(-229.36)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#EBA955" offset={0} />
        <stop stopColor="#E99C40" offset={0.2915} />
        <stop stopColor="#E27A0B" offset={0.8905} />
        <stop stopColor="#E17300" offset={1} />
      </radialGradient>
      <path
        d="m123.09 49.49c-0.8-2.5-1.77-4.98-3.27-7.13-0.8-1.14-2.51-3.32-4.25-4.06 1.48 8.66-7.25 16.35-14.97 19.78-0.19 0.09-0.38 0.16-0.58 0.23 3.79 2.43 8.09 4.06 12.55 4.72 3.54 0.53 7.66 0.24 9.96-2.51 2.47-2.94 1.74-7.36 0.56-11.03z"
        fill="url(#g)"
      />
      <path
        d="m87.87 20.8c-3.35 0.92-0.71 5.77-0.27 8.62 0.68 4.38 0.58 8.88-0.26 13.23-0.23 1.18-3.28 12.39-4.6 12.04 0.95 0.25 1.92 0.5 2.89 0.74 1.32-1.55 2.51-3.19 3.55-4.84 5.23-8.92 6.98-22.77-1.31-29.79z"
        fill="#B05E19"
      />
      <path
        d="m94.08 46.34c2.66-8.27 2.37-18.41-2.78-25.58-0.73-0.08-1.45-0.12-2.17-0.12-0.49 0-0.91 0.06-1.26 0.15 8.29 7.03 6.54 20.87 1.31 29.79-1.05 1.64-2.23 3.29-3.55 4.84 0.07 0.02 0.15 0.04 0.23 0.05 3.33-2.49 6.7-4.81 8.22-9.13z"
        fill="#F4B972"
      />
      <radialGradient
        id="f"
      ...
      >
        <stop stopColor="#EBA955" offset={0} />
        <stop stopColor="#E99E43" offset={0.1551} />
        <stop stopColor="#E5871F" offset={0.5181} />
        <stop stopColor="#E27808" offset={0.8127} />
        <stop stopColor="#E17300" offset={1} />
      </radialGradient>
      <path
        d="m112.2 32.63c-2.91-3.74-6.71-6.74-10.97-8.81-3-1.46-6.51-2.68-9.94-3.05 5.16 7.17 5.44 17.31 2.78 25.58-1.51 4.32-4.88 6.64-8.22 9.13 5.03 1.2 10.25 1.93 14.95 0.01 5.07-2.07 8.46-6.8 11.58-11.3 1.06-1.53 2.16-3.15 2.35-5 0.25-2.4-1.06-4.67-2.53-6.56z"
        fill="url(#f)"
      />
      <path
        d="m59.17 24.16c-2.72-1.94-6.95-1.8-10.33-2.75-0.55 0.13-1.11 0.3-1.66 0.51-1.54 1.48-1.74 3.09 1.36 4.44 1.11 0.48 2.33 0.65 3.51 0.95 6.27 1.59 11.04 6.81 14.01 12.55s4.49 12.1 6.65 18.19c0.38 1.08 0.86 2.22 1.82 2.81 0.32-1.08 0.55-2.17 0.95-3.09 0.02-0.08 0.04-0.17 0.06-0.26-0.33-12.82-4.97-25.1-16.37-33.35z"
        fill="#B05E19"
      />
      <path
        d="m75.48 49.93c-0.65-3.92-1.63-7.5-2.94-11.09-3.63-9.5-13.24-19.95-23.71-17.43 3.39 0.95 7.61 0.81 10.33 2.75 11.4 8.26 16.05 20.54 16.38 33.35 0.58-2.25 0.57-5.06-0.06-7.58z"
        fill="#F4B972"
      />
      <radialGradient
        id="e"
      ...
      >
        <stop stopColor="#EBA955" offset={0} />
        <stop stopColor="#EAA650" offset={0.1903} />
        <stop stopColor="#E99C40" offset={0.4307} />
        <stop stopColor="#E58B26" offset={0.6982} />
        <stop stopColor="#E17402" offset={0.9835} />
        <stop stopColor="#E17300" offset={1} />
      </radialGradient>
      <path
        d="m50.69 78.55c2.49-2.18 3.96-5.58 3.97-8.94 0.02-4.39-2.14-8.6-5.22-11.73-3.09-3.12-7.04-5.26-11.11-6.91-4.75-1.93-9.83-3.26-14.94-3.01-5.12 0.25-10.28 2.23-13.67 6.07-2.55 2.89-3.95 6.64-4.6 10.43-0.64 3.79-0.58 7.67-0.49 11.52 0.08 3.34 0.17 6.73 1.1 9.95 0.18 0.63 0.41 1.31 0.68 1.99 12.83-8.97 29.19-13.26 44.28-9.37z"
        fill="url(#c)"
      />
      <path
        d="m7.85 90.64c1.2 1.75 2.85 2.99 5.04 2.68 4.65-0.67 8.66-2.74 12.61-5.19 4.24-2.63 8.52-5.49 13.42-6.39 3.07-0.56 6.32-0.34 9.19-1.56 0.95-0.4 1.81-0.97 2.58-1.64-2.04-0.53-4.1-0.9-6.18-1.13-13.56-0.25-27.11 3.73-36.66 13.23z"
        fill="#B05E19"
      />
      <path
        d="m6.41 87.91c0.38 0.95 0.86 1.9 1.44 2.73 9.55-9.5 23.1-13.48 36.66-13.23-13.27-1.5-27 2.75-38.1 10.5z"
        fill="#F4B972"
      />
      <radialGradient
        id="b"
      ...
      >
        <stop stopColor="#EBA955" offset={0} />
        <stop stopColor="#EAA34B" offset={0.1939} />
        <stop stopColor="#E79231" offset={0.5189} />
        <stop stopColor="#E27808" offset={0.9328} />
        <stop stopColor="#E17300" offset={1} />
      </radialGradient>
      <path
        d="m53.37 94.39c-0.06-1.02-0.35-2.07-0.65-3.05-1.35-4.39-3.13-9.28-7.33-11.12-2.56-1.12-5.49-0.84-8.24-0.32-7 1.32-13.72 4.07-19.66 8-2.18 1.44-6.49 3.6-6.39 6.43 0.13 3.57 2.47 7.37 4.59 10.09 2.49 3.22 5.58 5.91 8.65 8.59 0.3 0.26 0.6 0.52 0.92 0.77 5.67-10.05 16.82-17.01 28.11-19.39z"
        fill="url(#b)"
      />
      <path
        d="m25.25 113.78c0.45 0.36 0.93 0.71 1.42 1.01 6.43-9.38 16.34-15.03 26.67-19.42 0.04-0.32 0.04-0.65 0.03-0.98-11.29 2.38-22.44 9.34-28.12 19.39z"
        fill="#F4B972"
      />
      <path
        d="m26.67 114.79c1.05 0.63 2.18 1.02 3.38 0.83 1.97-0.31 3.32-2.08 4.56-3.64 4.13-5.2 9.33-9.55 15.17-12.7 1.14-0.61 2.36-1.24 3.03-2.34 0.3-0.49 0.46-1.02 0.52-1.57-10.32 4.39-20.23 10.03-26.66 19.42z"
        fill="#B05E19"
      />
      <radialGradient
        id="a"
