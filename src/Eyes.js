...
function Eyes(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#FAFAFA" offset={0.5926} />
      ...
      <path
        d="m85.57 60.14c-2.67-2.51-2.07-7.49 1.34-11.13 0.18-0.19 0.36-0.36 0.54-0.54-1.52-0.86-3.2-1.35-4.95-1.35-7.11 0-12.88 7.84-12.88 17.5s5.76 17.5 12.88 17.5 12.88-7.84 12.88-17.5c0-1.73-0.19-3.41-0.54-4.99-3.2 2.31-7.03 2.61-9.27 0.51z"
        fill="#424242"
      />
      <g opacity={0.2}>
        <path
          d="m82.44 50.13c-0.77 1.44-1.27 2.98-1.46 4.51-0.36 3.03 0.56 5.83 2.54 7.69 1.55 1.46 3.59 2.23 5.89 2.23 0.98 0 1.98-0.14 2.97-0.42 0 0.16 0.01 0.33 0.01 0.49 0 7.86-4.52 14.5-9.88 14.5s-9.88-6.64-9.88-14.5c-0.01-7.83 4.48-14.45 9.81-14.5m0.06-3.01c-7.11 0-12.88 7.84-12.88 17.5s5.76 17.5 12.88 17.5 12.88-7.84 12.88-17.5c0-1.73-0.19-3.41-0.54-4.99-1.74 1.25-3.68 1.92-5.44 1.92-1.47 0-2.81-0.46-3.83-1.42-2.67-2.51-2.07-7.49 1.34-11.13 0.18-0.19 0.36-0.36 0.54-0.54-1.52-0.85-3.19-1.34-4.95-1.34z"
          fill="#eee"
        />
      </g>
    </svg>
