...
function SparklingHeart(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m93.92 9.08c-21.92 0-29.97 26.2-29.97 26.2s-7.95-26.2-30.03-26.2c-16.59 0-35.51 13.15-28.52 43.03 6.99 29.89 58.33 66.97 58.33 66.97s0.26-0.1 0.26-0.27c0 0.16 0.17 0.25 0.17 0.25s51.27-37.06 58.26-66.95c6.99-29.88-11.91-43.03-28.5-43.03z"
        fill="url(#a)"
      />
      <g opacity={0.2}>
        <path
      ...
      <g opacity={0.2}>
        <path
          d="m79.31 46.24c1.1 0 2 0.9 2 2s-0.9 2-2 2-2-0.9-2-2 0.89-2 2-2m0-1c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.35-3-3-3z"
          fill="#424242"
        />
      </g>
      <circle cx={71.76} cy={81.58} r={4.21} fill="#fff" />
      <g opacity={0.2}>
        <path
          d="m71.76 78.37c1.77 0 3.21 1.44 3.21 3.21s-1.44 3.21-3.21 3.21-3.21-1.44-3.21-3.21 1.44-3.21 3.21-3.21m0-1c-2.32 0-4.21 1.88-4.21 4.21s1.89 4.21 4.21 4.21c2.33 0 4.21-1.88 4.21-4.21s-1.88-4.21-4.21-4.21z"
          fill="#424242"
        />
      </g>
      <circle cx={51.9} cy={56.75} r={4.21} fill="#fff" />
      <g opacity={0.2}>
        <path
          d="m51.9 53.54c1.77 0 3.21 1.44 3.21 3.21s-1.44 3.21-3.21 3.21-3.21-1.44-3.21-3.21 1.44-3.21 3.21-3.21m0-1c-2.33 0-4.21 1.88-4.21 4.21s1.88 4.21 4.21 4.21 4.21-1.88 4.21-4.21-1.89-4.21-4.21-4.21z"
          fill="#424242"
        />
      </g>
      <circle cx={21.28} cy={55.92} r={2.87} fill="#fff" />
      <g opacity={0.2}>
        <path
          d="m21.28 54.05c1.03 0 1.87 0.84 1.87 1.87s-0.84 1.87-1.87 1.87-1.87-0.84-1.87-1.87 0.83-1.87 1.87-1.87m0-1c-1.59 0-2.87 1.29-2.87 2.87s1.29 2.87 2.87 2.87c1.59 0 2.87-1.29 2.87-2.87s-1.29-2.87-2.87-2.87z"
          fill="#424242"
        />
      </g>
      <circle cx={109.31} cy={46.24} r={4} fill="#fff" />
      <g opacity={0.2}>
        <path
          d="m109.31 43.24c1.65 0 3 1.35 3 3s-1.35 3-3 3-3-1.35-3-3 1.34-3 3-3m0-1c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"
          fill="#424242"
        />
      </g>
    </svg>
