  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <radialGradient
        ...
        cy={47.344}
        r={55.854}
        gradientTransform="matrix(1.0287e-13 1 -1.0267 1.0561e-13 113.15 -17.194)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#ECEFF1" offset={0} />
        <stop stopColor="#E8ECEE" offset={0.1864} />
        <stop stopColor="#DCE2E6" offset={0.3692} />
        <stop stopColor="#C9D2D7" offset={0.5506} />
        <stop stopColor="#ADBCC3" offset={0.73} />
        <stop stopColor="#90A4AE" offset={0.8805} />
      </radialGradient>
      <path
        d="m64 4.55c-27.76 0-56 23.51-56 51.27s44.33 67.68 56.17 67.68c13.17 0 55.83-39.92 55.83-67.68s-28.24-51.27-56-51.27z"
        fill="url(#c)"
      />
      <g opacity={0.2}>
        <path d="m64 8.55c12.55 0 25.58 5.18 35.76 14.21 10.32 9.17 16.24 21.22 16.24 33.06 0 11.02-8.2 26.55-21.93 41.55-12.51 13.67-25.27 22.13-29.9 22.13-3.64 0-16.27-7.89-29.6-22.16-14.34-15.36-22.57-30.49-22.57-41.52 0-11.84 5.92-23.89 16.24-33.05 10.18-9.03 23.21-14.22 35.76-14.22m0-4c-27.76 0-56 23.51-56 51.27s44.33 67.68 56.17 67.68c13.17 0 55.83-39.92 55.83-67.68s-28.24-51.27-56-51.27z" />
      </g>
      <linearGradient
        id="b"
        x1={36.576}
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#414042" offset={0} />
        <stop stopColor="#29292A" offset={0.3436} />
        <stop offset={1} />
      </linearGradient>
      <path
        d="m54.05 81.56c-2.99 3.89-17.71 3.89-28.85-6.36-10.1-9.29-9.46-25.64-6.13-28.94 3.33-3.31 19.19-3.38 28.85 6.36 9.66 9.75 9.8 25.3 6.13 28.94z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m80.08 52.58c9.66-9.69 25.52-9.61 28.85-6.32 3.33 3.28 3.53 19.11-6.13 28.8-9.67 9.69-25.16 9.95-28.85 6.32-3.67-3.63-3.53-19.1 6.13-28.8z"
        fill="url(#a)"
      />
      <path
        d="m64 102.35c-9.37 0-16.06-5.52-18.07-8.58-0.78-1.18-0.93-2.47-0.41-3.43 0.39-0.73 1.11-1.15 1.97-1.15 0.29 0 0.58 0.05 0.88 0.14 4.72 1.48 8.85 3.63 15.63 3.63 6.85 0 10.92-2.15 15.63-3.63 0.3-0.1 0.6-0.14 0.89-0.14 0.86 0 1.57 0.42 1.97 1.15 0.52 0.97 0.37 2.25-0.41 3.43-2.02 3.06-8.71 8.58-18.08 8.58z"
        fill="#242424"
      />
    </svg>
  );
