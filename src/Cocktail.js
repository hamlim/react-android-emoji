...
function Cocktail(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path d="m19.33 33.84" fill="#F5FAFC" />
      <path d="m95.11 1.14" fill="#FFCA28" />
      <linearGradient
        id="c"
        x1={63.678}
        x2={63.678}
      ...
      >
        <stop stopColor="#F2F3ED" offset={0} />
        <stop stopColor="#C8C6B9" offset={1} />
      </linearGradient>
      <ellipse cx={63.68} cy={118.15} rx={17.25} ry={5.49} fill="url(#c)" />
      <linearGradient
        id="b"
        x1={64}
        x2={64}
