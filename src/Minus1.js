  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <radialGradient
        ...
        cy={38.936}
        r={75.834}
        gradientTransform="matrix(1.0287e-13 -1 -.787 -8.0957e-14 76.694 131.12)"
      ...
      <radialGradient
        ...
        cy={-549.66}
        r={20.331}
        gradientTransform="matrix(-1.3883 -.0794 -.0374 .6794 3541.4 640.54)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <radialGradient
        ...
        cy={-727.5}
        r={18.753}
        gradientTransform="matrix(-1.6967 .001885 .0029132 .6804 4488 540.01)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#70534A" offset={0.6064} />
        <stop stopColor="#5C4037" offset={0.9991} />
      ...
      <path
        d="m92.55 60.18c-10.91 0-23.91-1.83-23.91-10.57 0-8.73 13-10.57 23.91-10.57 9.26 0 17.68 1.35 17.76 1.36s0.16 0.02 0.24 0.02c4.21 0 7.48 5.12 7.48 9.53 0 4.18-3.07 8.84-7.48 8.84-0.08 0-0.16 0.01-0.24 0.02-0.09 0.02-8.51 1.37-17.76 1.37z"
        fill="url(#c)"
      />
      <path
        d="m92.55 40.55c9.12 0 17.44 1.33 17.52 1.34 0.16 0.03 0.32 0.04 0.48 0.04 3.22 0 5.98 4.41 5.98 8.03 0 3.47-2.56 7.34-5.98 7.34-0.16 0-0.32 0.01-0.48 0.04-0.08 0.01-8.4 1.34-17.52 1.34-6.83 0-12.26-0.72-16.15-2.15-5.61-2.06-6.26-4.94-6.26-6.92 0-1.99 0.65-4.86 6.26-6.92 3.88-1.42 9.32-2.14 16.15-2.14m0-3c-11.93 0-25.41 2.19-25.41 12.07s13.47 12.07 25.41 12.07c9.49 0 18-1.38 18-1.38 5.16 0 8.98-5.23 8.98-10.34s-3.82-11.03-8.98-11.03c0-0.01-8.52-1.39-18-1.39z"
        fill="#4A2F27"
      />
      <radialGradient
        id="b"
        ...
        cy={-563.09}
        r={20.446}
        gradientTransform="matrix(-1.3069 .0062595 .0045215 .6804 3533.2 382.11)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#70534A" offset={0.6064} />
        <stop stopColor="#5C4037" offset={0.9991} />
      ...
      <path
        d="m91.85 24.59c-15.66 0-24.64-3.01-24.66-8.26 0-1.38 0.54-2.6 1.67-3.73 6.45-6.47 27.79-6.8 32-6.8 0.62 0 0.98 0.01 0.98 0.01 4.91 0 8.86 4.11 8.88 9.15 0.01 2.46-0.91 4.78-2.58 6.52-1.66 1.73-3.86 2.68-6.2 2.69-0.04 0-0.09 0-0.13 0.01-0.05 0.01-4.39 0.41-9.96 0.41z"
        fill="url(#b)"
      />
      <path
      ...
      <radialGradient
        ...
        cy={-707.6}
        r={18.611}
        gradientTransform="matrix(-1.6358 .001885 .0028087 .6804 4362.6 508.27)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#70534A" offset={0.6064} />
        <stop stopColor="#5C4037" offset={0.9991} />
