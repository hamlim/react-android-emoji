...
function Sauropod(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#2D80B1" offset={0} />
        <stop stopColor="#2E7E6D" offset={0.2656} />
        <stop stopColor="#2E7D32" offset={0.5117} />
        <stop stopColor="#378234" offset={0.5676} />
        <stop stopColor="#4E8E3B" offset={0.657} />
        <stop stopColor="#74A346" offset={0.7687} />
        <stop stopColor="#A8C055" offset={0.897} />
        <stop stopColor="#D7DA62" offset={1} />
      </linearGradient>
      <path
        d="m53.89 99.66s-1.14 5.22 0 8.73 2.64 7.54 2.12 8.68-2.43 1.14-6.52 1.19-8.28-0.83-8.28-0.83 3.05-13.84 4.35-16.48 5.69-4.34 7.51-3.87c1.81 0.47 0.82 2.58 0.82 2.58z"
        fill="url(#f)"
      />
      <linearGradient
        id="e"
      ...
      <path
        d="m67.56 104.11s-0.98 8.26-2.12 9.4-3.21 2.43-2.85 3.77 2.8 1.6 5.75 1.5 5.54-0.21 5.85-1.45-0.47-3.15 0.62-5.48c1.09-2.32 3.31-6.87 3.05-10.49-0.26-3.61-9.01-4.23-10.3 2.75z"
        fill="url(#e)"
      />
      <path
        d="m30.49 21.9c0.24-0.9 0.58-1.47 1.37-1.9 2.38-1.29 5.94-1.37 8.25-2.08 0.05-0.6-0.02-1.12-0.21-1.56-10.63 1.37-21.85 5.13-23.08 14.49 0.99-2.19 2.88-3.91 5.95-4.86 2.37-0.73 3.56-0.85 6.51-1 2.76-0.15 4.98-0.87 7.4-2.22 2.4-1.33 3.87-2.6 3.73-2.99-0.15-0.38-7.8 2.12-9.92 2.12z"
        fill="#E8CF99"
      />
      <linearGradient
        id="d"
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#2DB1A8" offset={0} />
        <stop stopColor="#2DA48B" offset={0.0585} />
        <stop stopColor="#2E966B" offset={0.1372} />
        <stop stopColor="#2E8B52" offset={0.2189} />
        <stop stopColor="#2E8340" offset={0.3037} />
        <stop stopColor="#2E7F35" offset={0.3937} />
        <stop stopColor="#2E7D32" offset={0.4976} />
        <stop stopColor="#378234" offset={0.5552} />
        <stop stopColor="#4E8E3B" offset={0.6472} />
        <stop stopColor="#74A346" offset={0.762} />
        <stop stopColor="#A8C055" offset={0.894} />
        <stop stopColor="#D7DA62" offset={1} />
      </linearGradient>
      <path
      ...
      />
      <path
        d="m27.24 18.68c-2.06 0-3.75-1.54-3.94-3.59-0.1-1.05 0.22-2.08 0.9-2.89s1.63-1.31 2.68-1.41c0.12-0.01 0.25-0.02 0.37-0.02 2.06 0 3.75 1.54 3.94 3.59 0.1 1.05-0.22 2.08-0.9 2.89s-1.63 1.31-2.68 1.41c-0.12 0.01-0.25 0.02-0.37 0.02z"
        fill="#fff"
      />
      <path
        d="m27.25 11.25c1.78 0 3.29 1.35 3.46 3.15 0.18 1.91-1.23 3.6-3.14 3.78-0.11 0.01-0.22 0.01-0.32 0.01-1.78 0-3.29-1.35-3.46-3.15-0.18-1.91 1.23-3.6 3.14-3.78 0.11-0.01 0.21-0.01 0.32-0.01m0-0.97c-0.14 0-0.27 0.01-0.41 0.02-1.18 0.11-2.25 0.67-3.01 1.58s-1.12 2.07-1.01 3.25c0.21 2.3 2.12 4.03 4.43 4.03 0.14 0 0.27-0.01 0.41-0.02 1.18-0.11 2.25-0.67 3.01-1.58s1.12-2.07 1.01-3.25c-0.22-2.3-2.12-4.03-4.43-4.03z"
        fill="#B3B3B3"
      />
      ...
      <path
        d="m9.84 41.48c4.62-2.55 9.51-4.55 14.56-5.94-0.15 0.04-2.18-4.24-2.41-4.62-4.7 1.55-9.43 6.3-12.15 10.56z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m13.08 50.48c4.62-2.55 9.51-4.55 14.56-5.94-0.15 0.04-2.18-4.24-2.41-4.62-4.7 1.55-9.43 6.3-12.15 10.56z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m18.83 59.36c4.62-2.55 9.51-4.55 14.56-5.94-0.15 0.04-2.18-4.24-2.41-4.62-4.7 1.56-9.43 6.31-12.15 10.56z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m27.32 68.15c4.37-3 9.07-5.47 13.97-7.34-0.15 0.06-2.55-4.01-2.81-4.36-4.54 2.01-8.83 7.2-11.16 11.7z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m44.11 77.94c1.64-5.21 3.85-10.22 6.56-14.91-0.08 0.14-4.37-1.46-4.78-1.57-2.36 4.55-2.63 11.42-1.78 16.48z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m58.63 80.31c0.94-5.4 2.47-10.68 4.54-15.72-0.06 0.15-4.52-0.81-4.94-0.86-1.74 4.86-1.1 11.7 0.4 16.58z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m69.78 82.32c2.13-4.48 4.76-8.75 7.84-12.68-0.09 0.12-3.94-1.61-4.32-1.73-2.72 3.84-3.75 9.88-3.52 14.41z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m77.56 87.23c3.49-3.4 7.39-6.41 11.59-8.96-0.13 0.08-3.15-2.97-3.46-3.22-3.84 2.58-6.83 7.86-8.13 12.18z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m88.59 93.19c2.91-3.18 6.19-6.03 9.77-8.49-0.11 0.07-2.93-2.46-3.21-2.66-3.27 2.47-5.63 7.28-6.56 11.15z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <path
        d="m97.87 94.27c1.76-3.93 3.99-7.66 6.61-11.11-0.08 0.1-3.55-1.42-3.89-1.53-2.32 3.37-3.06 8.67-2.72 12.64z"
        clipPath="url(#a)"
        fill="#33691E"
      />
      <g fill="#EFD7AB">
