...
function CouplekissManWoman(props) {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "radialGradient",
          {
            ...
            cy: 31.897,
            r: 45.167,
            gradientTransform: "matrix(-1.0193 -.0197 0 .9956 219.34 -.6374)",
            gradientUnits: "userSpaceOnUse"
          },
          _react2.default.createElement("stop", {
            stopColor: "#6D4C41",
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "radialGradient",
          {
            ...
            cy: 30.096,
            r: 45.167,
            gradientTransform: "matrix(1.0193 -.0197 0 .9956 .9905 -.6374)",
            gradientUnits: "userSpaceOnUse"
          },
          _react2.default.createElement("stop", {
            stopColor: "#6D4C41",
        ...
        _react2.default.createElement("path", {
          d:
            "m17.73 9.1c-22.83 0.52-25.21 11.12-25.82 11.01-6.57-1.2-15.61 3.94-20.56 12.62-12.79 22.43 2.86 39.63 3.19 41.58 1.71 10.05 2.55 11.78 2.55 11.78s0.51-13.87 8.25-23.04c4.94-5.86 9.68-18.63 9.68-18.63s13.89 4.7 24.46 10.58c8.92 4.96 14.5 11.55 14.5 11.55s1.67-5.17 0.36-10.51c-2.82-11.48-13.91-16.47-13.91-16.47s5.54 1.44 13.07 7.96c16.61 14.39 21.04 41.04 21.04 41.04 5.7-5.29 15.18-18.04 14.02-36.7-0.57-9.32-9.47-43.71-50.83-42.77z",
          fill: "url(#k)"
        }),
        _react2.default.createElement("path", {
          d:
            "m-5.17 20.86c3.37-5.7 11.08-8.84 22.91-9.07h0.24c16.64-0.32 29.5 5.31 38.2 16.59 6.91 8.96 9.25 19.59 9.6 24.17 1.08 14.28-6.45 26.63-12.01 32.57 0.2 1.11 0.72 2.81 0.78 3.55 6.41-5.49 15.1-19.45 14.02-36.83-0.58-9.29-9.45-43.64-50.59-42.84h-0.25c-22.7 0.43-25.18 11.07-25.81 11.08l-0.01 0.04c-0.8-0.15-1.68-0.19-2.6-0.17-6.6 0.13-12.65 4.32-17.32 11.76-13.87 22.06 2.22 40.7 2.55 42.65 1.71 10.05 2.55 11.78 2.55 11.78s0.12-3.15 1.07-7.43c-0.36-2.09-0.69-3.81-1.13-6.14-0.27-0.45-14.68-19.82-2.81-38.96 4.08-6.57 9.47-10.73 15.09-10.84 0.73-0.01 1.41 0.03 2.02 0.15 0.19 0.03 0.39 0.05 0.59 0.05 1.74-0.04 2.53-1.46 2.91-2.11z",
          fill: "#3F2720"
        })
      ),
      _react2.default.createElement("rect", {
...
exports.default = CouplekissManWoman;
