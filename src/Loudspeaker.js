  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#8D8D8D" offset={0.2247} />
        <stop stopColor="#6D6D6D" offset={0.7241} />
        <stop stopColor="#616161" offset={1} />
      </radialGradient>
      <path
        d="m118.86 62c2.83 0 5.14-2.31 5.14-5.14v-13.72c0-2.83-2.31-5.14-5.14-5.14s-5.14 2.31-5.14 5.14v13.71c-0.01 2.84 2.31 5.15 5.14 5.15z"
        fill="url(#f)"
      />
      <radialGradient
        id="e"
      ...
      <path
        d="m22.26 62.25 7.75-2c4.26-1.1 8.65 1.49 9.75 5.75l4 15.49c1.1 4.26-1.49 8.65-5.75 9.75l-7.75 2c-4.26 1.1-8.65-1.49-9.75-5.75l-4-15.49c-1.1-4.26 1.49-8.65 5.75-9.75z"
        fill="url(#e)"
      />
      <g opacity={0.2}>
        <path
          d="m31.99 63c2.29 0 4.28 1.54 4.85 3.75l4 15.49c0.69 2.67-0.92 5.4-3.59 6.09l-7.75 2c-0.41 0.1-0.82 0.16-1.24 0.16-2.29 0-4.28-1.54-4.85-3.75l-4-15.49c-0.69-2.67 0.92-5.4 3.59-6.09l7.75-2c0.41-0.11 0.83-0.16 1.24-0.16m0-3c-0.66 0-1.32 0.08-1.99 0.25l-7.75 2c-4.26 1.1-6.85 5.48-5.75 9.75l4 15.49c0.93 3.6 4.2 6 7.76 6 0.66 0 1.32-0.08 1.99-0.25l7.75-2c4.26-1.1 6.85-5.48 5.75-9.75l-4-15.49c-0.93-3.6-4.2-6-7.76-6z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m118.86 41c1.18 0 2.14 0.96 2.14 2.14v13.71c0 1.18-0.96 2.14-2.14 2.14s-2.14-0.96-2.14-2.14v-13.71c-0.01-1.18 0.96-2.14 2.14-2.14m0-3c-2.83 0-5.14 2.31-5.14 5.14v13.71c0 2.83 2.31 5.14 5.14 5.14s5.14-2.31 5.14-5.14v-13.71c0-2.83-2.31-5.14-5.14-5.14z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      >
        ...
        <stop stopColor="#6E6E6E" offset={0.1054} />
        <stop stopColor="#4E4E4E" offset={0.6817} />
        <stop stopColor="#424242" offset={1} />
      </radialGradient>
      <path
        d="m32 106.68v-3.75c0-1.64 0.84-3.08 2.08-3.87 1.2-0.76 1.92-2.15 1.92-3.64v-2.22c0-1.83-0.72-3.22-1.93-3.98-1.23-0.78-2.07-2.22-2.07-3.86v-3.75c0-1.65 0.84-3.08 2.08-3.87 1.2-0.76 1.92-2.14 1.92-3.63v-3.27c0-6.36-4.67-11.35-10.39-11.35h-3.48c-5.71 0-10.39 4.98-10.39 11.07v44.9c0 4.69 3.6 8.53 8 8.53h8.26c4.4 0 8-3.84 8-8.53v-1.28c0-1.49-0.72-2.88-1.93-3.64-1.23-0.78-2.07-2.21-2.07-3.86z"
        fill="url(#d)"
      />
      <path
      ...
      >
        ...
        <stop stopColor="#F0504B" offset={0.3237} />
        <stop stopColor="#F3473C" offset={0.7149} />
        <stop stopColor="#F44336" offset={0.8365} />
        <stop stopColor="#F44336" offset={1} />
      </radialGradient>
      <path
        d="m10 30 40-4c3.31 0 6 10.75 6 24s-2.69 24-6 24l-40-4c-3.31 0-6-8.95-6-20s2.69-20 6-20z"
        fill="url(#c)"
      />
      <g opacity={0.2}>
        <path
          d="m49.55 29.06c1.29 1.68 3.45 9 3.45 20.94s-2.16 19.26-3.45 20.94l-39.18-3.92c-1.21-1.1-3.37-7.07-3.37-17.02s2.16-15.92 3.36-17.02l39.19-3.92m0.45-3.06-40 4c-3.31 0-6 8.95-6 20s2.69 20 6 20l40 4c3.31 0 6-10.75 6-24s-2.69-24-6-24z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      >
        ...
        <stop stopColor="#E8E8E8" offset={0.5297} />
        <stop stopColor="#E0E0E0" offset={0.7836} />
        <stop stopColor="#E0E0E0" offset={1} />
      </radialGradient>
      <path
        d="M52.88,24.29L116,5.36v89.28L52.88,75.71C48.53,75.71,45,64.2,45,50S48.53,24.29,52.88,24.29 z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
