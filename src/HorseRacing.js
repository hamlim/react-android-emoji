...
function HorseRacing(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#FFAF61" offset={0.2321} />
        <stop stopColor="#C46D3D" offset={1} />
      </linearGradient>
      <path
        d="m10.91 65.03c-2.53 0-4-1.13-5.11-2.23-2.1-2.09-1.26-4.4-0.38-6.85l0.06-0.15c0.08-0.22 0.27-0.75 3.84-4.35 0.1-0.1 0.22-0.15 0.35-0.15 0.05 0 0.11 0.01 0.16 0.03 4.2 1.45 7.44 5.6 8.65 11.1 0.04 0.17-0.02 0.33-0.14 0.45-0.09 0.09-0.21 0.12-0.34 0.12h-0.03c-0.22 0-1.01 0.38-1.65 0.64-0.9 0.36-1.91 0.79-2.61 0.98-1 0.27-1.94 0.41-2.8 0.41z"
        fill="url(#c)"
      />
      <path
        d="m9.67 51.81c4.46 1.54 7.29 6.03 8.33 10.73h-0.03c-0.43 0-3.07 1.25-4.39 1.61-1.01 0.27-1.89 0.39-2.66 0.39-2.49 0-3.85-1.18-4.76-2.08-1.91-1.9-1.12-3.94-0.21-6.48 0.16-0.48 1.61-2.05 3.72-4.17m0-1c-0.26 0-0.52 0.1-0.71 0.29-3.65 3.68-3.84 4.21-3.96 4.53l-0.06 0.15c-0.89 2.49-1.82 5.06 0.5 7.37 0.71 0.71 2.38 2.37 5.46 2.37 0.9 0 1.89-0.14 2.92-0.42 0.72-0.2 1.76-0.62 2.67-0.99 0.54-0.22 1.26-0.51 1.52-0.59 0.25-0.01 0.49-0.1 0.67-0.28 0.25-0.24 0.36-0.6 0.28-0.94-1.26-5.67-4.61-9.95-8.98-11.46-0.09-0.01-0.2-0.03-0.31-0.03z"
        fill="#B05A2A"
      />
      <linearGradient
        id="b"
      ...
      >
        <stop stopColor="#FFAF61" offset={0.2321} />
        <stop stopColor="#FCAC5F" offset={0.4152} />
        <stop stopColor="#F3A159" offset={0.572} />
        <stop stopColor="#E38F50" offset={0.7192} />
        <stop stopColor="#CD7742" offset={0.8597} />
        <stop stopColor="#C46D3D" offset={0.9051} />
      </linearGradient>
      <path
        d="m105.07 102.8c0.35-0.22 0.61-0.55 0.74-0.94 0.34-1 0.81-2.95-0.23-3.86-1.43-1.25-8.76-13.59-8.04-14.48s-16.09 1.08-16.09 1.08l3.22 2.68s5.01 6.79 8.22 9.65 4.83 4.29 2.86 6.26-13.31 9.86-14.98 11.01c-0.54 0.37-0.87 1.06-1.17 1.71 2.15-0.55 4.29-0.86 6.5-0.82-0.01-0.06-0.01-0.09-0.01-0.09l18.98-12.2z"
        fill="url(#a)"
        stroke="#B05A2A"
        strokeMiterlimit={10}
      />
      ...
      <path
        d="m40.08 108.29c-0.54-0.25-1.09-0.52-1.66-0.79-0.59-0.29-1.21-0.51-1.8-0.72-1.45-0.52-2.82-1.01-3.25-2.31-0.34-1.03-4.4-5.02-6.87-7.29l-0.21-0.19 1.3-6.21 12.85-6.73c9.88-6.95 12.51-7.76 13.62-7.76 0.65 0 0.95 0.31 1.09 0.56 0.62 1.14-0.85 3.56-3.33 7.41-1.19 1.84-2.82 4.36-2.72 4.92 0.14 0.3 0.14 0.65-0.02 0.98-0.71 1.46-4.61 2.5-10.48 3.91-2.82 0.68-6.69 1.61-7.06 2.18-0.31 0.93 4.02 4.04 8.12 6.17 0.49 0.25 1.7 0.25 2.09 0.25l1.29-0.02-0.32 0.72c-0.7 1.56-1.38 3.09-1.93 4.63l-0.19 0.52-0.52-0.23z"
        fill="url(#ad)"
      />
      <path
        d="m54.04 76.78c3.41 0-6.14 11.02-5.42 12.58 1.27 2.77-16.96 4.91-17.57 6.7s6.47 5.82 8.35 6.8c0.47 0.25 1.33 0.31 2.33 0.31h0.51c-0.7 1.56-1.39 3.11-1.95 4.67-0.53-0.25-1.09-0.52-1.66-0.79-2.03-0.98-4.29-1.21-4.8-2.74s-7.01-7.5-7.01-7.5l1.2-5.7 12.64-6.62c8.07-5.69 11.92-7.71 13.38-7.71m0-1c-1.28 0-4.01 0.89-13.91 7.85l-12.58 6.59-0.42 0.22-0.1 0.46-1.2 5.7-0.12 0.56 0.42 0.38c3.01 2.77 6.44 6.26 6.73 7.08 0.51 1.53 2.06 2.08 3.56 2.62 0.58 0.21 1.19 0.43 1.76 0.7 0.57 0.28 1.13 0.54 1.67 0.8l0.99 0.47 0.37-1.03c0.55-1.53 1.22-3.05 1.92-4.6l0.65-1.44-1.58 0.03h-0.49c-1.29 0-1.72-0.12-1.87-0.2-3.74-1.95-7.28-4.48-7.79-5.53 0.93-0.52 4.19-1.31 6.62-1.89 6.19-1.49 10-2.52 10.81-4.18 0.2-0.41 0.23-0.86 0.08-1.28 0.14-0.71 1.63-3.03 2.63-4.57 2.89-4.48 4.09-6.58 3.35-7.92-0.13-0.31-0.55-0.82-1.5-0.82z"
        fill="#B05A2A"
      />
      <path
        d="m46.5 111.13c-0.03-0.01-2.77-1.13-6.42-2.85l-0.41-0.19 0.15-0.43c0.57-1.57 1.25-3.12 1.96-4.7l0.13-0.29 0.32-0.01c0.43-0.01 0.87-0.02 1.32-0.04 0.64-0.02 1.29-0.04 1.89-0.04 1.9 0 2.85 0.24 3.28 0.83 0.16 0.22 0.31 0.61 0.13 1.16-0.59 1.74-1.66 6.17-1.67 6.21l-0.14 0.57-0.54-0.22z"
        fill="#603813"
      />
      <path
        d="m45.44 103.08c1.86 0 3.3 0.22 2.93 1.33-0.6 1.78-1.68 6.26-1.68 6.26s-2.71-1.1-6.4-2.84c0.56-1.56 1.25-3.11 1.95-4.67 1.04-0.01 2.18-0.08 3.2-0.08m0-1c-0.61 0-1.26 0.02-1.91 0.05-0.45 0.02-0.89 0.03-1.32 0.04l-0.63 0.01-0.26 0.58c-0.68 1.52-1.4 3.14-1.98 4.74l-0.31 0.86 0.82 0.39c3.67 1.73 6.42 2.85 6.45 2.86l1.08 0.44 0.27-1.13c0.01-0.04 1.07-4.45 1.65-6.17 0.27-0.79-0.01-1.35-0.19-1.61-0.6-0.88-1.91-1.06-3.67-1.06z"
        fill="#4D290A"
      />
      <path
        d="m72.02 117.82s-1.91-4.08-3.5-7c-1-1.83-4.24 0.56-6.22 2.29 0.3 2.11 0.88 4.08 1.86 5.98l7.86-1.27z"
        fill="#603813"
        stroke="#4D290A"
        strokeMiterlimit={10}
      />
      <path
        d="m84.36 99.29 0.22-0.13s0.85-0.49 1.13-0.64l0.23-0.13 0.23 0.12c1.83 0.92 3.74 1.36 5.83 1.36 0.63 0 1.28-0.04 1.95-0.12l1.66-0.2-1.27 1.08c-0.89 0.75-1.41 1.42-1.53 1.98-0.85 3.68-8.33 3.83-8.65 3.83l-0.57 0.01 0.77-7.16z"
        fill="#603813"
      />
      <path
        d="m85.95 98.96c1.97 0.98 3.97 1.42 6.06 1.42 0.66 0 1.33-0.04 2.01-0.13-0.9 0.76-1.53 1.52-1.7 2.25-0.77 3.34-8.17 3.45-8.17 3.45l0.69-6.35c-0.01 0 0.83-0.49 1.11-0.64m-0.03-1.13-0.46 0.25c-0.28 0.15-1.14 0.65-1.14 0.65l-0.44 0.25-0.05 0.51-0.69 6.35-0.12 1.12 1.13-0.02c0.84-0.01 8.21-0.24 9.13-4.22 0.06-0.25 0.31-0.81 1.37-1.71l2.55-2.16-3.31 0.4c-0.65 0.08-1.28 0.12-1.89 0.12-2.01 0-3.85-0.43-5.61-1.31l-0.47-0.23z"
        fill="#4D290A"
      />
      <linearGradient
        id="ac"
      ...
      <linearGradient
        ...
        y1={72.965}
        y2={85.94}
        gradientTransform="matrix(.9977 .0673 -.0673 .9977 30.809 -19.695)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFF1C4" offset={0} />
        <stop stopColor="#FFE2A7" offset={0.4265} />
        <stop stopColor="#FFCA7B" offset={1} />
      </linearGradient>
      <path
        d="m9.67 51.81c-2.11 2.12-3.56 3.7-3.73 4.16-0.91 2.54-1.7 4.58 0.21 6.48 1.18 1.18 3.16 2.84 7.42 1.7 1.36-0.37 4.12-1.69 4.42-1.61-1.03-4.7-3.86-9.19-8.32-10.73z"
        fill="url(#ab)"
      />
      <path
        d="m80.01 74.4c0.04 3.63 1.74 7.21 4.53 9.53 1.82 1.52 4.03 2.49 6.21 3.44 1.37 0.6 2.18 1.53 3.93 2.95"
        fill="none"
        stroke="#B05A2A"
        strokeLinecap="round"
        strokeMiterlimit={10}
      />
      <ellipse
        transform="matrix(.0673 -.9977 .9977 .0673 -22.789 69.472)"
        cx={25.76}
        cy={46.93}
        rx={3.06}
        ry={2.71}
      ...
      />
      <path
        d="m32.95 28.22c0.6-0.52 1.72-0.1 1.9 0.71 0.87 3.94 2.08 12.53-4.56 10.27-6.54-2.22-0.35-8.39 2.66-10.98z"
        fill="#FFAF61"
      />
      <linearGradient
        id="y"
        ...
        y1={-64.841}
        y2={-56.908}
        gradientTransform="matrix(.8586 .5127 -.5127 .8586 14.368 92.316)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#D49151" offset={0} />
        <stop stopColor="#D28E4F" offset={0.3194} />
        <stop stopColor="#CE8349" offset={0.5929} />
        <stop stopColor="#C6713F" offset={0.8489} />
        <stop stopColor="#C46D3D" offset={0.9} />
      </linearGradient>
      <path
        d="m33.42 34.99c-0.08 0.56-0.22 1.13-0.58 1.56s-1 0.71-1.61 0.54c-0.69-0.18-1.16-0.87-1.23-1.51-0.08-0.64 0.16-1.26 0.42-1.83 0.3-0.66 1.86-2.63 3.09-3.7 0.37-0.33 0 4.25-0.09 4.94z"
        fill="url(#y)"
      />
      <line
        x1={43.83}
      ...
      />
      <path
        d="m57.06 94.19c0.92-3.58 2.69-6.61 4.12-9.87"
        fill="none"
        stroke="#B05A2A"
        strokeLinecap="round"
        strokeMiterlimit={10}
      />
      <path
        d="m10.14 51.5c4.07 1.56 7.52 4.47 7.37 11.16"
        fill="none"
        stroke="#4E342E"
        strokeLinecap="round"
        strokeMiterlimit={10}
      ...
      />
      <path
        d="m17.91 59.11c3.59-1.11 8.84-3.7 12.76-7.11"
        fill="none"
        stroke="#4E342E"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <polyline
        points="36.53 40.03 31.58 44.83 29.88 59.63"
        fill="none"
        stroke="#4E342E"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="m31.36 44.55c-3.63-4.19-5.87-5.61-9.86-7.47"
        fill="none"
        stroke="#4E342E"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="m17.51 62.66c7.99 0 20.99-5.87 27.08-13.16"
        fill="none"
        stroke="#4E342E"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#5C4037" offset={0.55} />
        <stop stopColor="#70534A" offset={1} />
      </linearGradient>
      <path
        d="m42.97 46.18c0.44 0.36 1.08 0.29 1.44-0.15l1.13-1.39c0.36-0.44 0.29-1.08-0.15-1.44s-1.08-0.29-1.44 0.15l-1.13 1.39c-0.35 0.44-0.29 1.08 0.15 1.44z"
        fill="url(#x)"
      />
      <linearGradient
        id="w"
      ...
      <path
        d="m48.99 46.54c0.3-0.48 0.15-1.11-0.33-1.41l-3.28-2.02c-0.48-0.3-1.11-0.15-1.41 0.33s-0.15 1.11 0.33 1.41l3.28 2.02c0.48 0.3 1.11 0.15 1.41-0.33z"
        fill="url(#w)"
      />
      <linearGradient
        id="v"
      ...
      <linearGradient
        ...
        y1={-1871.9}
        y2={-1865.8}
        gradientTransform="matrix(-.1634 -.8565 -.8818 .1683 -1497.3 893.6)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#5C4037" offset={0.55} />
        <stop stopColor="#70534A" offset={1} />
      ...
      <path
        d="m48.98 45.06 1.83 5.96s-5.95 4.12-6.58 2.56c-0.05-0.12-0.07-0.56-0.08-0.73-0.01-0.21-0.12-0.3-0.3-0.42-0.27-0.19-0.57-0.44-0.63-0.72-0.05-0.28 0.02-0.64 0.12-0.93 0.07-0.21-0.05-0.42-0.25-0.51-0.44-0.18-0.72-0.32-0.81-0.8-0.07-0.39-0.11-0.83 0.11-1.14 0.23-0.34 0.16-0.93-0.13-1.22-0.16-0.16-0.37-0.64-0.12-1.24 0.39-0.94 6.84-0.81 6.84-0.81z"
        fill="url(#u)"
      />
      <linearGradient
        id="t"
      ...
      <linearGradient
        ...
        y1={-264.81}
        y2={-246.61}
        gradientTransform="matrix(.936 -.3521 .3521 .936 2.6586 310.84)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#70534A" offset={0.55} />
        <stop stopColor="#5C4037" offset={0.83} />
        <stop stopColor="#3C2B24" offset={1} />
      </linearGradient>
      <path
        d="m57.05 8.35c-2.94-2.91-8.02-3-11.89-1.53-4.32 1.65-6.07 5.37-5.87 9.58 0.07 1.53 0.42 3 0.88 3.99 0.06 0.12 0.49 0.98 0.57 1.26 0.39 1.07-1.51 2.6-1.52 3.86 0 0.95 2.03 1.15 2.21 1.28 0.92 0.67 0.54 4.85 5.85 4.14 1.85-0.25 3.65-1.74 5.14-1.18 1.6 0.61 4.82 1.26 4.82 1.26l3.38-4.34s-1.74-3.55-0.52-5.47c2.42-3.81-0.6-10.43-3.05-12.85z"
        fill="url(#s)"
      />
      <linearGradient
        id="r"
      ...
      <radialGradient
        ...
        cy={-174.32}
        r={11.339}
        gradientTransform="matrix(1.0201 -.1951 .1937 .9813 -5.5909 198.7)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <path
        d="m51.78 24.28 0.7-4.6s2.89 0.24 2.51 3.21c-0.27 2.09 1.27 4.22 2.21 4.3l0.55 0.09c0.57-3.13 4.19-4.53 3.79-12.51-0.35-6.92-6.83-10-12.61-9.39-5.53 0.59-11.29 5.02-9.84 12.46 0.05 0.26 7.32-0.03 9.23 1.53 1.89 1.54 0.95 4.98 3.46 4.91z"
        fill="url(#q)"
      />
      <defs>
        <path
          id="p"
          d="m56.42 18.87 0.74 7.4-0.39 0.76s0.3 0.14 0.44 0.16l0.55 0.09c0.57-3.13 4.19-4.53 3.79-12.51-0.35-6.92-6.83-10-12.61-9.39-5.53 0.59-11.33 5.3-9.87 12.49 0.01 0.05 0.86 0.07 0.86 0.07l-0.13-1.19 8.5-0.09 8.12 2.21z"
        />
      </defs>
      <clipPath id="o">
        <use xlinkHref="#p" />
      ...
      <g clipPath="url(#o)">
        <path
          d="m50.39 6.31c4.69 0 9.87 2.66 10.16 8.51 0.25 4.98-1.1 7.13-2.3 9.03-0.45 0.72-0.88 1.4-1.18 2.18-0.5-0.45-1.26-1.7-1.09-3.02 0.19-1.46-0.29-2.4-0.72-2.94-0.99-1.22-2.53-1.38-2.7-1.4h-0.08c-0.49 0-0.91 0.36-0.99 0.85l-0.49 3.25c-0.1-0.23-0.21-0.57-0.35-1.05-0.28-1.01-0.64-2.26-1.7-3.12-1.49-1.21-4.89-1.46-8.26-1.61-0.26-0.01-0.54-0.02-0.77-0.04-0.31-2.4 0.22-4.62 1.56-6.44 1.67-2.27 4.49-3.81 7.55-4.14 0.45-0.04 0.91-0.06 1.36-0.06m0-1c-0.49 0-0.97 0.03-1.45 0.08-5.53 0.59-11.31 5.11-9.87 12.46 0.05 0.26 7.35-0.03 9.27 1.53 1.87 1.52 0.96 4.91 3.38 4.91h0.08l0.7-4.6s2.89 0.24 2.51 3.21c-0.27 2.09 1.27 4.22 2.21 4.3l0.55 0.09c0.57-3.13 4.19-4.53 3.79-12.51-0.33-6.35-5.81-9.47-11.17-9.47z"
          fill="#402821"
        />
      </g>
      <path
        d="m43.98 25.94-1.95 0.73s0.4 0.88 0.59 1.23c1.05 1.92 2.88 3.8 6.44 2.83 0.32-0.09-2.68-4.24-2.68-4.24l-2.4-0.55z"
        fill="none"
      />
      <defs>
        <path
          id="n"
          d="m57.05 8.35c-2.94-2.91-8.02-3-11.89-1.53-5.34 2.04-7 6.83-5.65 12.22 0 0 0.81 2.19 1.06 3.14 0.68 1.83-0.98 1.76-1.08 3.24-0.1 1.4 1.76 1.25 1.94 1.38 0.92 0.67 0.54 4.85 5.85 4.14 1.85-0.25 3.36-0.65 4.28-0.1l3.04 2.47 4.94-1.84s-2.99-4.63 0.56-10.26c2.42-3.82-0.6-10.44-3.05-12.86z"
        />
      </defs>
      <clipPath id="m">
        <use xlinkHref="#n" />
      ...
      <g clipPath="url(#m)">
        <path
          d="m38.51 27.63c1.51 1.4 4.35 1.91 5.85 0.24 0.57-0.63-0.01-1.1-0.7-0.61-1.13 0.79-3.45 0.44-4.39-0.45-0.63-0.58-1.38 0.24-0.76 0.82z"
          fill="#1A1717"
        />
      </g>
      <ellipse
        transform="matrix(.9879 -.1552 .1552 .9879 -2.9752 7.0366)"
        cx={43.59}
        cy={22.58}
        rx={0.98}
        ry={1.5}
      ...
      />
      <path
        d="m42.56 20.47c-0.93 0.35-1.2-0.27-0.92-0.8 0.21-0.39 0.76-0.74 1.89-0.6 1.06 0.13 1.54 0.71 1.85 1.05 0.31 0.35 0.3 0.72 0.06 0.76-0.33 0.07-1.73-0.84-2.88-0.41z"
        fill="#1A1717"
      />
      <linearGradient
        id="l"
        ...
        y1={84.105}
        y2={109.59}
        gradientTransform="matrix(.9975 -.0712 .0712 .9975 .0375 -35.813)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFB300" offset={0.1952} />
        <stop stopColor="#FFCA28" offset={0.6908} />
      </linearGradient>
      <polygon
        points="70.81 77.2 64.82 77.7 60.62 54.36 70.53 53.56"
        fill="url(#l)"
      />
      <linearGradient
        id="k"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#eee" offset={0.0834} />
        <stop stopColor="#BDBDBD" offset={1} />
      </linearGradient>
      <polygon
        points="68.55 57.85 62.49 49.95 81.95 36.03 89.07 47.44"
        fill="url(#k)"
      />
      <linearGradient
        id="j"
      ...
      <circle cx={85.94} cy={41.85} r={6.97} fill="url(#h)" />
      <linearGradient
        id="g"
        x1={59.053}
        x2={83.553}
      ...
      <circle cx={65.55} cy={53.81} r={4.97} fill="url(#g)" />
      <path
        d="m89.61 35.92c-2.42-1.5-5.4-1.33-7.61 0.18l-0.04-0.07-18.7 13.38c-0.87 0.45-1.62 1.16-2.1 2.09-0.52 0.99-0.66 2.08-0.49 3.11l4.15 23.09 5.99-0.5-0.24-20.37s20.07-9.31 21.31-11.3c2.02-3.28 1.01-7.58-2.27-9.61z"
        fill="none"
        stroke="#ABA59F"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="m73.34 82.5c0.56-0.09 0.95-0.61 0.86-1.17l-1.33-4.35-1.58-13.96-9.61 1.45 2.28 12.56-3.86 2.09c-1.27 0.73-1.96 2.16-1.75 3.61l0.17 1.12c0.07 0.49 0.53 0.83 1.02 0.76l13.8-2.11z"
        fill="#444"
        stroke="#2D2E30"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        d="m57.5 24.24c-0.64 1.44-2.43 7.35 0.67 8.33 8.06 2.56 15.67 9.5 15.67 9.5s9.08-6.14 16.67-6.33c-4.23-7.13-14.86-11.98-24-13.99-3.48-0.75-7.87-0.1-9.01 2.49z"
        fill="url(#f)"
        stroke="#009984"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeMiterlimit={10}
      />
      <circle cx={59.52} cy={44.16} r={3.24} fill="#05A287" />
      <path
        d="m56.73 44.64 6.04-0.11 1.9-15.35c-0.04-2.16-1.82-3.87-3.98-3.83h-0.2c-2.16 0.04-3.87 1.82-3.83 3.98l0.07 15.31z"
        fill="#05A287"
      />
      <polygon
        points="48.25 44.93 49.77 51.37 61.21 46.93 56.62 41.96"
        fill="#05A287"
      />
      <radialGradient
        id="e"
      ...
      <path
        d="m18.57 42.92c-0.94 0-1.95-0.12-3-0.34-2.12-0.46-4.35-2.29-4.77-5.34 0.71 0.43 1.62 0.67 2.55 0.67 0.57 0 1.12-0.09 1.61-0.26 1.65-0.59 3.05-1.8 4.29-2.87 1.16-1.01 2.48-2.15 3.97-2.66 0.47-0.16 1-0.25 1.52-0.25 0.55 0 2.39 0.12 2.73 1.71 0.25 1.2-0.22 4.01-2.03 6.24-1.15 1.41-3.27 3.1-6.87 3.1z"
        fill="url(#d)"
      />
      <path
        d="m24.75 32.36c0.46 0 1.98 0.09 2.24 1.31 0.23 1.1-0.22 3.72-1.93 5.82-1.58 1.94-3.76 2.93-6.49 2.93-0.9 0-1.88-0.11-2.89-0.33-1.31-0.29-3.44-1.44-4.18-3.98 0.57 0.2 1.21 0.3 1.86 0.3 0.62 0 1.24-0.1 1.78-0.29 1.74-0.62 3.18-1.87 4.45-2.97 1.13-0.98 2.4-2.09 3.81-2.57 0.41-0.15 0.88-0.22 1.35-0.22m0-1c-0.58 0-1.16 0.1-1.68 0.28-1.55 0.53-2.87 1.66-4.14 2.76s-2.58 2.23-4.13 2.78c-0.45 0.16-0.94 0.24-1.44 0.24-1.01 0-2.04-0.32-2.72-0.91-0.05-0.04-0.1-0.06-0.15-0.06-0.12 0-0.24 0.1-0.23 0.25 0.22 3.79 2.94 5.88 5.22 6.37 1.12 0.24 2.15 0.36 3.1 0.36 7.76 0 9.92-7.44 9.39-9.96-0.32-1.48-1.75-2.11-3.22-2.11z"
        fill="#734825"
      />
      <path
        d="m64.67 29.17c-0.04-2.16-1.82-3.87-3.98-3.83h-0.2c-2.16 0.04-3.87 1.82-3.83 3.98l0.06 12.75-0.1-0.11-8.37 2.97 1.52 6.44 10.4-4.04c0.36-0.07 0.69-0.21 0.99-0.38l0.05-0.02-0.01-0.01c0.84-0.51 1.42-1.38 1.53-2.4h0.04l1.9-15.35z"
        fill="none"
        stroke="#008F76"
        strokeLinecap="round"
        strokeLinejoin="round"
