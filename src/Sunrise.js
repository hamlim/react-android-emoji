  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFF9C3" offset={0} />
        <stop stopColor="#E4EDC5" offset={0.0984} />
        <stop stopColor="#6CB7CB" offset={0.549} />
        <stop stopColor="#2095CF" offset={0.8582} />
        <stop stopColor="#0288D1" offset={1} />
      </linearGradient>
      <rect x={4} y={63.75} width={120} height={60.25} fill="url(#c)" />
      <g opacity={0.2}>
        <path
          d="m121 66.75v54.25h-114v-54.25h114m3-3h-120v60.25h120v-60.25z"
          fill="#424242"
        />
      </g>
      <defs>
      ...
      <g clipPath="url(#a)">
        <path
          d="m-19.97 74.4s-30.21 1.28-14.62 3.83c0 0 23.87 2.13 12.51 3.83-11.37 1.7-9.91 5.11 3.25 4.26s16.08 1.28 6.17 3.41-7.31 2.55 7.15 1.7 11.69 3.83 3.25 5.53-2.42 3.73 10.12 2.84c12.49-0.89 12.82-2.3 4.9-2.82-6.7-0.44-5.76-5.13 4.8-6.41s6.5-3.41-5.52-3.41-16.73-3.4-0.81-4.68 17.38-1.7 7.15-2.13-3.57-2.13 7.8-3.83c0 0 18.35-2.55 2.44-2.98l-48.59 0.86z"
          fill="#E1F5FE"
          opacity={0.2}
        />
        <path
          d="m45.07 65.22s-47.8 1.83-23.13 5.49c0 0 37.78 3.05 19.79 5.49s-15.68 7.32 5.14 6.1 25.44 1.83 9.77 4.88c-15.68 3.05-11.57 3.66 11.31 2.44s17.85 4.5 4.48 6.94c-13.36 2.44-4.02 3.31 15.77 1.48s17.74-3.45 8.79-4.15c-10.58-0.82-9.25-3.66 7.45-5.49s10.28-4.88-8.74-4.88-26.47-4.88-1.29-6.71 27.5-2.44 11.31-3.05-5.65-3.05 12.34-5.49c0 0 29.04-3.66 3.85-4.27l-76.84 1.22z"
          fill="#FFF9C4"
          opacity={0.33}
        />
        <path
          d="m36.93 95.73c0 0.99-3.38 1.8-7.57 1.82s-7.57-0.77-7.58-1.76c0-0.99 3.38-1.8 7.57-1.81s7.58 0.76 7.58 1.75z"
          fill="#E1F5FE"
          opacity={0.2}
        />
      </g>
