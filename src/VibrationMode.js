...
function VibrationMode(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m92.31 7.31c-3.1-0.8-11.31-3.31-28.31-3.31s-26.61 2.81-28.31 3.31c-2.1 0.5-3.69 2.59-3.69 4.69v104c0 2.1 1.59 4.19 3.69 4.69 1.7 0.5 11.31 3.31 28.31 3.31s25.21-2.51 28.31-3.31c2.1-0.5 3.69-2.59 3.69-4.69v-104c0-2.1-1.59-4.19-3.69-4.69z"
        fill="url(#d)"
      />
      <path
      ...
      <path
        d="m86 104h-44c-1.1 0-2-0.9-2-2v-76c0-1.1 0.9-2 2-2h44c1.1 0 2 0.9 2 2v76c0 1.1-0.9 2-2 2z"
        fill="url(#c)"
      />
      <circle cx={42} cy={14} r={2} fill="#9E9E9E" />
      <g opacity={0.2}>
        <path
          d="m78 13c0.55 0 1 0.45 1 1s-0.45 1-1 1h-28c-0.55 0-1-0.45-1-1s0.45-1 1-1h28m0-1h-28c-1.1 0-2 0.9-2 2s0.9 2 2 2h28c1.1 0 2-0.9 2-2s-0.9-2-2-2z"
          fill="#eee"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m42 13c0.55 0 1 0.45 1 1s-0.45 1-1 1-1-0.45-1-1 0.45-1 1-1m0-1c-1.1 0-2 0.9-2 2s0.9 2 2 2 2-0.9 2-2-0.9-2-2-2z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m86 24c1.1 0 2 0.9 2 2v76c0 1.1-0.9 2-2 2h-44c-1.1 0-2-0.9-2-2v-76c0-1.1 0.9-2 2-2h44m0-3h-44c-2.76 0-5 2.24-5 5v76c0 2.76 2.24 5 5 5h44c2.76 0 5-2.24 5-5v-76c0-2.76-2.24-5-5-5z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m64 7c15.45 0 23.43 2.12 26.84 3.03 0.27 0.07 0.51 0.14 0.73 0.19l0.06 0.02c0.7 0.16 1.37 1.02 1.37 1.76v104c0 0.74-0.67 1.6-1.38 1.77l-0.06 0.02c-0.22 0.06-0.46 0.12-0.73 0.19-3.4 0.9-11.38 3.02-26.83 3.02-15 0-24.2-2.23-27.47-3.19l-0.16-0.04c-0.7-0.17-1.37-1.03-1.37-1.77v-104c0-0.74 0.67-1.6 1.38-1.77l0.16-0.04c3.26-0.96 12.46-3.19 27.46-3.19m0-3c-17 0-26.61 2.81-28.31 3.31-2.1 0.5-3.69 2.59-3.69 4.69v104c0 2.1 1.59 4.19 3.69 4.69 1.7 0.5 11.31 3.31 28.31 3.31s25.21-2.51 28.31-3.31c2.1-0.5 3.69-2.59 3.69-4.69v-104c0-2.1-1.59-4.19-3.69-4.69-3.1-0.8-11.31-3.31-28.31-3.31z"
          fill="#eee"
        />
      </g>
      <linearGradient
