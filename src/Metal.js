  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <radialGradient
        ...
        cy={5.8006}
        r={115.53}
        gradientTransform="matrix(6.1232e-17 1 -.442 2.7065e-17 66.365 -58)"
      ...
      />
      <path
        d="m83.39 86.17c-3.71-1.09-7.79-1.48-11.37 0.26-3.7 1.8-5.57 5.42-7.06 9.06-0.73 1.79 2.17 2.56 2.89 0.8 1.23-3 2.8-6.05 5.96-7.35 2.85-1.18 5.91-0.72 8.78 0.13 1.86 0.54 2.65-2.35 0.8-2.9z"
        fill="#4A2F27"
      />
      <radialGradient
        id="e"
        ...
        fx={96.379}
        fy={221.76}
        gradientTransform="matrix(-.0699 .9347 -.3356 -.0192 161.48 -26.431)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <path
        d="m69.86 81.21c-0.19 0-0.39-0.01-0.58-0.02-2.25-0.14-4.33-1.13-5.69-2.71-1.14-1.31-1.69-2.94-1.56-4.57l1.52-18.92c0.29-3.56 3.72-6.35 7.81-6.35 0.19 0 0.39 0.01 0.58 0.02 2.25 0.14 4.33 1.13 5.69 2.71 1.14 1.31 1.69 2.94 1.56 4.57l-1.52 18.92c-0.28 3.56-3.71 6.35-7.81 6.35z"
        fill="url(#e)"
      />
      <path
      ...
      <radialGradient
        ...
        cy={86.008}
        r={20.902}
        gradientTransform="matrix(.1233 .9292 -.3952 .0436 134.83 423.79)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#70534A" offset={0.6064} />
        <stop stopColor="#5C4037" offset={0.9991} />
      ...
      <path
        d="m53.95 80.01c-4.13 0-7.57-2.7-8-6.28l-1.88-15.53c-0.2-1.68 0.3-3.36 1.41-4.75 1.33-1.66 3.42-2.73 5.72-2.96 0.3-0.03 0.6-0.04 0.89-0.04 4.13 0 7.57 2.7 8 6.28l1.88 15.53c0.2 1.68-0.3 3.37-1.41 4.75-1.33 1.66-3.42 2.73-5.72 2.96-0.3 0.02-0.59 0.04-0.89 0.04z"
        fill="url(#d)"
      />
      <path
        d="m52.1 51.94c3.31 0 6.17 2.18 6.51 4.96l1.88 15.53c0.2 1.63-0.48 2.88-1.09 3.63-1.08 1.34-2.79 2.22-4.69 2.4-0.25 0.02-0.5 0.04-0.75 0.04-3.31 0-6.17-2.18-6.51-4.96l-1.88-15.53c-0.2-1.63 0.48-2.88 1.09-3.63 1.08-1.34 2.79-2.22 4.69-2.4 0.25-0.02 0.5-0.04 0.75-0.04m0-3c-0.34 0-0.69 0.02-1.04 0.05-5.25 0.5-9.04 4.7-8.48 9.38l1.88 15.53c0.53 4.37 4.67 7.6 9.49 7.6 0.34 0 0.69-0.02 1.04-0.05 5.25-0.5 9.04-4.7 8.48-9.38l-1.88-15.53c-0.53-4.36-4.68-7.6-9.49-7.6z"
        fill="#4A2F27"
      />
      <defs>
        <path
          id="c"
          d="m58.09 66.25c-6.2-0.7-7.95 5.63-6.89 9.49s5.18 6.93 9.14 7.02c14.22 0.31 17.52 2.8 18.92 6.82 1.93 5.54 7.52 9.25 10.63 9.5 9.4 0.76 10.39-10.51 9.24-18.2-1.63-10.87-19.7-14.26-19.7-14.26s-18.38-0.03-21.34-0.37z"
        />
      </defs>
      <clipPath id="b">
        <use xlinkHref="#c" />
      ...
      <g clipPath="url(#b)">
        <radialGradient
          ...
          cy={502.65}
          r={26.301}
          gradientTransform="matrix(.7905 .0898 -.0981 .8635 27.951 -360.35)"
          gradientUnits="userSpaceOnUse"
        >
