    ...
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        <linearGradient
          ...
          y1={39.245}
          y2={65.497}
          gradientTransform="matrix(-.9233 -.3841 -.3841 .9233 -18.609 -65.054)"
        ...
        <radialGradient
          ...
          cy={-1.7311}
          r={14.631}
          gradientTransform="matrix(-1.0128 -.2301 -.2274 .9741 -84.709 -20.737)"
          gradientUnits="userSpaceOnUse"
        >
        ...
        <path
          d="m59.33 28.5-0.7-5.96s-3.74 0.18-3.38 4.03c0.25 2.71-1.82 5.39-3.05 5.45l-0.72 0.09c-0.6-4.07-5.21-6.03-4.33-16.3 0.76-8.91 9.26-12.6 16.68-11.54 7.11 1.01 14.33 6.97 12.14 16.5-0.08 0.33-9.43-0.36-11.98 1.56-2.48 1.9-1.42 6.38-4.66 6.17z"
          fill="url(#f)"
        />
        <defs>
          <path
            id="e"
            d="m53.6 21.33-1.28 9.51 0.47 0.99s-0.4 0.17-0.57 0.18l-0.72 0.09c-0.6-4.07-5.21-6.03-4.33-16.3 0.76-8.91 9.26-12.6 16.68-11.54 7.11 1.01 14.38 7.33 12.18 16.54-0.02 0.07-1.12 0.05-1.12 0.05l0.23-1.53-10.95-0.49-10.59 2.5z"
          />
        </defs>
        <clipPath id="d">
          <use xlinkHref="#e" />
        ...
        <g clipPath="url(#o)">
          <path
            d="m76.3 33.42c-2 1.74-5.7 2.27-7.56 0.05-0.71-0.84 0.06-1.41 0.94-0.76 1.43 1.06 4.42 0.71 5.69-0.38 0.83-0.72 1.76 0.37 0.93 1.09z"
            fill="#795548"
          />
        </g>
        <ellipse
        ...
        />
        <path
          d="m71.4 24c1.19 0.49 1.56-0.29 1.22-0.99-0.25-0.51-0.95-0.99-2.41-0.86-1.38 0.12-2.02 0.84-2.43 1.28s-0.42 0.91-0.11 0.98c0.41 0.1 2.26-1.02 3.73-0.41z"
          fill="#6D4C41"
        />
      </g>
      <g clipPath="url(#a)">
        ...
        <path
          d="m36.1 65.44 0.59-2.34 7.95-16.9c1.92-4.09 5.23-7.42 9.31-9.36 0.82-0.39 1.69-0.59 2.59-0.59 2.29 0 4.42 1.33 5.41 3.39l2.38 4.94-2.44 8.69-4.31 12.37-0.42 1.79-21.06-1.99z"
          fill="url(#n)"
        />
        <path
          d="m56.53 36.74c2.1 0 4.05 1.22 4.96 3.11l2.3 4.77-2.38 8.47-4.31 12.38c-0.01 0.03-0.02 0.07-0.03 0.1l-0.31 1.32-20.04-1.89 0.43-1.69 7.94-16.91c1.87-3.99 5.09-7.23 9.07-9.13 0.75-0.34 1.55-0.53 2.37-0.53m0-1c-0.94 0-1.9 0.2-2.8 0.64-4.14 1.97-7.54 5.33-9.55 9.6l-7.98 17-0.73 2.91 22.08 2.08 0.51-2.17 4.32-12.4 2.49-8.87-2.46-5.11c-1.14-2.32-3.46-3.68-5.88-3.68z"
          fill="#009984"
        />
      </g>
      <polygon
        points="34.64 68.94 36.2 62.98 58.05 65.8 74.29 68.94 74.29 72.73 34.64 72.73"
        clipPath="url(#a)"
        fill="#646464"
      />
      <g clipPath="url(#a)">
        <path
          d="m36.95 64.08 20.94 2.7 15.4 2.98v1.97h-37.65v-2.66l1.31-4.99m-0.75-1.1-1.56 5.96v3.79h39.65v-3.79l-16.24-3.14-21.85-2.82z"
          fill="#4F4F4F"
        />
      </g>
      <g clipPath="url(#a)">
        <radialGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FF9800" offset={0.5} />
          <stop stopColor="#FA8B00" offset={0.7654} />
          <stop stopColor="#F57C00" offset={0.9949} />
        </radialGradient>
        <path
          d="m7.61 73.15h111.59s-0.13 17.86-10.14 24.98h-81.9s-13.2-9.91-19.55-24.98z"
          fill="url(#b)"
          stroke="#E37200"
          strokeMiterlimit={10}
        />
        <path
          d="m119.49 76.64h-110.98c-2.49 0-4.51-2.01-4.51-4.5s2.02-4.51 4.51-4.51h110.99c2.49 0 4.51 2.02 4.51 4.51-0.01 2.49-2.03 4.5-4.52 4.5z"
          fill="#DB5E2C"
        />
        <path
          d="m119.49 76.64h-110.98c-2.49 0-4.51-2.01-4.51-4.5s2.02-4.51 4.51-4.51h110.99c2.49 0 4.51 2.02 4.51 4.51-0.01 2.49-2.03 4.5-4.52 4.5z"
        ...
        />
        <path
          d="m119.49 68.63c1.93 0 3.51 1.57 3.51 3.51 0 1.93-1.57 3.51-3.51 3.51h-110.98c-1.94-0.01-3.51-1.58-3.51-3.51s1.57-3.51 3.51-3.51h110.98m0-1h-110.98c-2.49 0-4.51 2.02-4.51 4.51s2.02 4.51 4.51 4.51h110.99c2.49 0 4.51-2.02 4.51-4.51-0.01-2.49-2.03-4.51-4.52-4.51z"
          fill="#D24A00"
        />
      </g>
      <rect
      ...
      <g clipPath="url(#a)">
        ...
        />
        <path
          d="m90.15 56.01 3.3 3.27-33.07 33.39-3.3-3.27 33.07-33.39m-0.01-1.41-34.48 34.81 4.72 4.68 34.48-34.81-4.72-4.68z"
          fill="#ED9513"
        />
      </g>
      <polygon
      ...
      <g clipPath="url(#a)">
        <path
          d="m46.08 111.41c-2.04 0-3.96-0.79-5.41-2.23-3.01-2.98-3.04-7.86-0.05-10.88l8.97-9.05c1.46-1.47 3.4-2.28 5.46-2.28 2.04 0 3.96 0.79 5.41 2.23 3.01 2.98 3.04 7.86 0.05 10.88l-8.97 9.05c-1.45 1.47-3.4 2.28-5.46 2.28z"
          fill="#FFD54F"
        />
        <path
          d="m55.04 87.47c1.91 0 3.7 0.74 5.06 2.08 1.36 1.35 2.12 3.15 2.13 5.08 0.01 1.92-0.73 3.73-2.08 5.1l-8.97 9.05c-1.36 1.37-3.18 2.13-5.11 2.13-1.91 0-3.7-0.74-5.06-2.08-1.36-1.35-2.12-3.15-2.13-5.08-0.01-1.92 0.73-3.73 2.08-5.1l8.97-9.05c1.36-1.37 3.18-2.12 5.11-2.13m0-1c-2.11 0-4.22 0.81-5.82 2.43l-8.97 9.05c-3.18 3.21-3.16 8.4 0.06 11.58 1.6 1.58 3.68 2.37 5.76 2.37 2.11 0 4.22-0.81 5.82-2.43l8.97-9.05c3.18-3.21 3.16-8.4-0.06-11.58-1.59-1.58-3.67-2.37-5.76-2.37z"
          fill="#EDC239"
        />
      </g>
      <g clipPath="url(#a)">
        ...
        <path
          d="m88.42 53.59c-0.36-0.59-0.18-1.36 0.41-1.73l4.01-2.47c0.59-0.36 1.36-0.18 1.73 0.41 0.36 0.59 0.18 1.36-0.41 1.73l-4.02 2.47c-0.59 0.37-1.36 0.18-1.72-0.41z"
          fill="url(#m)"
        />
        <radialGradient
          id="l"
        ...
        <path
          d="m95.78 53.16c-0.54 0.44-1.33 0.36-1.76-0.18l-1.39-1.7c-0.44-0.54-0.36-1.33 0.18-1.76 0.54-0.44 1.33-0.36 1.76 0.18l1.39 1.7c0.44 0.53 0.36 1.32-0.18 1.76z"
          fill="url(#l)"
        />
      </g>
      <rect
