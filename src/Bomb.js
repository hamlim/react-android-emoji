  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FF9100" offset={0.3616} />
        <stop stopColor="#FF8A04" offset={0.454} />
        <stop stopColor="#FF760F" offset={0.5892} />
        <stop stopColor="#FF5621" offset={0.7507} />
        <stop stopColor="#FF2A39" offset={0.9311} />
        <stop stopColor="#FF1744" offset={1} />
      </linearGradient>
      <polygon points="28.67 2.67 30.33 13.98 27.33 14.02" fill="url(#f)" />
      <linearGradient
        id="e"
        x1={13.25}
        x2={24.472}
      ...
      <polygon points="13.25 9.88 24.47 15.23 22.86 17.77" fill="url(#e)" />
      <linearGradient
        id="d"
        x1={13.52}
        x2={23.02}
      ...
      <polygon points="11.5 25.17 22.8 21.16 23.45 24.09" fill="url(#d)" />
      <linearGradient
        id="c"
        x1={19.648}
        x2={26.148}
      ...
      <polygon points="27.34 28.09 19.68 36.56 24.87 26.39" fill="url(#c)" />
      <linearGradient
        id="b"
        x1={29.578}
        x2={34.903}
      ...
      <polygon points="32.04 28.43 32.52 37.77 29.62 28.88" fill="url(#b)" />
      <linearGradient
        id="a"
        x1={34.528}
        x2={41.528}
      ...
      >
        ...
        <stop stopColor="#FF2A39" offset={0.0689} />
        <stop stopColor="#FF5621" offset={0.2493} />
        <stop stopColor="#FF760F" offset={0.4108} />
        <stop stopColor="#FF8A04" offset={0.546} />
        <stop stopColor="#FF9100" offset={0.6384} />
      </linearGradient>
      <polygon points="33.04 14.01 41.67 6.5 35.29 15.99" fill="url(#a)" />
      <circle cx={22.94} cy={10.19} r={0.94} fill="#F44336" />
      <circle cx={17.75} cy={19.38} r={1} fill="#F44336" />
      <circle cx={38} cy={17.38} r={1} fill="#F44336" />
      <circle cx={26.33} cy={32.92} r={0.57} fill="#F44336" />
      <circle cx={17.38} cy={29.5} r={1} fill="#F44336" />
    </svg>
  );
}
