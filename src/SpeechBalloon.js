...
function SpeechBalloon(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#FAFAFA" offset={0.4391} />
        <stop stopColor="#E0E0E0" offset={0.8212} />
      </linearGradient>
      <path
        d="m110.46 14.21h-93.12c-7.34 0-13.34 6-13.34 13.34v53.79c0 7.08 5.79 12.87 12.87 12.87 1.98 0 3.52 1.75 3.25 3.71-1.06 7.74-5.19 11.53-5.6 12.96-0.63 2.22 9.81 3.81 18.97-5 3.84-3.69 5.68-7.36 6.51-9.57 0.48-1.27 1.7-2.1 3.06-2.1h67.72c7.3 0 13.21-5.92 13.21-13.21v-53.25c0.01-7.45-6.08-13.54-13.53-13.54z"
        fill="url(#a)"
      />
      <g fill="#2196F3">
