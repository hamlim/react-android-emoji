  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        >
          <stop stopColor="#1565C0" offset={0.111} />
          <stop stopColor="#1E88E5" offset={0.8469} />
        </linearGradient>
        <path
          d="m73.08 95.03v-1.07c9.32-2.75 17.57-9.83 21.67-21.32 4.22-1.53 6.62-15.3 5.48-17.12 0.88-5.94 6.23-51.27-36.23-51.5h-0.02s-0.01 0-0.02 0c-42.56 0.24-37.08 45.8-36.22 51.55-1.12 1.8 1.28 15.54 5.5 17.07 4.11 11.49 12.35 18.57 21.67 21.32v1.06c-22.16 1.63-42.05 9.29-42.05 24.94v10.94h102.27v-10.94c0-14.8-19.79-23.17-42.05-24.93z"
          fill="url(#b)"
        />
      </g>
