...
function Rage(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#F15B52" offset={0.3413} />
        <stop stopColor="#EF5851" offset={0.5564} />
        <stop stopColor="#EA4E50" offset={0.718} />
        <stop stopColor="#E13E4D" offset={0.8618} />
        <stop stopColor="#D9314B" offset={0.9457} />
      </linearGradient>
      <path
        d="M64,119.79c-27.88,0-57.9-17.46-57.9-55.79S36.12,8.21,64,8.21 c15.46,0,29.76,5.12,40.29,14.4c11.52,10.17,17.61,24.48,17.61,41.38c0,16.83-6.09,31.12-17.61,41.31 C93.73,114.65,79.43,119.79,64,119.79z"
        fill="url(#a)"
      />
      <path
        d="m64 10.32c14.94 0 28.75 4.93 38.9 13.88 11.05 9.75 16.89 23.52 16.89 39.81 0 16.21-5.84 29.95-16.9 39.73-10.17 9-23.98 13.95-38.89 13.95-14.99 0-28.8-4.89-38.9-13.77-11.05-9.72-16.89-23.52-16.89-39.92 0-16.48 5.84-30.3 16.88-39.99 10.08-8.83 23.89-13.69 38.91-13.69m0-4.21c-31.15 0-60 20-60 57.89 0 37.68 28.85 57.89 60 57.89s60-20.73 60-57.89c0-37.37-28.85-57.89-60-57.89z"
        fill="#C7203A"
      />
      <path
