...
function Candy(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#44B3E6" offset={0.3474} />
        <stop stopColor="#2C98D4" offset={0.6576} />
      </linearGradient>
      <path
        d="m43.21 118.87 5.33-33.31c0.65-4.09-2.88-7.63-6.98-6.98l-32.43 5.18c-6.19 0.99-7.03 9.56-1.14 11.73 2.59 0.96 4.22 3.54 3.96 6.29l-0.6 6.25c-0.36 3.78 2.78 6.96 6.56 6.65l6.6-0.55c2.68-0.22 5.19 1.35 6.17 3.85l0.83 2.13c2.27 5.8 10.72 4.89 11.7-1.24z"
        fill="url(#j)"
      />
      <defs>
        <path
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#2C98D4" offset={0.4177} />
        <stop stopColor="#0277BD" offset={0.8503} />
      </linearGradient>
      <path
        d="m49.82 80.56-3.1-3.1-26.56 14.33c-1.1 0.59-0.34 2.26 0.83 1.81l15.66-5.98-13.94 15.67c-0.83 0.93 0.46 2.24 1.4 1.42l15.86-13.76-5.25 14.09c-0.44 1.17 1.24 1.92 1.82 0.81l13.28-25.29z"
        clipPath="url(#h)"
        fill="url(#g)"
      />
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#44B3E6" offset={0.364} />
        <stop stopColor="#2C98D4" offset={0.6128} />
      </linearGradient>
      <path
        d="m118.87 43.21-33.31 5.33c-4.09 0.65-7.63-2.88-6.98-6.98l5.18-32.43c0.99-6.19 9.56-7.03 11.73-1.14 0.96 2.59 3.54 4.22 6.29 3.96l6.25-0.6c3.78-0.36 6.96 2.78 6.65 6.56l-0.55 6.6c-0.22 2.68 1.35 5.19 3.85 6.17l2.13 0.83c5.8 2.27 4.89 10.72-1.24 11.7z"
        fill="url(#f)"
      />
      <defs>
        <path
      ...
      <path
        d="m80.56 49.82-3.1-3.1 14.33-26.56c0.59-1.1 2.26-0.34 1.81 0.83l-5.98 15.66 15.67-13.94c0.93-0.83 2.24 0.46 1.42 1.4l-13.76 15.87 14.09-5.25c1.17-0.44 1.92 1.24 0.81 1.82l-25.29 13.27z"
        clipPath="url(#d)"
        fill="url(#c)"
      />
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#57A0D7" offset={0.4042} />
        <stop stopColor="#3D82C4" offset={0.8643} />
      </radialGradient>
      <path
        d="m87.79 37.99s20.78 29.01 0 49.79-49.79 0-49.79 0-23.49-26.3 0-49.79 49.79 0 49.79 0z"
        fill="url(#b)"
      />
      <defs>
        <path
      ...
      <g clipPath="url(#a)">
        <radialGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FFE081" offset={0.211} />
          <stop stopColor="#FFCB28" offset={0.8584} />
        </radialGradient>
        <path
          d="m84.36 103.21c-32.9 0-60.69-27.79-60.69-60.69h10.53c0 27.19 22.97 50.16 50.16 50.16v10.53z"
          fill="url(#m)"
        />
      </g>
      <g clipPath="url(#a)">
        ...
        <path
          d="m99.43 88.14c-25.52 0-60.69-35.17-60.69-60.69h10.53c0 19.69 30.47 50.16 50.16 50.16v10.53z"
          fill="url(#l)"
        />
      </g>
      <g clipPath="url(#a)">
