    ...
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#b)">
        ...
        >
          ...
          <stop stopColor="#323232" offset={0.7831} />
      ...
      <g clipPath="url(#b)">
        ...
        <g clipPath="url(#a)" fill="#9E9E9E">
          <path d="m51.61 96.09 6.54 30h-7.29l-11.44-11.14 4.75-6.11-7.12-4.36 4.29-6.86c-0.01 0 4.35-1.1 10.27-1.53z" />
          <path d="m76.39 96.09-6.54 30h7.29l11.44-11.14-4.75-6.11 7.12-4.36-4.29-6.86c0.01 0-4.35-1.1-10.27-1.53z" />
        </g>
        <g clipPath="url(#a)" fill="#757575">
          <path d="m50.03 98.23 5.64 25.86h-4l-9.58-9.33 3.65-4.7c0.35-0.45 0.49-1.03 0.39-1.59s-0.44-1.05-0.92-1.35l-5.4-3.3 2.78-4.44c1.26-0.27 3.99-0.81 7.44-1.15m1.58-2.14c-5.92 0.43-10.28 1.53-10.28 1.53l-4.29 6.86 7.12 4.36-4.75 6.11 11.44 11.14h7.29l-6.53-30z" />
          <path d="m77.97 98.23c3.45 0.34 6.18 0.88 7.45 1.15l2.78 4.44-5.4 3.3c-0.49 0.3-0.82 0.79-0.92 1.35s0.04 1.14 0.39 1.59l3.65 4.7-9.58 9.33h-4l5.63-25.86m-1.58-2.14-6.54 30h7.29l11.44-11.14-4.75-6.11 7.12-4.36-4.29-6.86c0.01 0-4.35-1.1-10.27-1.53z" />
        </g>
        <g clipPath="url(#a)">
          <path
            d="m64.77 115.14h-1.4c-1.53 0-2.85-1.05-3.21-2.54l-0.53-2.24c-0.49-2.07 1.08-4.06 3.21-4.06h2.45c2.12 0 3.68 1.97 3.21 4.03l-0.51 2.24c-0.35 1.51-1.69 2.57-3.22 2.57z"
            fill="#212121"
          />
        </g>
        <path
          d="m48.79 117.09v-12.07c0-1.5 1.63-2.45 2.95-1.71l10.7 5.94c1.34 0.74 1.35 2.65 0.02 3.42l-10.7 6.13c-1.32 0.74-2.97-0.2-2.97-1.71z"
          clipPath="url(#a)"
          fill="#212121"
        />
        <path
          d="m78.79 117.09v-12.07c0-1.5-1.63-2.45-2.95-1.71l-10.7 5.94c-1.34 0.74-1.35 2.65-0.02 3.42l10.7 6.13c1.32 0.74 2.97-0.2 2.97-1.71z"
          clipPath="url(#a)"
          fill="#212121"
        />
        <circle cx={63.75} cy={120} r={2} clipPath="url(#a)" fill="#212121" />
      </g>
      <g clipPath="url(#b)">
        <path
