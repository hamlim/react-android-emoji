...
function DesertIsland(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#01579B" offset={0} />
        <stop stopColor="#00ACC1" offset={1} />
      </linearGradient>
      <path
      ...
      <ellipse
        ...
        opacity={0.7}
      />
      <ellipse cx={63.96} cy={102.12} rx={50} ry={6.21} fill="#FFECB3" />
      <linearGradient
        id="c"
        x1={63.982}
        x2={63.982}
      ...
      >
        ...
        <stop stopColor="#FFD965" offset={0.4442} />
        <stop stopColor="#FFCA28" offset={0.8164} />
        <stop stopColor="#FFCA28" offset={1} />
      </linearGradient>
      <path
        d="m112 100.67h-0.02c-5.23-11.46-24.72-19.96-47.98-19.96s-42.75 8.51-47.98 19.96h-0.02l0.01 0.01c0 0.01-0.01 0.02-0.01 0.02h0.03c-1.66 3.21 27.97 4.88 47.97 4.88s48.75-1.92 47.97-4.88h0.03c0-0.01-0.01-0.02-0.01-0.02l0.01-0.01z"
        fill="url(#c)"
      />
      <g opacity={0.2}>
        <path
          d="m116 67c2.76 0 5 2.24 5 5v49h-114v-49c0-2.76 2.24-5 5-5h104m0-3h-104c-4.42 0-8 3.58-8 8v52h120v-52c0-4.42-3.58-8-8-8z"
          fill="#424242"
        />
      </g>
      <ellipse cx={30.89} cy={95.76} rx={1.49} ry={0.93} fill="#FFB300" />
      <ellipse cx={37.17} cy={89.43} rx={0.94} ry={0.59} fill="#FFC107" />
      <ellipse cx={74} cy={91.89} rx={0.94} ry={0.59} fill="#FFD54F" />
      <ellipse cx={85.48} cy={100.75} rx={1.49} ry={0.93} fill="#FFC107" />
      <ellipse cx={56.76} cy={90.86} rx={1.35} ry={0.85} fill="#FFC107" />
      <ellipse cx={50.14} cy={91.36} rx={1.35} ry={0.85} fill="#FFC107" />
      <ellipse cx={63.05} cy={95.59} rx={0.94} ry={0.59} fill="#FFC107" />
      <ellipse cx={36.86} cy={100.77} rx={1.25} ry={0.79} fill="#FFC107" />
      <ellipse cx={58.38} cy={94.25} rx={0.94} ry={0.59} fill="#FFD54F" />
      <ellipse cx={46.42} cy={102.19} rx={0.94} ry={0.59} fill="#FFD54F" />
      <ellipse cx={26.73} cy={97.78} rx={0.94} ry={0.59} fill="#FFC107" />
      <ellipse cx={47.18} cy={96.12} rx={1.25} ry={0.79} fill="#FFC107" />
      <ellipse cx={96.58} cy={102.07} rx={1.25} ry={0.79} fill="#FFC107" />
      <ellipse cx={75.05} cy={100.57} rx={0.94} ry={0.59} fill="#FFD54F" />
      <ellipse cx={102.76} cy={97.72} rx={1.49} ry={0.93} fill="#FFC107" />
      <g opacity={0.2}>
        <path
          d="m64 83.71c19.81 0 37.59 6.56 43.94 15.9-6.22 1.47-24.7 2.98-43.94 2.98-21.54 0-38.35-1.5-44.04-2.83 6.27-9.43 24.13-16.05 44.04-16.05m0-3c-23.26 0-42.75 8.51-47.98 19.96h-0.02l0.01 0.01c0 0.01-0.01 0.02-0.01 0.02h0.03c-1.66 3.21 27.97 4.88 47.97 4.88s48.75-1.92 47.97-4.88h0.03c0-0.01-0.01-0.02-0.01-0.02l0.01-0.01h-0.02c-5.23-11.46-24.72-19.96-47.98-19.96z"
          fill="#424242"
        />
      </g>
      <linearGradient
      ...
      <path
        d="m68.84 28.35c14.78 26.34 8.17 63.35 8.17 63.35s1.31 2.1 6.91 2.29c4.65 0.16 7.04-2.03 7.04-2.04 2.98-32.36-8.86-58.2-16.84-65.11 0.03 0-4.35 0.46-5.28 1.51z"
        fill="url(#b)"
      />
      <g opacity={0.2}>
        <path
