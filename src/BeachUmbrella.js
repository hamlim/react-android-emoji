  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#FFD965" offset={0.3144} />
        <stop stopColor="#FFCA28" offset={1} />
      </linearGradient>
      <rect x={4} y={71.89} width={120} height={52.11} fill="url(#i)" />
      <defs>
        <rect id="h" x={4} y={71.77} width={120} height={52.11} />
      </defs>
      <clipPath id="g">
        <use xlinkHref="#h" />
      </clipPath>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#00ACC1" offset={0} />
        <stop stopColor="#13B1C4" offset={0.075} />
        <stop stopColor="#68CAD0" offset={0.4329} />
        <stop stopColor="#9DD9D8" offset={0.6855} />
        <stop stopColor="#B2DFDB" offset={0.808} />
        <stop stopColor="#B2DFDB" offset={1} />
      </linearGradient>
      <path
      ...
      <path
        d="m60.8 107.9c-1.31-0.23-2.19-1.48-1.95-2.79l18.08-99.12c0.23-1.31 1.48-2.18 2.79-1.95s2.19 1.48 1.95 2.79l-18.08 99.13c-0.23 1.3-1.48 2.18-2.79 1.94z"
        fill="url(#d)"
      />
      <radialGradient
        id="c"
        ...
        cy={7.2556}
        r={47.974}
        gradientTransform="matrix(1 0 0 1.0004 0 -.0277)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#EF5350" offset={0} />
