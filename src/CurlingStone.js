  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#434343" offset={0.9231} />
      </radialGradient>
      <path
      ...
      <g clipPath="url(#c)" opacity={0.78}>
        ...
        >
          ...
          <stop stopColor="#B0AFAF" offset={0.7305} />
          <stop stopColor="#E0E0E0" offset={1} />
        </linearGradient>
        <path
          d="m62.29 93.2c-43.51 0-65.37-5.97-66.28-6.29-5.59-1.99-8.13-7.27-5.68-11.79 2.44-4.51 8.92-6.58 14.5-4.62 0.47 0.16 19.44 4.81 57.47 4.81 39.32 0 62.3-4.95 62.53-5.01 5.73-1.67 12.07 0.74 14.13 5.4 2.06 4.65-0.92 9.78-6.66 11.45-1.08 0.29-26.88 6.05-70.01 6.05z"
          fill="url(#b)"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m98.44 48.46c12.41 0 22.5 9.83 22.5 21.9v12.18c0 16.48-8.58 24.84-25.51 24.84h-62.87c-22.2 0-25.51-15.56-25.51-24.84v-14.14c0-11 9.2-19.94 20.5-19.94h70.89m0-3.05h-70.9c-13 0-23.54 10.29-23.54 22.99v14.14c0 15.34 8.33 27.89 28.56 27.89h62.87c21.23 0 28.56-12.55 28.56-27.89v-12.18c0.01-13.72-11.49-24.95-25.55-24.95z"
          fill="#434343"
        />
      </g>
      <linearGradient
