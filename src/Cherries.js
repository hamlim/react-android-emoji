...
function Cherries(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m74.09 15.41c0.49 0.36 1 0.81 1.07 1.42 0.07 0.6-0.31 1.15-0.67 1.63-0.3 0.4-0.64 0.82-1.12 0.92-0.51 0.1-1-0.19-1.43-0.48-2.03-1.41-3.95-3.31-6.41-3.56-0.85-0.08-3.22-0.24-2.61-1.74 0.37-0.93 2.11-0.97 2.91-0.97 2.92 0.01 5.9 1.06 8.26 2.78z"
        fill="#558B2F"
      />
      <linearGradient
        id="d"
      ...
      <linearGradient
        ...
        y1={6.5951}
        y2={85.465}
        gradientTransform="matrix(.9998 -.0192 .0192 .9998 -1.1879 1.2407)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#A67C52" offset={0.0033059} />
        <stop stopColor="#9F754C" offset={0.2137} />
        <stop stopColor="#8B623A" offset={0.523} />
        <stop stopColor="#6B431D" offset={0.892} />
        <stop stopColor="#603813" offset={1} />
      </linearGradient>
      <path
        d="m62.41 5.9-9.83 2.31s2.94 4.77 5.08 10.65c-6.39 43.67-23.8 64.14-23.8 64.14l5.42 0.98c14.75-20.43 19.81-41.87 22.95-55.08 1.09 6.69 14.82 40.68 28.7 51.5l2.8-1.72c0 0.01-18.36-21.28-31.32-72.78z"
        fill="url(#c)"
      />
      <g opacity={0.2}>
        <path
          d="m60.96 8.29c10.1 39.2 23.11 60.47 28.63 68.25-12.21-12.12-24.35-41.59-25.39-47.96-0.15-0.94-0.95-1.64-1.9-1.68h-0.07c-0.92 0-1.73 0.63-1.94 1.54l-0.05 0.19c-2.99 12.56-7.96 33.44-21.85 53.15l-0.98-0.18c4.86-6.9 17.05-27.1 22.23-62.45 0.05-0.33 0.01-0.66-0.1-0.97-1.28-3.52-2.82-6.62-3.9-8.63l5.32-1.26m1.45-2.39-9.83 2.31s2.94 4.77 5.08 10.65c-6.39 43.67-23.8 64.14-23.8 64.14l5.42 0.98c14.75-20.43 19.81-41.87 22.95-55.08 1.09 6.69 14.82 40.68 28.7 51.5l2.8-1.72c0 0.01-18.36-21.28-31.32-72.78z"
          fill="#424242"
        />
      </g>
      <radialGradient
