...
function Crown(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#FDD835" offset={0.0577} />
        <stop stopColor="#F9A825" offset={0.7565} />
      </linearGradient>
      <path
        d="m49.57 89.51h-32.92c-2.35 0-4.25-1.9-4.25-4.25v-3.43c0-0.55 0.11-1.09 0.31-1.6l13.63-33.5c1.34-3.28 5.87-3.58 7.62-0.51l19.29 33.8c0.37 0.64 0.56 1.37 0.56 2.11v3.13c0 2.35-1.9 4.25-4.24 4.25z"
        fill="url(#g)"
      />
      <linearGradient
        id="f"
      ...
      <path
        d="m79.49 89.51h32.92c2.35 0 4.25-1.9 4.25-4.25v-3.43c0-0.55-0.11-1.09-0.31-1.6l-13.63-33.5c-1.34-3.28-5.87-3.58-7.62-0.51l-19.29 33.8c-0.37 0.64-0.56 1.37-0.56 2.11v3.13c0 2.35 1.9 4.25 4.24 4.25z"
        fill="url(#f)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m80.46 89.51h-32.92c-2.35 0-4.25-1.9-4.25-4.25v-3.28c0-0.65 0.15-1.28 0.43-1.87l16.46-33.67c1.55-3.18 6.08-3.18 7.63 0l16.46 33.67c0.28 0.58 0.43 1.22 0.43 1.87v3.28c0.01 2.35-1.89 4.25-4.24 4.25z"
        fill="url(#a)"
      />
      <linearGradient
        id="e"
      ...
      <circle cx={99.72} cy={42.04} r={4.05} fill="url(#e)" />
      <circle cx={64} cy={42.04} r={4.05} fill="url(#a)" />
      <linearGradient
        id="d"
        x1={29.197}
        x2={29.197}
      ...
      <circle cx={84.47} cy={28.33} r={7.1} fill="url(#b)" />
      <linearGradient
        id="o"
        x1={44.595}
        x2={44.595}
      ...
      <circle cx={44.6} cy={28.33} r={7.1} fill="url(#o)" />
      <linearGradient
        id="n"
        x1={10.082}
        x2={10.082}
      ...
      <circle cx={10.08} cy={45.85} r={6.08} fill="url(#n)" />
      <linearGradient
        id="m"
        x1={117.92}
        x2={117.92}
      ...
      <circle cx={64.53} cy={81.36} r={11.15} fill="url(#l)" />
      <linearGradient
        id="k"
        x1={32.946}
        x2={41.957}
      ...
      <circle cx={37.45} cy={81.36} r={6.37} fill="url(#k)" />
      <linearGradient
        id="j"
        x1={87.105}
        x2={96.116}
      ...
      <circle cx={91.61} cy={81.36} r={6.37} fill="url(#j)" />
      <linearGradient
        id="i"
        x1={7.8614}
        x2={17.13}
      ...
      <ellipse cx={12.5} cy={81.36} rx={5.62} ry={7.37} fill="url(#i)" />
      <linearGradient
        id="h"
        x1={111.93}
        x2={121.2}
      ...
      <ellipse cx={116.57} cy={81.36} rx={5.62} ry={7.37} fill="url(#h)" />
      <g opacity={0.2}>
        <path
          d="m12.5 75.99c1.96 0 3.62 2.46 3.62 5.37s-1.66 5.37-3.62 5.37-3.62-2.46-3.62-5.37 1.66-5.37 3.62-5.37m0-2c-3.1 0-5.62 3.3-5.62 7.37s2.51 7.37 5.62 7.37 5.62-3.3 5.62-7.37c-0.01-4.07-2.52-7.37-5.62-7.37z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m116.57 75.99c1.96 0 3.62 2.46 3.62 5.37s-1.66 5.37-3.62 5.37-3.62-2.46-3.62-5.37 1.66-5.37 3.62-5.37m0-2c-3.1 0-5.62 3.3-5.62 7.37s2.51 7.37 5.62 7.37 5.62-3.3 5.62-7.37c-0.01-4.07-2.52-7.37-5.62-7.37z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m64.53 72.21c5.05 0 9.15 4.1 9.15 9.15s-4.1 9.15-9.15 9.15-9.15-4.1-9.15-9.15 4.11-9.15 9.15-9.15m0-2c-6.16 0-11.15 4.99-11.15 11.15s4.99 11.15 11.15 11.15 11.15-4.99 11.15-11.15-4.99-11.15-11.15-11.15z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m37.45 76.99c2.41 0 4.37 1.96 4.37 4.37s-1.96 4.37-4.37 4.37-4.37-1.96-4.37-4.37 1.96-4.37 4.37-4.37m0-2c-3.52 0-6.37 2.85-6.37 6.37s2.85 6.37 6.37 6.37 6.37-2.85 6.37-6.37-2.85-6.37-6.37-6.37z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m91.61 76.99c2.41 0 4.37 1.96 4.37 4.37s-1.96 4.37-4.37 4.37-4.37-1.96-4.37-4.37 1.96-4.37 4.37-4.37m0-2c-3.52 0-6.37 2.85-6.37 6.37s2.85 6.37 6.37 6.37 6.37-2.85 6.37-6.37-2.85-6.37-6.37-6.37z"
          fill="#424242"
        />
      </g>
    </svg>
