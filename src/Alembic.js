  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#673AB7" offset={0} />
        <stop stopColor="#9575CD" offset={1} />
      </linearGradient>
      <path
        d="M11.2,52c2.51,18.22,18.14,32.26,37.05,32.26S82.79,70.22,85.3,52H11.2z"
        fill="url(#e)"
      />
      <path
        d="m76.46 72h12.72c2.17 0 3.94-1.83 3.94-4s-1.77-4-3.94-4h-81.12c-2.17 0-3.94 1.83-3.94 4s1.77 4 3.94 4h11.72l-15.5 49.29c-0.43 1.08 0.07 2.3 1.13 2.77s2.3 0.02 2.81-1.02l20.3-51.04h15.6l1.67 50.17c0.05 1.16 1 2.07 2.16 2.07s2.11-0.91 2.16-2.07l1.67-50.17h15.96l20.29 51.04c0.51 1.04 1.75 1.49 2.81 1.02s1.56-1.69 1.13-2.77l-15.51-49.29z"
        fill="#BDBDBD"
      />
      <g opacity={0.2}>
        <path
          d="m89.96 123.25c-0.45 0-0.85-0.25-1.04-0.65l-20.26-50.97c-0.15-0.38-0.52-0.63-0.93-0.63h-15.95c-0.54 0-0.98 0.43-1 0.97l-1.67 50.17c-0.03 0.62-0.54 1.1-1.16 1.1s-1.13-0.49-1.16-1.11l-1.67-50.17c-0.02-0.54-0.46-0.97-1-0.97h-15.6c-0.41 0-0.78 0.25-0.93 0.63l-20.3 51.05c-0.16 0.33-0.56 0.57-1.01 0.57-0.16 0-0.32-0.03-0.47-0.1-0.57-0.25-0.84-0.91-0.61-1.49l15.54-49.35c0.1-0.3 0.04-0.63-0.15-0.89s-0.49-0.41-0.8-0.41h-11.73c-1.59 0-2.94-1.37-2.94-3s1.35-3 2.94-3h81.12c1.59 0 2.94 1.37 2.94 3s-1.34 3-2.94 3h-12.72c-0.32 0-0.62 0.15-0.81 0.41s-0.24 0.59-0.14 0.89l15.51 49.29c0.25 0.65-0.01 1.3-0.59 1.56-0.15 0.06-0.3 0.1-0.47 0.1z"
          fill="#BDBDBD"
        />
        <path
          d="m89.19 66c1.05 0 1.94 0.92 1.94 2s-0.89 2-1.94 2h-12.73c-0.64 0-1.24 0.3-1.61 0.82-0.38 0.51-0.49 1.18-0.3 1.78l15.51 49.29c0.01 0.05 0.03 0.09 0.05 0.13 0.03 0.08-0.01 0.17-0.08 0.21-0.02 0.01-0.04 0.01-0.06 0.01-0.01 0-0.08 0-0.13-0.06l-20.25-50.92c-0.3-0.76-1.04-1.26-1.86-1.26h-15.95c-1.08 0-1.96 0.86-2 1.93l-1.67 50.16c0 0.09-0.07 0.15-0.16 0.15s-0.16-0.07-0.16-0.14l-1.67-50.17c-0.04-1.08-0.92-1.93-2-1.93h-15.6c-0.82 0-1.56 0.5-1.86 1.26l-20.25 50.93c-0.05 0.06-0.11 0.06-0.13 0.06s-0.04 0-0.06-0.01c-0.08-0.04-0.12-0.13-0.08-0.21 0.02-0.04 0.03-0.09 0.05-0.13l15.5-49.3c0.19-0.61 0.08-1.27-0.3-1.78-0.37-0.52-0.97-0.82-1.6-0.82h-11.73c-1.05 0-1.94-0.92-1.94-2s0.89-2 1.94-2h81.13m0-2h-81.13c-2.17 0-3.94 1.83-3.94 4s1.77 4 3.94 4h11.72l-15.5 49.29c-0.43 1.08 0.07 2.3 1.13 2.77 0.28 0.13 0.58 0.19 0.88 0.19 0.8 0 1.56-0.44 1.94-1.2l20.29-51.05h15.6l1.67 50.17c0.05 1.16 1 2.07 2.16 2.07s2.11-0.91 2.16-2.07l1.67-50.17h15.96l20.29 51.04c0.38 0.76 1.14 1.2 1.94 1.2 0.29 0 0.59-0.06 0.88-0.19 1.06-0.47 1.56-1.69 1.13-2.77l-15.52-49.28h12.72c2.17 0 3.94-1.83 3.94-4 0.01-2.17-1.77-4-3.93-4z"
          fill="#424242"
        />
      </g>
      <path
        d="m-103.44 43.44 11.36-27.41 55.59 23.21c2.32 0.97 3.55 3.51 2.88 5.92l-2.27 8.22c-0.7 2.55-3.28 4.11-5.87 3.54l-61.69-13.48z"
        fill="#CFD8DC"
      />
      <circle cx={-108.88} cy={53.73} r={41.27} fill="#CFD8DC" />
      <circle cx={-108.88} cy={53.73} r={36.42} fill="#7E57C2" />
      <path
        d="m-68.81 80h-80.13c-2.17 0-3.94-1.77-3.94-3.94s1.77-3.94 3.94-3.94h80.13c2.17 0 3.94 1.77 3.94 3.94-0.01 2.17-1.78 3.94-3.94 3.94z"
        fill="#CFD8DC"
      />
      <path
        d="m-109.05 122.25c-1.16 0-2.11-0.91-2.16-2.07l-1.91-45.99h8.15l-1.91 45.99c-0.06 1.15-1.01 2.07-2.17 2.07z"
        fill="#CFD8DC"
      />
      <path
        d="m-151.59 122.06c-1.06-0.47-1.56-1.69-1.13-2.77l16.9-42.82 7.45 3.3-20.4 41.26c-0.52 1.05-1.76 1.5-2.82 1.03z"
        fill="#CFD8DC"
      />
      <path
        d="m-66.16 122.06c1.06-0.47 1.56-1.69 1.13-2.77l-16.9-42.82-7.45 3.3 20.4 41.26c0.52 1.05 1.76 1.5 2.82 1.03z"
        fill="#CFD8DC"
      />
    </svg>
  );
