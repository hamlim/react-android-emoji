...
function MountainBikingMan(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        >
          <stop stopColor="#BCAAA4" offset={0.2149} />
          <stop stopColor="#8D6E63" offset={1} />
        </linearGradient>
        <path
          d="m0.5 127.5v-52.36c0.64-1.74 11.29-30.41 23.03-32.63 0.6-0.11 1.23-0.17 1.85-0.17 3.63 0 6.99 1.91 10.55 3.94 3.62 2.06 7.37 4.19 11.51 4.19h0.14c6.28-0.08 11.17-5.17 15.26-9.94 8.44-9.84 13.49-15.43 15.02-16.61 3.65-2.81 8.34-4.36 13.2-4.36 16.28 0 35.19 32.39 36.44 34.57v73.38h-127z"
          fill="url(#f)"
        />
        <path
          d="m91.06 20.05c15.76 0 34.22 31.23 35.94 34.21v72.75h-126v-51.79c0.87-2.38 11.31-30.09 22.62-32.23 0.57-0.11 1.16-0.16 1.75-0.16 3.5 0 6.8 1.88 10.3 3.87 3.68 2.09 7.49 4.26 11.75 4.26h0.15c6.49-0.08 11.47-5.26 15.63-10.11 10.48-12.22 13.91-15.74 14.95-16.54 3.58-2.75 8.16-4.26 12.91-4.26m0-1c-4.83 0-9.68 1.52-13.51 4.47-2.35 1.81-12.14 13.22-15.1 16.68-3.99 4.65-8.76 9.69-14.89 9.76h-0.14c-7.92 0-14.46-8.12-22.06-8.13-0.64 0-1.28 0.06-1.94 0.18-12.45 2.36-23.42 33.04-23.42 33.04v52.95h128v-74.01s-19.7-34.94-36.94-34.94z"
          fill="#A1887F"
        />
      </g>
      <g clipPath="url(#a)">
        <path
          d="m66.37 91.4c-0.17 0-0.33-0.08-0.43-0.23l-0.73-1.06c-0.83-1.21-0.84-2.79-0.02-4.01l3.99-5.31 5.59-3.88c0.66 0.19 2.66 0.85 3.48 2.03l1.63 2.35c0.21 0.3 0.14 0.72-0.17 0.93l-13.05 9.1c-0.08 0.05-0.18 0.08-0.29 0.08z"
          fill="#4568AD"
        />
        <path
          d="m74.86 77.45c0.88 0.27 2.37 0.89 2.98 1.77l1.63 2.34c0.03 0.05 0.03 0.1 0.03 0.13-0.01 0.03-0.02 0.08-0.07 0.11l-13.08 9.09-0.73-1.06c-0.71-1.04-0.72-2.38-0.03-3.43l3.94-5.25 5.33-3.7m-0.19-1.09-5.85 4.06-4.06 5.4c-0.93 1.39-0.92 3.2 0.03 4.57l0.73 1.06c0.2 0.29 0.52 0.44 0.84 0.44 0.2 0 0.4-0.06 0.58-0.18l13.05-9.1c0.53-0.37 0.66-1.1 0.29-1.63l-1.63-2.34c-1.1-1.59-3.98-2.28-3.98-2.28z"
          fill="#315499"
        />
      </g>
      <g clipPath="url(#a)">
        <linearGradient
          ...
          y1={69.131}
          y2={90.297}
          gradientTransform="matrix(.936 -.3521 .3521 .936 9.7038 -51.083)"
          gradientUnits="userSpaceOnUse"
        >
        ...
        <radialGradient
          ...
          cy={6.9921}
          r={13.186}
          gradientTransform="matrix(1.0201 -.1951 .1937 .9813 53.132 1.5246)"
          gradientUnits="userSpaceOnUse"
        >
        ...
        <path
          d="m46.04 26.37 0.81-5.35s3.36 0.28 2.92 3.73c-0.31 2.43 1.47 4.91 2.57 5l0.64 0.11c0.66-3.64 4.88-5.27 4.41-14.55-0.4-8.04-7.94-11.63-14.66-10.91-6.44 0.69-13.12 5.84-11.45 14.49 0.06 0.3 8.51-0.04 10.74 1.78 2.19 1.78 1.09 5.79 4.02 5.7z"
          fill="url(#c)"
        />
        <defs>
          <path
            id="b"
            d="m51.43 20.09 0.86 8.61-0.45 0.88s0.35 0.17 0.51 0.18l0.64 0.11c0.66-3.64 4.88-5.27 4.41-14.55-0.41-8.05-7.95-11.64-14.67-10.92-6.44 0.69-13.18 6.16-11.48 14.52 0.01 0.06 1.01 0.08 1.01 0.08l-0.16-1.38 9.88-0.1 9.45 2.57z"
          />
        </defs>
        <clipPath id="x">
          <use xlinkHref="#b" />
        ...
        <g clipPath="url(#x)">
          <path
            d="m44.42 5.31c5.53 0 11.63 3.15 11.98 10.06 0.29 5.84-1.29 8.37-2.69 10.6-0.56 0.89-1.09 1.74-1.43 2.71-0.59-0.4-1.73-2.05-1.51-3.8 0.17-1.32-0.1-2.42-0.8-3.29-1.11-1.37-2.83-1.55-3.02-1.56h-0.08c-0.49 0-0.91 0.36-0.99 0.85l-0.64 4.22c-0.22-0.26-0.4-0.76-0.65-1.66-0.32-1.15-0.73-2.57-1.92-3.54-1.69-1.38-5.62-1.66-9.51-1.83-0.35-0.02-0.73-0.03-1.04-0.05-0.41-2.89 0.22-5.55 1.83-7.74 1.97-2.67 5.3-4.49 8.89-4.88 0.51-0.06 1.05-0.09 1.58-0.09m0-1c-0.57 0-1.13 0.03-1.69 0.09-6.44 0.69-13.15 5.94-11.48 14.49 0.06 0.3 8.54-0.04 10.77 1.78 2.17 1.77 1.12 5.7 3.93 5.7h0.09l0.81-5.35s3.36 0.28 2.92 3.73c-0.31 2.43 1.47 4.91 2.57 5l0.64 0.11c0.66-3.64 4.88-5.27 4.41-14.55-0.36-7.37-6.73-11-12.97-11z"
            fill="#402821"
          />
        </g>
        <path
          d="m36.97 28.31-2.27 0.85s0.46 1.03 0.69 1.44c1.22 2.23 3.35 4.42 7.49 3.29 0.38-0.1-3.12-4.93-3.12-4.93l-2.79-0.65z"
          fill="none"
        />
        <defs>
          <path
            id="w"
            d="m52.17 7.84c-3.42-3.38-9.33-3.49-13.82-1.77-6.21 2.37-8.14 7.94-6.58 14.21 0 0 0.94 2.55 1.24 3.65 0.79 2.13-1.14 2.04-1.26 3.77-0.11 1.63 2.05 1.45 2.26 1.6 1.07 0.78 0.62 5.65 6.8 4.81 2.16-0.29 3.91-0.76 4.98-0.12l3.54 2.88 5.74-2.14s-3.48-5.39 0.65-11.94c2.81-4.44-0.7-12.13-3.55-14.95z"
          />
        </defs>
        <clipPath id="v">
          <use xlinkHref="#w" />
        ...
        <g clipPath="url(#v)">
          <path
            d="m30.6 30.27c1.75 1.63 5.06 2.22 6.8 0.28 0.66-0.74-0.01-1.28-0.82-0.71-1.32 0.91-4.01 0.51-5.11-0.52-0.72-0.68-1.59 0.28-0.87 0.95z"
            fill="#795548"
          />
        </g>
        <ellipse
          transform="matrix(.9879 -.1552 .1552 .9879 -3.3424 5.9603)"
          cx={36.51}
          cy={24.39}
          rx={1.14}
          ry={1.75}
        ...
        />
        <path
          d="m35.31 21.93c-1.09 0.4-1.4-0.31-1.07-0.93 0.24-0.45 0.89-0.86 2.2-0.7 1.24 0.15 1.79 0.82 2.15 1.23 0.36 0.4 0.35 0.83 0.07 0.89-0.38 0.08-2.01-0.98-3.35-0.49z"
          fill="#6D4C41"
        />
        <path
          d="m51.94 60s-0.02-0.03-0.03-0.05c-0.2-0.25-0.35-0.49-0.48-0.73-1.32-2.49-0.37-5.59 2.11-6.91 0.03-0.02 0.06-0.04 0.08-0.06l23.53-13.61 5.72 10.76-18.83 9.16c-0.13 0.06-0.23 0.18-0.26 0.32-0.04 0.14-0.01 0.29 0.07 0.41l11.11 16.15-6.31 4.64-16.71-20.08z"
          fill="#E59600"
        />
        <path
        ...
        <path
          d="m60.58 46.83 16.44-9.56 0.09-0.05c1.06-0.56 2.26-0.86 3.45-0.86 2.73 0 5.23 1.5 6.51 3.91 0.92 1.74 1.12 3.73 0.54 5.61s-1.85 3.43-3.59 4.35l-16.87 8.97-6.57-12.37z"
          fill="#E65100"
        />
        <path
          d="m80.57 36.86c2.55 0 4.87 1.4 6.07 3.64 0.86 1.62 1.04 3.48 0.5 5.23s-1.72 3.19-3.34 4.05l-16.43 8.74-6.12-11.51 15.99-9.29 0.11-0.06c0.99-0.52 2.1-0.8 3.22-0.8m0-1c-1.25 0-2.51 0.3-3.69 0.92v-0.01l-16.97 9.86 7.04 13.24 17.31-9.21c3.84-2.04 5.29-6.8 3.25-10.64-1.4-2.64-4.13-4.16-6.94-4.16z"
          fill="#D14A00"
        />
        <polygon
          points="71.3 69.26 63.66 74.88 68.56 80.77 75.64 75.56"
          fill="#E0E0E0"
          stroke="#CCC7BD"
          strokeLinecap="round"
        ...
        <path
          d="m30.48 122.57c-12.59 0-22.84-10.24-22.84-22.83s10.25-22.83 22.84-22.83 22.83 10.24 22.83 22.83-10.24 22.83-22.83 22.83zm0-38.33c-8.55 0-15.51 6.95-15.51 15.5s6.96 15.5 15.51 15.5c8.54 0 15.5-6.95 15.5-15.5s-6.95-15.5-15.5-15.5z"
          fill="url(#t)"
        />
        <path
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#4FC3F7" offset={0.2236} />
          <stop stopColor="#32B9F6" offset={0.4161} />
          <stop stopColor="#10ADF5" offset={0.6821} />
          <stop stopColor="#03A9F4" offset={0.8262} />
        </linearGradient>
        <path
          d="m77.15 74.57c-0.13 0-0.26-0.01-0.4-0.03l-36.42-5.26c-1.5-0.22-2.54-1.6-2.32-3.1s1.64-2.55 3.11-2.32l36.42 5.26c1.5 0.22 2.54 1.61 2.32 3.11-0.2 1.36-1.37 2.34-2.71 2.34z"
          fill="url(#s)"
        />
        <linearGradient
          id="r"
        ...
        <path
          d="m64.44 101.78c-0.87 0-1.7-0.42-2.22-1.12l-23.71-32.48c-0.9-1.22-0.63-2.94 0.6-3.83 1.22-0.89 2.94-0.62 3.83 0.6l20.96 28.69 15.04-32.74c0.63-1.38 2.26-1.98 3.64-1.35s1.99 2.26 1.35 3.64l-17 36.99c-0.4 0.88-1.25 1.48-2.22 1.58-0.09 0.01-0.18 0.02-0.27 0.02z"
          fill="url(#r)"
        />
        <linearGradient
          id="q"
        ...
        <path
          d="m42.52 61.15c-0.18 0-0.35-0.02-0.52-0.06l-8.54-2.05c-0.58-0.14-1.08-0.5-1.39-1.01s-0.41-1.11-0.27-1.7c0.24-1.01 1.14-1.72 2.19-1.72 0.17 0 0.35 0.02 0.52 0.06l8.54 2.05c1.2 0.29 1.95 1.5 1.66 2.71-0.25 1.01-1.15 1.72-2.19 1.72z"
          fill="url(#o)"
        />
        <path
          d="m33.98 55.12c0.14 0 0.27 0.02 0.4 0.05l8.54 2.05c0.94 0.23 1.52 1.17 1.29 2.1-0.19 0.79-0.89 1.34-1.7 1.34-0.14 0-0.27-0.02-0.41-0.05l-8.54-2.05c-0.45-0.11-0.84-0.39-1.08-0.78-0.24-0.4-0.32-0.87-0.21-1.32 0.2-0.79 0.9-1.34 1.71-1.34m0-1c-1.24 0-2.37 0.84-2.67 2.1-0.35 1.48 0.55 2.96 2.03 3.31l8.54 2.05c0.21 0.05 0.42 0.08 0.64 0.08 1.24 0 2.36-0.84 2.67-2.1 0.35-1.47-0.56-2.95-2.03-3.31l-8.54-2.05c-0.21-0.06-0.43-0.08-0.64-0.08z"
          fill="#405966"
        />
        <radialGradient
          id="n"
        ...
        <path
          d="m86.54 46.67-11.24-6.96-13.77 24.14h0.01c-0.76 1.23-0.98 2.63-0.74 3.95l2.77 25.84 6.79-0.09 1.48-24.9 14.7-21.98z"
          fill="url(#m)"
        />
        <circle cx={80.92} cy={43.19} r={6.61} fill="#FBC11B" />
        <path
          d="m75.66 41.1 9.48 5.87-14.14 21.12c-0.1 0.15-0.16 0.32-0.17 0.5l-1.43 23.97-4.94 0.06-2.67-24.93c0-0.02-0.01-0.05-0.01-0.07-0.2-1.13 0.01-2.28 0.61-3.24 0.03-0.04 0.05-0.09 0.07-0.13l13.2-23.15m-0.36-1.39-13.77 24.14h0.01c-0.76 1.23-0.98 2.63-0.74 3.95l2.77 25.84 6.79-0.09 1.48-24.9 14.72-21.98-11.26-6.96z"
          fill="#EDA600"
        />
        <polygon
          points="63.15 86.49 70.41 86.41 69.88 93.05 64 93.13"
          fill="#E0E0E0"
        />
        <path
          d="m69.87 86.91-0.44 5.65-4.98 0.06-0.72-5.64 6.14-0.07m1.08-1.01zm0 0-8.36 0.09 0.98 7.64 6.79-0.09 0.59-7.64z"
          fill="#CCC7BD"
        />
        <linearGradient
          id="l"
        ...
        <path
          d="m64.85 56.19 9.84-16.93c0.01-0.02 0.02-0.03 0.04-0.05 1.35-2.18 3.7-3.49 6.27-3.49 1.36 0 2.7 0.38 3.87 1.1 3.63 2.25 4.05 7.03 2.37 10.17-1.06 1.98-8.91 14.17-10.47 16.58l-11.92-7.38z"
          fill="url(#l)"
        />
        <path
          d="m81 36.21c1.27 0 2.52 0.36 3.61 1.03 3.38 2.09 3.77 6.56 2.19 9.51-1 1.87-8.16 12.99-10.18 16.14l-11.09-6.86 9.58-16.49c0.02-0.02 0.03-0.04 0.04-0.07 1.27-2.04 3.45-3.26 5.85-3.26m0-1c-2.63 0-5.21 1.32-6.7 3.73l-10.13 17.41 12.75 7.89s9.56-14.8 10.76-17.03c1.93-3.6 1.15-8.54-2.55-10.83-1.29-0.79-2.72-1.17-4.13-1.17z"
          fill="#DB6300"
        />
        <path
          d="m57.7 102.75c-0.23 0-0.44-0.16-0.5-0.38l-0.34-1.25c-0.38-1.42 0.13-2.91 1.31-3.79l5.53-3.69 6.56-1.81c0.56 0.4 2.23 1.68 2.61 3.07l0.77 2.75c0.05 0.17 0.03 0.35-0.06 0.51s-0.23 0.27-0.4 0.32l-15.33 4.26c-0.06 0-0.11 0.01-0.15 0.01z"
          fill="#4568AD"
        />
        <path
          d="m70.15 92.37c0.74 0.55 1.94 1.63 2.23 2.66l0.77 2.75c0.02 0.06 0 0.1-0.02 0.13s-0.05 0.06-0.1 0.08l-15.35 4.24-0.34-1.24c-0.33-1.21 0.11-2.49 1.11-3.25l5.46-3.64 6.24-1.73m0.19-1.09-6.86 1.9-5.61 3.75c-1.33 1-1.92 2.71-1.49 4.33l0.34 1.25c0.12 0.45 0.54 0.75 0.98 0.75 0.09 0 0.18-0.01 0.27-0.04l15.33-4.26c0.62-0.17 0.99-0.82 0.81-1.44l-0.77-2.75c-0.51-1.88-3-3.49-3-3.49z"
          fill="#315499"
        />
        <radialGradient
          id="k"
        ...
        <linearGradient
          ...
          y1={21.367}
          y2={29.238}
          gradientTransform="matrix(.9962 .0868 -.0868 .9962 -23.007 -4.8195)"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#646464" offset={0} />
          <stop stopColor="#262626" offset={0.9947} />
        </linearGradient>
        <path
          d="m45.93 27.8c0.11 1.66-2.98 5.7-3.06 5.93 0.18 0.11 1.99-0.39 1.99-0.39s3.54-3.34 5.61-7.3c0.93-1.78 3.03-6.51 3.03-6.51l-2.93-1.43s-0.86 8.22-2.93 8.19c-2.08-0.03-2.04-7.99-2.04-7.99l-4.67 1.94s4.94 6.53 5 7.56z"
          fill="url(#j)"
        />
        <radialGradient
          id="i"
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m32.94 58.89c-1.29 0-2.34-1.05-2.34-2.34s1.05-2.34 2.34-2.34 2.34 1.05 2.34 2.34-1.05 2.34-2.34 2.34z"
          clipRule="evenodd"
          fill="url(#g)"
          fillRule="evenodd"
        />
        <path
          d="m32.94 54.71c1.01 0 1.84 0.83 1.84 1.84s-0.82 1.84-1.84 1.84c-1.01 0-1.84-0.83-1.84-1.84 0-1.02 0.82-1.84 1.84-1.84m0-1c-1.57 0-2.84 1.27-2.84 2.84s1.27 2.84 2.84 2.84 2.84-1.27 2.84-2.84c-0.01-1.57-1.28-2.84-2.84-2.84z"
          fill="#405966"
        />
      </g>
    </svg>
...
export default MountainBikingMan;
