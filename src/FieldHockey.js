...
function FieldHockey(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m-47.33-67.67-73.32 121.85c-4.03 6.68-12.76 8.74-19.35 4.57l-1.17-0.74c-6.38-4.04-8.37-12.45-4.47-18.92v0"
        fill="none"
        stroke="#434343"
        strokeLinecap="round"
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FEEA39" offset={0.3218} />
        <stop stopColor="#F9BF2C" offset={1} />
      </radialGradient>
      <circle cx={88} cy={104} r={16} clipPath="url(#a)" fill="url(#c)" />
      <g clipPath="url(#a)" opacity={0.2}>
        <path
          d="m88 91c7.17 0 13 5.83 13 13s-5.83 13-13 13-13-5.83-13-13 5.83-13 13-13m0-3c-8.84 0-16 7.16-16 16s7.16 16 16 16 16-7.16 16-16-7.16-16-16-16z"
          fill="#434343"
        />
      </g>
    </svg>
