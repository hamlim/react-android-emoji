...
function Frowning(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m53.81 96.35c-3.04 0-5.85-1.71-7.34-4.47s-1.34-5.97 0.4-8.61c3.84-5.84 9.76-8.92 17.13-8.92 7.36 0 13.29 3.09 17.13 8.92 1.73 2.64 1.88 5.85 0.4 8.61-1.49 2.75-4.3 4.47-7.34 4.47-0.94 0-1.89-0.16-2.82-0.49-2.39-0.83-4.87-1.26-7.37-1.26s-4.98 0.42-7.37 1.26c-0.92 0.33-1.87 0.49-2.82 0.49z"
        fill="#242424"
      />
      <path
        d="m82.74 43.44c4.19 0 8 3.54 8 9.42s-3.81 9.42-8 9.42-8-3.54-8-9.42 3.81-9.42 8-9.42z"
        fill="#242424"
      />
      <path
        d="m45.2 43.44c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42 8-3.54 8-9.42-3.81-9.42-8-9.42z"
        fill="#242424"
      />
    </svg>
  );
