...
function WindFace(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("path", {
      d:
        "m62.71 63.42-3.32-6.54 9.18-1.15c2.94-0.37 5.75-1.3 8.33-2.76l2.72-1.54-1.57 2.15c-2.7 3.71-6.22 6.44-10.25 7.94l-5.09 1.9z",
      clipPath: "url(#a)",
      fill: "#42A5F5"
    }),
    _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("path", {
        d:
          "m62.7 75.29c-0.64 0.65-0.78 1.8-0.37 2.35 1.57 2.09 2.93 5.87 2.61 10.54-0.37 5.39-4.8 7.6-7.25 9.38-1.36 0.99-0.79 2.18-0.12 2.84s2.37 0 2.9-0.29c4.03-2.18 8.28-7.36 8.24-12.58-0.04-4.27-1.63-10.81-3.94-12.26-0.43-0.26-2.07 0.02-2.07 0.02z",
        fill: "#90CAF9"
      })
    ),
    _react2.default.createElement("path", {
      d:
        "m85.74 85.23c7.9 0.03 17.12-1.07 22.73-7.27 3.65-4.04 5.52-8.67 4.62-14.09-0.75-4.52-3.69-8.18-8.64-7.36-6.03 1.01-7.52 7.94-3.46 12.06 1.36 1.38 3.48-0.74 2.12-2.12-4.93-5 4.27-10.38 6.65-3.75 0.81 2.25 0.87 5.3 0.1 7.58-3.41 10.01-14.95 11.99-24.11 11.95-1.94-0.01-1.95 2.99-0.01 3z",
      fill: "#90CAF9"
    }),
    _react2.default.createElement("path", {
      d:
        "m84.54 95.25c8.7 0.39 22.18 2.52 25.39 12.35 0.68 2.09 0.55 4.85-0.08 6.92-2.12 6.99-11.85 1.81-6.75-3.36 1.36-1.38-0.76-3.5-2.12-2.12-3.85 3.91-2.79 10.67 2.96 11.94 4.96 1.09 8.18-2.2 9.08-6.84 3.1-15.87-16.38-21.35-28.48-21.89-1.93-0.09-1.92 2.91 0 3z",
      fill: "#90CAF9"
    }),
    _react2.default.createElement("path", {
      d:
        "m85.25 90.46c7.54-0.66 15.26-1.34 22.84-0.96 2.12 0.11 6.11 0.09 7.95 1.52 4.12 3.18-3.65 5.91-5.62 2.47-0.96-1.68-3.55-0.17-2.59 1.51 3.35 5.87 16.36 2.64 12.04-4.57-1.97-3.29-7.49-3.64-10.86-3.87-7.86-0.55-15.93 0.22-23.76 0.9-1.9 0.17-1.92 3.17 0 3z",
      fill: "#90CAF9"
    })
  );
}

exports.default = WindFace;
