...
function KiwiFruit(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#AFB42B" offset={0.0085237} />
        <stop stopColor="#8F8136" offset={0.448} />
        <stop stopColor="#6D4C41" offset={0.8725} />
      </linearGradient>
      <path
        d="m91.74 11.6-82.27 82.2c16.35 23.78 72.21 44.18 98.65 16.57 34.2-35.72 5.26-84.52-16.38-98.77z"
        fill="url(#c)"
      />
      <radialGradient
        id="b"
      ...
      />
      <path
        d="m66.48 33.18c1.53 0.47 2.89 1.74 3.09 3.33 0.3 2.4-1.98 4.53-1.78 6.94 0.12 1.52 1.22 2.81 1.38 4.32 0.22 1.99-1.22 3.8-2.85 4.97s-3.53 1.97-4.99 3.34c-2.34 2.22-3.16 5.55-4.25 8.59s-2.92 6.24-6.04 7.08c-3.52 0.95-6.99-1.5-10.6-2-2.19-0.3-4.41 0.12-6.62 0.07s-4.62-0.74-5.8-2.61c-1.13-1.79-0.79-4.2 0.29-6.02s2.77-3.18 4.43-4.49c5.88-4.67 13.47-9.02 18.22-14.84 3.56-4.35 9.02-10.66 15.52-8.68z"
        fill="#DCE775"
      />
    </svg>
  );
