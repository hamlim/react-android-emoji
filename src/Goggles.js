...
function Goggles(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m120.79 73.29h-113.58c-1.77 0-3.21-1.44-3.21-3.21v-12.71c0-1.77 1.44-3.21 3.21-3.21h113.58c1.77 0 3.21 1.44 3.21 3.21v12.71c0 1.77-1.44 3.21-3.21 3.21z"
        fill="#333"
      />
      ...
      <defs>
        <path
          id="b"
          d="m105.88 48.35c-5.8-5.33-37.26-5.59-41.63-5.6h-0.25-0.25c-4.37 0.01-35.82 0.27-41.63 5.6 0 0-3.95 1.15-3.44 14 0.51 12.86-1.4 19.86 13.75 21.51s18.46 2.67 22.15-2.04c4.66-5.95 6.87-8.3 9.42-8.3s4.76 2.35 9.42 8.3c3.69 4.71 7 3.69 22.15 2.04s13.24-8.66 13.75-21.51-3.44-14-3.44-14z"
        />
      </defs>
      <linearGradient
        id="c"
      ...
      >
        <stop stopColor="#ADD7FB" offset={0.0028045} />
        <stop stopColor="#F7FCFF" offset={0.4863} />
        <stop stopColor="#F0F9FF" offset={0.6062} />
        <stop stopColor="#DDEFFD" offset={0.7805} />
        <stop stopColor="#BDDFFB" offset={0.9869} />
        <stop stopColor="#BBDEFB" offset={0.9995} />
      </linearGradient>
