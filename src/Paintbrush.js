  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#F47A00" offset={0.4277} />
        <stop stopColor="#F17200" offset={0.6585} />
        <stop stopColor="#ED6400" offset={0.8418} />
        <stop stopColor="#E65100" offset={1} />
      </radialGradient>
      <path
        d="m48.06 90.75s-5.46-8.56-9.81-6.94c-6.62 2.48-4.57 1.64-11.62 4.81-17.66 7.93-4.81 18.13-21.78 31.46-1.66 1.3-0.72 3.98 1.38 3.91 9.42-0.31 24.9-2.91 31.18-11.72 6.52-9.17 2.9-15.27 10.65-21.52z"
        fill="url(#d)"
      />
      <radialGradient
        id="c"
      ...
      >
        ...
        <stop stopColor="#1F8EEB" offset={0.2752} />
        <stop stopColor="#1A79D5" offset={0.7013} />
        <stop stopColor="#1976D2" offset={0.7539} />
        <stop stopColor="#1976D2" offset={1} />
      </radialGradient>
      <path
        d="m122.78 16.2c1.98-3.14 1.5-7.23-1.12-9.85s-6.72-3.1-9.85-1.12c-8.25 5.21-24.91 18.39-53.84 49.56l16.25 16.25c31.16-28.94 43.36-46.59 48.56-54.84z"
        fill="url(#b)"
      />
      <radialGradient
        id="a"
