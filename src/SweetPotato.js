  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FEC111" offset={0.5233} />
        <stop stopColor="#FDBE12" offset={0.6569} />
        <stop stopColor="#FCB516" offset={0.7877} />
        <stop stopColor="#FAA71A" offset={0.9169} />
        <stop stopColor="#F9A01B" offset={0.9715} />
      </radialGradient>
      <path
        d="m50.63 27.69c-1.29-0.57-2.6-1.05-3.92-1.44l-3.27 6.51-1.23-7.51c-2.18-0.32-4.37-0.42-6.53-0.29-0.66 0.04-1.62 3.47-1.62 3.47s-1.81-3.1-2.54-2.96c-9.78 1.86-18.45 8.24-22.75 17.91-7.01 15.8 0.35 34.4 16.45 41.55s34.84 0.12 41.85-15.68c7.02-15.81-0.34-34.42-16.44-41.56z"
        fill="url(#e)"
      />
      <defs>
        <path
      ...
      <g clipPath="url(#a)" opacity={0.2}>
        <path
          d="m84.88 74.54c5.46-21.85-11.93-37.67-11.93-37.67s5.26 5.9 7.46 14.72 2.45 22.21-3.49 29.2c-0.92 1.09 5.12-3.79 5.12-3.79l2.84-2.46z"
          fill="#434343"
        />
      </g>
      <g clipPath="url(#a)" opacity={0.2}>
        <path
          d="m64.63 13.27c14.98 2.44 19.64 19.77 19.64 19.77s-13.16-23.69-36.84-18.19c-1.4 0.33 9.31-2.56 9.31-2.56l7.89 0.98z"
          fill="#434343"
          opacity={0.5}
        />
      </g>
      <g clipPath="url(#a)" opacity={0.2}>
        <path
          d="m107.27 49.55c0.68-12.7-12.53-21.65-12.53-21.65s13.39 16.52 8.29 26.95c-0.42 0.87 2.76-3.26 2.76-3.26l1.48-2.04z"
          fill="#434343"
        />
      </g>
      <g clipPath="url(#a)">
        <path
          d="m114.43 46.34c0.25-7.99-6.47-14.59-6.47-14.59s6.88 11.04 1.65 18.73c-0.36 0.53 3.81-2.8 3.81-2.8l1.01-1.34z"
          fill="#434343"
          opacity={0.2}
        />
      </g>
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFCB28" offset={0} />
        <stop stopColor="#FFCC2E" offset={0.2139} />
        <stop stopColor="#FFCF3C" offset={0.4233} />
        <stop stopColor="#FFD352" offset={0.631} />
        <stop stopColor="#FFDA6E" offset={0.8363} />
        <stop stopColor="#FFE081" offset={0.9741} />
      </radialGradient>
      <ellipse cx={49.04} cy={93.64} rx={39.16} ry={16.06} fill="url(#b)" />
      <g opacity={0.2}>
        <path
