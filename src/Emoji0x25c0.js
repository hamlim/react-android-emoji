...
function Emoji0x25c0(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g opacity={0.2}>
        <path
          d="m81.72 36c1.19 0 2.28 0.98 2.28 2.34v51.32c0 1.36-1.09 2.34-2.28 2.34-0.38 0-0.76-0.1-1.12-0.31l-43.45-25.66c-1.53-0.9-1.53-3.16 0-4.05l43.45-25.67c0.36-0.21 0.75-0.31 1.12-0.31m0-3c-0.92 0-1.84 0.25-2.64 0.72l-43.46 25.67c-1.64 0.96-2.62 2.69-2.62 4.61s0.98 3.65 2.63 4.61l43.44 25.66c0.82 0.48 1.73 0.73 2.65 0.73 2.91 0 5.28-2.39 5.28-5.34v-51.32c0-2.95-2.37-5.34-5.28-5.34z"
          fill="#424242"
        />
      </g>
      <path
        d="M84,64V38.34c0-1.79-1.89-2.91-3.4-2.03L37.15,61.97c-1.53,0.9-1.53,3.16,0,4.05L80.6,91.69 c1.52,0.89,3.4-0.23,3.4-2.03V64z"
        fill="#FAFAFA"
      />
    </svg>
  );
