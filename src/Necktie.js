  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <g opacity={0.2}>
        ...
        >
          <stop stopColor="#eee" offset={0.3924} />
          <stop stopColor="#595959" offset={0.996} />
        </linearGradient>
        <path
          d="m28.17 122.5c-8.36 0-15.17-6.8-15.17-15.17l-2-63.05c0-8.31 6.8-15.12 15.17-15.12h75.67c8.36 0 15.17 6.8 15.17 15.17l-2 62.96c0 8.41-6.8 15.21-15.17 15.21h-71.67z"
          fill="url(#g)"
        />
        <path
      ...
      <path
        d="m95.21 18.75-31.01 33.25-31.49-33.25 6.94-11.79s4.64-2.88 24.06-2.88 24.61 2.83 24.61 2.83l6.89 11.84z"
        fill="url(#f)"
      />
      <g opacity={0.2}>
        <linearGradient
        ...
        <path
          d="m34.57 18.54 6.14-10.43c1.24-0.53 7-2.52 23-2.52 15.95 0 22.12 1.95 23.56 2.51l6.09 10.45-29.17 31.26-29.62-31.27z"
          fill="url(#e)"
        />
        <path
          d="m63.71 7.08c14.36 0 20.6 1.59 22.53 2.23l5.25 9.02-27.31 29.29-27.74-29.29 5.3-9.01c1.75-0.63 7.66-2.24 21.97-2.24m0-3c-19.42 0-24.06 2.88-24.06 2.88l-6.94 11.79 31.49 33.25 31.01-33.25-6.9-11.84s-5.19-2.83-24.6-2.83z"
          fill="#424242"
        />
      </g>
      <path
        d="m85.02 103.56c-2.22-11.46-12.8-42.09-12.8-42.09s12.5-9.21 12.5-21.46-20.72-0.02-20.72-0.02-21.74-12.73-21.74 0.01 13.49 21.46 13.49 21.46-10.56 30.64-12.79 42.09c-1.25 6.48 16.43 22.85 21.04 22.85s22.27-16.37 21.02-22.84z"
        fill="#ED6C30"
      />
      <defs>
        <path
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#757575" stopOpacity={0} offset={0.4473} />
        <stop stopColor="#424242" offset={0.8148} />
      </linearGradient>
      <path
        d="m89.21 61.99s-12.35-6.1-25.42-6.1-25.08 6.1-25.08 6.1v-22.06h50.5v22.06z"
        fill="url(#b)"
        opacity={0.2}
      />
      <path
