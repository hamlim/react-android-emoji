  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#FFBF1D" offset={0.5092} />
        <stop stopColor="#FFB30C" offset={0.8171} />
        <stop stopColor="#FFAB00" offset={1} />
      </linearGradient>
      <rect x={4} y={87} width={40} height={12} fill="url(#i)" />
      <linearGradient
        id="h"
        x1={8}
        x2={8}
      ...
      <path
        d="m11 100.5h-6c-0.55 0-1-0.45-1-1v-13c0-0.55 0.45-1 1-1h6c0.55 0 1 0.45 1 1v13c0 0.55-0.45 1-1 1z"
        fill="url(#h)"
      />
      <linearGradient
        id="g"
      ...
      <rect x={4} y={87} width={40} height={12} fill="url(#g)" />
      <radialGradient
        id="f"
        cx={48.859}
        cy={127.68}
      ...
      <path
        d="m52.65 113.85c0-6.95-3.9-6.25-3.9-6.25s-3.9-0.71-3.9 6.25c0 3.94-0.38 6.67-0.7 8.3-0.19 0.96 0.53 1.85 1.5 1.85h6.2c0.97 0 1.69-0.89 1.5-1.85-0.33-1.63-0.7-4.36-0.7-8.3z"
        fill="url(#f)"
      />
      <radialGradient
        id="e"
      ...
      <path
        d="m45.51 113.85c0-6.95-3.9-6.25-3.9-6.25s-3.9-0.71-3.9 6.25c0 3.94-0.38 6.67-0.7 8.3-0.19 0.96 0.53 1.85 1.5 1.85h6.2c0.97 0 1.69-0.89 1.5-1.85-0.32-1.63-0.7-4.36-0.7-8.3z"
        fill="url(#d)"
      />
      <radialGradient
        id="c"
      ...
      <path
        d="m44 47c11.03 0 20 8.97 20 20s-8.97 20-20 20-20-8.97-20-20 8.97-20 20-20m0-12c-17.67 0-32 14.33-32 32s14.33 32 32 32 32-14.33 32-32-14.33-32-32-32z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="M44,35c-0.14,0-0.27,0.01-0.41,0.01v12.01c0.14,0,0.27-0.02,0.41-0.02c11.03,0,20,8.97,20,20 c0,9.73-6.99,17.85-16.21,19.63c0.13,0.24,0.25,0.49,0.37,0.74c0.56-0.06,4.31-0.46,4.98-0.63c4.05-1.04,17.74-5.6,22.84-20.42 C75.62,48.96,61.45,35,44,35z"
        fill="url(#a)"
      />
      <g opacity={0.2}>
        <path
          d="m44 38c15.99 0 29 13.01 29 29s-13.01 29-29 29-29-13.01-29-29 13.01-29 29-29m0 52c12.68 0 23-10.32 23-23s-10.32-23-23-23-23 10.32-23 23 10.32 23 23 23m0-55c-17.67 0-32 14.33-32 32s14.33 32 32 32 32-14.33 32-32-14.33-32-32-32zm0 52c-11.03 0-20-8.97-20-20s8.97-20 20-20 20 8.97 20 20-8.97 20-20 20z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      >
        ...
        <stop stopColor="#E53935" offset={0.9956} />
      </linearGradient>
      <path
        d="m49.17 100.42h-8c-1.66 0-3-1.34-3-3v-10c0-1.66 1.34-3 3-3h8c1.66 0 3 1.34 3 3v10c0 1.65-1.34 3-3 3z"
        fill="url(#j)"
      />
      <g opacity={0.2}>
        <path
          d="m49.17 84.42h-8c-1.66 0-3 1.34-3 3v10c0 1.66 1.34 3 3 3h8c1.66 0 3-1.34 3-3v-10c0-1.66-1.34-3-3-3zm-2.87 2v12h-2.29v-12h2.29zm-6.13 11v-10c0-0.55 0.45-1 1-1h0.84v12h-0.84c-0.55 0-1-0.45-1-1zm10 0c0 0.55-0.45 1-1 1h-0.87v-12h0.87c0.55 0 1 0.45 1 1v10z"
          fill="#424242"
        />
      </g>
    </svg>
