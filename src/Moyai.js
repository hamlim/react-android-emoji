...
function Moyai(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m74.01 82.46c-3.84 1.52-8.21 3.89-12.76 7.33-10.56 7.96-17.08 29.6-17.43 30.23-0.89 1.62-1.4 5.27 13.89 3.53 2.34-0.27 4.66-0.7 6.93-1.23 2.75-10.54 13.57-27.23 21.21-38.13-3.2-2.53-7.72-3.36-11.84-1.73z"
        fill="url(#g)"
      />
      <path
        d="m96.39 97.77c-0.65-0.75-1.16-1.61-1.41-2.55-0.03-0.1-0.06-0.21-0.08-0.31-3.14-11.9-1.71-18.68-6.85-13.83-0.69 0.97-1.43 2.01-2.2 3.11-7.63 10.9-18.45 27.58-21.21 38.13 12.7-2.96 23.88-9.37 28.4-12.19 1.65-1.03 3.23-2.93 4.18-4.75 0.19-0.37 0.37-0.74 0.51-1.1 0.78-2.08 0.72-4.15-1.34-6.51z"
        fill="#616161"
      />
      <radialGradient
        id="f"
      ...
      >
        ...
        <stop stopColor="#616161" stopOpacity={0} offset={1} />
      </radialGradient>
      <path
      ...
      <path
        d="m86.92 4.02c-11.44 0.01-37.87 2.63-44.98 26.08 0 0 0 4.31 4.57 8.62 0 0-8.85 8.34-13.49 29.14-0.15 0.67-0.27 1.34-0.36 2.02-0.65 4.68-3.58 24.83-6.89 33.85-0.89 2.43 0.52 5.07 3.12 5.82 4.02 1.17 10.14 2.45 17.63 2.45 13.72 0 45.73-8.62 45.73-21.55v-81.4c0-2.78-2.38-5.03-5.33-5.03z"
        fill="url(#d)"
      />
      <path
        d="m88.27 4.92s13.72-4.31 13.72 17.24v32.98c0 2.84 0.18 5.68 0.43 8.51 0.43 4.85-0.43 14.55-14.15 14.55v-73.28z"
        fill="#616161"
      />
      <radialGradient
        id="c"
      ...
      <path
        d="m92.45 14.12s4.9-3.75 4.9 14.99v31.82c0 1.01 0.03 2.01 0.09 3.02 0.23 3.49 0.44 13.86-4.99 13.86v-63.69z"
        fill="url(#c)"
        opacity={0.7}
      />
      <linearGradient
      ...
      <path
        d="m84.75 4.11c-2.96 3.31-2.7 11.6 0.34 20.09 2.08 5.82 2.69 12.02 2.07 18.14-1.87 18.65-8.58 53.87-32.88 69 15.36-2.17 38.17-9.53 38.17-20.46v-82.27c0-2.56-2.21-4.64-4.92-4.6-0.84 0-1.77 0.03-2.78 0.1z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m60.65 26.53c3.27 0.89 7.46 3.47 9.96 10.55 0 0-11.85 5.13-14.3 15.51-0.47 1.97-0.03 4.03 1.09 5.75 1.16 1.79 2.62 4.81 2.97 9.07 0.08 1.04-0.82 1.91-1.92 1.89-8.08-0.2-39.07-3.1-27.19-14.29 0 0 14.31-9.5 23.02-25.9 1.16-2.21 3.88-3.26 6.37-2.58z"
        fill="url(#k)"
      />
      <linearGradient
        id="j"
      ...
      <path
        d="m28.58 59.88c0.94 8.21 23.29 9.26 30.08 9.42 0.89 0.02 1.44-0.89 1-1.62-4.63-7.63-22.08-8.27-31.08-7.8z"
        fill="url(#j)"
      />
      <path
        d="m43.64 62.71c2.29 0.26 8.25 1.09 10.54 3.1 0.4 0.35 0.29 0.98-0.22 1.16-0.89 0.33-2.55 0.74-5.3 0.78-2.3 0.04-4.53-1.12-5.47-3.1-0.16-0.35-0.29-0.72-0.37-1.13-0.09-0.45 0.33-0.86 0.82-0.81z"
        fill="#515151"
      />
      <path
        d="m32.93 60.96s2.44 4.06 4.89 5.71c0 0-2.23-0.27-3.96-1.25-1.12-0.63-1.74-1.86-1.48-3.08 0.09-0.43 0.26-0.89 0.55-1.38z"
        fill="#515151"
      />
      <g fill="#A1887F">
        <ellipse
        ...
        <ellipse
          ...
          opacity={0.2}
        />
        <ellipse cx={40.28} cy={97.77} rx={2.59} ry={1.34} opacity={0.08} />
        <ellipse
      ...
      <path
        d="m60.7 87.61c-1.86-0.75-2.97-2.07-7.11-2.82-6.01-1.09-9.35 1.3-13.51 1.04-4.86-0.31-3.8-2.49-2.14-3.29 2.25-1.08 4.96-2.23 17.19 1.46 2.39 0.72 1.33-0.39 1.33-0.39-1.17-1.58-7.63-3.77-13.28-3.92-14.75-0.39-10.2 9.58-5.36 10.89 7.55 2.04 17.96-1.19 22.76-2.35 0.37-0.08 0.47-0.48 0.12-0.62z"
        fill="url(#i)"
      />
    </svg>
  );
