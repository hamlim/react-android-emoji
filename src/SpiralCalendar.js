...
function SpiralCalendar(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m108.21 124h-88.42c-5.52 0-10-4.48-10-10v-76.5c0-5.76 4.67-10.43 10.43-10.43h87.56c5.76 0 10.43 4.67 10.43 10.43v76.5c0 5.52-4.47 10-10 10z"
        fill="url(#d)"
      />
      <path
        d="M118.21,57.95H9.79V22.17c0-4.42,3.58-8,8-8h92.43c4.42,0,8,3.58,8,8V57.95z"
        fill="#1E88E5"
      />
      <g fill="#fff">
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#757575" offset={0.0054573} />
        <stop stopColor="#424242" offset={1} />
      </linearGradient>
      <path
        d="m31.92 19.62c-1.39 0-2.95-2.1-2.95-4.92s1.56-4.92 2.95-4.92c1.32 0 2.78 1.91 2.93 4.52h5.79c-0.17-5.81-3.93-10.3-8.72-10.3-4.9 0-8.73 4.7-8.73 10.7s3.84 10.7 8.73 10.7c1.6 0 2.89-1.29 2.89-2.89 0.01-1.6-1.29-2.89-2.89-2.89z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <path
        d="m65.21 19.62c-1.39 0-2.95-2.1-2.95-4.92s1.56-4.92 2.95-4.92c1.32 0 2.78 1.91 2.93 4.52h5.79c-0.17-5.81-3.93-10.3-8.72-10.3-4.9 0-8.73 4.7-8.73 10.7s3.84 10.7 8.73 10.7c1.6 0 2.89-1.29 2.89-2.89s-1.29-2.89-2.89-2.89z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m99.35 19.62c-1.39 0-2.95-2.1-2.95-4.92s1.56-4.92 2.95-4.92c1.32 0 2.78 1.91 2.93 4.52h5.79c-0.17-5.81-3.93-10.3-8.72-10.3-4.9 0-8.73 4.7-8.73 10.7s3.84 10.7 8.73 10.7c1.6 0 2.89-1.29 2.89-2.89s-1.29-2.89-2.89-2.89z"
        fill="url(#a)"
      />
      <g opacity={0.2}>
        <path
