...
function Handbag(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#795548" offset={0.3883} />
        <stop stopColor="#5D4037" offset={0.7397} />
      </linearGradient>
      <path
        d="m121.61 104.01c1.32-2.74 1.54-5.87 0.64-8.77l-13.55-43.53c-1.78-4.64-6.23-7.71-11.21-7.71h-67.2c-4.99 0-9.46 3.09-11.22 7.76l-13.35 43.5c-0.89 2.89-0.65 6 0.66 8.72l5.26 15.9c0.81 2.46 3.11 4.12 5.7 4.12h93.33c2.59 0 4.88-1.66 5.7-4.12l5.24-15.87z"
        fill="url(#b)"
      />
      <radialGradient
        id="a"
