...
function Stars(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m24.02 41.66 19.61 13.66c1.16 0.81 2.7 0.81 3.85 0l19.54-13.69c2.62-1.83 6.08 0.68 5.16 3.75l-6.84 22.94c-0.4 1.35 0.07 2.82 1.2 3.67l19.06 14.45c2.55 1.94 1.24 6.01-1.96 6.08l-23.84 0.5c-1.41 0.03-2.65 0.94-3.11 2.28l-7.76 22.61c-1.04 3.03-5.31 3.04-6.37 0.01l-7.9-22.62c-0.47-1.33-1.71-2.24-3.12-2.27l-23.85-0.47c-3.19-0.06-4.52-4.13-1.98-6.07l18.97-14.48c1.12-0.86 1.59-2.32 1.18-3.68l-6.97-22.91c-0.94-3.07 2.51-5.59 5.13-3.76z"
        fill="url(#d)"
      />
      <g opacity={0.2}>
        <path
      ...
      <path
        d="m77.64 38.37-5.92 24.91s36.25-34.1 52.28-41.43c0 0-22.69 0.28-46.36 16.52z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <path
        d="m26.09 39.11 14.06 8.88s38.26-32.01 64.61-36.59c0 0-42.66-7.64-78.67 27.71z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m78.87 75.36 10.94 9.19s20.5-32.33 31.01-40.85c0 0-27.07 6.35-41.95 31.66z"
        fill="url(#a)"
      />
      <g opacity={0.2}>
        <path
          d="m110.09 26.99c-11.52 8.29-25.13 20.22-33.26 27.57l3.42-14.39c10.98-7.33 21.73-11.17 29.84-13.18m13.91-4.99zm0-0.15s-22.69 0.28-46.36 16.52l-5.92 24.91s36.25-34.1 52.28-41.43z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m87.41 13.95c-20.35 9.03-41.42 25.49-47.49 30.4l-9.03-5.71c20.13-18.37 41.96-23.55 56.52-24.69m7.06-3.25c-14.84 0-43.23 3.72-68.38 28.41l14.06 8.88s38.26-32.01 64.61-36.59c0 0-3.88-0.7-10.29-0.7z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m109.8 51.13c-8.05 9.88-16.9 23.21-20.67 28.99l-6.41-5.38c7.89-12.23 18.83-19.52 27.08-23.61m11.02-7.13zm0-0.3s-27.07 6.35-41.95 31.66l10.94 9.19c-0.01 0 20.5-32.33 31.01-40.85z"
          fill="#424242"
        />
      </g>
    </svg>
