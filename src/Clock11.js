...
function Clock11(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m68 27.8c0-2.1-1.7-3.8-3.8-3.8h-0.4c-2.1 0-3.8 1.7-3.8 3.8v32.4c0 2.1 1.7 3.8 3.8 3.8h0.4c2.1 0 3.8-1.7 3.8-3.8v-32.4z"
        fill="#424242"
      />
      <path
        d="m63.7 64.08 0.35-0.19c1.83-1.02 2.5-3.33 1.48-5.17l-10.48-18.87c-1.02-1.83-3.33-2.5-5.17-1.48l-0.35 0.19c-1.83 1.02-2.5 3.33-1.48 5.17l10.48 18.87c1.02 1.84 3.34 2.5 5.17 1.48z"
        fill="#424242"
      />
