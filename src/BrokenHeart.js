...
function BrokenHeart(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m37.33 40.17 22.31-16.95s-13.33-14.85-31.28-9.27c-31.6 9.83-28.78 48.95-13.22 69.07 10.95 14.16 46.51 40.64 46.51 40.64l-23.82-38 30.83-19.33-31.33-26.16z"
        fill="url(#c)"
      />
      <radialGradient
        id="b"
      ...
      <path
        d="m64.05 123.92s0.05-0.02 0.02-0.05c-0.01 0.02-0.03 0.03-0.04 0.05h0.02z"
        fill="url(#b)"
      />
      <radialGradient
        id="a"
      ...
      <path
        d="m100 14c-8.87-3.24-17-0.82-23.28 2.86-12.12 7.48-19.89 21.81-19.89 21.81l33.5 23.83-35.16 30.83s8.03 26.46 9.19 30.21c4.52-3.01 33.97-23.37 48.4-42.03 15.55-20.13 17.99-56.26-12.76-67.51z"
        fill="url(#a)"
      />
      <path
        d="m64 123.89c0 0.01 0.01 0.01 0.02 0.02 0-0.01 0.01-0.02 0.05-0.05v0.01c0.09-0.11 0.19-0.22 0.29-0.33-0.14 0.1-0.26 0.17-0.35 0.23v0.12z"
        fill="#fff"
      />
      <path
        d="m64.02 123.91c0.01 0.01 0.01 0.01 0 0 0.02-0.01 0.03-0.03 0.05-0.04v-0.01c-0.04 0.03-0.04 0.05-0.05 0.05z"
        fill="#fff"
      />
      <path
        d="m64.02 123.91c-0.01 0-0.02-0.01-0.02-0.02 0 0.02 0.01 0.03 0.02 0.02-0.01 0.01 0 0.01 0 0z"
        fill="#fff"
      />
