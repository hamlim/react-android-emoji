...
function ArrowDownSmall(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g opacity={0.2}>
        <path
          d="m93.49 39.71c2.05 0 3.33 2.21 2.32 3.99l-29.33 50.96c-0.51 0.9-1.41 1.34-2.32 1.34s-1.8-0.45-2.32-1.34l-29.32-50.96c-1.02-1.78 0.27-3.99 2.32-3.99h58.65m0-3h-58.66c-2.04 0-3.88 1.06-4.9 2.82-1.03 1.77-1.03 3.88-0.02 5.66l29.33 50.96c1.02 1.78 2.86 2.85 4.92 2.85s3.9-1.07 4.92-2.86l29.33-50.94c1.02-1.78 1.01-3.9-0.01-5.66-1.03-1.77-2.86-2.83-4.91-2.83z"
          fill="#424242"
        />
      </g>
      <path
        d="M64.16,39.71H34.83c-2.05,0-3.33,2.21-2.32,3.99l29.33,50.95c1.02,1.79,3.61,1.79,4.63,0L95.81,43.7 c1.02-1.78-0.27-3.99-2.32-3.99H64.16z"
        fill="#FAFAFA"
      />
    </svg>
  );
