  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <circle
        ...
        strokeWidth={3}
      />
      <circle cx={24.39} cy={25.89} r={9.82} fill="#fff" />
      <linearGradient
        id="e"
        x1={86.389}
        x2={120.83}
      ...
      <circle
        ...
        strokeWidth={3}
      />
      <circle cx={103.61} cy={25.89} r={9.82} fill="#fff" />
      <linearGradient
        id="d"
        x1={64}
        x2={64}
      ...
      <path
        d="m64 58.45c-4.39 0-8 3.59-8 7.97v10.38c0 4.39 3.61 7.97 8 7.97s8-3.59 8-7.97v-10.38c0-4.39-3.61-7.97-8-7.97z"
        fill="#FF9D00"
      />
      <g fill="#fff">
        <circle cx={51.24} cy={85.37} r={16.17} />
        <circle cx={76.76} cy={85.37} r={16.17} />
      </g>
      <linearGradient
        id="c"
        x1={64.001}
      ...
      <path
        d="m64 78.87c3.23 0 6.19-3.26 8-5.92 0.9-1.32-0.04-2.95-1.64-2.95h-12.72c-1.59 0-2.53 1.63-1.64 2.95 1.82 2.66 4.77 5.92 8 5.92z"
        fill="url(#c)"
      />
      <defs>
        <path
          id="b"
          d="m119 65.33c0-34.86-26.44-54-55-54-28.55 0-55 18.66-55 54 0 35.15 26.44 54 55 54s55-19.33 55-54z"
        />
      </defs>
      <clipPath id="a">
        <use xlinkHref="#b" />
      ...
      <g clipPath="url(#a)" fill="#404040">
        <path d="m9.61 59.21 12.73 1.75c0.83 0.11 1.41 0.88 1.29 1.71-0.09 0.69-0.64 1.2-1.29 1.29l-12.73 1.74c-1.79 0.25-3.44-1.01-3.69-2.8s1.01-3.44 2.8-3.69c0.29-0.04 0.6-0.03 0.89 0z" />
        <path d="m9.61 69.21 12.73 1.75c0.83 0.11 1.41 0.88 1.29 1.71-0.09 0.69-0.64 1.2-1.29 1.29l-12.73 1.74c-1.79 0.25-3.44-1.01-3.69-2.8s1.01-3.44 2.8-3.69c0.29-0.04 0.6-0.04 0.89 0z" />
        <path d="m9.61 49.71 12.73 1.75c0.83 0.11 1.41 0.88 1.29 1.71-0.09 0.69-0.64 1.2-1.29 1.29l-12.73 1.74c-1.79 0.25-3.44-1.01-3.69-2.8s1.01-3.44 2.8-3.69c0.29-0.04 0.6-0.03 0.89 0z" />
        <path d="m118.67 65.73-12.73-1.75c-0.83-0.11-1.41-0.88-1.29-1.71 0.09-0.69 0.64-1.2 1.29-1.29l12.73-1.75c1.79-0.25 3.44 1.01 3.69 2.8s-1.01 3.44-2.8 3.69c-0.3 0.05-0.61 0.05-0.89 0.01z" />
        <path d="m118.67 75.72-12.73-1.75c-0.83-0.11-1.41-0.88-1.29-1.71 0.09-0.69 0.64-1.2 1.29-1.29l12.73-1.75c1.79-0.25 3.44 1.01 3.69 2.8s-1.01 3.44-2.8 3.69c-0.3 0.06-0.61 0.05-0.89 0.01z" />
        <path d="m118.67 56.23-12.73-1.75c-0.83-0.11-1.41-0.88-1.29-1.71 0.09-0.69 0.64-1.2 1.29-1.29l12.73-1.75c1.79-0.25 3.44 1.01 3.69 2.8s-1.01 3.44-2.8 3.69c-0.3 0.05-0.61 0.05-0.89 0.01z" />
      </g>
    </svg>
  );
}
