...
function Tent(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m122.72 81.02c-8.7-66.78-58.72-62.37-58.72-62.37s-50.02-4.41-58.72 62.37c-0.87 6.71-1.33 14.14-1.28 22.35 0.02 2.98 2.87 5.26 6.07 4.86 9.21-1.15 28.52-3.1 53.92-3.1s44.71 1.95 53.92 3.1c3.21 0.4 6.05-1.89 6.07-4.86 0.07-8.21-0.39-15.64-1.26-22.35z"
        fill="url(#g)"
      />
      <g opacity={0.2}>
        <path
      ...
      >
        ...
        <stop stopColor="#BF360C" offset={0.7719} />
        <stop stopColor="#BF360C" offset={1} />
      </radialGradient>
      <path
        d="m87.37 83.66c-1.68-9.65-3.84-16.57-5.13-20.19-0.63-1.76-2.22-2.91-3.99-2.91h-28.5c-1.77 0-3.36 1.15-3.99 2.91-1.3 3.62-3.46 10.54-5.13 20.19 7.07-1.53 15-2.38 23.37-2.38s16.3 0.86 23.37 2.38z"
        fill="url(#e)"
      />
      <radialGradient
        id="d"
      ...
      <path
        d="m42.84 106.01h21.16 21.16c2.47 0 4.44-2.21 4.27-4.83-0.41-6.56-1.17-12.42-2.05-17.52-7.07-1.53-15-2.38-23.37-2.38s-16.3 0.86-23.37 2.38c-0.89 5.1-1.64 10.95-2.05 17.52-0.18 2.61 1.79 4.83 4.25 4.83z"
        fill="url(#d)"
      />
      <radialGradient
        id="c"
      ...
      <defs>
        <path
          id="b"
          d="m87.37 83.66c-1.68-9.65-3.84-16.57-5.13-20.19-0.63-1.76-2.22-2.91-3.99-2.91h-28.5c-1.77 0-3.36 1.15-3.99 2.91-1.3 3.62-3.46 10.54-5.13 20.19-0.89 5.1-1.64 10.95-2.05 17.52-0.17 2.61 1.81 4.83 4.27 4.83h21.16 21.16c2.47 0 4.44-2.21 4.27-4.83-0.43-6.56-1.18-12.42-2.07-17.52z"
        />
      </defs>
      <clipPath>
        <use xlinkHref="#b" />
