...
function AerialTramway(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="M75.76,56.89l5.48-2.44l-15-33.67l-2.24,1l-2.24-1L54.53,37H54.5l-7.74,17.45l5.48,2.44L55.31,50 h17.38L75.76,56.89z M64,30.49L66.9,37h-5.8L64,30.49z M57.09,46l2.23-5h9.36l2.23,5H57.09z"
        fill="#546E7A"
      />
      <path
        d="m75 18.13c0 2.14-1.73 3.87-3.87 3.87h-15.26c-2.14 0-3.87-1.73-3.87-3.87v-0.25c0-2.14 1.73-3.87 3.87-3.87h15.25c2.14 0 3.87 1.73 3.87 3.87v0.25z"
        fill="#546E7A"
      />
      <g fill="#90A4AE">
      ...
      >
        <stop stopColor="#F44336" offset={0.2785} />
        <stop stopColor="#EE3F35" offset={0.5259} />
        <stop stopColor="#DC3431" offset={0.8679} />
        <stop stopColor="#D32F2F" offset={1} />
      </linearGradient>
      <path
        d="M96.39,48H31.61C25.04,48,20,53.79,20,61.06v36.49c0,1.06-0.06,1.87,0.09,2.88 C21.44,109.36,28.3,116,36.72,116h54.56c8.42,0,15.29-6.64,16.63-15.57c0.15-1.01,0.09-1.82,0.09-2.88V61.06 C108,53.79,102.96,48,96.39,48z"
        fill="url(#a)"
      />
      <path
        d="m76.33 96.32h-24.17c-2.21 0-4-1.79-4-4v-28.34c0-2.21 1.79-4 4-4h24.17c2.21 0 4 1.79 4 4v28.33c0 2.22-1.79 4.01-4 4.01z"
        fill="#4FC3F7"
      />
      <g opacity={0.2}>
        <path
          d="m96.2 51c4.83 0 8.8 4.42 8.8 10.06v36.49c0 0.27 0 0.52 0.01 0.76 0.01 0.66 0.02 1.14-0.06 1.67-1.14 7.54-6.89 13.02-13.67 13.02h-54.56c-6.78 0-12.53-5.47-13.67-13.02-0.08-0.53-0.07-1.01-0.06-1.67 0-0.24 0.01-0.49 0.01-0.76v-36.49c0-5.64 3.78-10.06 8.61-10.06h64.39m0.39-3h-64.78c-6.57 0-11.61 5.79-11.61 13.06v36.49c0 1.06-0.06 1.87 0.09 2.88 1.35 8.93 8.21 15.57 16.63 15.57h54.56c8.42 0 15.29-6.64 16.63-15.57 0.15-1.01 0.09-1.82 0.09-2.88v-36.49c0-7.27-5.04-13.06-11.61-13.06z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m76.33 62.98c0.55 0 1 0.45 1 1v28.33c0 0.55-0.45 1-1 1h-24.17c-0.55 0-1-0.45-1-1v-28.33c0-0.55 0.45-1 1-1h24.17m0-3h-24.17c-2.21 0-4 1.79-4 4v28.33c0 2.21 1.79 4 4 4h24.17c2.21 0 4-1.79 4-4v-28.33c0-2.2-1.79-4-4-4z"
          fill="#424242"
        />
      </g>
      <path
        d="m36.05 96.32h-16.05v-36.34h16.05c2.21 0 4 1.79 4 4v28.33c0 2.22-1.79 4.01-4 4.01z"
        fill="#4FC3F7"
      />
      <path
        d="M108,96.32H91.69c-2.21,0-4-1.79-4-4V63.98c0-2.21,1.79-4,4-4H108V96.32z"
        fill="#4FC3F7"
      />
      <g opacity={0.2}>
        <path
          d="m36.05 62.98c0.55 0 1 0.45 1 1v28.33c0 0.55-0.45 1-1 1h-13.05v-30.33h13.05m0-3h-16.05v36.33h16.05c2.21 0 4-1.79 4-4v-28.33c0-2.2-1.79-4-4-4z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m105 62.98v30.33h-13.31c-0.55 0-1-0.45-1-1v-28.33c0-0.55 0.45-1 1-1h13.31m3-3h-16.31c-2.21 0-4 1.79-4 4v28.33c0 2.21 1.79 4 4 4h16.31v-36.33z"
          fill="#424242"
        />
      </g>
    </svg>
