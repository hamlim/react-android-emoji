  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#EFEFEF" offset={0.1455} />
        <stop stopColor="#DFDFDF" offset={0.3368} />
        <stop stopColor="#C3C3C3" offset={0.5535} />
        <stop stopColor="#9E9E9E" offset={0.7872} />
        <stop stopColor="#757575" offset={1} />
      </linearGradient>
      <path
        d="m39.2 83.75c0.51-0.53 1.04-1.05 1.6-1.51 1.63-1.37 5.88-4.55 8.17-3.23 1.36 0.78 1.16 3.4 0.66 4.49-1.24 2.69-4.4 4.96-6.34 7.19-1.52 1.77-3.36 3.36-5.02 5.02-2.66 2.66-5.21 5.65-8.08 8.08-0.01 0-23.01 19.42-23.01 19.42l-1.79-1.79 19.43-23.02c3.65-3.65 7.29-7.3 10.94-10.94 1.18-1.16 2.28-2.49 3.44-3.71z"
        fill="url(#e)"
      />
      <linearGradient
        id="d"
      ...
      >
        ...
        <stop stopColor="#F34949" offset={0.0742} />
        <stop stopColor="#D93535" offset={0.2674} />
        <stop stopColor="#C62727" offset={0.4653} />
        <stop stopColor="#BB1F1F" offset={0.6692} />
        <stop stopColor="#B71C1C" offset={0.8882} />
      </linearGradient>
      <path
        d="m123.24 51.51c-2.88 2.88-15.58-5.13-28.36-17.91s-20.79-25.47-17.91-28.36c2.88-2.88 15.58 5.13 28.36 17.91s20.79 25.48 17.91 28.36z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      >
        <stop stopColor="#FF5252" offset={0.0020297} />
        <stop stopColor="#E13B3B" offset={0.1867} />
        <stop stopColor="#CA2A2A" offset={0.3739} />
        <stop stopColor="#BC2020" offset={0.5502} />
        <stop stopColor="#B71C1C" offset={0.7029} />
      </linearGradient>
      <path
        d="m83.63 100.27c-3.58 3.58-18.83-5.85-34.05-21.07s-24.66-30.47-21.08-34.05 19.46 1.31 36.74 18.86c16.76 17.01 21.97 32.68 18.39 36.26z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
