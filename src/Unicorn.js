...
function Unicorn(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m13.43 70.15c-4.67 5.42-7.86 9.43-8.18 10.57-1.76 6.23-1.34 14.57 3.5 18.82 3 2.63 9.61 4.8 16.05 2.8 3.2-0.99 9.39-7.98 10.13-7.83-3.22-11.1-10.66-21.4-21.5-24.36z"
        fill="#fff"
      />
      <path
        d="m18.33 78.02c1.35 0.36 2.26 1.75 2.34 3.16 0.07 1.4-0.59 2.77-1.53 3.8-1.13 1.24-2.78 1.11-3.2-0.73-0.21-0.94 0.73-2.19 0.5-3.23-0.26-1.19-3.79-0.96-1.59-2.26 1.01-0.59 2.33-1.05 3.48-0.74z"
        fill="#404040"
      />
      <linearGradient
        id="h"
      ...
      >
        <stop stopColor="#fff" offset={0} />
        <stop stopColor="#FCEAF3" offset={0.1669} />
        <stop stopColor="#F5B4D2" offset={0.5119} />
        <stop stopColor="#EA5E9F" offset={0.9998} />
      </linearGradient>
      <path
        d="m50.4 39.75c-1.35 0-2.04-0.56-2.37-1.02-0.12-0.17-0.48-0.72-2.19-3.52l-0.12-0.19 0.01-0.23c0.07-1.68 0.23-3.45 0.38-5.16 0.24-2.74 0.5-5.57 0.42-8.25l-0.06-1.93 1.34 1.39c6.26 6.51 9.79 10.17 10.2 10.58 0.43 0.44 0.65 1 0.62 1.64-0.07 1.85-2.13 3.82-3.01 4.58-1.42 1.25-3.57 2.11-5.22 2.11z"
        fill="url(#e)"
      />
      <path
        d="m47.27 21.37c5.2 5.41 9.73 10.1 10.21 10.59 1.19 1.2-0.39 3.45-2.34 5.13-1.29 1.11-3.25 1.92-4.74 1.92-0.77 0-1.41-0.21-1.77-0.71-0.19-0.27-0.99-1.56-2.16-3.47 0.18-4.35 0.93-9.05 0.8-13.46m-1.6-3.82 0.11 3.86c0.08 2.63-0.17 5.44-0.42 8.16-0.15 1.72-0.31 3.49-0.38 5.19l-0.02 0.45 0.24 0.39c1.7 2.79 2.08 3.37 2.22 3.57 0.44 0.61 1.31 1.33 2.98 1.33 1.84 0 4.14-0.92 5.72-2.28 1.19-1.02 3.19-3.05 3.27-5.12 0.03-0.85-0.26-1.61-0.84-2.2-0.41-0.41-3.84-3.97-10.19-10.57l-2.69-2.78z"
        fill="#999"
      />
      <linearGradient
        id="d"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#aff" offset={0.2787} />
        <stop stopColor="#AAFEFF" offset={0.2809} />
        <stop stopColor="#CEB1E4" offset={0.5413} />
        <stop stopColor="#E978D1" offset={0.7562} />
        <stop stopColor="#F955C5" offset={0.9148} />
        <stop stopColor="#FF48C0" offset={1} />
      </linearGradient>
      <path
        d="m39.08 24.06c-1.99-3.29-4.03-6.69-5.81-9.64l-0.12-0.2 0.01-0.23c0.03-0.48 0.07-0.97 0.1-1.45 0.12-1.59 0.24-3.23 0.14-4.76l-0.13-2.04 7.48 7.78v0.3c0.02 1.79-0.07 3.64-0.15 5.43-0.07 1.47-0.14 2.98-0.15 4.43l-0.01 2.66-1.36-2.28z"
        fill="url(#d)"
      />
      <path
        d="m34.15 7.73c1.62 1.68 3.66 3.81 5.86 6.1 0.04 3.25-0.29 6.63-0.3 9.85-1.99-3.29-4.03-6.69-5.81-9.64 0.14-2.11 0.39-4.25 0.25-6.31m-1.75-3.97 0.26 4.07c0.1 1.48-0.02 3.03-0.14 4.66-0.04 0.49-0.07 0.97-0.1 1.46l-0.03 0.47 0.24 0.4c1.78 2.95 3.82 6.35 5.81 9.64l2.74 4.54 0.03-5.31c0.01-1.43 0.08-2.94 0.15-4.4 0.09-1.8 0.18-3.66 0.15-5.48l-0.01-0.59-0.41-0.43-5.86-6.1-2.83-2.93z"
        fill="#999"
      />
      <defs>
        <rect id="c" x={5} y={4} width={119} height={120} />
      </defs>
      <clipPath id="b">
        <use xlinkHref="#c" />
      </clipPath>
