...
function Smoking(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m119.45 65.73c1.24 0.74 0.18 2.71-1.17 2.18-7.22-2.84-18.42-12.89-16.28-30.15 2.12-17.07 2.79-25.5-8.39-31.97-0.73-0.42-0.39-1.54 0.45-1.45 7.82 0.79 26.2 5.55 22.21 26.26-3.25 16.88-4.81 30.36 3.18 35.13z"
        fill="url(#e)"
      />
      <linearGradient
        id="d"
      ...
      <path
        d="m100.64 54.69c1.01 0.63 0.11 2.23-0.99 1.77-5.88-2.43-14.92-10.83-12.91-24.95 1.98-13.96 2.65-20.86-6.42-26.32-0.59-0.36-0.29-1.27 0.39-1.19 6.4 0.76 21.4 4.92 17.83 21.85-2.91 13.79-4.38 24.82 2.1 28.84z"
        fill="url(#d)"
      />
      <linearGradient
        id="c"
      ...
      >
        <stop stopColor="#eee" offset={0} />
        <stop stopColor="#E9E9E9" offset={0.2665} />
        <stop stopColor="#DADADA" offset={0.5944} />
        <stop stopColor="#C1C1C1" offset={0.9532} />
        <stop stopColor="#BDBDBD" offset={1} />
      </linearGradient>
      <polygon points="48 72 40 72 40 92 48 92 112 92 112 72" fill="url(#c)" />
      <linearGradient
        id="b"
        x1={117.68}
        x2={117.68}
      ...
      >
        ...
        <stop stopColor="#FF6A3A" offset={0.224} />
        <stop stopColor="#FF5D2A" offset={0.519} />
        <stop stopColor="#FF480E" offset={0.8523} />
        <stop stopColor="#FF3D00" offset={1} />
      </linearGradient>
      <path
        d="m121.95 92h-10.59v-20h10.59c1.13 0 2.05 0.92 2.05 2.05v15.89c0 1.14-0.92 2.06-2.05 2.06z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        ...
        fill="url(#a)"
      />
      <rect x={37} y={72} width={3} height={20} fill="#424242" opacity={0.2} />
      <rect x={40} y={72} width={8} height={20} fill="#eee" opacity={0.8} />
      <g fill="#FFCA28">
      ...
      <g opacity={0.2}>
        <path
          d="m121 75v14h-112.51c-0.59-0.79-1.49-3.32-1.49-7s0.9-6.21 1.49-7h112.51m0.95-3h-113.95c-2.21 0-4 4.48-4 10s1.79 10 4 10h113.95c1.13 0 2.05-0.92 2.05-2.05v-15.9c0-1.13-0.92-2.05-2.05-2.05z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m102.41 9.41c3.08 1.22 6.28 3.13 8.49 6.1 2.75 3.7 3.57 8.58 2.42 14.52-2.18 11.33-3.84 22.1-1.65 29.72-4.32-4.5-7.94-11.61-6.7-21.62 1.55-12.41 2.7-21.64-2.56-28.72m-8.44-5.08c-0.77 0-1.06 1.05-0.36 1.46 11.18 6.47 10.52 14.9 8.39 31.97-2.14 17.26 9.06 27.31 16.28 30.15 0.16 0.06 0.31 0.09 0.45 0.09 1.11 0 1.81-1.62 0.71-2.27-7.99-4.77-6.43-18.25-3.18-35.13 3.99-20.72-14.39-25.47-22.21-26.26-0.02-0.01-0.05-0.01-0.08-0.01z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m88.85 9.52c1.9 0.99 3.73 2.35 5.06 4.2 2.11 2.94 2.68 6.81 1.69 11.51-1.75 8.32-3.15 16.28-2.21 22.45-2.72-3.65-4.66-8.86-3.68-15.74 1.3-9.15 2.35-16.53-0.86-22.42m-8.23-5.52c-0.62 0-0.87 0.85-0.3 1.19 9.07 5.46 8.41 12.36 6.42 26.32-2 14.11 7.03 22.51 12.91 24.95 0.13 0.06 0.26 0.08 0.39 0.08 0.9 0 1.49-1.3 0.6-1.85-6.48-4.02-5.01-15.05-2.11-28.84 3.57-16.92-11.43-21.08-17.83-21.84-0.02-0.01-0.05-0.01-0.08-0.01z"
          fill="#424242"
        />
      </g>
    </svg>
