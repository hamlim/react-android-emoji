...
function Eyeglasses(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m57.84 50.84s-7.54-8.78-34.58-6.26c-18.05 1.68-19.03 3.36-19.03 3.36l-0.11 6.81s2.69 0.77 4.43 2.93c1.74 2.13 2.55 14.07 5.37 19.7 4.37 8.72 26.09 6.51 26.09 6.51s8.86 0.7 13.18-6.76c4.32-7.44 5.64-18.2 5.64-18.2l-0.99-8.09z"
        fill="url(#g)"
      />
      <linearGradient
        id="f"
      ...
      <path
        d="m70.16 50.84s7.54-8.78 34.58-6.26c18.05 1.68 19.02 3.36 19.02 3.36l0.11 6.81s-2.69 0.77-4.43 2.93c-1.74 2.13-2.55 14.07-5.37 19.7-4.37 8.72-26.09 6.51-26.09 6.51s-8.86 0.7-13.18-6.76c-4.32-7.44-5.64-18.2-5.64-18.2l1-8.09z"
        fill="url(#a)"
      />
      <linearGradient
        id="m"
