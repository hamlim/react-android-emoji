...
function Beer(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m86.43 34.5h-60.71l-4.93-0.01 1.2 72.55c0 12.19 21.45 16.74 34.51 16.74s34.08-4.67 34.08-16.86l0.88-72.43-5.03 0.01z"
        fill="url(#d)"
      />
      <g opacity={0.2}>
        <path
          d="m23.83 37.49 1.88 0.01h60.72 2l-0.85 69.42c0 5.13-5.57 8.39-10.24 10.21-6.89 2.69-15.29 3.65-20.85 3.65-5.62 0-14.11-0.95-21.09-3.6-4.76-1.81-10.42-5.04-10.42-10.19l-1.15-69.5m-3.05-3 1.2 72.55c0 12.19 21.45 16.74 34.51 16.74s34.08-4.67 34.08-16.86l0.88-72.43-5.04 0.01h-60.69l-4.94-0.01zm70.69 0z"
          fill="#424242"
        />
      </g>
      <linearGradient
      ...
      <path
        d="m84.3 36-0.33 66.23c-0.27 2.27-2.13 4.46-4.67 5.62-4.55 2.09-13.44 4.14-23.28 4.14-9.4 0-17.4-1.87-22.04-3.84-2.94-1.24-5.31-3.74-5.67-5.89l-0.45-66.26h56.44z"
        fill="url(#c)"
      />
      <g fill="#E4A324">
        <circle cx={40.22} cy={101.92} r={1.35} />
        <circle cx={37.23} cy={98.21} r={0.93} />
        <circle cx={43.2} cy={96.48} r={1.63} />
        <circle cx={37.53} cy={94.8} r={1.68} />
        <circle cx={42.91} cy={87.61} r={1.35} />
        <circle cx={39.36} cy={88.26} r={1.2} />
        <circle cx={34.27} cy={80.53} r={1.2} />
        <circle cx={45.78} cy={73.4} r={1.52} />
        <circle cx={38.16} cy={84.41} r={1.86} />
        <circle cx={43.01} cy={78.71} r={1.82} />
        <circle cx={36.81} cy={76.49} r={1.35} />
      </g>
      <linearGradient
        id="b"
        x1={103.92}
      ...
      <path
        d="m87.91 75.83-0.24 26.34 2.92 3.33s2.94-2.44 13.67-4.98c12.33-2.92 15.21-7.76 15.86-29.04 0.75-24.4-5.77-26.7-13.12-27.98-8.58-1.49-12.45-6.23-12.45-6.23l-6.36 4.35-0.28 34.21zm8.59-4.85c0-8.13 0-14.72 6.23-14.72s6.23 6.59 6.23 14.72 0 14.72-6.23 14.72c-5.85-0.01-6.23-6.6-6.23-14.72z"
        fill="url(#b)"
      />
      <g opacity={0.2}>
        <path
          d="m94.26 41.11c2.2 1.78 6.21 4.3 12.23 5.35 3.74 0.65 5.93 1.44 7.59 3.99 2.37 3.65 3.36 10.5 3.04 20.94-0.64 20.9-3.31 23.79-13.55 26.22-6.34 1.5-10.16 2.99-12.35 4.06l-0.54-0.61 0.23-25.2 0.27-32.64 3.08-2.11m8.47 47.58c2.94 0 6.77-1.12 8.33-6.47 0.9-3.08 0.9-7.05 0.9-11.25s0-8.17-0.9-11.25c-1.56-5.35-5.39-6.47-8.33-6.47s-6.77 1.12-8.33 6.47c-0.9 3.08-0.9 7.05-0.9 11.25 0 7.06 0 17.72 9.23 17.72m-8.18-51.42-6.36 4.35-0.28 34.21-0.24 26.34 2.92 3.33s2.94-2.44 13.67-4.98c12.33-2.92 15.21-7.76 15.86-29.04 0.75-24.4-5.77-26.7-13.12-27.98-8.58-1.49-12.45-6.23-12.45-6.23zm8.18 48.42c-5.85 0-6.23-6.59-6.23-14.72s0-14.72 6.23-14.72 6.23 6.59 6.23 14.72 0 14.72-6.23 14.72z"
          fill="#424242"
        />
      </g>
      <path
        d="m74.85 98.22c-2.39 0.31-4.51-1.55-4.51-3.96v-36.1c0-2.02 1.51-3.73 3.52-3.97 2.38-0.28 4.47 1.57 4.47 3.97v36.1c0 2.01-1.49 3.7-3.48 3.96z"
        fill="#fff"
        fillOpacity={0.72}
        opacity={0.51}
      />
      <path
        d="m60.85 103.22c-2.39 0.31-4.51-1.55-4.51-3.96v-36.1c0-2.02 1.51-3.73 3.52-3.97 2.38-0.28 4.47 1.57 4.47 3.97v36.1c0 2.01-1.49 3.7-3.48 3.96z"
        fill="#fff"
        fillOpacity={0.72}
        opacity={0.51}
      />
