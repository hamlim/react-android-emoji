  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#2196F3" stopOpacity={0} offset={1} />
      </radialGradient>
      <path
        d="m39.05 4.41c-14.57 1.1-24.38 3.93-29.93 6.04-3.39 1.29-5.45 4.72-5.07 8.32 6.99 67.5 40.81 61.8 40.81 61.8s34.29 0.54 30.97-67.23c-0.18-3.61-2.73-6.69-6.28-7.46-5.81-1.25-15.93-2.57-30.5-1.47zm-15.5 35.75c-3.28 0.16-7.1 1.24-9 1.83-0.57 0.18-1.16-0.19-1.1-0.69 1.21-9.72 8.25-11.63 13-11.78 3.06-0.1 6.16 1.13 7.21 3.5 2.03 4.63-5.29 6.91-10.11 7.14zm34.37 24.2c-4.37-1.04-9.37-1.25-12.18-1.27-1.53-0.01-3.05 0.1-4.56 0.33-2.88 0.44-7.86 1.38-11.64 3.07-0.93 0.42-2.1-0.05-1.95-0.8 0.42-2.08 1.91-5.54 6.95-8.12 4.93-2.53 11.47-3.06 16.77-1.36 5.56 1.78 7.59 5.04 8.34 7.06 0.26 0.69-0.75 1.32-1.73 1.09zm11.04-26.48c-1.97-0.31-5.91-0.8-9.18-0.46-4.8 0.49-12.38-0.65-11.07-5.53 0.67-2.51 3.55-4.18 6.59-4.55 4.72-0.56 11.97 0.27 14.64 9.69 0.14 0.49-0.39 0.94-0.98 0.85z"
        fill="url(#g)"
      ...
      <path
        d="m35.81 30.37c-1.2-3.18-4.67-4.86-8.09-4.78-5.29 0.12-13.1 2.55-14.29 15.46-0.01 0.09 0 0.18 0.02 0.27v-0.01c1.21-9.72 8.25-11.63 13-11.78 3.06-0.1 6.16 1.13 7.21 3.5 1.04 2.37-0.38 4.12-2.66 5.3 3.56-1.44 6.29-4.04 4.81-7.96z"
        fill="url(#f)"
      />
      <radialGradient
        id="e"
      ...
      <path
        d="m14.55 42c-0.06 0.02-0.11 0.03-0.17 0.03 0.09 0 0.19-0.02 0.29-0.05 0.12-0.04 0.27-0.09 0.4-0.14-0.18 0.05-0.37 0.11-0.52 0.16z"
        fill="url(#e)"
      />
      <radialGradient
        id="d"
      ...
      <path
        d="m68.96 37.88c-0.16-0.02-0.35-0.05-0.53-0.08 0.14 0.03 0.29 0.05 0.42 0.08 0.1 0.02 0.2 0.02 0.29 0.01-0.06 0-0.12 0-0.18-0.01z"
        fill="url(#d)"
      />
      <radialGradient
        id="c"
      ...
      <path
        d="m48.72 31.89c0.67-2.51 3.55-4.18 6.59-4.55 4.72-0.56 11.97 0.27 14.64 9.69v0.01c0.01-0.09 0-0.18-0.02-0.27-3.13-12.58-11.22-13.81-16.47-13.13-3.38 0.43-6.56 2.62-7.27 5.94-0.87 4.1 2.22 6.27 5.96 7.15-2.44-0.82-4.11-2.34-3.43-4.84z"
        fill="url(#c)"
      />
      <radialGradient
        id="b"
      ...
      <path
        d="m77.56 69.14c-4.24-3.28-11.91-6.91-20.84 3.05-0.46 0.51-0.24 1.35 0.39 1.56 0.71 0.24 1.74 0.6 2.91 1.03-0.26-0.25-0.32-0.59-0.05-0.77 7.09-4.91 13.71-2.15 17.46 0.37 2.16 1.45 3.67 3.53 3.46 5.34 0.13-0.28 0.25-0.58 0.35-0.91 1.04-3.42-0.94-7.56-3.68-9.67z"
        fill="url(#k)"
      />
      <radialGradient
        id="j"
      ...
      <path
        d="m117.08 76.81c-7.3-11.21-15.43-8.78-20.13-6.19-3.03 1.67-5.62 5.47-5.13 8.99 0.05 0.35 0.12 0.66 0.2 0.95 0.08-1.82 1.88-3.64 4.24-4.74 4.1-1.92 11.06-3.64 17.31 2.3 0.24 0.23 0.13 0.55-0.17 0.76 1.22-0.25 2.29-0.45 3.04-0.58 0.67-0.11 1.02-0.91 0.64-1.49z"
        fill="url(#j)"
      />
      <radialGradient
        id="i"
