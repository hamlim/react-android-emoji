...
function Emoji0x2b05(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g opacity={0.2}>
        <path
          d="m49.98 36c2.06 0 4.02 1.62 4.02 4.01v13.99c0 1.1 0.9 2 2 2h46c2.21 0 4 1.79 4 4v8c0 2.21-1.79 4-4 4h-46c-1.1 0-2 0.9-2 2v13.99c0 2.39-1.96 4.01-4.02 4.01-0.9 0-1.82-0.31-2.61-1l-24-23.99c-1.82-1.59-1.82-4.43 0-6.02l24-23.99c0.78-0.69 1.7-1 2.61-1m0-3c-1.68 0-3.3 0.62-4.59 1.74l-0.14 0.14-23.94 23.93c-1.47 1.32-2.31 3.21-2.31 5.19s0.84 3.87 2.31 5.19l23.94 23.93 0.14 0.14c1.28 1.12 2.91 1.74 4.59 1.74 3.87 0 7.02-3.14 7.02-7.01v-12.99h45c3.86 0 7-3.14 7-7v-8c0-3.86-3.14-7-7-7h-45v-12.99c0-3.87-3.15-7.01-7.02-7.01z"
          fill="#424242"
        />
      </g>
      <path
        d="m47.37 91-24-23.99c-1.82-1.59-1.82-4.43 0-6.02l24-23.99c2.59-2.26 6.63-0.43 6.63 3.01v13.99c0 1.1 0.9 2 2 2h46c2.21 0 4 1.79 4 4v8c0 2.21-1.79 4-4 4h-46c-1.1 0-2 0.9-2 2v13.99c0 3.44-4.05 5.28-6.63 3.01z"
        fill="#FAFAFA"
      />
    </svg>
  );
