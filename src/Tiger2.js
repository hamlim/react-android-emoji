  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#FFECB3" offset={0.7729} />
      </linearGradient>
      <path
        d="m73.7 84.1c2.93 4.19 7.4 8.56 8.49 13.9 0.94 4.58-1.02 13.2-4 13.12-5.25-0.12-5.68 3.1-5.38 8.38 0.3 5.09 8.09 3.88 10.62 3.88 2.12 0 4.33-0.02 6.11-0.77 2.57-1.08 4.19-5.5 5.2-12.99 0.78-5.76 0-14.88-2.26-22.73-2.26-7.84-4.17-11.83-4.17-11.83"
        fill="url(#i)"
        stroke="#DE8900"
        strokeLinecap="round"
      ...
      <path
        d="m33.18 104.37c1.5 1.98 2.82 4.8 1.34 6.81-1.21 1.64-3.73 1.8-5.05 3.36-1.61 1.91-0.52 5.06 1.54 6.47s4.77 2.2 7.21 1.65c3.49-0.8 12.9-3.3 13.51-5.9 0.51-2.13-0.22-4.37-1.26-6.3s-2.39-3.69-3.28-5.69c-3.42-7.71 0.52-17.55-3.96-24.69-1.85-2.95-18.69-5.71-18.86-2.82-0.87 14.99 4.07 20.86 8.81 27.11z"
        fill="url(#h)"
        stroke="#DE8900"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        d="m123.3 103.65c0.22-2.65-2.55-4.23-4.9-3.96-1.03 0.12-1.85 0.57-2.69 1.16-0.78 0.55-1.55 0.93-2.07 1.79-2.56 4.28 3.81 6.63 6.97 5.08 0.3-0.15 0.57-0.34 0.82-0.54 0.44-0.3 0.84-0.71 1.17-1.26 0.21-0.36 0.33-0.74 0.41-1.12 0.14-0.35 0.26-0.73 0.29-1.15z"
        clipPath="url(#f)"
      />
      <linearGradient
        id="e"
      ...
      >
        <stop stopColor="#FFECB3" offset={0.0396} />
        <stop stopColor="#FFD555" offset={0.1715} />
        <stop stopColor="#FFCB38" offset={0.2244} />
        <stop stopColor="#FFC220" offset={0.2842} />
        <stop stopColor="#FFBC0E" offset={0.3469} />
        <stop stopColor="#FFB803" offset={0.4136} />
        <stop stopColor="#FFB700" offset={0.4916} />
        <stop stopColor="#EF8E07" offset={0.728} />
        <stop stopColor="#DB5E0F" offset={0.9846} />
      </linearGradient>
      <path
      ...
      />
      <path
        d="m38.59 110.35c-0.41-0.05-2.8 0.06-3.65 0.1-0.76 0.03-2.16 0.04-2.92-0.01 0 0-1.51-0.52-3.2-0.34-1.22-0.46-8.49-0.67-8.9 6.52-0.2 3.55 1.29 6.81 4.28 7.02s3.08-0.47 3.46-0.52c0.62 0.22 1.57 1.11 4.25 1.03s2.58-1.06 3.93-0.96c1.19 0.09 2.46 1.06 3.64 0.87 3.06-0.48 5.3-3.88 5.45-6.63 0.12-2.15-0.91-4.39-2.76-5.75-1.04-0.76-2.29-1.17-3.58-1.33z"
        fill="#FFECB3"
        stroke="#DE8900"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="m101.07 110.43c-1.83-0.18-3.77 0.57-5.47 0.57 0 0-3.19-0.36-3.54-0.3-0.59-0.19-7.5-0.76-7.5 6.55 0 3.61 0.69 6.75 4.13 6.75 0 0 1.16-0.59 2.56-0.53s0.69 0.88 4.34 1c2.17 0.07 3.03-1.03 3.03-1.03 2.65 0 3.17 1.19 5.53-0.19 1.99-1.16 3.29-4.21 3.16-6.49-0.17-2.76-1.21-4.41-3.22-5.57-0.91-0.53-1.94-0.65-3.02-0.76z"
        fill="#FFECB3"
        stroke="#DE8900"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        d="m75.44 49.8-1.47 11.31c-0.23 1.78-2.07 1.78-2.3 0l-1.46-11.31c-0.13-1 0.42-1.91 1.15-1.91h2.94c0.72 0 1.27 0.92 1.14 1.91z"
        clipPath="url(#a)"
        fill="#404040"
      />
      <path
        d="m86.52 50.48-1.74 10.77c-0.29 1.78-2.33 1.75-2.59-0.03l-1.67-11.53c-0.16-1.13 0.63-2.11 1.53-1.91l3.41 0.76c0.73 0.17 1.21 1.04 1.06 1.94z"
        clipPath="url(#a)"
        fill="#404040"
      />
      <path
        d="m99.71 53.83-4.6 9.29c-0.76 1.53-2.91 0.9-2.73-0.8l1.19-11.01c0.12-1.08 1.2-1.74 2.11-1.28l3.41 1.71c0.73 0.37 1.01 1.31 0.62 2.09z"
        clipPath="url(#a)"
        fill="#404040"
      />
      <g clipPath="url(#a)" fill="#404040">
        <path d="m48.81 101.71-6.38-3.19c-1.44-0.72-0.82-2.68 0.85-2.68l7.4-0.03c1.06 0 1.82 0.88 1.53 1.79l-1.02 3.22c-0.29 0.91-1.47 1.35-2.38 0.89z" />
        <path d="m51.47 93.63-6.38-3.19c-1.44-0.72-0.82-2.68 0.85-2.68l7.4-0.03c1.06 0 1.82 0.88 1.53 1.79l-1.02 3.22c-0.29 0.9-1.46 1.35-2.38 0.89z" />
        <path d="m45.52 110.07-5.66-3.63c-1.33-0.85-0.5-2.74 1.15-2.62l7.02 0.52c1.07 0.08 1.75 1.04 1.35 1.94l-1.36 3.11c-0.39 0.9-1.64 1.24-2.5 0.68z" />
      </g>
      <g clipPath="url(#a)" fill="#404040">
        <path d="m107.89 91.84-7.95-0.77c-1.99-0.19-2.21-1.8-0.32-2.27l7.57-1.88c1.26-0.31 2.64 0.16 2.75 0.95l0.38 2.65c0.11 0.79-1.1 1.44-2.43 1.32z" />
        <path d="m108.76 99.28-8.31-1.07c-1.87-0.24-1.97-1.8-0.14-2.14l8.14-1.5c1.17-0.21 2.36 0.29 2.4 1.01l0.17 2.57c0.05 0.72-1.07 1.28-2.26 1.13z" />
        <path d="m108.06 107.1-7.69-1.54c-1.81-0.36-1.65-1.92 0.22-2.16l7.95-1.02c1.22-0.16 2.34 0.42 2.27 1.16l-0.26 2.56c-0.08 0.74-1.32 1.24-2.49 1z" />
      </g>
      <linearGradient
        id="b"
        x1={50}
      ...
      >
        <stop stopColor="#FFB700" offset={0.5} />
        <stop stopColor="#FFB503" offset={0.6437} />
        <stop stopColor="#FFB10E" offset={0.7668} />
        <stop stopColor="#FFA920" offset={0.882} />
        <stop stopColor="#FFA723" offset={0.9} />
      </linearGradient>
      <circle
        cx={13.81}
        cy={20.32}
        ...
        strokeWidth={2}
      />
      <circle cx={13.81} cy={20.32} r={5.5} fill="#fff" />
      <linearGradient
        id="n"
        x1={48.544}
        x2={67.842}
      ...
      <circle
        ...
        strokeWidth={2}
      />
      <circle cx={58.19} cy={20.32} r={5.5} fill="#fff" />
      <linearGradient
        id="m"
        x1={36}
        x2={36}
      ...
      <path
        d="M36,50c1.81,0,3.47-1.84,4.48-3.33c0.5-0.74-0.02-1.67-0.92-1.67h-7.13 c-0.89,0-1.42,0.93-0.92,1.67C32.54,48.16,34.19,50,36,50z"
        fill="url(#l)"
      />
      <defs>
        <path
          id="k"
          d="m66.81 42.41c0-19.53-14.81-30.25-30.81-30.25s-30.81 10.45-30.81 30.25c0 19.7 14.81 30.26 30.81 30.26s30.81-10.83 30.81-30.26z"
        />
      </defs>
      <clipPath id="j">
        <use xlinkHref="#k" />
      </clipPath>
      <g clipPath="url(#j)" fill="#404040">
        <path d="m5.52 38.99 7.13 0.98c0.46 0.06 0.79 0.49 0.73 0.96-0.05 0.39-0.36 0.67-0.73 0.73l-7.13 0.98c-1 0.14-1.93-0.56-2.07-1.57s0.56-1.93 1.57-2.07c0.17-0.04 0.35-0.03 0.5-0.01z" />
        <path d="m5.52 44.59 7.13 0.98c0.46 0.06 0.79 0.49 0.73 0.96-0.05 0.39-0.36 0.67-0.73 0.73l-7.13 0.98c-1 0.14-1.93-0.56-2.07-1.57s0.56-1.93 1.57-2.07c0.17-0.04 0.35-0.03 0.5-0.01z" />
        <path d="m5.52 33.66 7.13 0.98c0.46 0.06 0.79 0.49 0.73 0.96-0.05 0.39-0.36 0.67-0.73 0.73l-7.13 0.97c-1 0.14-1.93-0.56-2.07-1.57s0.56-1.93 1.57-2.07c0.17-0.02 0.35-0.02 0.5 0z" />
        <path d="m66.63 42.64-7.13-0.98c-0.46-0.06-0.79-0.49-0.73-0.96 0.05-0.39 0.36-0.67 0.73-0.73l7.13-0.97c1-0.14 1.93 0.56 2.07 1.57s-0.56 1.93-1.57 2.07c-0.17 0.02-0.34 0.02-0.5 0z" />
        <path d="m66.63 48.24-7.13-0.98c-0.46-0.06-0.79-0.49-0.73-0.96 0.05-0.39 0.36-0.67 0.73-0.73l7.13-0.98c1-0.14 1.93 0.56 2.07 1.57s-0.56 1.93-1.57 2.07c-0.17 0.03-0.34 0.03-0.5 0.01z" />
        <path d="m66.63 37.32-7.13-0.98c-0.46-0.06-0.79-0.49-0.73-0.96 0.05-0.39 0.36-0.67 0.73-0.73l7.13-0.98c1-0.14 1.93 0.56 2.07 1.57s-0.56 1.93-1.57 2.07c-0.17 0.03-0.34 0.03-0.5 0.01z" />
      </g>
    </svg>
  );
}

export default Tiger2;
