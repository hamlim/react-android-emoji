...
function SpiralNotepad(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m105.23 123.57h-79.83c-1.54 0-2.79-1.25-2.79-2.79v-102.81c0-1.54 1.25-2.79 2.79-2.79h79.83c1.54 0 2.79 1.25 2.79 2.79v102.81c0 1.54-1.25 2.79-2.79 2.79z"
        fill="url(#e)"
      />
      <linearGradient
        id="d"
      ...
      <path
        d="m102.6 118.83h-79.83c-1.54 0-2.79-1.23-2.79-2.74v-100.81c0-1.51 1.25-2.74 2.79-2.74h79.83c1.54 0 2.79 1.23 2.79 2.74v100.81c0 1.51-1.25 2.74-2.79 2.74z"
        fill="url(#d)"
      />
      <g fill="#616161">
      ...
      <path
        d="m105.39 90.85-12.26 15.33-15.78 12.62h25.25c1.56 0 2.79-1.21 2.79-2.79v-25.16z"
        fill="#BDBDBD"
      />
      <path
        d="m77.35 118.8c0.8-4.35 1.07-9.43 0.36-15.9-0.16-1.48 0.94-2.79 2.42-2.86 3.44-0.17 9.35-0.6 13.54-1.72 6-1.59 11.73-7.47 11.73-7.47s-3.49 9.28-12.69 18.16c-6.49 6.25-15.36 9.79-15.36 9.79z"
        fill="#757575"
      />
      <linearGradient
        id="c"
      ...
      >
        ...
        <stop stopColor="#BDBDBD" offset={0.032} />
        <stop stopColor="#616161" offset={1} />
      </linearGradient>
      <path
        d="m38.41 17.64c-1.26 0-2.66-1.89-2.66-4.43s1.4-4.43 2.66-4.43c1.19 0 2.51 1.72 2.64 4.07h5.22c-0.15-5.23-3.54-9.28-7.85-9.28-4.41 0-7.87 4.23-7.87 9.64 0 5.4 3.46 9.64 7.87 9.64 1.44 0 2.6-1.17 2.6-2.6-0.01-1.44-1.17-2.61-2.61-2.61z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <path
        d="m62.69 17.64c-1.26 0-2.66-1.89-2.66-4.43s1.4-4.43 2.66-4.43c1.19 0 2.51 1.72 2.64 4.07h5.22c-0.16-5.23-3.55-9.28-7.86-9.28-4.41 0-7.87 4.23-7.87 9.64 0 5.4 3.46 9.64 7.87 9.64 1.44 0 2.6-1.17 2.6-2.6 0.01-1.44-1.16-2.61-2.6-2.61z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
