...
function Dog(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m108.97 61.01c-5.3-1.14-14.41-0.19-19.02 14.62-1 3.22-4.16 7.06-7.34 7.14-6.3 0.15-7.57-7.58-18.8-7.58s-12.05 7.72-18.35 7.58c-3.17-0.07-6.43-3.92-7.44-7.14-4.61-14.81-13.72-15.76-19.02-14.62-22.7 4.87-4.91 38.57 4 48.1 21.29 22.75 60.14 23.43 82.07 0 8.91-9.53 26.6-43.23 3.9-48.1z"
        clipPath="url(#e)"
        fill="url(#d)"
      />
      ...
      <path
        d="m64.29 93.57c-4.83 0-11.29-3.66-11.29-8.13v-0.22c0-4.47 4.41-9.22 9.24-9.22h3.51c4.83 0 9.24 4.75 9.24 9.22v0.11c0.01 4.47-5.86 8.24-10.7 8.24z"
        fill="url(#c)"
      />
      ...
      <path
        d="m46.56 111.09c0-5.47 8.03-11.34 17.92-11.34s17.92 5.87 17.92 11.34-8.03 9.91-17.92 9.91-17.92-4.44-17.92-9.91z"
        clipPath="url(#a)"
        fill="#FF8282"
      />
      <g fill="#FFF5B5">
