  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#e)">
        ...
        >
          <stop stopColor="#D1D1D1" offset={0.00097656} />
          <stop stopColor="#D4D4D4" offset={0.5765} />
        </linearGradient>
        <path
          d="m34.27 53.88c4.5 8.44 11.28 15.58 19.41 20.34 0.68 0.4 1.33 0.89 1.84 1.51 3.26 3.97-1.14 8.2-4.54 8.9-3 0.62-5.34-2.31-7.2-4.35-4.65-5.08-8.04-11.38-9.81-18.13-0.67-2.55-1.1-5.16-1.29-7.79-0.07-0.92 1.15-1.3 1.59-0.48z"
          fill="url(#d)"
          stroke="#878787"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#A3A3A3" offset={0.00097656} />
          <stop stopColor="#A4A4A4" offset={0.0023064} />
          <stop stopColor="#BCBCBC" offset={0.0572} />
          <stop stopColor="#CFCFCF" offset={0.119} />
          <stop stopColor="#DCDCDC" offset={0.1915} />
          <stop stopColor="#E4E4E4" offset={0.284} />
          <stop stopColor="#E6E6E6" offset={0.4651} />
          <stop stopColor="#fff" offset={0.6631} />
        </linearGradient>
        <path
          d="m22.29 59.5c5.49 10.28 13.74 18.97 23.63 24.77 0.83 0.49 1.62 1.08 2.24 1.83 3.98 4.84-1.38 9.99-5.53 10.84-3.66 0.75-6.5-2.82-8.77-5.29-5.67-6.19-9.79-13.86-11.95-22.08-0.81-3.1-1.35-6.28-1.57-9.48-0.07-1.13 1.42-1.58 1.95-0.59z"
          fill="url(#b)"
          stroke="#999"
          strokeLinejoin="round"
          strokeMiterlimit={10}
        ...
        />
        <path
          d="m93.34 27.72c6.06-3.04 15.96-5.87 21.62-2.15 1.18 8.14-2.3 17.45-8.48 22.88-4.2 3.7-11.33 5.51-16.97 1.33-9.93-7.36-5.03-17.62 3.83-22.06z"
          fill="#4D4131"
        />
        <linearGradient
          id="a"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#50433C" offset={0.0204} />
          <stop stopColor="#59493E" offset={0.1246} />
          <stop stopColor="#85664A" offset={0.6528} />
          <stop stopColor="#96714E" offset={0.921} />
        </linearGradient>
        <path
          d="m92.06 33.54c4.51-2.26 11.88-4.37 16.09-1.6 0.88 6.06-1.71 12.99-6.31 17.03-3.13 2.75-8.43 4.1-12.63 0.99-7.39-5.48-3.74-13.12 2.85-16.42z"
          fill="url(#a)"
        />
      </g>
      <path
        d="m20.88 95c2.64 4.58 2.79 10.66 1.25 11.55s-4.93-2.1-7.58-6.68c-2.64-4.58-3.54-9.01-2-9.9s5.68 0.45 8.33 5.03z"
        fill="#423732"
      />
    </svg>
  );
