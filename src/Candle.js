  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <radialGradient
        ...
        cy={58.5}
        r={64.302}
        gradientTransform="matrix(1.0287e-13 1 -.7335 7.5455e-14 106.58 -5.1667)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#eee" offset={0.1652} />
        <stop stopColor="#E0E0E0" offset={0.5547} />
      ...
      <g opacity={0.2}>
        <path
          d="m81 51v65c0 0.42-0.97 1.67-3.97 2.87-3.38 1.35-8.13 2.13-13.03 2.13s-9.65-0.78-13.03-2.13c-3-1.2-3.97-2.45-3.97-2.87v-65h34m3-3h-40v68c0 4.42 8.95 8 20 8s20-3.58 20-8v-68z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      >
        ...
        <stop stopColor="#FEA700" offset={0.1699} />
        <stop stopColor="#FA9A00" offset={0.3491} />
        <stop stopColor="#F58500" offset={0.5327} />
        <stop stopColor="#ED6700" offset={0.7192} />
        <stop stopColor="#E34200" offset={0.9062} />
        <stop stopColor="#DD2C00" offset={1} />
      </radialGradient>
      <path
        d="m70.42 42.69c-3.97 2.52-9.09 2.64-13.23 0.42-4.57-2.45-9.15-7.77-4-19.11 8.68-19.1 12.85-20.42 13.46-19.92s-1.16 6.51 5.81 17.33c5.45 8.45 4.64 17.05-2.04 21.28z"
        fill="url(#b)"
      />
      <radialGradient
        id="a"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFEA00" offset={0} />
        <stop stopColor="#FFE600" offset={0.2549} />
        <stop stopColor="#FFDA00" offset={0.5051} />
        <stop stopColor="#FFC700" offset={0.7526} />
        <stop stopColor="#FFAB00" offset={0.9984} />
        <stop stopColor="#FFAB00" offset={1} />
      </radialGradient>
      <path
        d="m67.17 37.63c-2.01 1.98-5.27 2.1-7.55 0.43-1.94-1.42-3.57-4.2-1.4-9.53 3.99-9.81 5.94-10.47 6.23-10.21s-0.52 3.36 2.79 8.98c2.35 4 2.28 8.02-0.07 10.33z"
        fill="url(#a)"
      />
      <path
        d="m64.65 52.53c-3.19 0.26-6.57-0.28-9.99-1.63-0.64-0.25-1.02-1.1-0.83-1.88 0.18-0.79 0.85-1.22 1.49-0.97 4.98 1.96 9.82 2.07 14 0.3 0.74-0.31 1.48-0.69 2.19-1.12 0.59-0.36 1.32-0.05 1.63 0.7s0.09 1.64-0.51 2c-0.8 0.49-1.62 0.91-2.46 1.26-1.75 0.74-3.6 1.19-5.52 1.34z"
        fill="#E0E0E0"
      />
      <g opacity={0.2}>
        <path
          d="m64.29 9.83c0.6 3.18 2.05 7.62 5.65 13.2 2.6 4.03 3.62 8.12 2.87 11.51-0.52 2.37-1.87 4.26-4 5.61-1.57 1-3.42 1.52-5.34 1.52-1.7 0-3.38-0.42-4.87-1.22-5.2-2.79-6.07-7.77-2.69-15.23 3.79-8.3 6.56-12.88 8.38-15.39m2.08-5.83c-1.19 0-5.34 2.76-13.18 20-5.15 11.34-0.57 16.66 4 19.11 1.95 1.05 4.12 1.57 6.29 1.57 2.43 0 4.85-0.66 6.94-1.99 6.68-4.23 7.49-12.84 2.04-21.28-6.97-10.81-5.19-16.82-5.81-17.33-0.06-0.05-0.15-0.08-0.28-0.08z"
          fill="#424242"
        />
      </g>
    </svg>
