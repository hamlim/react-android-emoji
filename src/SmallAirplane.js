...
function SmallAirplane(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <g fill="#757575">
        <path d="m89.31 64.17 0.4 0.4c0.77 0.77 2.03 0.77 2.8 0l6.72-6.72c0.77-0.77 0.77-2.03 0-2.8l-0.4-0.4c-0.77-0.77-2.03-0.77-2.8 0l-6.72 6.72c-0.78 0.77-0.78 2.03 0 2.8z" />
      ...
      <path
        d="m26.24 101.61c4.14 4.14 55.66-40 69.16-51.71 2.08-1.8 3.57-4.17 4.2-6.66l0.77-3.06c0.49-1.93 0.06-3.79-1.16-5l-6.44-6.38c-1.17-1.16-2.94-1.59-4.81-1.17l-3.17 0.72c-2.59 0.59-5.06 2.1-6.93 4.26-11.86 13.68-55.74 64.87-51.62 69z"
        fill="url(#e)"
      />
      <path
        d="m95.74 28.9 3.25 3.25 8.34-9.49c0.95-0.95 1.24-2.18 0.66-2.77-0.58-0.58-1.82-0.29-2.77 0.66l-9.48 8.35z"
        fill="#616161"
      />
      <path
        d="m87.49 10.83 16.4 13.17 13.17 16.4c0.8 0.8 2.09 0.8 2.88 0l0.36-0.36c0.8-0.8 0.8-2.09 0-2.88l-16.41-13.16-13.16-16.4c-0.8-0.8-2.09-0.8-2.88 0l-0.36 0.36c-0.8 0.79-0.8 2.08 0 2.87z"
        fill="#424242"
      />
      <path
        d="m96.84 26.36 4.69 4.69c1.17 1.17 1.17 3.07 0 4.24l-4.29 4.29-8.93-8.93 4.29-4.29c1.17-1.17 3.07-1.17 4.24 0z"
        fill="#424242"
      />
      <defs>
        <path
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#EF6C00" offset={0} />
        <stop stopColor="#FB8C00" offset={1} />
      </linearGradient>
      <path
        d="m8.47 85.02 18.79 15.63 15.61 18.77c1.29 1.55 3.47 1.64 4.17 0.18l5.1-8.38c0.73-1.51 0.46-3.5-0.7-5.2l-12.12-17.73-17.84-12.23c-1.71-1.17-3.72-1.44-5.23-0.7l-7.97 5.49c-1.45 0.72-1.35 2.89 0.19 4.17z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
