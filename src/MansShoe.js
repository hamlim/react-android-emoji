...
function MansShoe(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#545454" offset={0} />
        <stop stopColor="#474747" offset={0.2183} />
        <stop stopColor="#262626" offset={0.6187} />
        <stop offset={1} />
      </linearGradient>
      <path
        d="m5.67 107.19 0.11 11.78c0.01 1.4 1.08 2.53 2.38 2.52l27.53-0.07c0.9 0 1.63-0.74 1.62-1.65l-0.03-2.15c-0.01-0.97 0.81-1.74 1.77-1.64 2.99 0.3 9.2 1.1 14.97 2.98 9.1 2.98 20.7 4.82 30.17 5.22 17.64 0.74 33.05-5.13 37.79-7.16 0.9-0.39 1.49-1.32 1.49-2.37v-3c0-1.37-1.07-1.86-2.34-1.92l-112.99-5.11c-1.36-0.06-2.48 1.11-2.47 2.57z"
        fill="url(#e)"
      />
      <linearGradient
        id="d"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#D17358" offset={0} />
        <stop stopColor="#8C401A" offset={1} />
      </linearGradient>
      <path
        d="m6.77 77.55c-2.32 5.73-4.52 16.27-1.39 26.3 0.88 2.81 4.63 5.39 17.13 6.89 13.54 1.62 22.2-0.61 34.61 3.6 10.31 3.5 22.34 7.51 49.22 1.98 11.44-2.35 14.15-4.79 15.54-5.83s-0.44-11.19-6.38-11.75-3.83 0.33-12.66-0.83c-13.22-1.72-27.75-10.06-45.44-25.76-1-0.89-2.43-0.96-3.5-0.18-4.09 3-14.42 9.95-22.8 10.41-7.72 0.43-16.16-3.87-20.26-6.3-1.5-0.88-3.4-0.21-4.07 1.47z"
        fill="url(#d)"
      />
      <g
        fill="none"
        ...
        strokeWidth={3}
      >
        <line x1={56.42} x2={61.04} y1={79.8} y2={74.83} />
        <line x1={61.08} x2={65.7} y1={83.22} y2={78.26} />
        <line x1={65.75} x2={70.37} y1={86.65} y2={81.68} />
        <line x1={70.41} x2={75.04} y1={90.07} y2={85.11} />
        <line x1={75.59} x2={80.22} y1={93.67} y2={88.7} />
      </g>
      <defs>
        <path
          id="c"
          d="m6.77 77.55c-2.32 5.73-4.2 16.17-1.39 26.3 0.27 0.99 1.17 1.45 1.9 2.08 2.56 2.23 7.35 4.21 16.74 4.73 13.61 0.75 20.68-0.53 33.09 3.68 10.31 3.5 22.34 7.51 49.22 1.98 11.44-2.35 14.15-4.79 15.54-5.83s-0.44-11.19-6.38-11.75-3.83 0.33-12.66-0.83c-13.21-1.72-27.74-10.06-45.43-25.76-1-0.89-2.43-0.96-3.5-0.18-4.09 3-14.42 9.95-22.8 10.41-7.72 0.43-16.16-3.87-20.26-6.3-1.5-0.88-3.4-0.21-4.07 1.47z"
        />
      </defs>
      <clipPath id="b">
        <use xlinkHref="#c" />
