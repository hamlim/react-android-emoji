  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g fill="#424242" opacity={0.2}>
        ...
        <path d="m58.77 21.2c11.33 0 20.52 9.19 20.52 20.52s-9.19 20.52-20.52 20.52-20.52-9.19-20.52-20.52 9.19-20.52 20.52-20.52m0-3c-12.97 0-23.52 10.55-23.52 23.52s10.55 23.52 23.52 23.52 23.52-10.55 23.52-23.52-10.55-23.52-23.52-23.52z" />
        <path d="m93.89 33.51c7.93 0 14.36 6.43 14.36 14.36s-6.43 14.36-14.36 14.36-14.36-6.43-14.36-14.36 6.42-14.36 14.36-14.36m0-3c-9.57 0-17.36 7.79-17.36 17.36s7.79 17.36 17.36 17.36 17.36-7.79 17.36-17.36-7.79-17.36-17.36-17.36z" />
      </g>
      <g fill="#FAFAFA">
        <path d="m99.08 61.47h-47.22c-3.12 0-5.67 2.55-5.67 5.67v9.44l-20.97-14.71c-2.51-1.26-5.47 0.57-5.47 3.38v37.77c0 2.81 2.96 4.63 5.47 3.38l20.98-14.71v9.44c0 3.12 2.55 5.67 5.67 5.67h47.22c3.12 0 5.67-2.55 5.67-5.67v-34c-0.01-3.11-2.56-5.66-5.68-5.66z" />
        <circle cx={58.77} cy={41.72} r={20.52} />
        <circle cx={93.89} cy={47.88} r={14.36} />
      </g>
    </svg>
  );
}
