...
function Partying(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m64 122c-25.94 0-53.85-16.24-53.85-51.89s27.92-51.89 53.85-51.9c14.38 0 27.69 4.76 37.48 13.4 10.71 9.46 16.38 22.77 16.38 38.49 0 15.66-5.66 28.94-16.38 38.42-9.82 8.7-23.13 13.48-37.48 13.48z"
        fill="url(#h)"
      />
      <path
        d="m64 20.21c13.89 0 26.73 4.58 36.15 12.9 10.27 9.06 15.7 21.86 15.7 37 0 15.07-5.43 27.84-15.7 36.93-9.45 8.35-22.29 12.96-36.15 12.96-13.93 0-26.77-4.54-36.16-12.8-10.27-9.03-15.69-21.85-15.69-37.1 0-15.31 5.43-28.17 15.69-37.17 9.36-8.2 22.2-12.72 36.16-12.72m0-4c-29 0-55.85 18.62-55.85 53.89 0 35.08 26.85 53.9 55.85 53.9s55.85-19.29 55.85-53.89c0-34.8-26.85-53.9-55.85-53.9z"
        fill="#EB8F00"
      />
      <radialGradient
        id="g"
      ...
      <g clipPath="url(#d)">
        ...
        />
        <path
          d="m80.85 15.24 43.5 6.22-0.77 5.39-43.5-6.22 0.77-5.39m-3.39-4.53-0.57 3.96-0.77 5.39-0.57 3.96 3.96 0.57 43.5 6.22 3.96 0.57 0.57-3.96 0.77-5.39 0.57-3.96-3.96-0.57-43.5-6.22-3.96-0.57z"
          fill="#C93737"
        />
        <rect
        ...
        />
        <path
          d="m80.23 25.5 43.5 6.22-0.77 5.39-43.5-6.22 0.77-5.39m-3.4-4.53-0.57 3.96-0.77 5.39-0.57 3.96 3.96 0.57 43.5 6.22 3.96 0.57 0.57-3.96 0.77-5.39 0.57-3.96-3.96-0.57-43.5-6.22-3.96-0.57z"
          fill="#C93737"
        />
        <rect
        ...
        />
        <path
          d="m77.77 36.8 43.5 6.22-0.77 5.39-43.5-6.22 0.77-5.39m-3.4-4.53-0.57 3.96-0.77 5.39-0.57 3.96 3.96 0.57 43.5 6.22 3.96 0.57 0.57-3.96 0.77-5.39 0.57-3.96-3.96-0.57-43.5-6.22-3.96-0.57z"
          fill="#C93737"
        />
      </g>
      <path
      ...
      />
      <path
        d="m71.38 90.25 0.38 5.12 10.49-0.11c-0.03-1.5-0.15-3.02-0.21-4.62-5.91-0.2-10.66-0.39-10.66-0.39z"
        fill="#7F0099"
      />
      <linearGradient
        id="a"
      ...
      <path
        ...
        fill="#242424"
      />
      <circle cx={120.75} cy={6.5} r={4.78} fill="#C93737" />
    </svg>
  );
}
