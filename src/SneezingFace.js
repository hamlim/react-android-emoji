  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#ED7770" offset={0.19} />
        <stop stopColor="#ED7770" stopOpacity={0.1191} offset={0.8154} />
        <stop stopColor="#ED7770" stopOpacity={0} offset={0.9} />
      </radialGradient>
      <ellipse cx={64.25} cy={61.16} rx={45.83} ry={35.13} fill="url(#b)" />
      <path
        d="m43.95 95.26c-7.29 0-13.19-6.71-13.19-14.98s5.91-14.98 13.19-14.98h40.12c7.29 0 13.19 6.71 13.19 14.98s-5.91 14.98-13.19 14.98h-40.12z"
        fill="#242424"
      />
      <linearGradient
        id="a"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#fff" offset={0.3913} />
        <stop stopColor="#F9F9F9" offset={0.5103} />
        <stop stopColor="#E8E8E8" offset={0.6689} />
        <stop stopColor="#CDCDCD" offset={0.8489} />
        <stop stopColor="#B0B0B0" offset={0.9993} />
      </linearGradient>
      <path
        d="m32.59 124.33c3.42 0 7.72-4.05 14.39-4.04s9.73 4.04 16.65 4.04c6.85 0 9.87-4.02 16.47-4.02 8.24 0.01 10.99 4.02 14.41 4.02 1.71 0 3.11-1 2.79-2l-15.1-47.33c-8.66-27.13-29.18-28.25-37.65-0.72l-14.77 48.02c-0.3 1.02 1.1 2.03 2.81 2.03z"
        fill="url(#a)"
      />
      <path
        d="m32.59 124.33c3.42 0 7.72-4.05 14.39-4.04s9.73 4.04 16.65 4.04c6.85 0 9.87-4.02 16.47-4.02 8.24 0.01 10.99 4.02 14.41 4.02 1.71 0 3.11-1 2.79-2l-15.1-47.33c-8.66-27.13-29.18-28.25-37.65-0.72l-14.77 48.02c-0.3 1.02 1.1 2.03 2.81 2.03z"
      ...
      />
      <path
        d="m33.19 48.05 12.17-2.36-12.55-5.21c-0.14-0.07-0.28-0.15-0.42-0.23-2.61-1.6-3.06-4.89-0.72-6.93 1.81-1.58 4.76-1.6 6.88-0.3 4.98 3.05 16.7 10.24 21.27 13.04 0.82 0.5 0.7 1.58-0.22 1.93l-22.91 8.6c-0.15 0.06-0.32 0.11-0.48 0.16-3.03 0.84-6.32-0.89-6.79-3.78-0.35-2.2 1.35-4.25 3.77-4.92z"
        fill="#242424"
      />
      <path
        d="m95.81 47.8-12.17-2.36 12.55-5.21c0.14-0.07 0.28-0.15 0.42-0.23 2.61-1.6 3.06-4.89 0.72-6.93-1.81-1.58-4.76-1.6-6.88-0.3-4.98 3.05-16.7 10.24-21.27 13.04-0.82 0.5-0.7 1.58 0.22 1.93l22.91 8.6c0.15 0.06 0.32 0.11 0.48 0.16 3.03 0.84 6.32-0.89 6.79-3.78 0.35-2.2-1.35-4.25-3.77-4.92z"
        fill="#242424"
      />
    </svg>
  );
