  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <linearGradient
        ...
        y1={195.87}
        y2={195.87}
        gradientTransform="matrix(.983 .1317 -.1306 .9913 -200.86 -167.55)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <radialGradient
        ...
        cy={196}
        r={16.524}
        gradientTransform="matrix(-.8204 .5799 -.3806 -.5426 1851.3 -1047.9)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <path
        d="m30.33 86.85c-2.11 0-4.07-1.05-5.26-2.8-1.99-2.93-1.25-6.96 1.66-8.97l10.98-7.59c1.07-0.74 2.31-1.13 3.59-1.13 2.11 0 4.07 1.05 5.26 2.8 1.99 2.93 1.25 6.96-1.66 8.97l-10.98 7.59c-1.06 0.74-2.3 1.13-3.59 1.13z"
        fill="url(#f)"
      />
      <path
        d="m41.3 67.87c1.61 0 3.11 0.8 4.02 2.14 1.53 2.26 0.96 5.35-1.27 6.89l-10.98 7.59c-0.81 0.56-1.76 0.86-2.74 0.86-1.61 0-3.11-0.8-4.02-2.14-1.53-2.26-0.96-5.35 1.27-6.89l10.98-7.59c0.81-0.56 1.76-0.86 2.74-0.86m0-3c-1.53 0-3.08 0.45-4.45 1.39l-10.98 7.59c-3.59 2.48-4.51 7.42-2.05 11.04 1.53 2.25 3.99 3.45 6.51 3.45 1.53 0 3.08-0.45 4.45-1.39l10.98-7.59c3.59-2.48 4.51-7.42 2.05-11.04-1.53-2.24-4-3.45-6.51-3.45z"
        fill="#4A2F27"
      />
      <radialGradient
        id="e"
        ...
        cy={632.2}
        r={16.282}
        gradientTransform="matrix(-.5733 .6659 -.498 -.4353 1279.1 -685.52)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#70534A" offset={0.6064} />
        <stop stopColor="#5C4037" offset={0.9991} />
      ...
      <path
        d="m53.06 104.36c-1.56 0-3.06-0.58-4.23-1.63-2.63-2.36-2.87-6.45-0.53-9.11l6.39-7.24c1.21-1.37 2.95-2.16 4.76-2.16 1.56 0 3.06 0.58 4.23 1.63 2.63 2.36 2.87 6.45 0.53 9.11l-6.39 7.24c-1.21 1.37-2.94 2.16-4.76 2.16z"
        fill="url(#e)"
      />
      <path
        d="m59.46 85.73c1.19 0 2.34 0.44 3.23 1.24 2.02 1.82 2.2 4.96 0.4 7l-6.39 7.24c-0.92 1.05-2.25 1.65-3.64 1.65-1.19 0-2.34-0.44-3.23-1.24-2.02-1.82-2.2-4.96-0.4-7l6.39-7.24c0.92-1.05 2.25-1.65 3.64-1.65m0-3c-2.17 0-4.33 0.9-5.89 2.66l-6.39 7.24c-2.89 3.28-2.6 8.3 0.65 11.21 1.5 1.35 3.37 2.01 5.23 2.01 2.17 0 4.33-0.9 5.89-2.66l6.39-7.24c2.89-3.28 2.6-8.3-0.65-11.21-1.5-1.35-3.37-2.01-5.23-2.01z"
        fill="#4A2F27"
      />
      <radialGradient
        id="d"
        ...
        cy={324.78}
        r={13.76}
        gradientTransform="matrix(-.7813 .4857 -.3539 -.5793 1858 -811.9)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#70534A" offset={0.6064} />
        <stop stopColor="#5C4037" offset={0.9991} />
      ...
      <path
        d="m22.31 76.23c-2.21 0-4.22-1.13-5.38-3.02-1.84-3-0.92-6.95 2.05-8.81l6.69-4.18c1-0.62 2.15-0.96 3.32-0.96 2.21 0 4.22 1.13 5.38 3.02 1.84 3 0.92 6.95-2.05 8.8l-6.69 4.18c-1 0.64-2.15 0.97-3.32 0.97z"
        fill="url(#d)"
      />
      <path
        d="m28.99 60.77c1.68 0 3.22 0.86 4.1 2.31 1.41 2.3 0.71 5.33-1.57 6.75l-6.68 4.17c-0.76 0.48-1.63 0.73-2.52 0.73-1.68 0-3.22-0.86-4.1-2.31-1.41-2.3-0.71-5.33 1.57-6.75l6.69-4.18c0.75-0.47 1.62-0.72 2.51-0.72m0-3c-1.41 0-2.83 0.38-4.11 1.18l-6.69 4.18c-3.67 2.29-4.81 7.16-2.53 10.86 1.48 2.41 4.04 3.74 6.66 3.74 1.41 0 2.83-0.38 4.11-1.18l6.69-4.18c3.67-2.29 4.81-7.16 2.53-10.86-1.48-2.42-4.04-3.74-6.66-3.74z"
        fill="#4A2F27"
      />
      <radialGradient
        id="c"
        ...
        cy={291.65}
        r={16.872}
        gradientTransform="matrix(.5965 .6015 -.7159 .7219 -749.49 -1151.8)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#70534A" offset={0.6064} />
        <stop stopColor="#5C4037" offset={0.9991} />
      ...
      <path
        d="m39.67 98.47c-1.65 0-3.21-0.65-4.38-1.83-2.42-2.44-2.42-6.42 0-8.87l11.74-11.84c1.17-1.18 2.73-1.83 4.38-1.83s3.21 0.65 4.38 1.83c2.43 2.45 2.43 6.42 0 8.87l-11.74 11.84c-1.17 1.18-2.73 1.83-4.38 1.83z"
        fill="url(#c)"
      />
      <path
        d="m51.41 75.6c1.25 0 2.43 0.49 3.32 1.39 1.85 1.86 1.85 4.89 0 6.76l-11.75 11.83c-0.89 0.89-2.06 1.39-3.32 1.39s-2.43-0.49-3.32-1.39c-1.85-1.86-1.85-4.89 0-6.76l11.74-11.84c0.9-0.89 2.07-1.38 3.33-1.38m0-3c-1.97 0-3.94 0.76-5.45 2.27l-11.74 11.84c-3.01 3.03-3.01 7.95 0 10.98 1.5 1.52 3.47 2.27 5.45 2.27 1.97 0 3.94-0.76 5.45-2.27l11.74-11.84c3.01-3.03 3.01-7.95 0-10.98-1.51-1.51-3.48-2.27-5.45-2.27z"
        fill="#4A2F27"
      />
      <defs>
        <path
          id="b"
          d="m44.83 46.73c-2.25-3.89-0.96-8.43 3.22-11.02l23.28-10.36c2.56-0.93 5.43 5.17 5.43 5.17l4.07 7.48s3.65 5.35 4.05 5.84c2.06 2.49-1.06-0.71-5.33-1.65-7.56-1.65-18.97 7.46-24.43 8.43s-8.04 0-10.29-3.89z"
        />
      </defs>
      <clipPath id="a">
        <use xlinkHref="#b" />
