  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m62.17 63.52c-0.97 0-2-0.1-3.05-0.3-7.65-1.42-17.36-7.99-19.53-21.79-1.25-7.92-0.09-14.79 3.33-19.86 3.01-4.46 7.72-7.4 13.26-8.27 1.09-0.17 2.2-0.26 3.28-0.26 13.04 0 19.47 11.33 21.14 21.94 2.17 13.82-5.06 23.05-11.92 26.75-1.58 0.85-3.18 1.42-4.62 1.65-0.59 0.1-1.23 0.14-1.89 0.14z"
          fill="url(#d)"
        />
        <path
          d="m59.46 14.05c4.75 0 9.08 1.7 12.52 4.93 3.91 3.66 6.54 9.25 7.63 16.17 2.09 13.31-4.84 22.17-11.41 25.71-1.48 0.8-2.97 1.33-4.3 1.54-0.54 0.08-1.12 0.13-1.73 0.13-0.91 0-1.87-0.09-2.87-0.28-7.33-1.37-16.63-7.67-18.72-20.96-2.78-17.66 6.75-25.58 15.75-26.99 1.05-0.17 2.1-0.25 3.13-0.25m0-2c-1.14 0-2.29 0.09-3.44 0.27-11.16 1.76-20.19 11.68-17.42 29.28 2.22 14.13 12.29 21.12 20.33 22.61 1.13 0.21 2.21 0.31 3.23 0.31 0.72 0 1.4-0.05 2.04-0.15 1.55-0.24 3.24-0.84 4.94-1.76 7.2-3.88 14.66-13.63 12.44-27.78-2.47-15.79-12.1-22.78-22.12-22.78z"
          fill="#4A2F27"
        />
      </g>
      <g clipPath="url(#a)">
        <defs>
          <path
            id="c"
            d="m42.42 63s-1.67-4.25-3.83-13.5c-2.17-9.25-3.17-19.17-3.17-19.17-1.73-11 7.21-21.54 18.2-23.27l3.2-0.5c11-1.73 22.43 5.05 24.16 16.04 0 0 1.65 6.83 2.59 15.65s2.19 18.44 2.19 18.44l-43.34 6.31z"
          />
        </defs>
        <clipPath id="b">
          <use xlinkHref="#c" />
        ...
        <g clipPath="url(#b)">
          <radialGradient
            ...
            cy={-16.645}
            r={24.764}
            gradientTransform="matrix(.7864 -.1237 .1237 .7864 -120.03 47.903)"
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#444140" offset={0} />
            <stop stopColor="#232020" offset={1} />
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m67.55 50.46c-1.85 1.54-8.54 2.59-10.78 1.7-1.28-0.51-2.31 0.74-1.66 1.73 0.64 0.97 4.68 2.83 7.84 2.33s6.38-3.49 6.69-4.62c0.32-1.14-1.03-2.02-2.09-1.14z"
          fill="#1A1717"
        />
        <path
          d="m63.6 44.38c-0.07-0.02-0.14-0.02-0.21-0.02l-4.53 0.71c-0.07 0.02-0.13 0.05-0.2 0.09-0.38 0.23-0.54 0.69-0.28 1.12 0.27 0.42 1.37 1.55 3.19 1.27 1.82-0.29 2.52-1.7 2.64-2.18 0.12-0.5-0.17-0.89-0.61-0.99z"
          fill="#33251F"
        />
        <g fill="#1A1717">
      ...
      <g clipPath="url(#a)">
        <radialGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#4F4C4A" offset={0.000015751} />
          <stop stopColor="#232020" offset={0.8427} />
        </radialGradient>
        <path
          d="m43.75 119.62c-7.94 0-14.17-5.78-14.17-13.16 0-6.39 3.46-13.86 13.21-13.86 0.22 0 0.45 0 0.67 0.01 3.99 0.14 8.05 2.14 10.88 5.35 2.5 2.83 3.71 6.18 3.41 9.43-0.5 5.59-3.35 12.23-14 12.23z"
          fill="url(#l)"
        />
        <path
      ...
      <g clipPath="url(#a)">
        <defs>
          <path
            id="j"
            d="m20.08 113.5 10.75 0.5s3.18 4.76 8.83 5.67c7.83 1.25 10.75-1.25 10.75-1.25l33.17-2.83 12.92 20.33-2.75 12.42-75-15.08 1.33-19.76z"
          />
        </defs>
        <clipPath id="i">
          <use xlinkHref="#j" />
        ...
        <g clipPath="url(#i)">
          <linearGradient
            ...
            y1={117.39}
            y2={130.52}
            gradientTransform="matrix(.9941 .1087 -.1087 .9941 13.885 -5.9617)"
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#70534A" offset={0} />
            <stop stopColor="#6D5047" offset={0.4665} />
