  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#F8FCFF" offset={0.3903} />
        <stop stopColor="#E5F3FD" offset={0.9561} />
        <stop stopColor="#E3F2FD" offset={0.999} />
      </linearGradient>
      <path
      ...
      <path
        d="m56.4 11.89-0.13-1.09c0-0.51 0.41-0.92 0.92-0.92h12.72c0.51 0 0.92 0.41 0.92 0.92l-0.13 1.09h0.03l0.89-7.42-0.16-0.19c-0.17-0.2-0.43-0.32-0.7-0.32h-7.12c-0.04-0.04-0.06 0.02-0.09 0.09-0.03-0.07-0.05-0.12-0.09-0.09h-7.12c-0.27 0-0.52 0.12-0.7 0.32l-0.24 0.28 0.88 7.32h0.12z"
        fill="url(#b)"
      />
      <path
