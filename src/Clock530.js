...
function Clock530(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m64.05 63.89-0.35 0.2c-1.83 1.03-2.47 3.35-1.44 5.18l10.6 18.8c1.03 1.83 3.35 2.47 5.18 1.44l0.35-0.2c1.83-1.03 2.47-3.35 1.44-5.18l-10.6-18.8c-1.04-1.83-3.35-2.47-5.18-1.44z"
        fill="#424242"
      />
