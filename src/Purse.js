...
function Purse(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <g fill="#F9A825">
        <rect
          transform="matrix(-.9579 .2872 -.2872 -.9579 122.14 59.033)"
          x={52.58}
          y={30.02}
          width={8.32}
          height={16.91}
        />
        <circle cx={53.45} cy={27.52} r={9.7} />
      </g>
      <radialGradient
        id="f"
        cx={64.084}
      ...
      >
        <stop stopColor="#FDD835" offset={0.4158} />
        <stop stopColor="#F9A825" offset={1} />
      </radialGradient>
      <path
        d="m89.79 43.26c-5.97-1.97-8.41-3.14-14.95-3.6l1.83-6.09-7.97-2.39-2.48 8.28c-6.05-0.54-15.82-0.24-23.52 2.52-9.65 3.46-19.54 7.36-25.68 15.78-2.94 4.03-5.22 9.04-5.53 14.09-0.35 5.67 8.26 5.75 8.95 0.33 0.12-0.63 0.23-1.26 0.39-1.88 0.59-2.34 14.83-20.53 43.17-20.53s43.51 21.51 43.67 22.29v0.02c0.46 5.67 9.37 5.69 8.99-0.08-0.95-14.36-14.27-24.57-26.87-28.74z"
        fill="url(#f)"
      />
      <radialGradient
        id="e"
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#D32F2F" offset={0.5095} />
        <stop stopColor="#B71C1C" offset={1} />
      </radialGradient>
      <path
        d="m113.84 122c-7.17 1.33-7.51 2.17-49.84 2.17s-43.08-0.83-49.95-2.17-9.99-4.47-10-9.99c0 0-4.2-65.85 59.88-65.85s59.92 65.85 59.92 65.85c-0.02 5.52-2.84 8.66-10.01 9.99z"
        fill="url(#d)"
      />
      <defs>
        <path
      ...
      <radialGradient
        ...
        cy={74.248}
        r={69.492}
        gradientTransform="matrix(.7803 0 0 .5516 -15.393 33.296)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F44336" offset={0.5256} />
        <stop stopColor="#D32F2F" offset={0.8872} />
      </radialGradient>
      <path
        d="M92.87,124H35.01c-4.31,0-23.82-9.92-23.82-28.79 s7.5-49.04,52.74-49.04s52.77,29.4,52.77,49.12S97.18,124,92.87,124z"
        clipPath="url(#b)"
        fill="url(#a)"
      />
      <g fill="#E53935">
        <path d="m50.64 64.26c-1.69 5.6-4.21 4.98-4.83 4.79s-3.06-1.06-1.37-6.66 7.7-14.28 7.7-14.28 0.19 10.55-1.5 16.15z" />
        <path d="m77.36 64.26c1.69 5.6 4.21 4.98 4.83 4.79s3.06-1.06 1.37-6.66-7.7-14.28-7.7-14.28-0.19 10.55 1.5 16.15z" />
        <path d="m68.65 70.58c-0.14 8.41-3.87 8.54-4.8 8.52s-4.65-0.27-4.51-8.68 5.04-22.76 5.04-22.76 4.42 14.52 4.27 22.92z" />
      </g>
      <g opacity={0.2}>
        <path
          d="m64.04 49.23c1.05 0 5.32 0.11 5.65 0.13 12.64 0.79 22.71 4.25 29.92 10.31 0.03 0.03 0.07 0.06 0.1 0.08 22.96 17.57 21.15 51.8 21.13 52.14 0 0.06-0.01 0.12-0.01 0.18-0.01 3.55-1.22 5.74-7.63 7.12-4.43 0.95-16.47 2.08-48.68 2.08-8.65 0-16.26-0.08-21.29-0.13-2.28-0.02-3.96-0.04-4.82-0.04-6.58 0-19.39-1.19-23.8-2.04-6.28-1.22-7.57-3.69-7.57-7.04 0-0.06 0-0.12-0.01-0.19-0.02-0.37-2.06-37.4 24.18-54.23 0.03-0.02 0.05-0.03 0.08-0.05 6.8-4.66 15.74-7.4 26.56-8.13 0.42-0.02 5.26-0.19 6.19-0.19m0-3c-1.01 0-6.06 0.18-6.38 0.2-12.2 0.83-21.32 4.03-28.06 8.65-28.04 17.98-25.55 56.94-25.55 56.94 0.01 5.52 3.12 8.65 10 9.98 4.64 0.9 17.7 2.1 24.37 2.1 2.72 0 13.43 0.17 26.11 0.17 18.42 0 41-0.36 49.31-2.15 7.13-1.53 9.99-4.53 10-10.05 0 0 2.26-35.92-22.3-54.71-7.03-5.9-17.18-10.1-31.67-11-0.11 0-4.68-0.13-5.83-0.13z"
          fill="#424242"
        />
      </g>
    </svg>
