...
function Grasshopper(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("path", {
      d:
        "m82.5 44.08c-1.94 0.13-3.88 0.24-5.81 0.32-1.94 0.07-3.87 0.23-5.8 0.34-1.93 0.08-3.86 0.19-5.79 0.31-1.93 0.11-3.86 0.24-5.78 0.42-7.68 0.63-15.39 1.26-22.85 2.88-3.75 0.69-7.45 1.65-10.91 3.06-0.86 0.36-1.69 0.77-2.53 1.17-0.77 0.48-1.63 0.87-2.33 1.44-1.49 1.03-2.78 2.27-3.66 3.75-0.88 1.47-1.27 3.21-1.15 4.99 0.11 1.78 0.69 3.57 1.45 5.28 1.48 3.48 3.83 6.59 6.19 9.66l-0.12 0.11c-2.59-2.87-5.08-5.91-6.82-9.4-0.86-1.74-1.54-3.6-1.73-5.55-0.21-1.94 0.15-3.96 1.09-5.68 0.93-1.73 2.34-3.16 3.94-4.28 0.76-0.62 1.64-1.04 2.47-1.56 0.87-0.43 1.74-0.87 2.63-1.26 3.59-1.51 7.36-2.53 11.16-3.28 7.62-1.53 15.37-2.16 23.11-2.56 7.75-0.37 15.5-0.41 23.25-0.3l-0.01 0.14z",
      fill: "#7C5329"
    }),
    _react2.default.createElement("path", {
      d:
        "m92.99 54.08c-3.55-0.02-7.09-0.2-10.63-0.25-3.54-0.14-7.07-0.27-10.6-0.33-3.53-0.02-7.05-0.19-10.57-0.18-3.52-0.01-7.03 0.07-10.53 0.28-3.5 0.14-6.98 0.41-10.4 0.96-3.41 0.56-6.78 1.42-9.73 2.9-1.46 0.76-2.77 1.76-3.63 3.06-0.87 1.29-1.2 2.89-1.04 4.53 0.12 1.65 0.64 3.31 1.36 4.89 0.73 1.58 1.6 3.12 2.54 4.62l-0.13 0.1c-1.06-1.42-2.06-2.9-2.88-4.47-0.83-1.57-1.48-3.25-1.72-5.03-0.26-1.77 0.04-3.64 0.99-5.18 0.93-1.55 2.37-2.72 3.91-3.59 3.11-1.76 6.62-2.62 10.1-3.26 3.5-0.61 7.03-0.93 10.57-1.12 7.08-0.33 14.17-0.13 21.25 0.25 7.07 0.39 14.13 1 21.18 1.66l-0.04 0.16z",
      fill: "#7C5329"
    }),
    ...
    _react2.default.createElement(
      "linearGradient",
      {
        ...
        y1: 77.229,
        y2: 77.229,
        gradientTransform: "matrix(.7917 -.2563 .1692 1.2083 2.6981 3.3208)",
        gradientUnits: "userSpaceOnUse"
      },
      _react2.default.createElement("stop", {
        stopColor: "#38210C",
    ...
    _react2.default.createElement("path", {
      d:
        "m78.61 65.17c1.25-1.35 2.54-2.95 4.07-3.15 1.52-0.2 2.31 3.54 2.91 5.69 1.78 6.43 2.85 11.01 3.96 17.78-0.21 0.47-0.68 0.5-1.01 0.24s-0.55-0.75-0.76-1.22c-1.42-3.18-2.85-3.91-4.05-7.29-1.37-3.85-1.09-4.51-1.36-5.31-0.43-1.24-9.33 20.14-17.12 14.31-1.64-1.22-1.75-2.65-1-3.74 2.73-3.94 12.15-14.92 14.36-17.31z",
      fill: "url(#g)"
    }),
    _react2.default.createElement("path", {
      d:
        "m30.46 92.31s7.8 12.75 29.85 12.9 43.36-8.4 49.81-15.45-71.41-9.9-76.81-8.7-2.85 11.25-2.85 11.25z",
      fill: "#3D250F"
    }),
    _react2.default.createElement("path", {
      d:
        "m92.42 92.01c-3.9-1.2-7.5-3-11.4-4.5-5.7-1.5-11.1-3.6-17.1-5.1-5.08-1.1-9.99-1.88-14.99-1.62-0.83 1.83-0.98 3.93 0.61 5.11 0.87 0.65 1.92 0.88 2.94 1.1l35.85 7.62c3.56 0.76 7.14 1.51 10.76 1.51 2.11 0 4.22-0.27 6.31-0.66 2.81-0.52 5.59-1.27 8.26-2.39 2.69-1.12 5.25-2.6 7.64-4.41 1.05-0.8 2.15-1.85 2.54-3.15-7.78 7.78-20.48 9.89-31.42 6.49z",
      fill: "#966A39"
    }),
    _react2.default.createElement(
      "linearGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m21.85 93.03c0.72 1.92 1.68 3.84 3.26 5.15 0.8 0.66 1.78 1.16 2.81 1.2 2.02 0.08 3.7-1.52 4.91-3.14 3.25-4.33 5.12-9.67 5.28-15.08 0.04-1.3-0.02-2.63-0.44-3.87-0.86-2.58-3.23-4.48-5.86-5.18-3.7-0.99-8.92-0.49-10.79 3.25-2.58 5.16-1.1 12.51 0.83 17.67z",
      fill: "url(#d)"
    }),
    _react2.default.createElement(
      "linearGradient",
    ...
    _react2.default.createElement(
      "linearGradient",
      {
        ...
        y1: 89.272,
        y2: 89.272,
        gradientTransform: "matrix(.8892 -.1308 .0476 1.1176 5.4939 .9958)",
        gradientUnits: "userSpaceOnUse"
      },
      _react2.default.createElement("stop", {
        stopColor: "#452E16",
    ...
    _react2.default.createElement("path", {
      d:
        "m88.92 117.31c-0.04-0.38-0.09-0.71-0.1-0.77-0.49-1.77-3.14-2.32-4.69-2.66-1.22-0.27-2.46-0.46-3.71-0.56 0 0-2.68-11.11-3.33-13.22-0.55-1.77-1.16-3.79-2.39-5.22-1.93-2.23-5.25-1.84-7.91-1.75-4.34 0.15-8.67 0.76-12.89 1.77-1.39 0.33-3.04 0.78-4.28 1.64-0.8 0.56-1.43 1.3-1.7 2.31-0.38 1.4-0.25 3.07 1.19 3.8 0.92 0.46 2.04 0.45 3.04 0.35 3.49-0.35 6.96-1.02 10.27-2.2 3.12-1.12 5.9-2.8 8.68-4.55 0.4-0.26 1.01-0.71 1.52-0.62 0.66 0.11 6.98 20.63 6.98 20.63l7.4 0.79 1.11 1.02c0.24 0.22 0.51 0.46 0.84 0.47 0.07-0.02 0.03-0.68-0.03-1.23z",
      fill: "url(#a)"
    }),
