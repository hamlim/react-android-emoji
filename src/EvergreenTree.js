...
function EvergreenTree(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("path", {
      d:
        "m67.06 124h-6.11c-3.28 0-5.94-2.66-5.94-5.94v-20.24c0-3.28 2.66-5.94 5.94-5.94h6.11c3.28 0 5.94 2.66 5.94 5.94v20.24c0 3.28-2.66 5.94-5.94 5.94z",
      fill: "url(#e)"
    }),
    _react2.default.createElement(
      "g",
      ...
      _react2.default.createElement("path", {
        d:
          "m67.06 95.28c1.4 0 2.54 1.14 2.54 2.54v20.24c0 1.4-1.14 2.54-2.54 2.54h-6.11c-1.4 0-2.54-1.14-2.54-2.54v-20.24c0-1.4 1.14-2.54 2.54-2.54h6.11m0-3.4h-6.11c-3.28 0-5.94 2.66-5.94 5.94v20.24c0 3.28 2.66 5.94 5.94 5.94h6.11c3.28 0 5.94-2.66 5.94-5.94v-20.24c0-3.28-2.66-5.94-5.94-5.94z",
        fill: "#424242"
      })
    ),
    _react2.default.createElement(
    ...
    _react2.default.createElement("path", {
      d:
        "m114.47 100.14c-33.25 7.14-67.65 6.82-100.74-0.83-3.01-0.75-4.07-3.82-1.75-5.42 15.32-10.87 27.73-25 36.59-37.71 0.57-0.8 1.47-1.29 2.44-1.3 8.68-0.09 17.35-0.18 26.02-0.28 0.96-0.01 1.87 0.46 2.44 1.27 8.81 12.72 21.26 27.19 36.73 38.7 2.33 1.71 1.29 4.86-1.73 5.57z",
      fill: "url(#d)"
    }),
    _react2.default.createElement(
      "g",
    ...
    _react2.default.createElement("path", {
      d:
        "m105.8 78.83c-27.55 5.84-56.02 5.59-83.45-0.66-3.04-0.76-4.03-3.89-1.6-5.48 12.38-8.44 22.37-19.31 29.8-29.13 0.58-0.75 1.45-1.2 2.37-1.21 7.4-0.07 14.79-0.15 22.17-0.22 0.93-0.01 1.8 0.43 2.37 1.18 7.38 9.83 17.4 20.96 29.9 29.89 2.46 1.69 1.5 4.91-1.56 5.63z",
      fill: "url(#c)"
    }),
    _react2.default.createElement(
      "g",
    ...
    _react2.default.createElement("path", {
      d:
        "m93.91 56.98c-19.74 4.02-40.1 3.83-59.75-0.5-3.1-0.78-4.1-3.89-1.62-5.49 9.39-6.41 16.73-14.49 22.35-21.89 0.58-0.75 1.45-1.2 2.37-1.21 4.42-0.05 8.83-0.1 13.24-0.14 0.92-0.01 1.79 0.42 2.36 1.16 5.64 7.39 13.05 15.66 22.61 22.43 2.53 1.69 1.57 4.91-1.56 5.64z",
      fill: "url(#b)"
    }),
    _react2.default.createElement(
      "g",
    ...
    _react2.default.createElement(
      "linearGradient",
      {
        ...
        y2: 18.365,
        gradientTransform:
          "matrix(1.0407 -.0108 -.0108 1.0532 -2.4286 -1.7213)",
        gradientUnits: "userSpaceOnUse"
      },
      _react2.default.createElement("stop", {
        stopColor: "#689F38",
    ...
    _react2.default.createElement("path", {
      d:
        "m66.59 6.05c4.8 6.96 10.86 14.7 19.78 21.15 2.63 1.8 1.41 5.14-2.07 5.89-13.54 2.56-27.43 2.58-40.98-0.14-3.47-0.8-4.65-4.01-1.99-5.72 9.05-6.15 15.26-13.9 20.2-21.06 1.27-1.81 3.82-1.89 5.06-0.12z",
      fill: "url(#a)"
    }),
    _react2.default.createElement(
      "g",
