...
function LyingFace(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m62.99 118.96c-27.47 0-57.03-17.2-57.03-54.96s29.56-54.96 57.03-54.96c15.22 0 29.32 5.04 39.69 14.19 11.35 10.02 17.35 24.11 17.35 40.77 0 16.58-6 30.65-17.35 40.7-10.4 9.2-24.49 14.26-39.69 14.26z"
        fill="url(#b)"
      />
      <path
        d="m62.99 11c14.74 0 28.37 4.87 38.38 13.7 10.91 9.63 16.68 23.22 16.68 39.3 0 16-5.77 29.57-16.69 39.23-10.02 8.88-23.65 13.77-38.37 13.77-14.79 0-28.42-4.83-38.39-13.59-10.91-9.59-16.68-23.22-16.68-39.41 0-16.26 5.77-29.92 16.67-39.48 9.95-8.72 23.59-13.52 38.4-13.52m0-3.93c-30.63 0-59 19.67-59 56.93 0 37.06 28.37 56.93 59 56.93s59-20.38 59-56.93c0-36.75-28.37-56.93-59-56.93z"
        fill="#EB8F00"
      />
      <path
        d="m52.68 105.33c-3.45 0-6.65-1.95-8.34-5.08s-1.52-6.79 0.45-9.78c4.36-6.63 11.09-10.14 19.46-10.14s15.1 3.51 19.46 10.14c1.97 2.99 2.14 6.65 0.45 9.78s-4.88 5.08-8.34 5.08c-1.07 0-2.15-0.19-3.2-0.55-2.72-0.95-5.54-1.43-8.37-1.43-2.84 0-5.65 0.48-8.37 1.43-1.05 0.37-2.13 0.55-3.2 0.55z"
        fill="#242424"
      />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FEE133" offset={0.1356} />
        <stop stopColor="#FDDD32" offset={0.3398} />
        <stop stopColor="#FCD02F" offset={0.5563} />
        <stop stopColor="#F9BB29" offset={0.7777} />
        <stop stopColor="#F6A323" offset={0.9645} />
      </linearGradient>
      <path
        d="m118.9 72.53h-50.8c-3.69 0-6.71-3.02-6.71-6.71s3.02-6.71 6.71-6.71h51.14c3.51 0 6.37 2.87 6.37 6.37v0.34c0.01 3.69-3.01 6.71-6.71 6.71z"
        fill="url(#a)"
      />
      <path
        d="m119.09 57.11h-51.09v4h51.09c2.46 0 4.47 1.95 4.47 4.36v0.37c0 2.59-2.16 4.69-4.81 4.69h-50.75v4h50.75c4.92 0 8.92-3.9 8.92-8.69v-0.37c0-4.61-3.85-8.36-8.58-8.36z"
        fill="#EB8F00"
      />
    </svg>
  );
