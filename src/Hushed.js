  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g fill="#EB8F00" stroke="#EB8F00" strokeMiterlimit={10}>
        <path d="m85.85 32.94c-0.04-0.02-0.09-0.03-0.13-0.05-2.09-0.68-1.74-3.88 0.69-3.6 1.89 0.25 3.8 0.8 5.64 1.66 5.05 2.33 8.82 6.54 10.58 11.1 0.85 2.29-2.19 3.42-3.33 1.54-2.97-4.74-7.74-8.68-13.45-10.65z" />
        <path d="m42.15 32.94c0.04-0.02 0.09-0.03 0.13-0.05 2.09-0.68 1.74-3.88-0.69-3.6-1.89 0.25-3.8 0.8-5.64 1.66-5.05 2.33-8.82 6.54-10.58 11.1-0.85 2.29 2.19 3.42 3.33 1.54 2.97-4.74 7.74-8.68 13.45-10.65z" />
      </g>
      <path
        d="m74.95 88.44c0 5.62-4.56 10.17-10.19 10.17s-10.19-4.55-10.19-10.17 4.56-14.17 10.19-14.17 10.19 8.55 10.19 14.17z"
        fill="#242424"
      />
      <path
        d="m82.74 43.86c4.19 0 8 3.54 8 9.42s-3.81 9.42-8 9.42-8-3.54-8-9.42 3.81-9.42 8-9.42z"
        fill="#242424"
      />
      <path
        d="m45.2 43.86c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42 8-3.54 8-9.42-3.81-9.42-8-9.42z"
        fill="#242424"
      />
    </svg>
  );
