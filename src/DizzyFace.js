...
function DizzyFace(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m102.18 50.48c0.02-8.95-7.22-16.22-16.17-16.24-7.16-0.02-12.98 5.77-12.99 12.93-0.01 5.73 4.62 10.38 10.35 10.39 4.58 0.01 8.3-3.7 8.32-8.28 0.01-3.67-2.96-6.64-6.62-6.65-2.93-0.01-5.32 2.36-5.32 5.3"
        fill="none"
        stroke="#242424"
        strokeLinecap="round"
      ...
      />
      <path
        d="m30.31 33.8c-5.16 7.31-3.41 17.42 3.9 22.58 5.85 4.13 13.94 2.73 18.07-3.12 3.3-4.68 2.18-11.15-2.5-14.45-3.74-2.64-8.92-1.75-11.56 2-2.11 3-1.4 7.14 1.6 9.25 2.4 1.69 5.71 1.12 7.4-1.28"
        fill="none"
        stroke="#242424"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <defs>
        <path
          id="d"
          d="m64 64.87c-16.03 0-33.43 16.18-33.43 36.14 0 5.58 5.31 8.83 10.05 6.56 5.86-2.8 14.49-8.36 23.38-8.36s17.52 5.56 23.38 8.36c4.74 2.27 10.05-0.98 10.05-6.56 0-19.96-18.61-36.14-33.43-36.14z"
        />
      </defs>
      <clipPath id="a">
        <use xlinkHref="#d" />
      ...
      <path
        d="m64 64.87c-16.03 0-33.43 16.18-33.43 36.14 0 5.58 5.31 8.83 10.05 6.56 5.86-2.8 14.49-5.62 23.38-5.62s17.52 2.81 23.38 5.62c4.74 2.27 10.05-0.98 10.05-6.56 0-19.96-18.61-36.14-33.43-36.14z"
        clipPath="url(#a)"
        fill="#242424"
      />
      <path
        d="m64 78.79c11.75 0 22.65 1.84 31.26 5.2v-32.65h-62.51v32.65c8.6-3.36 19.5-5.2 31.25-5.2z"
        clipPath="url(#a)"
        fill="#fff"
      />
      <g clipPath="url(#a)">
        ...
        <g clipPath="url(#b)">
          <path
            d="m64 69.4c6.08 0 13.39 3.54 19.06 9.25 6.35 6.38 9.84 14.32 9.84 22.37 0 1.9-1.23 2.76-2.38 2.76-0.39 0-0.79-0.1-1.19-0.29-3.81-1.82-13.9-6.06-25.33-6.06s-21.52 4.24-25.33 6.06c-0.4 0.19-0.8 0.29-1.19 0.29-1.15 0-2.38-0.86-2.38-2.76 0-17.81 15.53-31.62 28.9-31.62m0-4.53c-16.03 0-33.43 16.18-33.43 36.14 0 4.36 3.24 7.29 6.91 7.29 1.03 0 2.1-0.23 3.14-0.73 5.86-2.8 14.49-5.62 23.38-5.62s17.52 2.81 23.38 5.62c1.04 0.5 2.11 0.73 3.14 0.73 3.67 0 6.91-2.93 6.91-7.29 0-19.96-18.61-36.14-33.43-36.14z"
            fill="#EB8F00"
          />
        </g>
      </g>
