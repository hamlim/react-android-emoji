  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#E3C386" offset={0} />
        <stop stopColor="#EACE94" offset={0.1473} />
        <stop stopColor="#F5E1AC" offset={0.4648} />
        <stop stopColor="#FDEDBB" offset={0.7576} />
        <stop stopColor="#FFF1C0" offset={1} />
      </linearGradient>
      <path
        d="m34.43 102.27c-6.46-2.03-13.92-4.28-19.27-9.63-0.67-1.01-1.24-2.01-1.63-3.05-0.28 5.62 0.48 7.06 3.59 9.65 3.21 2.68 1.43 4.64 8.92 6.78s13.02 5.35 25.33 5.89 21.76 3.51 32.65-0.54c11.06-4.1 19.27-5.35 23.55-8.56 3.5-2.63 8.48-11.33 6.77-15.92-17.63 24.24-54.35 23.41-79.91 15.38z"
        fill="url(#g)"
      />
      <linearGradient
        id="f"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#A5551B" offset={0} />
        <stop stopColor="#E7971C" offset={1} />
      </linearGradient>
      <path
        d="m34.43 102.27c25.66 9.5 77.07 6.56 79.91-15.38-0.38-1.02-1.01-1.92-1.95-2.64-5.17-3.92-36.93-15.16-58.69-13.74s-26.4 5-34.79 9.99c0 0-5 2.5-5.35 8.56-0.01 0.18-0.02 0.34-0.03 0.52 0.39 1.04 1.85 2.94 2.52 3.94 5.36 5.36 11.96 6.61 18.38 8.75z"
        fill="url(#f)"
      />
      <path
        d="m23.55 61.41c-1.07 0.36-3.75 8.38 1.96 11.95s11.42 5.71 16.95 7.49 5.53 3.57 16.06 3.21 11.24 1.25 16.77 1.07 10.53 0 15.16-3.03c4.64-3.03 6.96-2.85 11.42-5.89 4.46-3.03 7.14-3.75 7.85-8.56 0.71-4.82 3.92-13.92-0.18-18.02s-27.12-9.99-45.67-9.1-30.87 9.65-34.61 12.14c-3.75 2.5-5.71 8.74-5.71 8.74z"
        fill="#FFEEBF"
      />
      <linearGradient
        id="e"
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#E7971C" offset={0} />
        <stop stopColor="#A5551B" offset={1} />
      </linearGradient>
      <path
        d="m83.85 47.1c-19.98-1.38-44.78-4.85-65.83 8.48-0.34 0.21-4.89 2.27-6.56 6.1 1.1 19.15 31.41 27.66 48.01 26.52 19.96-1.37 37.23 4.25 49.89-17.73 0.85-0.83 1.54-1.65 2.25-2.28-0.9-4.53-8.36-19.75-27.76-21.09z"
        fill="url(#d)"
      />
      <linearGradient
        id="c"
