...
function Bamboo(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <rect x={55.03} y={21.65} width={18} height={93.45} fill="url(#i)" />
      <path
        d="m72.33 78.52h-16.37c-1.53 0-2.77-1.24-2.77-2.77s1.24-2.77 2.77-2.77h16.37c1.53 0 2.77 1.24 2.77 2.77 0.01 1.53-1.24 2.77-2.77 2.77z"
        fill="#558B2F"
      />
      <path
        d="m72.33 49.19h-16.37c-1.53 0-2.77-1.24-2.77-2.77s1.24-2.77 2.77-2.77h16.37c1.53 0 2.77 1.24 2.77 2.77 0.01 1.53-1.24 2.77-2.77 2.77z"
        fill="#558B2F"
      />
      <linearGradient
        id="h"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#9CCC65" offset={0.00043623} />
        <stop stopColor="#7CB342" offset={0.7329} />
      </linearGradient>
      <rect x={37.21} y={43.45} width={18} height={71.65} fill="url(#h)" />
      <path
        d="m54.63 71.55h-16.32c-1.53 0-2.77-1.24-2.77-2.77s1.24-2.77 2.77-2.77h16.33c1.53 0 2.77 1.24 2.77 2.77s-1.24 2.77-2.78 2.77z"
        fill="#689F38"
      />
      <linearGradient
        id="g"
      ...
      >
        ...
        <stop stopColor="#689F38" offset={0.7338} />
      </linearGradient>
      <rect x={72.28} y={53.64} width={17.75} height={61.46} fill="url(#g)" />
      <path
        d="m89.69 85.49h-17.32c-1.53 0-2.77-1.24-2.77-2.77s1.24-2.77 2.77-2.77h17.33c1.53 0 2.77 1.24 2.77 2.77s-1.24 2.77-2.78 2.77z"
        fill="#689F38"
      />
      <ellipse cx={64.09} cy={19.63} rx={9.38} ry={15.51} fill="#FFF9C4" />
      <radialGradient
        id="f"
        cx={63.986}
        cy={16.929}
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFE0B2" offset={0.263} />
        <stop stopColor="#FFB74D" offset={0.7198} />
      </radialGradient>
      <ellipse cx={64.09} cy={19.63} rx={6.37} ry={10.52} fill="url(#f)" />
      <ellipse cx={46.01} cy={43.45} rx={9.2} ry={15.51} fill="#FFF9C4" />
      <radialGradient
        id="e"
        cx={46.09}
        cy={40.753}
      ...
      <ellipse cx={46.01} cy={43.45} rx={6.24} ry={10.52} fill="url(#e)" />
      <ellipse cx={81.17} cy={55.45} rx={9.36} ry={13.96} fill="#FFF9C4" />
      <radialGradient
        id="d"
        cx={81.061}
        cy={53.023}
      ...
      <ellipse cx={81.17} cy={55.45} rx={6.35} ry={9.47} fill="url(#d)" />
      <linearGradient
        id="c"
        x1={63.622}
        x2={63.622}
      ...
      >
        ...
        <stop stopColor="#FFE082" offset={0.9996} />
      </linearGradient>
      <rect x={37.21} y={95.21} width={52.82} height={18.38} fill="url(#c)" />
      <g fill="#FFA000">
        <rect x={45} y={95} width={2} height={19} />
        <rect x={80} y={95} width={2} height={19} />
        <rect x={71} y={95} width={2} height={19} />
        <rect x={62} y={95} width={2} height={19} />
        <rect x={54} y={95} width={2} height={19} />
      </g>
      <g opacity={0.2}>
        <path
