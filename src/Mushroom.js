  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FF7A86" offset={0.0049261} />
        <stop stopColor="#DE121C" offset={0.8128} />
        <stop stopColor="#EE000C" offset={1} />
      </radialGradient>
      <path
        d="m105.36 73.96c0.65-0.34 1.29-0.71 1.9-1.13 5.75-3.96 7.48-10.84 7.27-17.5-0.72-22.95-16.83-43.48-39-49.6-21.58-5.95-44.58 6.35-55.3 25.26-4.21 7.42-6.49 15.82-6.75 24.35-0.26 8.3 2.71 16.03 10.76 19.37 0.08 0.03 0.15 0.06 0.23 0.09 6.02-11.22 62.52-13.9 80.89-0.84z"
        fill="url(#c)"
      />
      <defs>
        <path
      ...
      <g clipPath="url(#a)" fill="#FFD9CF">
        <ellipse cx={61.92} cy={35.14} rx={12.58} ry={8.77} />
        <ellipse cx={28.4} cy={29.13} rx={9.93} ry={7.17} />
        <ellipse cx={29.1} cy={56.07} rx={9.76} ry={8.04} />
        <ellipse cx={95.46} cy={54.29} rx={8.19} ry={7.15} />
        <ellipse
