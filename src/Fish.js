  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#C9E6F5" offset={0.1948} />
        <stop stopColor="#5FB4E2" offset={0.594} />
        <stop stopColor="#1C94D6" offset={0.8708} />
        <stop stopColor="#0288D1" offset={1} />
      </linearGradient>
      <path
        d="m83.35 41.37c-8.46-2.97-18.09-5.19-27.48-7.17 6.97-4.96 19.98-10.67 26.59-10.67 1.54 0 2.65 0.32 3.12 0.9 0.39 0.48 0.46 1.29 0.22 2.4-0.82 3.72-1.9 9.91-2.45 14.54z"
        fill="url(#d)"
      />
      <path
        d="m82.46 25.03c1.48 0 1.92 0.32 1.93 0.32 0.01 0.02 0.12 0.33-0.06 1.16-0.72 3.29-1.64 8.47-2.23 12.85-7.02-2.34-14.73-4.2-22.39-5.87 7.04-4.25 17.37-8.46 22.75-8.46m0-3c-8.21 0-24.27 7.78-30.02 12.98 10.55 2.2 22.33 4.75 32.21 8.42 0.42-4.54 1.68-11.98 2.62-16.28 0.79-3.69-1.29-5.12-4.81-5.12z"
        fill="#258ECC"
      />
      <linearGradient
        id="c"
      ...
      >
        <stop stopColor="#fff" offset={0} />
        <stop stopColor="#FCFDFE" offset={0.1406} />
        <stop stopColor="#F2F9FD" offset={0.2559} />
        <stop stopColor="#E0F1F9" offset={0.3624} />
        <stop stopColor="#C8E5F5" offset={0.4635} />
        <stop stopColor="#A9D7EF" offset={0.5609} />
        <stop stopColor="#83C5E8" offset={0.6555} />
        <stop stopColor="#55AFE0" offset={0.7478} />
        <stop stopColor="#2297D7" offset={0.836} />
        <stop stopColor="#0288D1" offset={0.8849} />
      </linearGradient>
      <path
        d="m88.01 102.71c-5.17 0-14.24-2.99-19.65-5.88 5.36-2.09 10.59-4.85 15.67-7.53 1.05-0.55 2.09-1.1 3.12-1.64 0.81 3.1 2.24 7.44 3.26 10.5 0.27 0.83 0.52 1.56 0.71 2.15 0.17 0.52 0.31 1.21 0.03 1.6-0.14 0.19-0.77 0.8-3.14 0.8z"
        fill="url(#c)"
      />
      <path
        d="m86.2 89.85c0.81 2.81 1.9 6.12 2.78 8.77 0.27 0.83 0.52 1.56 0.71 2.15 0.03 0.1 0.05 0.18 0.07 0.25-0.29 0.09-0.83 0.19-1.75 0.19-4.04 0-10.82-2.02-15.98-4.28 4.34-1.89 8.56-4.12 12.7-6.3 0.49-0.27 0.98-0.52 1.47-0.78m1.97-4.41c-7.39 3.78-15.23 8.34-23.26 11.04 4.57 3.29 16.4 7.73 23.09 7.73 3.47 0 5.56-1.19 4.54-4.36-1.05-3.25-3.7-10.93-4.37-14.41z"
        fill="#258ECC"
      />
      <linearGradient
        id="b"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#fff" offset={0.0029626} />
        <stop stopColor="#A9D1E9" offset={0.3089} />
        <stop stopColor="#50A1D1" offset={0.6463} />
        <stop stopColor="#1883C3" offset={0.8842} />
        <stop stopColor="#0277BD" offset={0.9985} />
      </linearGradient>
      <path
        d="m59.62 107.32c-4.07 0-13.88-8.49-18.86-15.19 0.3 0.05 0.59 0.1 0.89 0.15 6.82 1.17 13.86 2.37 20.82 2.61-0.66 3.55-1.17 7.35-1.42 10.46-0.16 1.97-0.92 1.97-1.43 1.97z"
        fill="url(#b)"
      />
      <path
        d="m44.44 94.27c5.35 0.9 10.8 1.73 16.25 2.04-0.52 3.09-0.93 6.26-1.14 8.92-0.02 0.26-0.06 0.45-0.09 0.58-2.93-0.2-10.02-5.89-15.02-11.54m-6.83-4.2c3.73 6.63 16.25 18.74 22.01 18.74 1.64 0 2.73-0.98 2.92-3.35 0.29-3.75 0.96-8.26 1.73-12.04-8.83-0.08-17.64-1.85-26.66-3.35z"
        fill="#258ECC"
      />
      <linearGradient
        id="a"
