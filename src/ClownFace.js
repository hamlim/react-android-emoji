  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#FCFCFC" offset={0.6126} />
        <stop stopColor="#F1F1F1" offset={0.7091} />
        <stop stopColor="#DFDFDF" offset={0.7997} />
        <stop stopColor="#C7C7C7" offset={0.8861} />
        <stop stopColor="#C2C2C2" offset={0.9} />
      </linearGradient>
      <path
        d="m63.99 119.76c-27.85 0-57.83-17.44-57.83-55.73s29.98-55.73 57.83-55.73c15.44 0 29.73 5.11 40.24 14.39 11.51 10.16 17.59 24.45 17.59 41.34 0 16.81-6.08 31.08-17.59 41.27-10.54 9.32-24.83 14.46-40.24 14.46z"
        fill="url(#f)"
      />
      <path
        d="m63.99 10.29c14.95 0 28.77 4.93 38.92 13.89 11.06 9.77 16.91 23.54 16.91 39.84 0 16.22-5.85 29.98-16.92 39.77-10.17 9-23.99 13.96-38.91 13.96-14.99 0-28.82-4.89-38.92-13.78-11.06-9.72-16.91-23.53-16.91-39.95 0-16.48 5.84-30.32 16.9-40.02 10.08-8.84 23.91-13.71 38.93-13.71m0-4c-31.06 0-59.83 19.95-59.83 57.73 0 37.58 28.77 57.73 59.83 57.73s59.83-20.67 59.83-57.73c0-37.26-28.77-57.73-59.83-57.73z"
        fill="#B0ABA3"
      />
      <radialGradient
        id="e"
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FF4900" offset={0} />
        <stop stopColor="#E30C00" offset={1} />
      </radialGradient>
      <circle
        cx={63.99}
        cy={66}
