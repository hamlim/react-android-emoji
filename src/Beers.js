  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <linearGradient
        ...
        y1={43.394}
        y2={108.64}
        gradientTransform="matrix(-.9934 -.1144 -.1144 .9934 167.8 10.533)"
      ...
      <path
        d="m32.73 38.42 44.58 5.14 3.62 0.41-7.02 53.18c-1.03 8.96-17.17 10.48-26.76 9.38-9.59-1.11-24.64-6.31-23.61-15.27l5.48-53.27 3.71 0.43z"
        fill="url(#h)"
      />
      <g opacity={0.2}>
        <path
          d="m31.01 40.45 1.47 0.17 22.29 2.57 22.3 2.57 1.38 0.15-6.73 50.98c-0.28 2.45-2.29 4.39-5.97 5.78-3.35 1.26-7.93 1.95-12.89 1.95-1.87 0-3.75-0.1-5.45-0.3-4.08-0.47-10.17-1.89-15-4.45-3.27-1.74-7.09-4.59-6.65-8.39l5.25-51.03m-1.98-2.47-5.48 53.27c-1.03 8.96 14.01 14.16 23.61 15.27 1.73 0.2 3.67 0.31 5.7 0.31 9.22 0 20.21-2.35 21.06-9.69l7.02-53.18-3.62-0.41-44.58-5.14-3.71-0.43z"
          fill="#424242"
        />
      </g>
      <linearGradient
      ...
      <path
        d="m33.96 40.32-5.16 48.05c0 1.69 1.18 3.45 2.95 4.52 3.16 1.92 9.52 4.18 16.75 5.01 6.9 0.8 12.94 0.1 16.51-0.95 2.27-0.66 4.22-2.3 4.66-3.85l5.73-48.01-41.44-4.77z"
        fill="url(#g)"
      />
      <g fill="#E4A324">
        <circle cx={58.51} cy={93.79} r={1} />
        <circle cx={61.01} cy={91.32} r={0.69} />
        <circle cx={56.78} cy={89.54} r={1.21} />
        <circle cx={61.09} cy={88.79} r={1.24} />
        <circle cx={57.74} cy={83.05} r={1} />
        <circle cx={60.29} cy={83.83} r={0.89} />
        <circle cx={64.69} cy={78.59} r={0.89} />
        <circle cx={56.84} cy={72.37} r={1.12} />
        <circle cx={61.5} cy={81.1} r={1.37} />
        <circle cx={58.42} cy={76.51} r={1.35} />
        <circle cx={63.16} cy={75.4} r={1} />
      </g>
      <linearGradient
        id="f"
        x1={143.92}
      ...
      <linearGradient
        ...
        y1={59.986}
        y2={121.56}
        gradientTransform="matrix(.9934 -.1144 .1144 .9934 -6.7954 10.533)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#eee" offset={0.0051299} />
        <stop stopColor="#EAEAEA" offset={0.2817} />
      ...
      <path
        d="m96.18 60.58 4.96 45.25c0 1.59-1.12 3.26-2.79 4.27-2.98 1.81-8.98 3.94-15.81 4.73-6.52 0.75-12.21 0.09-15.59-0.9-2.14-0.63-3.98-2.17-4.4-3.63l-5.5-45.21 39.13-4.51z"
        fill="url(#c)"
      />
      <g fill="#E4A324">
        <circle cx={73.11} cy={110.94} r={0.94} />
        <circle cx={70.74} cy={108.61} r={0.65} />
        <circle cx={74.74} cy={106.94} r={1.14} />
        <circle cx={70.68} cy={106.22} r={1.17} />
        <circle cx={73.84} cy={100.81} r={0.94} />
        <circle cx={71.42} cy={101.54} r={0.84} />
        <circle cx={67.28} cy={96.6} r={0.84} />
        <circle cx={74.69} cy={90.73} r={1.06} />
        <circle cx={70.28} cy={98.97} r={1.29} />
        <circle cx={73.19} cy={94.63} r={1.27} />
        <circle cx={68.72} cy={93.59} r={0.94} />
      </g>
      <linearGradient
        id="b"
        x1={110.24}
      ...
      <path
        d="m101.76 87.21 1.94 18.27 2.29 2.08s1.84-1.93 9.08-4.54c8.32-3.01 9.92-6.59 8.67-21.4-1.43-16.97-6.13-18.05-11.32-18.35-6.07-0.35-9.12-3.32-9.12-3.32l-4.06 3.52 2.52 23.74zm5.57-4.05c-0.65-5.63-1.18-10.2 3.14-10.7s4.84 4.07 5.49 9.7 1.18 10.2-3.14 10.7c-4.05 0.47-4.84-4.06-5.49-9.7z"
        fill="url(#b)"
      />
      <g opacity={0.2}>
        <path
          d="m103.39 62.64c1.66 1.06 4.65 2.49 8.9 2.73 3.94 0.23 8.01 0.46 9.36 16.43 1.22 14.54-0.39 16.76-7.3 19.25-4.28 1.55-6.8 2.88-8.24 3.8l-0.42-0.38-1.85-17.48-2.42-22.65 1.97-1.7m8.88 32.35c0.26 0 0.53-0.02 0.8-0.05 2.04-0.23 4.6-1.32 5.26-5.15 0.38-2.2 0.06-4.96-0.28-7.87-0.66-5.7-1.34-11.59-6.95-11.59-0.28 0-0.57 0.02-0.86 0.05-2.04 0.23-4.6 1.32-5.26 5.15-0.38 2.2-0.06 4.96 0.27 7.87 0.56 4.89 1.34 11.59 7.02 11.59m-8.98-35.03-4.06 3.52 2.54 23.73 1.94 18.27 2.29 2.08s1.84-1.93 9.08-4.54c8.32-3.01 9.92-6.59 8.67-21.4-1.43-16.97-6.13-18.05-11.32-18.35-6.08-0.34-9.14-3.31-9.14-3.31zm8.98 32.94c-3.57 0-4.32-4.37-4.94-9.74-0.65-5.63-1.18-10.2 3.14-10.7 0.22-0.02 0.42-0.04 0.62-0.04 3.75 0 4.26 4.39 4.87 9.74 0.65 5.63 1.18 10.2-3.14 10.7-0.19 0.03-0.37 0.04-0.55 0.04z"
          fill="#424242"
        />
      </g>
      <path
        d="m95.04 104.41c-1.63 0.41-3.25-0.72-3.44-2.39l-2.88-25.02c-0.16-1.4 0.75-2.71 2.13-3.03 1.63-0.39 3.22 0.73 3.42 2.39l2.88 25.02c0.14 1.4-0.76 2.7-2.11 3.03z"
        fill="#fff"
        fillOpacity={0.72}
        opacity={0.51}
      />
      <path
        d="m87.04 109.41c-1.63 0.41-3.25-0.72-3.44-2.39l-2.88-25.02c-0.16-1.4 0.75-2.71 2.13-3.03 1.63-0.39 3.22 0.73 3.42 2.39l2.88 25.02c0.14 1.4-0.76 2.7-2.11 3.03z"
        fill="#fff"
        fillOpacity={0.72}
        opacity={0.51}
      />
