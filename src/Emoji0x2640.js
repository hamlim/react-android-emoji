...
function Emoji0x2640(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#C71FFF" offset={0} />
        <stop stopColor="#BE1BF2" offset={0.2936} />
        <stop stopColor="#A710D0" offset={0.8358} />
        <stop stopColor="#9F0CC4" offset={1} />
      </linearGradient>
      <path
