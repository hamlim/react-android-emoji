  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#E35C6E" offset={0.1591} />
        <stop stopColor="#EC855D" offset={0.4687} />
        <stop stopColor="#FAC742" offset={0.8948} />
        <stop stopColor="#FAC742" offset={0.8977} />
      </linearGradient>
      <path
      ...
      <path
        d="m64.83 119.4c-27.86 0-57.84-17.44-57.84-55.74s29.98-55.74 57.84-55.75c15.44 0 29.73 5.11 40.25 14.39 11.51 10.16 17.59 24.46 17.59 41.35 0 16.82-6.08 31.09-17.59 41.27-10.54 9.34-24.84 14.48-40.25 14.48z"
        fill="url(#a)"
      />
      <path
        d="m64.83 9.91c14.95 0 28.77 4.93 38.92 13.89 11.07 9.77 16.92 23.55 16.92 39.85 0 16.23-5.85 29.98-16.92 39.78-10.18 9.01-24 13.96-38.92 13.96-15 0-28.82-4.89-38.93-13.78-11.06-9.72-16.91-23.54-16.91-39.95 0-16.49 5.85-30.34 16.91-40.03 10.08-8.85 23.91-13.72 38.93-13.72m0-4c-31.07 0-59.84 19.95-59.84 57.74 0 37.58 28.77 57.74 59.84 57.74s59.84-20.67 59.84-57.74c0-37.27-28.77-57.74-59.84-57.74z"
        fill="#CC2362"
      />
      <path
