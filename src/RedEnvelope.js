...
function RedEnvelope(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#FF1908" offset={0.00066106} />
        <stop stopColor="#F71A09" offset={0.2725} />
        <stop stopColor="#E01B0E" offset={0.7034} />
        <stop stopColor="#CC1D11" offset={1} />
      </linearGradient>
      ...
      <path
        d="m84.31 24.79h-40.62c-5.17 0-9.4-4.23-9.4-9.4v-6.16c0-5.17 4.23-9.4 9.4-9.4h40.61c5.17 0 9.4 4.23 9.4 9.4v6.16c0.01 5.17-4.22 9.4-9.39 9.4z"
        clipPath="url(#a)"
        fill="#A1001E"
      />
      <path
        d="m71.69 28.52c0.53-0.98 0.83-3.09 0.83-4.24 0-4.15-3.82-7.52-8.53-7.52s-8.53 3.37-8.53 7.52c0 1.16 0.3 3.27 0.83 4.24h15.4z"
        clipPath="url(#a)"
        fill="#A1001E"
      />
      <line
      ...
      <g opacity={0.2}>
        <path
          d="m88.96 11.82v104.36h-49.92v-104.36h49.92m2.82-2.82h-55.56v110h55.56v-110z"
          fill="#424242"
        />
      </g>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFD500" offset={0.00066106} />
        <stop stopColor="#FFCD00" offset={0.3082} />
        <stop stopColor="#FFB600" offset={0.7958} />
        <stop stopColor="#fa0" offset={1} />
      </linearGradient>
      <path
        d="m64 48c9.76 0 17.67 7.91 17.67 17.67s-7.91 17.66-17.67 17.66-17.67-7.91-17.67-17.67 7.91-17.66 17.67-17.66m0-2.84c-11.31 0-20.51 9.2-20.51 20.51s9.2 20.5 20.51 20.5 20.51-9.2 20.51-20.51-9.2-20.5-20.51-20.5z"
        fill="url(#d)"
      />
      <linearGradient
        id="c"
      ...
      >
        <stop stopColor="#FFD500" offset={0.00066106} />
        <stop stopColor="#FBCD00" offset={0.1152} />
        <stop stopColor="#F1B600" offset={0.2972} />
        <stop stopColor="#E39700" offset={0.4854} />
        <stop stopColor="#EAA700" offset={0.5924} />
        <stop stopColor="#F9C800" offset={0.8563} />
        <stop stopColor="#FFD500" offset={1} />
      </linearGradient>
      <linearGradient
        id="b"
        x1={50.346}
