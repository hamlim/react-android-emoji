...
function Emoji8ball(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#616262" offset={0.5} />
        <stop stopColor="#212121" offset={0.9927} />
      </radialGradient>
      <path
        d="M63.88,4C30.76,4.06,3.94,30.98,4,64.12C4.07,97.25,30.99,124.06,64.13,124 c33.13-0.07,59.94-26.98,59.87-60.11C123.95,30.75,97.03,3.93,63.88,4z"
        fill="url(#c)"
      />
      <radialGradient
        id="b"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#eee" offset={0.4945} />
        <stop stopColor="#BDBDBD" offset={0.9973} />
      </radialGradient>
      <path
        d="m92.93 63.95c0.03 15.97-12.9 28.95-28.87 28.98-15.98 0.03-28.96-12.9-28.99-28.87-0.03-15.98 12.9-28.96 28.87-28.98 15.98-0.04 28.97 12.89 28.99 28.87z"
        fill="url(#b)"
      />
      <radialGradient
        id="a"
