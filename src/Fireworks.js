  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFF9C4" offset={0.1884} />
        <stop stopColor="#FFF176" offset={1} />
      </radialGradient>
      <path
        d="m94.65 32.89-17.24 17.59c-0.68 0.69-0.14 1.84 0.84 1.79l24.9-1.25c1.32-0.07 1.59 1.79 0.31 2.09l-24.24 5.7c-0.95 0.22-1.14 1.47-0.29 1.95l21.64 12.1c1.14 0.64 0.35 2.34-0.9 1.92l-23.54-8.01c-0.93-0.32-1.77 0.64-1.32 1.49l11.51 21.6c0.61 1.14-1 2.16-1.82 1.14l-15.3-19.08c-0.61-0.77-1.87-0.39-1.94 0.59l-2.34 50.64c-0.09 1.32-2.08 1.32-2.16 0l-2.39-50.63c-0.06-0.97-1.32-1.35-1.94-0.58l-15.27 19.1c-0.81 1.02-2.42 0-1.82-1.14l11.46-21.62c0.45-0.85-0.4-1.8-1.32-1.49l-23.53 8.05c-1.24 0.43-2.04-1.28-0.9-1.92l21.61-12.14c0.85-0.48 0.67-1.73-0.29-1.95l-24.25-5.65c-1.28-0.3-1.01-2.15 0.31-2.09l24.9 1.2c0.98 0.05 1.52-1.1 0.84-1.79l-17.27-17.56c-0.91-0.93 0.34-2.35 1.41-1.6l20.29 14.17c0.8 0.56 1.88-0.13 1.7-1.07l-4.81-23.9c-0.25-1.26 1.58-1.79 2.07-0.6l9.22 22.63c0.36 0.89 1.65 0.89 2.02 0l9.18-22.64c0.49-1.2 2.33-0.67 2.07 0.59l-4.76 23.9c-0.19 0.94 0.9 1.62 1.7 1.06l20.25-14.2c1.06-0.74 2.32 0.68 1.41 1.61z"
        fill="url(#a)"
      />
      <path
        d="m66.8 10.14c-0.46 3.77-2.95 10.39-2.95 10.39s-2.81-6.45-3.34-10.39 1.41-5.91 3.15-5.91 3.6 2.15 3.14 5.91z"
        fill="#FFF9C4"
      />
      <path
        d="m92 17.6c-2.4 2.98-8.06 7.36-8.06 7.36s1.04-6.94 2.69-10.57 4.36-4.33 5.84-3.44c1.48 0.88 1.93 3.66-0.47 6.65z"
        fill="#FFF9C4"
      />
      <path
        d="m110.6 38.16c-3.58 1.47-10.71 2.61-10.71 2.61s4.36-5.57 7.61-7.96 5.96-1.71 6.82-0.24c0.85 1.48-0.15 4.13-3.72 5.59z"
        fill="#FFF9C4"
      />
      <path
        d="m117.5 67.22c-3.81-0.73-10.38-3.67-10.38-3.67s6.8-2.25 10.86-2.46 5.93 1.82 5.79 3.52c-0.13 1.69-2.47 3.34-6.27 2.61z"
        fill="#FFF9C4"
      />
      <path
        d="m103.56 94.14c-2.78-2.64-6.65-8.6-6.65-8.6s6.95 1.73 10.48 3.72 3.95 4.69 2.9 6.03c-1.07 1.35-3.95 1.49-6.73-1.15z"
        fill="#FFF9C4"
      />
      <path
        d="m76.09 110.1c-0.66-3.74-0.2-10.78-0.2-10.78s4.58 5.4 6.23 9.03 0.37 6.06-1.29 6.54c-1.66 0.49-4.07-1.05-4.74-4.79z"
        fill="#FFF9C4"
      />
      <path
        d="m45.46 108.42c1.64-3.44 6.13-8.97 6.13-8.97s0.61 6.98-0.15 10.89c-0.76 3.9-3.23 5.19-4.88 4.66-1.66-0.53-2.74-3.14-1.1-6.58z"
        fill="#FFF9C4"
      />
      <path
        d="m20.36 88.57c3.22-2.12 9.99-4.58 9.99-4.58s-3.17 6.29-5.89 9.25-5.51 2.81-6.64 1.52-0.68-4.07 2.54-6.19z"
        fill="#FFF9C4"
      />
      <path
        d="m9.97 61.11c3.88 0.1 10.86 1.94 10.86 1.94s-6.32 3.32-10.29 4.19-6.15-0.84-6.31-2.53c-0.16-1.7 1.86-3.71 5.74-3.6z"
        fill="#FFF9C4"
      />
      <path
        d="m19.38 33.39c3.24 2.09 8.16 7.26 8.16 7.26s-7.16-0.45-11-1.77-4.77-3.89-3.98-5.41c0.78-1.52 3.58-2.18 6.82-0.08z"
        fill="#FFF9C4"
      />
      <path
        d="m40.29 15.15c1.36 3.55 2.23 10.56 2.23 10.56s-5.52-4.48-7.83-7.75-1.51-5.89 0.03-6.66c1.55-0.79 4.21 0.29 5.57 3.85z"
        fill="#FFF9C4"
      />
      <g opacity={0.2}>
