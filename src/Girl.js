  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        >
          <stop stopColor="#232020" offset={0} />
          <stop stopColor="#262322" offset={0.4373} />
          <stop stopColor="#2E2B2B" offset={0.7002} />
          <stop stopColor="#3C3938" offset={0.9163} />
          <stop stopColor="#444140" offset={1} />
        </linearGradient>
        <path
          d="m16.53 123.82 1.58-7.48-13.79 3.44s-0.97-13.3 10.9-20.98c13.01-8.42 27.99 0.55 27.99 0.55s-1.47 10.04-10.38 18.69c-6 5.81-16.3 5.78-16.3 5.78z"
          fill="url(#f)"
        />
        <path
          d="m27.73 95.2v3c5.07 0 9.58 1.67 12.02 2.77-0.89 3.13-3.26 9.33-9.02 14.92-2.95 2.86-7.31 4.06-10.42 4.57l0.74-3.49c0.21-1.01-0.11-2.06-0.85-2.78-0.57-0.55-1.31-0.84-2.08-0.84-0.24 0-0.49 0.03-0.73 0.09l-9.83 2.45c0.62-3.96 2.67-10.28 9.29-14.57 3.2-2.07 6.86-3.12 10.88-3.12v-3m0 0c-4 0-8.36 0.92-12.51 3.6-11.87 7.68-10.9 20.98-10.9 20.98l13.79-3.44-1.58 7.48c0.2 0 10.35-0.03 16.28-5.78 8.91-8.64 10.38-18.69 10.38-18.69s-6.92-4.15-15.46-4.15z"
          fill="#1F1D1B"
        />
        <linearGradient
          id="e"
        ...
        <path
          d="m111.47 123.82-1.58-7.48 13.79 3.44s0.97-13.3-10.9-20.98c-13.01-8.42-27.99 0.55-27.99 0.55s1.47 10.04 10.38 18.69c6 5.81 16.3 5.78 16.3 5.78z"
          fill="url(#e)"
        />
        <path
          d="m100.27 98.2c4.02 0 7.68 1.05 10.88 3.12 6.66 4.31 8.7 10.61 9.31 14.57l-9.85-2.46c-0.24-0.06-0.48-0.09-0.73-0.09-0.77 0-1.52 0.29-2.08 0.84-0.74 0.72-1.07 1.77-0.85 2.78l0.74 3.49c-3.11-0.5-7.47-1.71-10.42-4.57-5.72-5.55-8.11-11.78-9.01-14.92 2.44-1.1 6.95-2.76 12.01-2.76m0-3c-8.54 0-15.47 4.16-15.47 4.16s1.47 10.04 10.38 18.69c5.93 5.75 16.08 5.78 16.28 5.78l-1.58-7.48 13.79 3.44s0.97-13.3-10.9-20.98c-4.14-2.7-8.5-3.61-12.5-3.61z"
          fill="#1F1D1B"
        />
      </g>
      <g clipPath="url(#a)">
        <path
          d="m26.79 95.34c-7.6 0-13.79-5.94-13.79-13.23 0-7.3 6.18-13.23 13.79-13.23h75.43c7.29 0 12.79 5.69 12.79 13.23s-5.5 13.23-12.79 13.23h-75.43z"
          fill="#3C2B24"
        />
        <path
          d="m102.21 69.87c6.72 0 11.79 5.26 11.79 12.23s-5.07 12.23-11.79 12.23h-75.42c-7.05 0.01-12.79-5.48-12.79-12.22s5.74-12.23 12.79-12.23h75.42m0-2.01h-75.42c-8.14 0-14.79 6.41-14.79 14.24s6.65 14.23 14.79 14.23h75.43c8.13 0 13.79-6.41 13.79-14.23s-5.66-14.24-13.8-14.24z"
          fill="#291B16"
        />
      </g>
      <g clipPath="url(#a)">
      ...
      <path
        d="m75.01 97.97c-4.19 2.49-17.91 2.49-22.1 0-2.4-1.43-4.86 0.76-3.86 2.94 0.98 2.15 8.47 7.13 14.95 7.13 6.47 0 13.87-4.98 14.85-7.13 0.99-2.19-1.43-4.37-3.84-2.94z"
        clipPath="url(#a)"
        fill="#1A1717"
      />
      <g clipPath="url(#a)">
        <radialGradient
          ...
          cy={-74.689}
          r={61.429}
          gradientTransform="matrix(1.0432 0 0 1.0432 3.2332 3.2251)"
          gradientUnits="userSpaceOnUse"
        >
