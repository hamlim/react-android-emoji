  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#81D4FA" offset={0.4702} />
        <stop stopColor="#7BD2FA" offset={0.5492} />
        <stop stopColor="#6CCDF9" offset={0.6502} />
        <stop stopColor="#51C4F8" offset={0.763} />
        <stop stopColor="#2DB7F6" offset={0.8836} />
        <stop stopColor="#03A9F4" offset={1} />
      </radialGradient>
      <rect x={16} y={24} width={92} height={68} fill="url(#h)" />
      <linearGradient
        id="a"
        x1={64}
        x2={64}
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#4DB6AC" offset={0} />
        <stop stopColor="#4AB5AA" offset={0.2539} />
        <stop stopColor="#3FB0A5" offset={0.4718} />
        <stop stopColor="#2DA99D" offset={0.6765} />
        <stop stopColor="#159F92" offset={0.8719} />
        <stop stopColor="#009688" offset={1} />
      </radialGradient>
      <path
        d="m72.48 54.15c-2.89-4.43-3.66-4.32-6.44-5.13-2.77-0.81-2.77-7.59-5.05-7.59-1.09 0-1.94-2.22-3.01-3.82-0.6-0.89-1.26-1.6-2.08-1.61-3.08-0.05-9.72 12.18-11.06 13.26-1.27 1.02-2.71 0.82-3.95 0.98-0.98 0.13-1.88 0.57-2.56 1.28-5.03 5.19-14.33 24.48-14.33 24.48h63.2c-1.97-0.77-9.5-13.85-14.72-21.85z"
        fill="url(#g)"
        opacity={0.8}
      />
      <radialGradient
      ...
      >
        ...
        <stop stopColor="#52AC56" offset={0.6026} />
        <stop stopColor="#43A047" offset={1} />
      </radialGradient>
      <path
        d="m90.1 57.52c-1.95 0.24-2.93 1.1-5-2.2-2.07-3.29-4.15-8.66-6.16-8.66-0.17 0-0.38 0.07-0.61 0.17-4.57 2.06-19.49 23.88-22.51 29.17h48.18s-11.95-18.72-13.9-18.48z"
        fill="url(#f)"
      />
      <path
        d="m75.24 57.95c0.08-0.2-0.2-0.35-0.33-0.18-1.74 2.31-8.35 8.77-10.84 11.6-0.24 0.28 0.07 0.68 0.4 0.53 1.01-0.47 3.05-1.63 3.24-2.06 0.27-0.62 1.86-2.19 2.36-2.68 0.1-0.1 0.2-0.19 0.3-0.27l2-1.66c0.39-0.32 0.71-0.73 0.92-1.19l1.95-4.09z"
        fill="#81C784"
        opacity={0.2}
      />
      <path
        d="m77.65 62.93c0.1-0.14-0.04-0.32-0.2-0.25l-1.91 0.84c-0.15 0.1-0.26 0.23-0.33 0.39l-2.39 4.92c-0.04 0.2 0.24 0.3 0.33 0.12l4.5-6.02z"
        fill="#81C784"
        opacity={0.2}
      />
      <path
        d="m52.23 45.7c0.05-0.28-0.34-0.41-0.47-0.15-1.68 3.44-8.63 13.48-11.13 17.78-0.24 0.42 0.26 0.87 0.65 0.59 1.2-0.86 3.55-2.88 3.68-3.49 0.19-0.88 1.86-3.31 2.39-4.07 0.1-0.15 0.21-0.29 0.33-0.43l2.17-2.66c0.42-0.52 0.73-1.13 0.9-1.77l1.48-5.8z"
        fill="#4DB6AC"
        opacity={0.2}
      />
      <path
        d="m43.87 54.42c0.15-0.17-0.02-0.43-0.24-0.36l-2.62 0.88c-0.2 0.11-0.37 0.27-0.48 0.47l-3.72 6.19c-0.08 0.26 0.27 0.43 0.42 0.2l6.64-7.38z"
        fill="#4DB6AC"
        opacity={0.2}
      />
      <path
        d="m88.95 67.15c0.13 0.08 0.27-0.09 0.17-0.2-1.35-1.51-4.89-6.91-6.5-8.99-0.16-0.2-0.48-0.05-0.42 0.2 0.18 0.76 0.71 2.31 0.98 2.5 0.39 0.27 1.25 1.57 1.52 1.98l0.15 0.24 0.87 1.59c0.17 0.31 0.41 0.58 0.69 0.79l2.54 1.89z"
        fill="#81C784"
        opacity={0.2}
      />
      <path
        d="m88.24 62.7c-0.06-0.11 0.04-0.13 0.17-0.04l2.15 1.6c0.16 0.08 0.31 0.21 0.41 0.35l2.22 3.21-1.68-1.56c-0.08-0.07-0.17-0.08-0.14-0.01l0.99 2.6c0.04 0.11-0.15 0.06-0.49 0l-3.63-6.15z"
        fill="#81C784"
        opacity={0.2}
      />
      <path
        d="m56.59 46.39c-0.04-0.19 0.12-0.19 0.27 0l2.69 3.28c0.21 0.18 0.4 0.44 0.49 0.69l2.17 5.77-1.98-3.04c-0.09-0.14-0.22-0.18-0.21-0.06l0.52 4.37c0.01 0.19-0.26 0.04-0.74-0.19l-3.21-10.82z"
        fill="#4DB6AC"
        opacity={0.2}
      />
      <linearGradient
      ...
      >
        ...
        <stop stopColor="#378C3B" offset={0.6026} />
      ...
      >
        ...
        <stop stopColor="#84BC47" offset={0.2466} />
        <stop stopColor="#72AA3D" offset={0.5981} />
        <stop stopColor="#689F38" offset={0.7526} />
        <stop stopColor="#689F38" offset={1} />
      </radialGradient>
      <rect x={24} y={76} width={80} height={32} fill="url(#b)" />
      <path
        d="m89.19 91.89h-0.92c-0.51 0-0.92-0.41-0.92-0.92v-4.59h2.76v4.59c0 0.51-0.41 0.92-0.92 0.92z"
        fill="#795548"
      />
      <radialGradient
        id="o"
      ...
      >
        ...
        <stop stopColor="#039BE5" offset={0.401} />
        <stop stopColor="#0A87D8" offset={0.6491} />
        <stop stopColor="#1565C0" offset={1} />
      </linearGradient>
      <path
        d="m60.25 95.67c9.52-4.48 15.75-8.8-6.17-13.33-17.11-3.55-17.73-6.34-17.73-6.34h-6.63c-0.39 3.67 7.73 6.26 15.43 8.77 7.67 2.5 14.17 4.57-2.15 9.17-11.9 3.35-17.4 8.26-16.15 14.06h45.33c-16.66-2.76-20.01-8.53-11.93-12.33z"
        fill="url(#n)"
      />
      <path
        d="m34.43 87.2h-0.78c-0.43 0-0.78-0.35-0.78-0.78v-3.89h2.34v3.89c0 0.43-0.35 0.78-0.78 0.78z"
        fill="#795548"
      />
      <radialGradient
        id="m"
      ...
      <polygon points="6.5 18 21.83 29.5 21.83 98.5 6.5 110" fill="url(#l)" />
      <linearGradient
        id="k"
        x1={64}
        x2={64}
      ...
      <polygon points="6.5 18 21.83 29.5 106.17 29.5 121.5 18" fill="url(#k)" />
      <linearGradient
        id="j"
        x1={125.17}
        x2={105.32}
      ...
      />
      <path
        d="m119 21v86h-110v-86h110m1-5h-112c-2.21 0-4 1.79-4 4v88c0 2.21 1.79 4 4 4h112c2.21 0 4-1.79 4-4v-88c0-2.21-1.79-4-4-4z"
        fill="#FFCA28"
      />
      <g opacity={0.2}>
        <path
          d="m120 19c0.55 0 1 0.45 1 1v88c0 0.55-0.45 1-1 1h-112c-0.55 0-1-0.45-1-1v-88c0-0.55 0.45-1 1-1h112m0-3h-112c-2.21 0-4 1.79-4 4v88c0 2.21 1.79 4 4 4h112c2.21 0 4-1.79 4-4v-88c0-2.21-1.79-4-4-4z"
          fill="#424242"
        />
      </g>
    </svg>
