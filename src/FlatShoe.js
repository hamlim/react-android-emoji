...
function FlatShoe(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#87FFDE" offset={0} />
        <stop stopColor="#63B59D" offset={1} />
      </linearGradient>
      <path
        d="m7.55 90.07c-4.69 0.74-5.07 25.2 0.87 27.52s15.64 2.46 29.26 2.46 25.41 1.38 29.5 1.98c8.74 1.28 24.46 1.78 35.07-1.84 10.42-3.55 18.62-6.95 21.42-11.2 0 0 2.61-4.34-6.57-8.21-7.2-3.03-13.03-4.15-24.72-2.8-11.68 1.35-26.55 1.26-37.95-0.58s-39.59-8.49-46.88-7.33z"
        fill="url(#d)"
      />
      <defs>
        <path
          id="c"
          d="m7.55 90.07c-4.69 0.74-5.07 25.2 0.87 27.52s15.64 2.46 29.26 2.46 25.44 1.21 29.5 1.98 24.91 1.93 35.15-2.12 18.54-6.66 21.34-10.91c0 0 2.61-4.34-6.57-8.21-7.2-3.03-13.03-4.15-24.72-2.8-11.68 1.35-26.55 1.26-37.95-0.58s-39.59-8.5-46.88-7.34z"
        />
      </defs>
      <clipPath id="b">
        <use xlinkHref="#c" />
