...
function Bikini(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#E91E63" offset={0} />
        <stop stopColor="#F06292" offset={0.567} />
      </radialGradient>
      <path
      ...
      <g clipPath="url(#a)">
        ...
        <radialGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#F06292" offset={0.433} />
          <stop stopColor="#E91E63" offset={1} />
        </radialGradient>
        <path
          d="m58.27 49.84c-6.47-3.47-21.21-12.63-25.78-30.19 1.22-12.24 11.43-24.61 21.69-30.54 3-1.73 0.29-6.39-2.72-4.65-10.18 5.89-19.83 17.05-23.21 28.99-4.76 8.45-13.44 26.23-9.83 38.07 6.46 21.2 30.47 13.91 39.4 9.98 2.3-1.01 3.8-3.26 3.86-5.77 0.07-2.45-1.25-4.73-3.41-5.89z"
          fill="url(#c)"
        />
        <radialGradient
          id="b"
        ...
        <path
          d="m99.99 13.84c-3.3-12.11-13.13-23.45-23.46-29.38-3.01-1.73-5.72 2.92-2.72 4.65 10.19 5.85 20.4 18.01 21.8 30.16-4.42 17.81-19.25 27.07-25.73 30.57-2.15 1.16-3.46 3.43-3.4 5.88 0.06 2.51 1.57 4.77 3.87 5.78 8.93 3.93 32.94 11.22 39.39-9.98 3.55-11.66-4.9-29.09-9.75-37.68z"
          fill="url(#b)"
        />
        <g fill="#D81B60">
          <path d="m46.06 52.95c-0.16 0.93 0.35 1.79 3.64 2.34s8.26-0.35 8.26-0.35-4.41-2.47-7.7-3.02c-3.28-0.55-4.04 0.1-4.2 1.03z" />
          <path d="m46.18 59.79c0.24 0.91 1.06 1.49 4.28 0.62 3.22-0.86 7.38-3.74 7.38-3.74s-5.04-0.42-8.26 0.44-3.64 1.76-3.4 2.68z" />
          <path d="m81.94 52.95c0.16 0.93-0.35 1.79-3.64 2.34s-8.26-0.35-8.26-0.35 4.41-2.47 7.7-3.02c3.28-0.55 4.04 0.1 4.2 1.03z" />
          <path d="m81.82 59.79c-0.24 0.91-1.06 1.49-4.28 0.62-3.22-0.86-7.38-3.74-7.38-3.74s5.04-0.42 8.26 0.44 3.64 1.76 3.4 2.68z" />
        </g>
        <ellipse
