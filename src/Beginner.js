...
function Beginner(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m61.5 34-39-29.12c-2.62-2.09-6.5-0.23-6.5 3.13v82.07c0 1.22 0.55 2.36 1.5 3.12l44 29.92c0.73 0.58 1.61 0.88 2.5 0.88v-89.12c-0.88 0-1.77-0.29-2.5-0.88z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      >
        ...
        <stop stopColor="#2BA296" offset={0.4722} />
        <stop stopColor="#00897B" offset={1} />
      </linearGradient>
      <path
        d="m105.5 4.88-39 29.12c-0.73 0.58-1.61 0.88-2.5 0.88v89.12c0.88 0 1.77-0.29 2.5-0.88l44-29.92c0.95-0.76 1.5-1.91 1.5-3.12v-82.07c0-3.36-3.88-5.22-6.5-3.13z"
        fill="url(#a)"
      />
      <g opacity={0.2}>
        <path
