  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        >
          <stop stopColor="#3B78E7" offset={0.0032478} />
          <stop stopColor="#386EDA" offset={0.2231} />
          <stop stopColor="#3052B8" offset={0.6286} />
          <stop stopColor="#283593" offset={1} />
        </linearGradient>
        <path
      ...
      <g clipPath="url(#a)">
        <path
          d="m51.31 97.61 2.71-0.25c0.52 2.33 2.37 6.1 4.13 8.23 1.37 1.65 3.03 2.9 4.15 3.64l-10.99 9.35v-20.97z"
          fill="#3674CE"
        />
        <path
          d="m53.28 98.43c0.75 2.48 2.44 5.79 4.1 7.79 1.04 1.26 2.25 2.3 3.29 3.07l-8.36 7.11v-17.88l0.97-0.09m1.6-2.16-4.57 0.42v24.04l13.69-11.64s-2.95-1.59-5.07-4.15c-2.1-2.52-4.05-7.07-4.05-8.67z"
          fill="#2E51B0"
        />
        <path
          d="m65.7 109.22c1.11-0.74 2.78-1.99 4.15-3.64 1.76-2.12 3.61-5.9 4.13-8.23l2.71 0.25v20.96l-10.99-9.34z"
          fill="#3674CE"
        />
        <path
          d="m74.72 98.43 0.97 0.09v17.89l-8.36-7.11c1.03-0.77 2.24-1.82 3.29-3.07 1.66-2.02 3.35-5.32 4.1-7.8m-1.6-2.16c0 1.6-1.95 6.15-4.04 8.67-2.12 2.56-5.07 4.15-5.07 4.15l13.69 11.64v-24.04l-4.58-0.42z"
          fill="#2E51B0"
        />
      </g>
      <path
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#666" offset={0.0040219} />
        <stop stopColor="#606060" offset={0.0985} />
        <stop stopColor="#3F3F3F" offset={0.6803} />
        <stop stopColor="#333" offset={1} />
      </linearGradient>
      <path
        d="m63.74 44.18c-22.51-0.15-33.39-6.6-36.54-8.89 2.22-2.56 10.66-9.57 36.54-9.57 25.68 0 34.55 6.52 37 9.01-3.29 2.45-14.51 9.3-37 9.45z"
        fill="url(#b)"
      />
      <path
        d="m63.74 27.22c21.68 0 31 4.67 34.57 7.37-1.37 0.87-3.33 1.96-5.96 3.06-5.39 2.24-14.74 4.94-28.59 5.03-19.39-0.13-29.91-4.99-34.2-7.61 3.33-2.82 12.32-7.85 34.18-7.85m0-3c-33.25 0-38.58 11.36-38.58 11.36s10.25 9.91 38.58 10.1c28.33-0.19 39.11-10.73 39.11-10.73s-5.86-10.73-39.11-10.73z"
        fill="#2A2A2B"
      />
      <linearGradient
        id="j"
      ...
      >
        <stop stopColor="#3B78E7" offset={0.0032478} />
        <stop stopColor="#3B77E6" offset={0.0115} />
        <stop stopColor="#335BC2" offset={0.2985} />
        <stop stopColor="#2D46A8" offset={0.5675} />
        <stop stopColor="#293998" offset={0.8091} />
        <stop stopColor="#283593" offset={1} />
      </linearGradient>
      <path
        d="m23.58 34.5c1.57 6.19 3.07 8.81 3.07 8.81 1.6-2 11.06-11.31 37.29-11.31h0.11 0.03c26.22 0 35.26 9.36 36.85 11.36 0 0 1.9-2.8 3.47-8.99 3.65-14.32-14.39-30.37-40.35-30.37-25.9 0-44.09 16.2-40.47 30.5z"
        fill="url(#j)"
      />
      <defs>
        <path
