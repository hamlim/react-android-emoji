...
function Mag(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g opacity={0.2}>
        <path
          d="m64.98 60.37 29.56 29.72-4.22 4.24-29.56-29.72 4.22-4.24m0-4.26-8.45 8.49 33.79 33.98 8.45-8.49-33.79-33.98z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      <ellipse cx={44.81} cy={45.03} rx={40.81} ry={41.03} fill="url(#d)" />
      <radialGradient
        id="c"
        cx={83.25}
        cy={72.5}
      ...
      <path
        d="m87.19 77.1-9.99 10.05c-1.13 1.14-2.96 1.14-4.09 0l-0.96-0.97c-1.13-1.14-1.13-2.98 0-4.11l9.99-10.05c1.13-1.14 2.96-1.14 4.09 0l0.96 0.97c1.13 1.14 1.13 2.98 0 4.11z"
        fill="url(#a)"
      />
      <g opacity={0.2}>
        <path
          d="m84.18 73.17c0.14 0 0.4 0.03 0.63 0.26l0.96 0.97c0.35 0.36 0.35 0.93 0 1.29l-9.99 10.05c-0.23 0.23-0.49 0.26-0.63 0.26s-0.4-0.03-0.63-0.26l-0.96-0.97c-0.35-0.36-0.35-0.93 0-1.29l9.99-10.05c0.23-0.22 0.5-0.26 0.63-0.26m0-2c-0.74 0-1.48 0.28-2.04 0.85l-9.99 10.05c-1.13 1.14-1.13 2.98 0 4.11l0.96 0.97c0.56 0.57 1.3 0.85 2.04 0.85s1.48-0.28 2.04-0.85l9.99-10.05c1.13-1.14 1.13-2.98 0-4.11l-0.96-0.97c-0.56-0.56-1.3-0.85-2.04-0.85z"
          fill="#424242"
        />
      </g>
    </svg>
