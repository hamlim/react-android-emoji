  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#B65B25" offset={0.1578} />
        <stop stopColor="#9F552A" offset={0.4072} />
        <stop stopColor="#7A4C33" offset={0.7149} />
        <stop stopColor="#52423C" offset={0.9987} />
      </radialGradient>
      <ellipse cx={63.86} cy={77.31} rx={45.01} ry={18.09} fill="url(#f)" />
      <linearGradient
        id="e"
        x1={22.114}
        x2={102.08}
      ...
      >
        ...
        <stop stopColor="#FF7DA9" offset={0.3169} />
        <stop stopColor="#FF669A" offset={0.8164} />
        <stop stopColor="#FF5C93" offset={1} />
      </linearGradient>
      <path
        d="m102.08 51.48c-0.84-0.85-1.87-1.65-3.1-2.35 0 0-28.68 9.33-48.64 8.32s-17.02-3.19-27.16 3.27c0 0-2.77 3.96 0.61 6.37 4.42 3.15 10 5.75 16.12 7.73 0.74-0.54 1.48-0.88 2.11-0.88 19.03-6.61 56.05 1.77 60.06-22.46z"
        fill="url(#e)"
      />
      <path
        d="m102.08 51.48c-4.01 24.23-41.03 15.85-60.05 22.46-0.63 0-1.37 0.33-2.11 0.88 15.35 4.96 34.13 5.97 46.67 1.8 15.75-5.22 22.86-17.67 15.49-25.14z"
        fill="#EB5E8E"
      />
      <linearGradient
        id="d"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFB0CB" offset={0.0026442} />
        <stop stopColor="#F383A9" offset={0.7919} />
        <stop stopColor="#F0769F" offset={1} />
      </linearGradient>
      <path
        d="m93.95 33.63s5.43 3.22 5.43 11.55-6.93 19.13-37.68 16.04c-30.48-3.07-38.35-0.47-38.35-0.47s-9.34-12.68 10.18-12.61c17.47 0.06 43.45 2.12 49.57-1.76 9.11-5.8 9.45-5.96 10.85-12.75z"
        fill="url(#d)"
      />
      <path
        d="m58.45 27.44c9.46-5.91 8.95-14.5 4.44-21.81-0.49 0.28-0.78 0.87-0.53 1.48 0.99 2.38 1.87 5.74 0.27 8-2.71 3.82-7.73 4.79-15.94 9.37-7.83 4.36-10.84 8.52-11.39 13.74-0.05 0.49 0.23 0.96 0.69 1.19 0.88 0.44 2.56 1.16 5.1 1.82 2.76-6.83 11.07-10.65 17.36-13.79z"
        fill="#F77CA5"
      />
      <linearGradient
        id="c"
      ...
      >
        ...
        <stop stopColor="#F78FB2" offset={0.3346} />
        <stop stopColor="#F878A3" offset={0.8618} />
        <stop stopColor="#F9719F" offset={0.9995} />
      </linearGradient>
      <path
        d="m79.09 16.45c-4.23-4.56-9.23-8.28-15.02-10.88-0.42-0.19-0.85-0.13-1.19 0.06 4.51 7.3 5.02 15.89-4.44 21.81-6.28 3.14-14.59 6.96-17.36 13.79 2.76 0.72 6.54 1.37 11.46 1.52 12.06 0.36 28.31-0.3 31.07-5.03 2.77-4.72 0.46-15.9-4.52-21.27z"
        fill="url(#c)"
      />
      <path
        d="m93.1 32c0.23-0.58 0.4-1.18 0.52-1.78-3.24-4.96-10.82-6.48-10.82-6.48 8.22 17.5-34.56 13.69-46.68 14.41-5.16 0.31-8.12 2.58-9.83 5.1 2.53-1.32 5.49-2.05 8.46-3.04 19.14-4.56 50.14 14.59 58.35-8.21z"
        fill="#F79EBC"
      />
      <linearGradient
        id="b"
      ...
      >
        ...
        <stop stopColor="#F887AD" offset={0.2719} />
        <stop stopColor="#FC709F" offset={0.7027} />
        <stop stopColor="#FF5C93" offset={1} />
      </linearGradient>
      <path
        d="m94.82 32.96c-0.24-1.01-0.66-1.92-1.2-2.74-0.12 0.61-0.29 1.2-0.52 1.78-8.21 22.8-39.21 3.65-58.36 8.21-2.96 0.99-5.93 1.71-8.46 3.04-2.31 3.39-2.32 7.21-2.32 7.21 12.47-3.78 21.67 0.02 45.64 0.37 23.97 0.33 26.94-10.71 25.22-17.87z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <g
        ...
        strokeWidth={3}
      >
        <line x1={28.5} x2={34.5} y1={85.5} y2={111.25} opacity={0.56} />
        <line x1={99.5} x2={93.5} y1={85.58} y2={111.5} opacity={0.56} />
      </g>
      <g
        fill="none"
        stroke="#49A5B0"
        ...
        strokeWidth={3}
      >
        <line x1={40.96} x2={44.46} y1={89.58} y2={115.08} opacity={0.56} />
        <line x1={87.04} x2={83.54} y1={88.67} y2={114.17} opacity={0.56} />
      </g>
      <g
        fill="none"
        stroke="#49A5B0"
        ...
        strokeWidth={3}
      >
        <line x1={51.83} x2={54.17} y1={91} y2={117.17} opacity={0.56} />
        <line x1={76.17} x2={73.83} y1={90.08} y2={116.25} opacity={0.56} />
      </g>
      <line
        x1={64.17}
        x2={64.5}
