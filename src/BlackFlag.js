...
function BlackFlag(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m124 107.2c-41.55 17.8-78.49-17.79-120 0v-86.4c41.51-17.79 78.45 17.8 120 0v86.4z"
        fill="#424242"
      />
      <linearGradient
        id="a"
      ...
      >
        ...
        <stop stopColor="#C8C8C8" stopOpacity={0.1646} offset={0.1646} />
        <stop stopColor="#828282" stopOpacity={0.3934} offset={0.3934} />
        <stop stopColor="#4A4A4A" stopOpacity={0.5997} offset={0.5997} />
        <stop stopColor="#222" stopOpacity={0.7759} offset={0.7759} />
        <stop stopColor="#090909" stopOpacity={0.9151} offset={0.9151} />
        <stop offset={1} />
      </linearGradient>
      <path
        d="m124 107.2c-41.55 17.8-78.49-17.79-120 0v-86.4c41.51-17.79 78.45 17.8 120 0v86.4z"
      ...
      <g opacity={0.2}>
        <path
          d="m121 25.48v80.4c-39.6 14.15-74.43-17.5-114-3.36v-80.4c39.57-14.14 74.4 17.51 114 3.36m3-4.68c-41.55 17.8-78.49-17.79-120 0v86.4c41.51-17.79 78.45 17.8 120 0v-86.4z"
          fill="#eee"
        />
      </g>
      <g fill="#fff">
