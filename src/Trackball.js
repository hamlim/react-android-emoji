...
function Trackball(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="m147-14.12v52.12h4v-52.12c-0.66-0.03-1.33-0.05-2-0.05s-1.34 0.02-2 0.05z"
        fill="#757575"
      />
      <linearGradient
        id="f"
      ...
      <path
        d="m103.75 55.79c0 33.11-20.12 67.96-40.12 67.96s-40.13-34.84-40.13-67.96 17.96-39.96 40.12-39.96 40.13 6.85 40.13 39.96z"
        fill="url(#f)"
      />
      <path
        d="m40.86 20h-0.01c-8.23 4-14.23 11.12-16.43 24h5.87c1.44 0 2.73-0.87 3.29-2.21 2.01-4.8 5.15-9.02 9.07-12.32 1.32-1.11 1.72-2.96 0.91-4.47-0.95-1.78-1.97-3.66-2.7-5z"
        fill="#212121"
        opacity={0.5}
      />
      <path
        d="m86.39 20h0.01c8.23 4 14.23 11.12 16.43 24h-5.87c-1.44 0-2.73-0.87-3.29-2.21-2.01-4.8-5.15-9.02-9.07-12.32-1.32-1.11-1.72-2.96-0.91-4.47 0.96-1.78 1.97-3.66 2.7-5z"
        fill="#212121"
        opacity={0.5}
      />
      <g opacity={0.2}>
        <path
          d="m63.62 18.83c12.23 0 20.65 2.19 26.49 6.9 7.16 5.77 10.63 15.6 10.63 30.06 0 15.35-4.43 31.7-12.15 44.88-7.37 12.57-16.7 20.08-24.97 20.08s-17.61-7.51-24.97-20.08c-7.72-13.17-12.15-29.53-12.15-44.88 0-14.46 3.48-24.3 10.63-30.06 5.85-4.7 14.26-6.9 26.49-6.9m0-3c-22.16 0-40.12 6.84-40.12 39.96s20.12 67.96 40.12 67.96 40.12-34.84 40.12-67.96-17.95-39.96-40.12-39.96z"
          fill="#eee"
        />
      </g>
      <circle cx={63.62} cy={54} r={24.81} fill="#212121" opacity={0.3} />
      <linearGradient
        id="e"
        x1={63.625}
        x2={63.625}
      ...
      <circle cx={63.62} cy={54} r={20} fill="url(#e)" />
    </svg>
  );
}
