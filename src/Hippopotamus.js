...
function Hippopotamus(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g fill="#F7F1E3">
        <path d="m25.04 118.79-0.41-0.12c-1.79-0.52-2.82-2.4-2.29-4.19l1.41-4.8c0.52-1.79 2.4-2.82 4.19-2.29l0.41 0.12c1.79 0.52 2.82 2.4 2.29 4.19l-1.41 4.8c-0.52 1.79-2.4 2.82-4.19 2.29z" />
        <path d="m102.96 118.79 0.41-0.12c1.79-0.52 2.82-2.4 2.29-4.19l-1.41-4.8c-0.52-1.79-2.4-2.82-4.19-2.29l-0.41 0.12c-1.79 0.52-2.82 2.4-2.29 4.19l1.41 4.8c0.52 1.79 2.4 2.82 4.19 2.29z" />
      </g>
      <linearGradient
        id="h"
        x1={14.568}
      ...
      >
        <stop stopColor="#E4C7FF" offset={0} />
        <stop stopColor="#997FB3" offset={1} />
      </linearGradient>
      <path
        d="m31.6 27.65c0.38-0.21 0.74-0.43 1.06-0.65 1.04-0.72 2.43-1.97 2.16-3.41-0.42-2.22-5.24-2.77-7.06-3.4-1.87-0.65-3.66-1.53-5.31-2.62-0.16-0.1-0.31-0.22-0.47-0.34-1.36-1.06-2.8-2.72-4.58-2.46-2.03 0.28-2.93 2.77-2.82 4.81 0.05 0.87 0.22 1.72 0.49 2.54 4.43 3.97 10.55 5.81 16.53 5.53z"
        fill="url(#h)"
      />
      <path
        d="m15.07 22.12c1.26 3.81 4.73 6.89 8.73 7.43 2.42 0.32 5.52-0.63 7.8-1.9-5.98 0.28-12.1-1.56-16.53-5.53z"
        fill="#F7F1E3"
      />
      <linearGradient
        id="g"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#997FB3" offset={0} />
        <stop stopColor="#E4C7FF" offset={1} />
      </linearGradient>
      <path
        d="m96.4 27.65c-0.38-0.21-0.74-0.43-1.06-0.65-1.04-0.72-2.43-1.97-2.16-3.41 0.42-2.22 5.24-2.77 7.06-3.4 1.87-0.65 3.66-1.53 5.31-2.62 0.16-0.1 0.31-0.22 0.47-0.34 1.36-1.06 2.8-2.72 4.58-2.46 2.03 0.28 2.93 2.77 2.82 4.81-0.05 0.87-0.22 1.72-0.49 2.54-4.43 3.97-10.55 5.81-16.53 5.53z"
        fill="url(#g)"
      />
      <path
        d="m112.93 22.12c-1.26 3.81-4.73 6.89-8.73 7.43-2.42 0.32-5.52-0.63-7.8-1.9 5.98 0.28 12.1-1.56 16.53-5.53z"
        fill="#F7F1E3"
      />
      <linearGradient
        id="f"
      ...
      <path
        d="m68.28 100.46h-8.56c-24.54 0-44.61-16.72-44.61-41.25v-3.52c0-24.54 20.08-44.61 44.61-44.61h8.56c24.54 0 44.61 20.08 44.61 44.61v3.52c0 24.53-20.07 41.25-44.61 41.25z"
        fill="url(#f)"
      />
      <linearGradient
        id="e"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#DECEF2" offset={0.00082131} />
        <stop stopColor="#CBBBDF" offset={0.5148} />
        <stop stopColor="#BDADD1" offset={0.9972} />
      </linearGradient>
      <path
        d="m64 115.24c-39.73 0-57.67-13.91-57.67-27.48s15.66-27.95 57.67-27.95 57.67 14.37 57.67 27.95-17.94 27.48-57.67 27.48z"
        fill="url(#e)"
      />
      <path
        ...
        fill="#A37DC7"
      />
      <circle cx={38.39} cy={54.5} r={3.49} />
      <circle cx={89.61} cy={54.5} r={3.49} />
      <path
        d="m64 72.89"
        fill="none"
        stroke="#AF8DCD"
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F5EDFF" offset={0} />
        <stop stopColor="#DBCBEF" offset={1} />
      </linearGradient>
      <path
        d="m26.2 81.47c-6.29-1.91-10.07-7.81-8.44-13.18s8.05-8.18 14.34-6.27 10.07 7.81 8.44 13.18-8.05 8.18-14.34 6.27z"
        fill="url(#d)"
      />
      <linearGradient
        id="c"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#3B393D" offset={0.213} />
        <stop stopColor="#343235" offset={0.3967} />
        <stop stopColor="#1F1E20" offset={0.6764} />
        <stop offset={0.9979} />
      </linearGradient>
      <path
        d="m28.9 73.72c-2.61-1.89-3.85-4.64-2.76-6.13 1.08-1.5 4.08-1.18 6.69 0.72 2.61 1.89 3.85 4.64 2.76 6.13-1.08 1.49-4.08 1.17-6.69-0.72z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <path
        d="m101.8 81.47c6.29-1.91 10.07-7.81 8.44-13.18s-8.05-8.18-14.34-6.27-10.07 7.81-8.44 13.18 8.05 8.18 14.34 6.27z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m99.1 73.72c2.61-1.89 3.85-4.64 2.76-6.13-1.08-1.5-4.08-1.18-6.69 0.72-2.61 1.89-3.85 4.64-2.76 6.13 1.08 1.49 4.08 1.17 6.69-0.72z"
        fill="url(#a)"
      />
      <g fill="#9785AB">
        <path d="m37.76 88.79c-1.08 0-1.96 0.88-1.96 1.96s0.88 1.96 1.96 1.96 1.96-0.88 1.96-1.96-0.88-1.96-1.96-1.96z" />
        ...
        <path d="m97.38 91.87c-1.08 0-1.96 0.88-1.96 1.96s0.88 1.96 1.96 1.96 1.96-0.88 1.96-1.96-0.88-1.96-1.96-1.96z" />
