  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        ...
        <stop stopColor="#989898" offset={0.2308} />
        <stop stopColor="#888" offset={0.5354} />
        <stop stopColor="#6C6C6C" offset={0.8799} />
      ...
      >
        ...
        <stop stopColor="#CBCBCB" offset={0.6431} />
      ...
      <g clipPath="url(#f)">
        ...
        <path
          d="m11.45 83.06c5.52-2.19 12.93-4.02 21.61-5.32l27.43 13.16-49.04-7.84z"
          fill="url(#e)"
        />
        <path
          d="m32.97 78.3 24 11.51-43.47-6.95c5.21-1.86 11.85-3.41 19.47-4.56m0.17-1.1c-9.73 1.45-17.88 3.55-23.61 6.09l54.47 8.71-30.86-14.8z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="d"
        ...
        />
        <path
          d="m9.68 84.39 41 6.55h-48.96c0.68-2.22 3.44-4.5 7.96-6.55m-0.15-1.1c-5.73 2.55-9.03 5.53-9.03 8.71h63.5l-54.47-8.71z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="c"
        ...
        <path
          d="M94.94,77.75c8.67,1.3,16.09,3.12,21.61,5.32L67.51,90.9L94.94,77.75z"
          fill="url(#c)"
        />
        <path
          d="m95.03 78.3c7.63 1.15 14.26 2.71 19.47 4.56l-43.47 6.95 24-11.51m-0.17-1.1-30.86 14.8 54.47-8.71c-5.73-2.54-13.88-4.64-23.61-6.09z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="b"
        ...
        />
        <path
          d="m62.94 76.13v14.19l-26.17-12.55c8.15-1.04 17.1-1.6 26.17-1.64m1.06-1.06c-11.2 0-21.72 0.78-30.86 2.13l30.86 14.8v-16.93z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="a"
        ...
        />
        <path
          d="m65.06 76.13c9.07 0.04 18.02 0.6 26.17 1.64l-26.17 12.55v-14.19m-1.06-1.06v16.93l30.86-14.8c-9.14-1.36-19.66-2.13-30.86-2.13z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="r"
        ...
        />
        <path
          d="M50.67,93.06l-41,6.55c-4.52-2.05-7.28-4.33-7.96-6.55H50.67 M64,92H0.5 c0,3.18,3.3,6.16,9.03,8.71L64,92L64,92z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="q"
        ...
        />
        <path
          d="m126.28 93.06c-0.68 2.22-3.44 4.51-7.96 6.55l-41-6.55h48.96m1.22-1.06h-63.5l54.47 8.71c5.73-2.55 9.03-5.53 9.03-8.71z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="p"
        ...
        <path
          d="m33.06 106.25c-8.67-1.3-16.09-3.12-21.61-5.32l49.04-7.84-27.43 13.16z"
          fill="url(#p)"
        />
        <path
          d="m56.98 94.19-24 11.51c-7.63-1.15-14.26-2.71-19.47-4.56l43.47-6.95m7.02-2.19-54.47 8.71c5.72 2.54 13.88 4.65 23.61 6.09l30.86-14.8z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="o"
        ...
        />
        <path
          d="m118.32 84.39c4.52 2.05 7.28 4.33 7.96 6.55h-48.95l40.99-6.55m0.15-1.1-54.47 8.71h63.5c0-3.18-3.3-6.16-9.03-8.71z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="n"
        ...
        <path
          d="M67.51,93.1l49.04,7.84c-5.52,2.19-12.94,4.02-21.61,5.32L67.51,93.1z"
          fill="url(#n)"
        />
        <path
          d="M71.02,94.19l43.47,6.95c-5.21,1.85-11.84,3.41-19.47,4.56L71.02,94.19 M64,92l30.86,14.8 c9.73-1.45,17.88-3.55,23.61-6.09L64,92L64,92z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="m"
        ...
        />
        <path
          d="M65.06,93.68l26.17,12.55c-8.15,1.04-17.1,1.6-26.17,1.64V93.68 M64,92v16.93 c11.2,0,21.72-0.78,30.86-2.13L64,92L64,92z"
          fill="#BDBDBD"
        />
        <linearGradient
          id="l"
        ...
        />
        <path
          d="m62.94 93.68v14.19c-9.07-0.04-18.02-0.6-26.17-1.64l26.17-12.55m1.06-1.68-30.86 14.8c9.14 1.36 19.66 2.13 30.86 2.13v-16.93z"
          fill="#BDBDBD"
        />
      </g>
      <path
        d="m109.26 96c1.77-1.25 2.74-2.6 2.74-4 0-6.63-21.49-12-48-12s-48 5.37-48 12c0 1.4 0.97 2.75 2.74 4 6.59-4.66 24.36-8 45.26-8s38.67 3.34 45.26 8z"
        fill="#9E9E9E"
      />
      <radialGradient
        id="k"
      ...
      >
        ...
        <stop stopColor="#49C0F6" offset={0.178} />
        <stop stopColor="#38B7F2" offset={0.4176} />
        <stop stopColor="#1CA8EB" offset={0.6911} />
        <stop stopColor="#039BE5" offset={0.8886} />
      ...
      <g opacity={0.2}>
        <path
          d="m64 82c30.2 0 46 6.51 46 10 0 0.65-0.69 1.51-1.9 2.37-6.35 4.49-24.49 7.63-44.1 7.63s-37.75-3.14-44.1-7.63c-1.21-0.86-1.9-1.72-1.9-2.37 0-3.49 15.8-10 46-10m0-2c-26.51 0-48 5.37-48 12 0 1.4 0.97 2.75 2.74 4 6.59 4.66 24.36 8 45.26 8s38.67-3.34 45.26-8c1.77-1.25 2.74-2.6 2.74-4 0-6.63-21.49-12-48-12z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m64 77c35.29 0 59 7.76 59 15s-23.71 15-59 15-59-7.76-59-15 23.71-15 59-15m0-1c-33.14 0-60 7.16-60 16s26.86 16 60 16 60-7.16 60-16-26.86-16-60-16z"
          fill="#424242"
        />
      </g>
      <ellipse cx={64} cy={95.44} rx={9.38} ry={2.23} fill="#81D4FA" />
      <g fill="#424242">
        <ellipse cx={10} cy={103.75} rx={2.83} ry={1.42} opacity={0.2} />
        <ellipse cx={25.67} cy={109} rx={3.33} ry={1.25} opacity={0.2} />
        <ellipse cx={17.5} cy={111.67} rx={2.33} ry={1.25} opacity={0.2} />
        <ellipse cx={50.83} cy={110.33} rx={3.67} ry={0.94} opacity={0.2} />
        <ellipse cx={64.67} cy={116.9} rx={3.67} ry={0.94} opacity={0.2} />
        <ellipse cx={80.25} cy={114.75} rx={4.25} ry={1.58} opacity={0.2} />
      </g>
      <path
        d="m8.15 43.27s4.16 1.7 4.49-2.57c0.1-1.3-0.3-3.45-0.94-4.59-1.15-2.07-3.11-6.1-1.05-12.17 0.12-0.35-13.17 11.8-2.5 19.33z"
        fill="#03A9F4"
        opacity={0.8}
      />
      <path
        d="m118.28 32.17c3.09 2.93 9.11 9.89 3.25 15.12 0 0-5.95 2.34-4.63-5.97 0.7-4.37 0.6-7.06 0.36-8.62-0.09-0.58 0.6-0.93 1.02-0.53z"
        fill="#03A9F4"
        opacity={0.8}
      />
      <path
        d="m116.29 70.36c7.14-6.68-1.87-18.98-1.91-18.33-0.24 3.92-2.01 9.62-3.68 11.44-1.28 1.38-2.04 3.2-2.04 5.08 0.01 2.63 1.57 3.38 3.07 3.51 1.68 0.13 3.34-0.56 4.56-1.7z"
        fill="#039BE5"
        opacity={0.8}
      />
      <linearGradient
