...
function MeatOnBone(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("path", {
      d:
        "m96.15 71.67c-1.01 1.7-0.7 3.72-0.52 5.58s0.04 4.09-1.46 5.36c-0.87-0.76-0.81-2.2-0.73-3.45 0.34-5.25-0.14-10.45-1.43-15.35-0.17-0.66 4.01-1.29 4.41-1.27 1.62 0.06 3.51 0.77 4.4 2.15 2.01 3.11-3.31 4.7-4.67 6.98z",
      fill: "url(#d)"
    }),
    _react2.default.createElement(
      "radialGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m77.7 96.5c0.03-0.93-0.19-1.85-0.01-2.78 0.54-2.76 4.09-4 5.36-6.57 0.14-0.28 0.24-0.64 0.05-0.84-0.24-0.25-0.68-0.04-0.99 0.17-3.42 2.33-6.99 4.82-9.04 8.46-0.74 1.31-1.25 2.73-2.02 4.03s-1.87 2.52-3.25 2.95c1.97-0.62 3.78-2.24 5.89-2.82 1.82-0.49 3.91 0.12 4.01-2.6z",
      fill: "url(#a)"
    }),
    _react2.default.createElement(
      "radialGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m106.47 69.69c-0.34 0.64-0.15 1.38 0.06 2.02 0.36 1.12 0.66 2.3 1.11 3.37 0.47-0.77 0.17-1.86-0.01-2.65-0.09-0.35-1.22-2.63-1.16-2.74z",
      fill: "url(#o)"
    }),
    _react2.default.createElement(
      "radialGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m84.81 102.73c-0.6 0.2-1.23 0.28-1.82 0.52-1.01 0.41-1.83 1.24-2.79 1.78s-2.27 0.71-2.85-0.12c-0.36-0.51-0.32-1.23-0.27-1.9 0.17-2.12 0.36-4.34 1.49-6.24 1-0.27 1.47 1.3 2.47 1.33 0.61 0.01 1.13-0.55 1.6-1.01 1.23-1.21 3.02-2.08 4.48-1.54 1.12 0.41 1.82 1.66 1.64 2.94-0.2 1.55-2.51 3.76-3.95 4.24z",
      fill: "url(#n)"
    }),
    _react2.default.createElement(
      "radialGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m81.86 69.55c-0.45 0.48-0.91 0.98-1.48 1.28s-1.29 0.35-1.73-0.04c-0.37-0.33 4.53-4.67 5.73-4.05-0.68 1-1.68 1.9-2.52 2.81z",
      fill: "url(#m)"
    }),
    _react2.default.createElement(
      "radialGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m64.22 89.17c-0.23 0.12-0.61 0.16-0.6-0.09 0.06-1.09 0.85-2.11 1.8-2.69s2.04-0.78 3.1-0.85c0.9-0.07 2.03-0.18 2.81-0.09-2.36 1.28-4.75 2.48-7.11 3.72z",
      fill: "url(#j)"
    }),
    _react2.default.createElement(
      "radialGradient",
