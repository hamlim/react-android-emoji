...
function MeatOnBone(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m96.15 71.67c-1.01 1.7-0.7 3.72-0.52 5.58s0.04 4.09-1.46 5.36c-0.87-0.76-0.81-2.2-0.73-3.45 0.34-5.25-0.14-10.45-1.43-15.35-0.17-0.66 4.01-1.29 4.41-1.27 1.62 0.06 3.51 0.77 4.4 2.15 2.01 3.11-3.31 4.7-4.67 6.98z"
        fill="url(#d)"
      />
      <radialGradient
        id="c"
      ...
      <path
        d="m77.7 96.5c0.03-0.93-0.19-1.85-0.01-2.78 0.54-2.76 4.09-4 5.36-6.57 0.14-0.28 0.24-0.64 0.05-0.84-0.24-0.25-0.68-0.04-0.99 0.17-3.42 2.33-6.99 4.82-9.04 8.46-0.74 1.31-1.25 2.73-2.02 4.03s-1.87 2.52-3.25 2.95c1.97-0.62 3.78-2.24 5.89-2.82 1.82-0.49 3.91 0.12 4.01-2.6z"
        fill="url(#a)"
      />
      <radialGradient
        id="p"
      ...
      <path
        d="m103.91 88.44c-0.38 0.82-0.79 1.67-1.5 2.23s-1.77 0.72-2.3 0.12c-0.34-0.38-0.39-0.96-0.57-1.45-0.48-1.24-1.81-1.83-3.08-2.15-1.28-0.32-2.66-0.5-3.66-1.31-1.01-0.81-1.44-2.55-0.46-3.63-0.11 0.88 0.78 1.5 1.64 1.42 0.85-0.09 1.63-0.66 2.33-1.24s1.41-1.22 2.25-1.47c0.97-0.29 1.99-0.02 2.94-0.4 1.3-0.51 2.03-2.05 2.18-3.44s-0.11-2.74 0-4.13 0.72-2.94 1.97-3.59c-0.68 0.35-0.06 3.88 0.07 4.41 0.36 1.42 1.8 2.56 2.08 3.83 0.27 1.22-1 3.62-1.45 4.86-0.73 2.01-1.54 3.99-2.44 5.94z"
        fill="url(#p)"
      />
      <radialGradient
        id="o"
      ...
      <path
        d="m106.47 69.69c-0.34 0.64-0.15 1.38 0.06 2.02 0.36 1.12 0.66 2.3 1.11 3.37 0.47-0.77 0.17-1.86-0.01-2.65-0.09-0.35-1.22-2.63-1.16-2.74z"
        fill="url(#o)"
      />
      <radialGradient
        id="n"
      ...
      <path
        d="m84.81 102.73c-0.6 0.2-1.23 0.28-1.82 0.52-1.01 0.41-1.83 1.24-2.79 1.78s-2.27 0.71-2.85-0.12c-0.36-0.51-0.32-1.23-0.27-1.9 0.17-2.12 0.36-4.34 1.49-6.24 1-0.27 1.47 1.3 2.47 1.33 0.61 0.01 1.13-0.55 1.6-1.01 1.23-1.21 3.02-2.08 4.48-1.54 1.12 0.41 1.82 1.66 1.64 2.94-0.2 1.55-2.51 3.76-3.95 4.24z"
        fill="url(#n)"
      />
      <radialGradient
        id="m"
      ...
      <path
        d="m81.86 69.55c-0.45 0.48-0.91 0.98-1.48 1.28s-1.29 0.35-1.73-0.04c-0.37-0.33 4.53-4.67 5.73-4.05-0.68 1-1.68 1.9-2.52 2.81z"
        fill="url(#m)"
      />
      <radialGradient
        id="l"
      ...
      <path
        d="m92.09 102.88c-0.41 0.3-0.94 0.61-1.35 0.4-0.25-0.13-0.36-0.41-0.51-0.65-0.43-0.68-1.26-1.04-2.1-0.92 0.06-0.69 0.63-1.28 1.23-1.67 0.6-0.38 1.27-0.64 1.82-1.09 1.1-0.9 1.54-2.37 2.09-3.68s1.51-2.72 2.85-2.89c0.61-0.07 1.14 0.19 1.73 0.19 0.86 0 1.12-0.36 1.87-0.59 1.85-0.56 1.39 0.9 0.51 2.29-2.1 3.34-5 6.3-8.14 8.61z"
        fill="url(#l)"
      />
      <radialGradient
        id="k"
        ...
        cy={52.774}
        r={6.9753}
        gradientTransform="matrix(-.8463 -.6489 -.6935 .9044 152.54 65.249)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F79792" offset={0} />
        <stop stopColor="#EE7276" offset={0.8818} />
      ...
      <path
        d="m64.22 89.17c-0.23 0.12-0.61 0.16-0.6-0.09 0.06-1.09 0.85-2.11 1.8-2.69s2.04-0.78 3.1-0.85c0.9-0.07 2.03-0.18 2.81-0.09-2.36 1.28-4.75 2.48-7.11 3.72z"
        fill="url(#j)"
      />
      <radialGradient
        id="i"
