...
function KissingHeart(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("path", {
        d:
          "m71.97 52.48s0.05-0.08 0.13-0.23c0.07-0.13 0.24-0.41 0.5-0.76 0.46-0.64 1.12-1.46 2-2.33 0.87-0.88 1.93-1.81 3.13-2.7 0.6-0.44 1.22-0.9 1.88-1.31 0.67-0.43 1.3-0.81 2.04-1.25 0.62-0.33 1.36-0.73 2.06-1.08 0.69-0.36 1.41-0.64 2.09-0.94 1.38-0.57 2.73-1 3.92-1.29 1.19-0.3 2.25-0.45 3.02-0.51s1.25-0.04 1.25-0.04c1.52 0.06 2.71 1.34 2.65 2.86-0.04 1.15-0.78 2.11-1.8 2.48l-0.22 0.08s-0.28 0.1-0.76 0.28c-0.5 0.19-1.23 0.48-2.14 0.88-0.9 0.41-1.97 0.91-3.1 1.49-0.57 0.3-1.15 0.61-1.75 0.92-0.59 0.31-1.15 0.62-1.82 1.01-0.55 0.3-1.18 0.67-1.75 1.01-0.57 0.35-1.14 0.69-1.69 1.03-1.08 0.68-2.06 1.34-2.87 1.9-0.81 0.57-1.44 1.06-1.85 1.38-0.17 0.13-0.33 0.24-0.47 0.38-0.13 0.12-0.2 0.18-0.2 0.18-1.13 1.03-2.88 0.94-3.91-0.19-0.81-0.92-0.91-2.24-0.34-3.25z"
      })
    ),
    _react2.default.createElement(
      "radialGradient",
      {
        ...
        cy: 66.916,
        r: 19.444,
        gradientTransform: "matrix(.9791 0 0 .9301 2.0871 8.0905)",
        gradientUnits: "userSpaceOnUse"
      },
      _react2.default.createElement("stop", {
        stopColor: "#ED7770",
    ...
    _react2.default.createElement("path", {
      d:
        "m44.67 40.61c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42 8-3.54 8-9.42-3.81-9.42-8-9.42z",
      fill: "#242424"
    })
  );
}

exports.default = KissingHeart;
