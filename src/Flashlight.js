...
function Flashlight(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m119.54 45.96c-4.25 4.25-19.18-3.79-26.57-11.18s-15.16-22.05-10.91-26.3 18.91 3.52 26.3 10.91 15.43 22.32 11.18 26.57z"
        fill="url(#f)"
      />
      <radialGradient
        id="e"
      ...
      >
        ...
        <stop stopColor="#FF9100" offset={0.5441} />
        <stop stopColor="#FF6D00" offset={1} />
      </radialGradient>
      <path
        d="m74.08 36.83-68.35 68.36c-3.15 3.15-1.87 9.52 2.85 14.24s11.09 5.99 14.24 2.85l68.35-68.35-17.09-17.1z"
        fill="url(#e)"
      />
      <radialGradient
        id="d"
      ...
      <path
        d="m22.93 122.39-17.32-17.32c-0.72-0.72-0.72-1.9 0-2.62l9.26-9.26c0.72-0.72 1.9-0.72 2.62 0l17.31 17.31c0.72 0.72 0.72 1.9 0 2.62l-9.26 9.26c-0.71 0.73-1.89 0.73-2.61 0.01z"
        fill="url(#c)"
      />
      <radialGradient
        id="b"
      ...
      <path
        d="m112.02 55.88-39.9-39.9c-0.79-0.79-0.79-2.06 0-2.85l8.54-8.54c0.79-0.79 2.06-0.79 2.85 0l39.89 39.89c0.79 0.79 0.79 2.06 0 2.85l-8.54 8.54c-0.78 0.79-2.06 0.79-2.84 0.01z"
        fill="url(#b)"
      />
      <rect
      ...
      <g opacity={0.2}>
        <path
          d="m16.18 96.12 15.69 15.69-7.64 7.64-15.69-15.69 7.64-7.64m0-3.47c-0.47 0-0.95 0.18-1.31 0.54l-9.26 9.26c-0.72 0.72-0.72 1.9 0 2.62l17.31 17.31c0.36 0.36 0.84 0.54 1.31 0.54s0.95-0.18 1.31-0.54l9.26-9.26c0.72-0.72 0.72-1.9 0-2.62l-17.3-17.31c-0.37-0.36-0.84-0.54-1.32-0.54z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m52.12 71.86c1.03 0 2.06 0.39 2.85 1.17 1.57 1.57 1.57 4.13 0 5.7l-5.7 5.7c-0.78 0.78-1.82 1.17-2.85 1.17s-2.06-0.39-2.85-1.17c-1.57-1.57-1.57-4.13 0-5.7l5.7-5.7c0.79-0.78 1.82-1.17 2.85-1.17m0-2c-1.61 0-3.13 0.63-4.26 1.76l-5.7 5.7c-2.35 2.35-2.35 6.17 0 8.52 1.14 1.14 2.65 1.76 4.26 1.76s3.13-0.63 4.26-1.76l5.7-5.7c2.35-2.35 2.35-6.17 0-8.52-1.13-1.14-2.65-1.76-4.26-1.76z"
          fill="#F57C00"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m82.09 7.41 38.5 38.5-7.15 7.15-38.5-38.5 7.15-7.15m0-3.41c-0.52 0-1.03 0.2-1.42 0.59l-8.54 8.54c-0.79 0.79-0.79 2.06 0 2.85l39.91 39.91c0.39 0.39 0.91 0.59 1.42 0.59s1.03-0.2 1.42-0.59l8.54-8.54c0.79-0.79 0.79-2.06 0-2.85l-39.9-39.91c-0.4-0.39-0.91-0.59-1.43-0.59z"
          fill="#424242"
        />
      </g>
      <radialGradient
      ...
      <path
        d="m46.42 86.1c-1.21 0-2.35-0.47-3.2-1.32-1.77-1.77-1.77-4.64 0-6.4l5.7-5.7c0.85-0.85 1.99-1.32 3.2-1.32s2.35 0.47 3.2 1.32c1.77 1.77 1.77 4.64 0 6.4l-5.7 5.7c-0.85 0.85-1.98 1.32-3.2 1.32z"
        fill="url(#a)"
      />
      <path
