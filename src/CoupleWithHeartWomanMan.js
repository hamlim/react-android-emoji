...
function CoupleWithHeartWomanMan(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m70.37 129.4v-9.44c0-7.61 5.08-13.64 15.1-17.92 8.83-3.77 21.09-5.85 34.54-5.86h0.13c24.6 0 49.5 8.17 49.5 23.78v9.44h-99.27z"
          fill="url(#g)"
        />
        <path
          d="m120.13 97.68c12.78 0 25.13 2.22 33.89 6.1 6.44 2.85 14.12 7.97 14.12 16.18v7.94h-96.27v-7.94c0-15.35 24.18-22.25 48.14-22.28h0.12m0-3h-0.13c-25.49 0.03-51.13 7.5-51.13 25.28v10.94h102.27v-10.94c-0.01-16.76-25.41-25.28-51.01-25.28z"
          fill="#DB5200"
        />
        <path
          d="m119.17 107.23c-4 0-7.26-3.22-7.26-7.17v-8.98h16.16v8.98c0 3.96-3.26 7.17-7.26 7.17h-1.64z"
          fill="#E49800"
        />
        <path
          d="m127.08 92.08v7.98c0 3.4-2.81 6.17-6.26 6.17h-1.65c-3.45 0-6.26-2.77-6.26-6.17v-7.98h14.17m2-2h-18.16v9.98c0 4.51 3.7 8.17 8.26 8.17h1.65c4.56 0 8.26-3.66 8.26-8.17v-9.98h-0.01z"
          fill="#C78500"
        />
        <defs>
          <rect id="f" x={74.35} y={4} width={91.3} height={91.3} />
        </defs>
        <clipPath id="e">
          <use xlinkHref="#f" />
        </clipPath>
        <g clipPath="url(#e)">
          <path
            d="M92.9,71.6c-5.24,0-9.5-4.57-9.5-10.19s4.26-10.19,9.5-10.19h54.31 c5.24,0,9.5,4.57,9.5,10.19s-4.26,10.19-9.5,10.19H92.9z"
            fill="#E59600"
          />
          <path
            d="m147.21 52.36c4.61 0 8.35 4.06 8.35 9.05s-3.75 9.05-8.35 9.05h-54.31c-4.61 0-8.35-4.06-8.35-9.05s3.75-9.05 8.35-9.05h54.31m0-2.29h-54.31c-5.85 0-10.65 5.1-10.65 11.34s4.79 11.34 10.65 11.34h54.3c5.86 0 10.65-5.1 10.65-11.34s-4.79-11.34-10.64-11.34z"
            fill="#D18100"
          />
          <linearGradient
            id="d"
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m-40.63 129.4v-9.44c0-7.61 5.08-13.64 15.1-17.92 8.83-3.77 21.09-5.85 34.54-5.86h0.13c24.6 0 49.5 8.17 49.5 23.78v9.44h-99.27z"
          fill="url(#b)"
        />
        <path
          d="m9.13 97.68c12.78 0 25.13 2.22 33.89 6.1 6.44 2.85 14.12 7.97 14.12 16.18v7.94h-96.27v-7.94c0-15.35 24.18-22.25 48.14-22.28h0.12m0-3h-0.13c-25.49 0.03-51.13 7.5-51.13 25.28v10.94h102.26v-10.94c0-16.76-25.4-25.28-51-25.28z"
          fill="#518626"
        />
        <path
          d="M8.17,107.23c-4,0-7.26-3.22-7.26-7.17v-8.98h16.16v8.98c0,3.96-3.26,7.17-7.26,7.17H8.17z"
          fill="#E49800"
        />
        <path
          d="m16.08 92.08v7.98c0 3.4-2.81 6.17-6.26 6.17h-1.65c-3.45 0-6.26-2.77-6.26-6.17v-7.98h14.17m2-2h-18.16v9.98c0 4.51 3.7 8.17 8.26 8.17h1.65c4.56 0 8.26-3.66 8.26-8.17v-9.98h-0.01z"
          fill="#C78500"
        />
        <defs>
          <rect id="m" x={-36.81} y={4.78} width={91.29} height={91.29} />
        </defs>
        <clipPath id="l">
          <use xlinkHref="#m" />
        </clipPath>
        <g clipPath="url(#l)">
          <path
            d="m-18.27 72.38c-5.24 0-9.5-4.57-9.5-10.19s4.26-10.19 9.5-10.19h54.31c5.24 0 9.5 4.57 9.5 10.19s-4.26 10.19-9.5 10.19h-54.31z"
            fill="#E59600"
          />
          <path
            d="m36.04 53.14c4.61 0 8.35 4.06 8.35 9.05s-3.75 9.05-8.35 9.05h-54.3c-4.61 0-8.35-4.06-8.35-9.05s3.75-9.05 8.35-9.05h54.3m0-2.29h-54.3c-5.85 0-10.65 5.1-10.65 11.34s4.79 11.34 10.65 11.34h54.3c5.86 0 10.65-5.1 10.65-11.34s-4.79-11.34-10.65-11.34z"
            fill="#D18100"
          />
          <linearGradient
            id="k"
