...
function BustsInSilhouette(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <defs>
        <polyline id="d" points="124 4 124 124 4 124 4 4" />
      </defs>
      <clipPath id="c">
        <use xlinkHref="#d" />
      </clipPath>
