...
function Carrot(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("path", {
      d:
        "m93.82 39.55c0.4-0.01 8.97 0.51 12.44 0.26s4.68 0.11 4.68 0.11l-0.61 1.76s1.14 0.03-4.4 0.28-15.58 1.71-16.74 1.01c-1.16-0.69 4.63-3.42 4.63-3.42z",
      fill: "#458C00"
    }),
    _react2.default.createElement("path", {
      d:
        "m108.74 16.2c0.01-0.34 0.2-0.67 0.2-0.67l-2.46-1.66s-8.52 9.1-11.5 12-5.43 5.66-7.3 7.66c-0.95 1.02-1.02 2.52-0.87 3.76 6.46-8 14.94-13.49 21.93-21.09z",
      fill: "#6A9600"
    }),
    _react2.default.createElement("path", {
      d:
        "m111.64 18.45s-2.32-1.39-2.73-1.78c-0.14-0.13-0.18-0.3-0.17-0.47-6.99 7.59-15.48 13.09-21.93 21.09 0.15 1.19 0.52 2.14 0.52 2.14s4.43-1.41 4.62-1.75 7.27-6.52 13.16-12.26 6.53-6.97 6.53-6.97z",
      fill: "#468C00"
    }),
    _react2.default.createElement(
      "linearGradient",
      {
        ...
        y1: 43.776,
        y2: 43.776,
        gradientTransform: "matrix(.7298 .6836 -.6836 .7298 33.126 -87.243)",
    ...
    _react2.default.createElement("path", {
      d:
        "m86.07 39.4c0.26-0.14 7.54-2.38 12.25-3.54s14.22-4.54 15.8-5.26 4.49-1.75 4.49-1.75l1.42 2.49s-13.9 6.13-20.84 8.43-11.69 4.19-13.53 5.19-1.36-2.7-1.36-2.7l1.77-2.86z",
      fill: "url(#d)"
    }),
    _react2.default.createElement(
      "linearGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m85.87 4.79s0.65-0.56 1.53-0.25 0.58 1.46 0.58 1.46-2.36 13.7-2.48 15.91c-0.13 2.21-1.89 11.82-1.86 14.56 0.02 2.74-1.78 6.74-1.78 6.74l-4.07-3.94s2.29-3.68 3.13-8.46 3.36-15.75 3.76-19.9 1.19-6.12 1.19-6.12z",
      fill: "url(#c)"
    }),
    _react2.default.createElement("path", {
      d:
        "m90.51 27.37c0.37-1.26 0.81-2.5 1.39-3.72 2.25-4.75 5.91-13.36 6.6-14.78s0.5-1.23 0.5-1.23-0.89-0.57-1.9-0.87c-0.56-0.17-0.97 0.01-1.37 0.15-2.44 6.65-5.41 13.29-5.22 20.45z",
      fill: "#468C00"
    }),
    _react2.default.createElement(
      "linearGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m88.05 38.67c1.02-3.86 1.41-7.66 2.47-11.3-0.2-7.16 2.77-13.79 5.22-20.45-0.32 0.11-0.64 0.2-1.03 0.06-0.88-0.31-2.77-1.05-2.77-1.05s-1.47 1.99-3.03 7.38-3.66 12.88-5.01 16.4c-1.36 3.52-3.76 11.62-3.76 11.62s1.87 2.14 3.34 4.03 1.81 2.08 1.81 2.08 1.39-3.58 2.76-8.77z",
      fill: "url(#b)"
    }),
    _react2.default.createElement(
      "g",
    ...
    _react2.default.createElement("path", {
      d:
        "m64.7 62.54s0.19-0.03 0.49-0.04c0.29-0.01 0.77 0.02 1.26 0.15 0.26 0.05 0.52 0.14 0.79 0.25s0.56 0.23 0.83 0.4 0.57 0.32 0.82 0.54c0.26 0.21 0.51 0.43 0.76 0.66 0.23 0.25 0.45 0.51 0.65 0.77 0.22 0.25 0.36 0.55 0.53 0.81 0.31 0.55 0.53 1.1 0.65 1.61 0.13 0.49 0.17 0.93 0.17 1.24s-0.02 0.5-0.02 0.5l-0.13 0.07s-0.29-0.55-0.79-1.32c-0.49-0.78-1.24-1.76-2.12-2.62-0.85-0.88-1.83-1.64-2.62-2.11-0.78-0.49-1.34-0.76-1.34-0.76l0.07-0.15z",
      fill: "#AB4400"
    }),
    _react2.default.createElement("path", {
      d:
        "m49.77 72.5s0.19-0.03 0.49-0.04c0.29-0.01 0.77 0.02 1.26 0.15 0.26 0.05 0.52 0.14 0.79 0.25s0.56 0.23 0.83 0.4 0.57 0.32 0.82 0.54c0.26 0.21 0.51 0.43 0.76 0.66 0.23 0.25 0.45 0.51 0.65 0.77 0.22 0.25 0.36 0.55 0.53 0.81 0.31 0.55 0.53 1.1 0.65 1.61 0.13 0.49 0.17 0.93 0.17 1.24s-0.02 0.5-0.02 0.5l-0.13 0.07s-0.29-0.55-0.79-1.32c-0.49-0.78-1.24-1.76-2.12-2.62-0.85-0.88-1.83-1.64-2.62-2.11-0.78-0.49-1.34-0.76-1.34-0.76l0.07-0.15z",
      fill: "#C95100"
    }),
    _react2.default.createElement("path", {
      d:
        "m40.46 74.56s0.19-0.06 0.51-0.12c0.31-0.06 0.8-0.1 1.34-0.04 0.28 0.02 0.57 0.06 0.87 0.13s0.62 0.15 0.93 0.28 0.65 0.24 0.95 0.43c0.31 0.17 0.61 0.36 0.91 0.56 0.28 0.22 0.56 0.45 0.82 0.68 0.27 0.22 0.48 0.51 0.71 0.75 0.42 0.52 0.76 1.05 0.98 1.55 0.23 0.49 0.36 0.93 0.42 1.25s0.08 0.52 0.08 0.52l-0.12 0.09s-0.4-0.52-1.06-1.25-1.62-1.63-2.69-2.38c-1.05-0.77-2.22-1.4-3.13-1.76-0.9-0.38-1.54-0.56-1.54-0.56l0.02-0.13z",
      fill: "#DE5900"
    }),
    _react2.default.createElement("path", {
      d:
        "m26.53 90.78s0.21-0.02 0.56-0.01c0.34 0.01 0.87 0.07 1.43 0.23 0.29 0.07 0.59 0.18 0.9 0.32s0.64 0.28 0.95 0.48 0.65 0.38 0.94 0.64c0.3 0.24 0.6 0.5 0.88 0.77 0.27 0.29 0.53 0.58 0.77 0.88 0.26 0.29 0.43 0.63 0.64 0.93 0.37 0.63 0.66 1.26 0.82 1.83 0.18 0.56 0.25 1.06 0.28 1.41 0.02 0.35 0.01 0.56 0.01 0.56l-0.13 0.07s-0.34-0.64-0.93-1.55c-0.58-0.91-1.47-2.07-2.5-3.07-1.01-1.03-2.17-1.91-3.1-2.47-0.92-0.57-1.58-0.87-1.58-0.87l0.06-0.15z",
      fill: "#DE5900"
    }),
    _react2.default.createElement("path", {
      d:
        "m22.1 107.01s0.15-0.05 0.39-0.1c0.23-0.05 0.6-0.07 0.98-0.01 0.2 0.02 0.41 0.06 0.62 0.13s0.44 0.14 0.64 0.26 0.44 0.21 0.63 0.38c0.2 0.15 0.39 0.31 0.58 0.48 0.17 0.19 0.33 0.38 0.48 0.57 0.16 0.19 0.26 0.42 0.38 0.62 0.21 0.42 0.35 0.85 0.4 1.24 0.13 0.77-0.06 1.37-0.06 1.37l-0.13 0.07s-0.22-0.39-0.58-0.94c-0.36-0.56-0.9-1.26-1.54-1.87-1.22-1.29-2.84-2.07-2.84-2.07l0.05-0.13z",
      fill: "#DE5900"
    }),
    _react2.default.createElement("path", {
      d:
        "m10.63 114.59s0.14-0.05 0.35-0.11 0.55-0.09 0.9-0.05c0.36 0.02 0.76 0.13 1.15 0.31 0.19 0.1 0.4 0.18 0.57 0.33 0.18 0.13 0.35 0.28 0.52 0.43 0.15 0.17 0.29 0.34 0.43 0.52 0.15 0.17 0.22 0.38 0.33 0.56 0.18 0.38 0.29 0.77 0.32 1.13 0.09 0.71-0.12 1.25-0.12 1.25l-0.13 0.07s-0.19-0.34-0.52-0.83c-0.32-0.49-0.8-1.11-1.36-1.64-1.08-1.14-2.5-1.83-2.5-1.83l0.06-0.14z",
      fill: "#DE5900"
    })
  );
}
