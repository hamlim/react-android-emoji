...
function Wolf(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m41.85 54.44c-9.86 0-22.55-1.73-27.07-9.99-6.86-12.51-7.24-31.13-7.19-36.58 6.54 0.57 31.85 3.58 38.72 16.11 6.78 12.38 7.16 25.71 7.11 29.72-2.04 0.26-6.43 0.74-11.57 0.74z"
        fill="#999"
      />
      <path
        d="m9.09 9.51c3.16 0.33 8.36 1.03 13.92 2.42 7.93 1.99 18.19 5.82 21.98 12.76 5.99 10.94 6.85 22.71 6.92 27.68-2.27 0.26-5.91 0.58-10.06 0.58-18.02 0-23.87-5.77-25.76-9.21-6.11-11.16-6.94-27.45-7-34.23m-2.97-3.26s-1.02 23.66 7.34 38.93c4.88 8.91 18.17 10.77 28.39 10.77 7.29 0 13.02-0.94 13.02-0.94s1.11-16.48-7.25-31.75-41.5-17.01-41.5-17.01z"
        fill="#666"
      />
      <path
        d="m30.4 31.62c4.42 8.27-1.4 19.55-1.4 19.55s-13-2.12-17.43-10.39-2.16-19.55-2.16-19.55 16.57 2.12 20.99 10.39z"
        fill="#666"
      />
      <path
        d="m86.15 54.44c-5.14 0-9.52-0.48-11.56-0.75-0.05-4.02 0.34-17.37 7.11-29.72 6.87-12.54 32.18-15.54 38.72-16.11 0.04 5.45-0.34 24.09-7.19 36.59-4.53 8.26-17.23 9.99-27.08 9.99z"
        fill="#999"
      />
      <path
        d="m118.91 9.51c-0.06 6.77-0.88 23.04-7.01 34.22-1.88 3.44-7.73 9.21-25.76 9.21-4.14 0-7.78-0.32-10.06-0.58 0.07-4.97 0.93-16.74 6.92-27.67 3.79-6.92 14-10.74 21.89-12.73 5.59-1.41 10.84-2.11 14.02-2.45m2.97-3.26s-33.14 1.73-41.5 17-7.25 31.75-7.25 31.75 5.73 0.94 13.02 0.94c10.22 0 23.51-1.85 28.39-10.77 8.36-15.26 7.34-38.92 7.34-38.92z"
        fill="#666"
      />
      <path
        d="m97.54 32.57c-4.28 9.02 1.36 21.34 1.36 21.34s12.58-2.32 16.86-11.34 2.09-21.34 2.09-21.34-16.02 2.32-20.31 11.34z"
        fill="#666"
      />
      <linearGradient
        id="c"
      ...
      >
        <stop stopColor="#8F8F8F" offset={0.0404} />
        <stop stopColor="#949494" offset={0.0825} />
        <stop stopColor="#ACACAC" offset={0.3249} />
        <stop stopColor="#BABABA" offset={0.5504} />
        <stop stopColor="#BFBFBF" offset={0.7408} />
      </linearGradient>
      <path
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#fff" offset={0.0035183} />
        <stop stopColor="#FCFCFC" offset={0.2881} />
        <stop stopColor="#F3F3F3" offset={0.4902} />
        <stop stopColor="#E3E3E3" offset={0.6668} />
        <stop stopColor="#CDCDCD" offset={0.8278} />
        <stop stopColor="#B3B3B3" offset={0.9698} />
      </linearGradient>
      <path
        d="m103.53 61.72c-0.3-8.06-2.3-19.68-9.66-23.9-10.57-6.05-21.07 6.43-20.94 17.1 0.16 13.96 12.58 30.69 2.93 43.84-2.77 3.78-6.85 5.51-11.85 5.43-5 0.08-8.76-1.65-11.54-5.43-9.65-13.15 2.51-29.88 2.68-43.84 0.13-10.67-10.43-23.15-20.99-17.09-7.37 4.22-9.38 15.84-9.69 23.9-0.55 14.78 3.92 29.55 13.85 40.12 8.33 8.86 15.68 14.66 25.68 14.86 8-0.2 17.68-6 26.02-14.87 9.93-10.57 14.07-25.34 13.51-40.12z"
        fill="url(#b)"
      />
      <path
        d="m73.19 107.6c-4.44 0-8.19-3.79-8.19-8.27v-7.33c0-0.83-0.67-1.5-1.5-1.5s-1.5 0.67-1.5 1.5v7.33c0 4.48-3.75 8.27-8.19 8.27-0.83 0-1.5 0.67-1.5 1.5s0.67 1.5 1.5 1.5c4.14 0 7.76-2.28 9.69-5.66 1.94 3.38 5.55 5.66 9.69 5.66 0.83 0 1.5-0.67 1.5-1.5s-0.67-1.5-1.5-1.5z"
        fill="#404040"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m57.47 84c-2.06 0-3.46 1.83-2.73 3.7 1.55 3.97 4.31 6.83 8.76 6.83 0.07 0 0.13-0.05 0.19-0.05 0.07 0 0.13-0.01 0.19-0.01 4.44 0 7.21-2.79 8.76-6.75 0.73-1.87-0.66-3.71-2.73-3.71h-12.44z"
        fill="url(#a)"
      />
      <g fill="#404040">
