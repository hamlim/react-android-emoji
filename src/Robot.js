...
function Robot(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="M12.53,106.01c-3.46,0-6.28-2.82-6.28-6.29V61.34c0-3.46,2.82-6.28,6.28-6.28h3.55v50.96H12.53z"
        fill="#F15A24"
      />
      <path
        d="m14.08 57.05v46.96h-1.55c-2.36 0-4.28-1.93-4.28-4.29v-38.38c0-2.36 1.92-4.28 4.28-4.28h1.55m4-4.01h-5.55c-4.57 0-8.28 3.72-8.28 8.28v38.38c0 4.57 3.72 8.29 8.28 8.29h5.55v-54.95z"
        fill="#C1272D"
      />
      <path
        d="m112.17 106.01v-50.96h3.55c3.46 0 6.28 2.82 6.28 6.28v38.38c0 3.47-2.82 6.29-6.28 6.29h-3.55z"
        fill="#F15A24"
      />
      <path
        d="m115.72 57.05c2.36 0 4.28 1.92 4.28 4.28v38.38c0 2.37-1.92 4.29-4.28 4.29h-1.55v-46.95h1.55m0-4h-5.55v54.96h5.55c4.56 0 8.28-3.72 8.28-8.29v-38.38c0-4.57-3.71-8.29-8.28-8.29z"
        fill="#C1272D"
      />
      <linearGradient
        id="a"
      ...
      />
      <path
        d="m84.95 55.28c-6.34 0-11.5 5.16-11.5 11.5s5.16 11.5 11.5 11.5 11.5-5.16 11.5-11.5c0-6.35-5.15-11.5-11.5-11.5z"
        fill="#fff"
        stroke="#666"
        strokeMiterlimit={10}
        strokeWidth={4}
      />
      <path
        d="m83.85 107.55h-39.7c-3.46 0-6.27-2.81-6.27-6.27v-0.56c0-3.46 2.81-6.27 6.27-6.27h39.71c3.46 0 6.27 2.81 6.27 6.27v0.56c-0.01 3.47-2.81 6.27-6.28 6.27z"
        fill="#fff"
        stroke="#666"
        strokeMiterlimit={10}
        strokeWidth={4}
      />
      <g fill="#666" stroke="#666" strokeMiterlimit={10} strokeWidth={0.7282}>
      ...
      <path
        d="m64 17.99c-2.22 0-4.03-1.81-4.03-4.03s1.81-4.02 4.03-4.02 4.03 1.81 4.03 4.03-1.81 4.02-4.03 4.02z"
        fill="#FF5252"
      />
      <path
        d="m58.67 86.83c-0.88 0-1.67-0.45-2.13-1.19-0.46-0.75-0.5-1.66-0.1-2.44l2.74-5.41 2.6-4.82c0.44-0.81 1.28-1.31 2.2-1.31 0.93 0 1.78 0.51 2.22 1.34l5.32 10.17c0.41 0.78 0.38 1.7-0.08 2.45s-1.26 1.21-2.14 1.21h-10.63z"
        fill="#FF5252"
      />
      <path
