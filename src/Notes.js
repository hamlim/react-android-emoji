...
function Notes(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m72 78.86c-0.09-13.04-2.26-16.72-16.03-27.07-5.73-4.31-4.6-7.32-6.15-7.74-0.92-0.25-1.82 0.43-1.82 1.36v45.81c0 0.61-0.55 1.09-1.15 0.98-5.19-0.9-11.53 1.29-16.45 6.2-7.07 7.07-8.5 17.1-3.2 22.4s15.33 3.87 22.4-3.2c4.52-4.52 6.72-10.23 6.35-15.16l0.02-39.78c0-0.73 0.73-1.13 1.43-0.91 2.63 0.83 11.41 4.29 12.04 17.81 0.06 1.36 2.58 1.62 2.56-0.7z"
        fill="url(#b)"
      />
      <radialGradient
        id="a"
