...
function Cucumber(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m112.98 9.33c-0.25 1.97-0.91 3.51-1.48 3.43-0.57-0.07-0.82-1.73-0.57-3.7s1.48-3.43 1.48-3.43 0.82 1.73 0.57 3.7z"
        fill="#592100"
      />
      <path
        d="m115.96 12.59c-1.93 0.46-3.6 0.39-3.74-0.17-0.13-0.55 1.33-1.38 3.26-1.84s3.74 0.17 3.74 0.17-1.33 1.37-3.26 1.84z"
        fill="#592100"
      />
      <path
        d="m109.51 6.35s1.98 3.53 2.67 5.08c0.44-2.15 2.65-3.32 4.24-3.98-0.11 1.89-1.42 4.32-3.05 5.07 2.08-0.47 3.83-0.09 5.73 0.4-0.35-0.13-4.34 3.31-7.66 0.85-3.44-2.55-1.93-7.42-1.93-7.42z"
        fill="#FDB800"
      />
      <linearGradient
        id="a"
