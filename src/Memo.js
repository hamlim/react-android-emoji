...
function Memo(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m92 124h-80c-4.4 0-8-3.6-8-8v-104c0-4.4 3.6-8 8-8h80c4.4 0 8 3.6 8 8v104c0 4.4-3.6 8-8 8z"
        fill="url(#h)"
      />
      ...
      <g opacity={0.2}>
        <path
          d="m92 7c2.76 0 5 2.24 5 5v104c0 2.76-2.24 5-5 5h-80c-2.76 0-5-2.24-5-5v-104c0-2.76 2.24-5 5-5h80m0-3h-80c-4.4 0-8 3.6-8 8v104c0 4.4 3.6 8 8 8h80c4.4 0 8-3.6 8-8v-104c0-4.4-3.6-8-8-8z"
          fill="#424242"
        />
      </g>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFECB3" offset={0.006854} />
        <stop stopColor="#FFE082" offset={1} />
      </linearGradient>
      <path
        d="m36.15 100.15 4.53-12.09 3.12-8.32c0.7-2.15 1.9-4.1 3.5-5.7l7.2-7.2 18.67 18.67-7.2 7.2c-1.6 1.6-3.55 2.8-5.7 3.5l-8.32 3.12-12.09 4.53c-2.29 0.74-4.46-1.43-3.71-3.71z"
        fill="url(#g)"
      />
      <g fill="none">
      ...
      <g opacity={0.2}>
        <path
          d="m54.49 71.08 14.42 14.42-5.08 5.08c-1.26 1.26-2.82 2.22-4.51 2.77l-0.12 0.04-8.32 3.12-11.83 4.43 4.43-11.83 3.12-8.32 0.04-0.12c0.55-1.69 1.51-3.25 2.77-4.51l5.08-5.08m0-4.24-7.2 7.2c-1.6 1.6-2.8 3.55-3.5 5.7l-3.12 8.32-4.53 12.09c-0.64 1.97 0.88 3.85 2.77 3.85 0.3 0 0.61-0.05 0.93-0.15l12.09-4.53 8.32-3.12c2.15-0.7 4.1-1.9 5.7-3.5l7.2-7.2-18.66-18.66z"
          fill="#424242"
        />
      </g>
      <linearGradient
      ...
      <path
        d="m36.15 100.15 4.53-12.09c2.36 1.17 4.59 2.74 6.55 4.71 1.97 1.97 3.53 4.19 4.71 6.55l-12.09 4.53c-2.28 0.75-4.45-1.42-3.7-3.7z"
        fill="url(#f)"
      />
      <g opacity={0.2}>
        <path
          d="m42.23 92.46c1.03 0.72 1.99 1.53 2.88 2.42s1.7 1.85 2.42 2.88l-8.48 3.18 3.18-8.48m-1.55-4.4-4.53 12.09c-0.64 1.97 0.88 3.85 2.77 3.85 0.3 0 0.61-0.05 0.93-0.15l12.09-4.53c-1.17-2.36-2.74-4.59-4.71-6.55-1.96-1.97-4.19-3.54-6.55-4.71z"
          fill="#424242"
        />
      </g>
      <linearGradient
      ...
      >
        ...
        <stop stopColor="#F44336" offset={1} />
      </linearGradient>
      <path
        d="m95.32 26.02 18.67 18.67 8.3-8.3c2.29-2.29 2.29-6.01 0-8.3l-10.37-10.37c-2.29-2.29-6.01-2.29-8.3 0l-8.3 8.3z"
        fill="url(#d)"
      />
      <linearGradient
        id="c"
      ...
      <path
        d="m102.23 45.37-7.61-7.61-38.4 38.4-0.07 1.5c-0.14 3.23 2.95 6.32 6.17 6.17l1.5-0.07 38.41-38.39z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <path
        d="m107.76 50.91-40.11 40.11c-2.25-0.94-3.99-3.3-3.89-5.74l0.07-1.5 38.4-38.4 5.53 5.53z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
