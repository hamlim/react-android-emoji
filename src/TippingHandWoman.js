  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m1.5 130.5v-9.38c0-16.28 23.54-23.6 46.87-23.62h0.12c22.87 0 46.01 8.12 46.01 23.62v9.38h-93z"
          fill="url(#g)"
        />
        <path
          d="m48.49 99c22.12 0 44.51 7.6 44.51 22.12v7.88h-90v-7.88c0-15.24 22.79-22.09 45.37-22.12h0.12m0-3h-0.12c-23.93 0.03-48.37 7.46-48.37 25.12v10.88h96v-10.88c0-16.65-23.48-25.12-47.51-25.12z"
          fill="#009984"
        />
        <path
          d="M47.19,103.1c-4,0-7.26-3.22-7.26-7.17v-8.98H56.1v8.98c0,3.95-3.26,7.17-7.26,7.17H47.19z"
          fill="#E59600"
        />
        <path
          d="m55.1 87.95v7.98c0 3.4-2.81 6.17-6.26 6.17h-1.65c-3.45 0-6.26-2.77-6.26-6.17v-7.98h14.17m2-2h-18.16v9.98c0 4.51 3.7 8.17 8.26 8.17h1.65c4.56 0 8.26-3.66 8.26-8.17v-9.98h-0.01z"
          fill="#D18100"
        />
        <path
          d="m20.69 72.26c-5.36 0-9.71-4.67-9.71-10.41s4.36-10.41 9.71-10.41h54.65c5.36 0 9.71 4.67 9.71 10.41s-4.36 10.41-9.71 10.41h-54.65z"
          fill="#E59600"
        />
        <path
          d="m75.34 52.43c4.8 0 8.71 4.22 8.71 9.41s-3.91 9.41-8.71 9.41h-54.65c-4.8 0-8.71-4.22-8.71-9.41s3.91-9.41 8.71-9.41h54.65m0-2h-54.65c-5.89 0-10.71 5.14-10.71 11.41 0 6.28 4.82 11.41 10.71 11.41h54.65c5.89 0 10.71-5.14 10.71-11.41s-4.82-11.41-10.71-11.41z"
          fill="#D18100"
        />
        <linearGradient
          id="f"
      ...
      <g clipPath="url(#a)">
        <defs>
          <rect id="d" x={4.41} width={91.38} height={91.38} />
        </defs>
        <clipPath>
          <use xlinkHref="#d" />
        </clipPath>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#00A68E" offset={0} />
        <stop stopColor="#00BFA5" stopOpacity={0} offset={1} />
      </linearGradient>
      <polygon
      ...
      <g clipPath="url(#a)">
        ...
        <path
          d="m75.74 130.5 12.13-57.41c0.01-0.04 0.02-0.09 0.02-0.14 0.01-0.13 0.12-0.22 0.25-0.22l12.75 0.76c0.11 0.01 0.21 0.11 0.22 0.24l2.16 56.77h-27.53z"
          fill="url(#i)"
        />
        <path
          d="m89.14 74.3 10.5 0.62 2.06 54.08h-24.11l11.55-54.7m-1.01-3.06c-0.88 0-1.63 0.66-1.73 1.55l-12.51 59.21h30.93l-2.22-58.31c-0.03-0.9-0.73-1.63-1.63-1.69l-12.72-0.76h-0.12z"
          fill="#009984"
        />
      </g>
    </svg>
...
export default TippingHandWoman;
