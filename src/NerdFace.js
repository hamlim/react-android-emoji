...
function NerdFace(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m63.74 119.04c-27.95 0-58.02-17.5-58.02-55.92s30.08-55.91 58.02-55.91c15.49 0 29.83 5.13 40.38 14.44 11.55 10.19 17.65 24.53 17.65 41.48 0 16.87-6.1 31.19-17.65 41.41-10.58 9.35-24.92 14.5-40.38 14.5z"
        fill="url(#h)"
      />
      <path
        d="m63.74 9.21c15 0 28.87 4.95 39.05 13.94 11.1 9.8 16.97 23.62 16.97 39.98 0 16.28-5.87 30.08-16.98 39.91-10.21 9.03-24.08 14.01-39.05 14.01-15.04 0-28.92-4.91-39.06-13.83-11.09-9.76-16.95-23.62-16.95-40.1 0-16.55 5.87-30.44 16.96-40.17 10.12-8.86 23.99-13.74 39.06-13.74m0-4c-31.16 0-60.02 20.01-60.02 57.92 0 37.7 28.86 57.92 60.02 57.92s60.02-20.73 60.02-57.92c0.01-37.39-28.85-57.92-60.02-57.92z"
        fill="#EB8F00"
      />
      <g fill="#242424">
      ...
      <defs>
        <path
          id="g"
          d="m63.99 69.45c-15.71 0-30.31-1.32-42.49-3.57-3.02-0.56-5.69 2.1-5.08 5.11 4.04 19.81 23.55 36.08 47.55 36.08 26.27 0 43.94-16.8 47.61-36.15 0.57-2.99-2.1-5.6-5.09-5.04-12.17 2.25-26.78 3.57-42.5 3.57z"
        />
      </defs>
      <clipPath id="a">
        <use xlinkHref="#g" />
      ...
      />
      <path
        d="M117.24,68.3V53.41H10.76V68.3C27.14,77.92,45.12,83.27,64,83.27 S100.86,77.92,117.24,68.3z"
        clipPath="url(#a)"
        fill="#fff"
      />
      <path
        d="M64,93.33c-11.78,0-22.05,6.42-27.53,15.95 c7.12,3.89,16.83,6.29,27.53,6.29s20.41-2.4,27.53-6.29C86.05,99.75,75.78,93.33,64,93.33z"
        clipPath="url(#a)"
        fill="#ED7770"
      />
      <g clipPath="url(#a)">
        <defs>
          <path
            id="f"
            d="m10.76 53.41v14.89c16.38 9.62 34.36 14.97 53.24 14.97s36.86-5.35 53.24-14.97v-14.89h-106.48zm53.24 39.92c-11.78 0-22.05 6.42-27.53 15.95 7.12 3.89 16.83 6.29 27.53 6.29 10.71 0 20.41-2.4 27.53-6.29-5.48-9.53-15.75-15.95-27.53-15.95z"
          />
        </defs>
        <clipPath id="e">
          <use xlinkHref="#f" />
      ...
      <path
        d="m51.32 42.58c0.89 1.52 1.61 5.06-0.17 13.23-1.77 8.18-3.99 13.76-19.13 12.9-9.74-0.55-16.52-0.53-18.08-14.75-0.96-8.83 0.11-12.17 0.84-13.24 0.72-1.06 3.32-4.12 18.41-3.59 15.09 0.52 17.25 3.91 18.13 5.45z"
        fill="none"
      />
      <linearGradient
        id="d"
      ...
      <path
        d="m10.83 35.59c-0.11 0-0.22 0.03-0.32 0.07 0.1-0.05 0.21-0.07 0.32-0.07z"
        fill="url(#d)"
      />
      <linearGradient
        id="c"
      ...
      <path
        d="m10.15 35.88c0.09-0.09 0.18-0.15 0.29-0.2-0.1 0.05-0.2 0.11-0.29 0.2z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <path
        d="m118.19 35.88c-0.09-0.09-0.18-0.15-0.29-0.2 0.1 0.05 0.2 0.11 0.29 0.2z"
        fill="url(#i)"
      />
      <g fill="#fff">
