  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g fill="#424242" opacity={0.2}>
        ...
        <path d="m94.15 88c1.02 0 1.85 0.83 1.85 1.85v8.3c0 1.02-0.83 1.85-1.85 1.85h-60.3c-1.02 0-1.85-0.83-1.85-1.85v-8.3c0-1.02 0.83-1.85 1.85-1.85h60.3m0-3h-60.3c-2.67 0-4.85 2.18-4.85 4.85v8.3c0 2.68 2.18 4.85 4.85 4.85h60.3c2.68 0 4.85-2.18 4.85-4.85v-8.3c0-2.67-2.18-4.85-4.85-4.85z" />
      </g>
      <g fill="#FAFAFA">
        <path d="M63.84,80h29.18c2.04,0,3.31-2.2,2.3-3.97L66.14,25.34c-1.02-1.78-3.59-1.78-4.61,0L32.35,76.03 C31.34,77.8,32.62,80,34.66,80H63.84z" />
        <path d="m32 98.15v-8.3c0-1.02 0.83-1.85 1.85-1.85h60.3c1.02 0 1.85 0.83 1.85 1.85v8.3c0 1.02-0.83 1.85-1.85 1.85h-60.3c-1.02 0-1.85-0.83-1.85-1.85z" />
      </g>
    </svg>
  );
}

export default Emoji0x23cf;
