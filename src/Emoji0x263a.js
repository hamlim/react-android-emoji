...
function Emoji0x263a(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <circle cx={27.25} cy={69.83} r={17.5} fill="url(#b)" opacity={0.8} />
      <radialGradient
        id="a"
        cx={100.77}
        cy={66.546}
      ...
      <circle cx={100.75} cy={69.83} r={17.5} fill="url(#a)" opacity={0.8} />
    </svg>
  );
}

export default Emoji0x263a;
