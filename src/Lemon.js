...
function Lemon(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#FFF176" offset={0.1619} />
        <stop stopColor="#FEE762" offset={0.3184} />
        <stop stopColor="#FCD745" offset={0.588} />
        <stop stopColor="#FBCE33" offset={0.8219} />
        <stop stopColor="#FBCB2D" offset={0.992} />
      </radialGradient>
      <path
        d="m27.37 49.81c16.11-17.01 38.79-23.59 56.01-16.12l0.01-0.02c3.87 1.8 7.41 1.49 11.7 5.71 5.06 4.97 3.22 6.43 5.27 10.17l-0.02 0.01c8.57 16.68 2.59 40.62-12.9 58.17-12.08 13.68-37.39 18.08-54.95 14.34l-0.01 0.02c-3.87-1.8-7.21-0.97-7.21-0.97l-2.75 0.42c-2.11 0.48-4.5 0.01-6.22-1.6s-2.33-3.76-1.95-5.86c0.76-2.99 3.35-4.47 1.17-7.87l0.01-0.01c-7.27-14.1-2.01-41.76 11.84-56.39z"
        fill="url(#d)"
      />
      <g opacity={0.2}>
        <path
      ...
      <path
        d="m20.71 21.11s20.52 3.85 29.3 9.04 34.67 10.16 40.14-0.94c4.93-9.99-9.57-24.14-29.85-24.25-20.27-0.1-25.11 11.28-39.59 16.15z"
        fill="url(#c)"
      />
      <g opacity={0.2}>
        <path
      ...
      <path
        d="m118.54 29.67c-0.87-1.96-3.25-2.86-3.25-2.86s-0.09 0.1-0.23 0.26c-0.05 1.22-0.26 2.01-1.05 2.8 1.02 0 2.28 1.21 3.54 1.9 0.8-0.78 1.24-1.53 0.99-2.1z"
        fill="url(#a)"
      />
    </svg>
  );
