...
function DromedaryCamel(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m98.31 32.55c4.76-0.18 9.37 1.56 12.8 4.62 3.42 3.1 5.48 7.38 5.91 11.78 0.23 2.22-0.05 4.42-0.4 6.39-0.34 1.99-0.73 3.86-0.75 5.68-0.03 1.8 0.3 3.65 1.03 5.28 0.73 1.62 1.94 3 3.59 3.53l-0.45 1.6c-1.1-0.26-2.14-0.81-3-1.55s-1.54-1.64-2.08-2.59c-1.07-1.92-1.62-4.03-1.78-6.2-0.15-2.16 0.11-4.22 0.27-6.17 0.17-1.96 0.23-3.76-0.11-5.48-0.63-3.46-2.59-6.65-5.26-8.66-2.68-2.02-6.16-2.94-9.33-2.52l-0.44-5.71z"
        fill="#9C652F"
      />
      <path
        d="m116.85 78.2c2.18 3.93 0.18 6.09 0.17 7.95 0.7-0.56 2.26-3.32 2.57-4.18-0.79 2.47-0.58 5.26 0.56 7.58 0.19-1.66 0.37-3.31 0.56-4.97 0.3 2 1.36 3.86 2.91 5.1-1.1-2.32-0.83-5.06-0.36-7.59s1.02-5.1 0.57-7.64c-0.42-2.35-3.16-6.5-5.99-5.19-3.2 1.49-2.51 6.19-0.99 8.94z"
        fill="#534741"
      />
      <linearGradient
        id="d"
      ...
      />
      <path
        d="m55.68 80.62c2.47-4.4 3.75-10.26 4-16.32"
        fill="none"
        stroke="#9C652F"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="m34.23 74.81c-1.1-4.2-1.05-8.71 0.13-12.88"
        fill="none"
        stroke="#9C652F"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        d="m12.92 16.45s-5.07 0.11-7.45-2.71-1.16-7.5-1.16-7.5 5.07-0.11 7.45 2.71 1.16 7.5 1.16 7.5z"
        fill="#D1A77D"
        stroke="#A67C52"
        strokeMiterlimit={10}
        strokeWidth={1.5791}
      />
      <path
        d="m33.96 16.45s5.07 0.11 7.45-2.71 1.16-7.5 1.16-7.5-5.07-0.11-7.45 2.71-1.16 7.5-1.16 7.5z"
        fill="#D1A77D"
        stroke="#A67C52"
        strokeMiterlimit={10}
        strokeWidth={1.5791}
      ...
      <path
        d="m21.06 45.27c-4.1 0-8.67-6.76-9.97-10.39l-3.9-11-0.03-0.05c-0.87-1.65-0.85-4.2 0.06-6.82 1.26-3.63 3.93-6.65 7.16-8.07l0.23-0.1 0.13-0.21c1.37-2.28 4.45-3.75 7.84-3.75 3.32 0 6.37 1.43 7.77 3.64l0.13 0.21 0.23 0.1c6.35 2.66 9.06 11.06 7.47 15.14l-3.89 10.92c-1.3 3.62-5.87 10.39-9.97 10.39h-3.26z"
        fill="url(#a)"
      />
      <path
        d="m22.57 5.66c3.06 0 5.85 1.29 7.11 3.28l0.27 0.42 0.46 0.19c6.34 2.66 8.35 10.75 7.02 14.17l-3.88 10.9c-0.56 1.57-1.95 4.13-3.78 6.3-1.94 2.3-3.88 3.57-5.45 3.57h-3.25c-1.57 0-3.5-1.27-5.45-3.57-1.83-2.17-3.22-4.72-3.78-6.29l-3.89-10.96-0.04-0.11-0.05-0.1c-0.76-1.44-0.72-3.82 0.1-6.2 1.19-3.43 3.7-6.27 6.73-7.61l0.46-0.2 0.26-0.43c1.23-2.04 4.04-3.36 7.16-3.36m0-1.58c-3.79 0-7.05 1.7-8.52 4.13-6.83 3.02-9.83 11.75-7.59 15.98l3.89 10.95c1.27 3.54 5.99 10.91 10.71 10.91h3.25c4.72 0 9.45-7.38 10.71-10.91l3.89-10.9c1.73-4.43-1.02-13.28-7.9-16.16-1.5-2.36-4.71-4-8.44-4z"
        fill="#9C652F"
      />
      <path
        d="m22.56 46.23c-5.97 0-9.83-3.97-9.83-10.12 0-6.39 4.29-13.81 9.83-13.81s9.83 7.43 9.83 13.81c0 6.14-3.86 10.12-9.83 10.12z"
        fill="#D1A77D"
      />
      <path
        d="m22.56 23.08c4.99 0 9.04 6.85 9.04 13.02s-4.05 9.33-9.04 9.33-9.04-3.16-9.04-9.33 4.05-13.02 9.04-13.02m0-1.58c-6.08 0-10.62 7.71-10.62 14.6 0 6.52 4.27 10.91 10.62 10.91s10.62-4.38 10.62-10.91c0-6.89-4.54-14.6-10.62-14.6z"
        fill="#8A623A"
      />
      <path
        d="m25.74 29.88h-6.34c-2.28 0-3.82-2.44-3.46-5.15l1.16-8.7c0.22-1.67 1.69-2.94 3.27-2.94h4.4c1.58 0 3.05 1.27 3.27 2.94l1.16 8.7c0.36 2.7-1.18 5.15-3.46 5.15z"
        fill="#D1A77D"
      />
      <line
        x1={22.57}
      ...
      />
      <path
        d="m14.45 25.13 5.53-7.19c1.1-1.43 3.9-1.42 5.03 0.03l5.67 7.25c1.13 1.45-0.25 4.57-2.48 4.56l-3.19 0.62c-1.62 0.32-3.27 0.31-4.89-0.03l-3.12-0.66c-2.24-0.01-3.65-3.15-2.55-4.58z"
        fill="#EDBD8E"
      />
      <path
        d="m15.18 37.99c2.12 1.47 4.74 2.3 7.37 2.33s5.26-0.75 7.42-2.18"
        fill="none"
        stroke="#595959"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <ellipse
        transform="matrix(.4759 -.8795 .8795 .4759 -14.517 30.65)"
        cx={18.46}
        cy={27.5}
        rx={1.22}
        ry={3.59}
      ...
      />
      <ellipse
        transform="matrix(.8795 -.4759 .4759 .8795 -9.8626 16.055)"
        cx={26.77}
        cy={27.5}
        rx={3.59}
        ry={1.22}
      ...
      />
      <ellipse
        transform="matrix(.9136 -.4066 .4066 .9136 -7.628 6.5545)"
        cx={11.61}
        cy={21.23}
        rx={3.29}
        ry={4.21}
      ...
      />
      <ellipse
        transform="matrix(.4066 -.9136 .9136 .4066 .3904 43.06)"
        cx={33.34}
        cy={21.23}
        rx={4.21}
        ry={3.29}
      ...
      />
      <path
        d="m10.04 16.71c-2.11 0.78-3.16 3.03-2.35 5.04l7.65-2.81c-0.81-2.01-3.19-3.01-5.3-2.23z"
        fill="#D1A77D"
      />
      <path
        d="m35.03 16.71c2.11 0.78 3.16 3.03 2.35 5.04l-7.65-2.81c0.81-2.01 3.19-3.01 5.3-2.23z"
        fill="#D1A77D"
      />
    </svg>
  );
