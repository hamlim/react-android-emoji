...
function MotorBoat(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m120.68 57.18-26.66-2.23 0.34-3.99 26.51 2.37c1.03 0.09 1.82 0.96 1.82 1.99 0 1.1-0.93 1.95-2.01 1.86z"
        fill="#757575"
      />
      <path
        d="m79.57 42.83 13.91-1.55c0.52-0.06 1 0.26 1.14 0.74l1.64 5.62c0.23 0.77-0.5 1.49-1.3 1.29l-15.55-4.07c-1.13-0.3-1-1.9 0.16-2.03z"
        fill="#757575"
      />
      <rect x={114.36} y={55.5} width={3.93} height={12} fill="#757575" />
      <rect x={104} y={55.5} width={3.93} height={12} fill="#757575" />
      <rect x={52} y={84.33} width={0} height={0.67} fill="#F2F2F2" />
      <path
        d="m54.5 29.83"
        fill="none"
        stroke="#f00"
      ...
      />
      <path
        d="m64.89 42c17.34 0.19 31.29 3.95 31.29 3.95l3.14 17.05-87.69-2.89s33.61-18.33 53.26-18.11z"
        fill="#ECEFF1"
      />
      <defs>
        <path
      ...
      <path
        d="m49.85 55.53-40.8-2.29 18.81-10.55 25.61 1.45c1.8 0.1 3.27 1.24 3.53 2.73l-1.45 4.7c-0.77 2.47-3.12 4.1-5.7 3.96z"
        clipPath="url(#a)"
        fill="#039BE5"
      />
      <path
        d="m83.64 57.18-16.98-0.94c-0.86-0.05-1.6-0.65-1.81-1.49l-1.61-6.37c-0.33-1.3 0.71-2.55 2.05-2.46l16.48 1.12c0.79 0.05 1.48 0.58 1.74 1.33l2.11 6.19c0.45 1.34-0.59 2.7-1.98 2.62z"
        clipPath="url(#a)"
        fill="#039BE5"
      />
      <linearGradient
      ...
      <g opacity={0.2}>
        <path
          d="m65 42v2h0.1c13.99 0.16 25.74 2.7 29.46 3.58l2.4 13.33-77.24-2.55c10.68-5.19 31.28-14.36 45.28-14.36v-2m-0.46 0c-19.7 0-52.9 18.11-52.9 18.11l87.68 2.89-3.15-17.04s-13.94-3.76-31.29-3.95c-0.11-0.01-0.23-0.01-0.34-0.01z"
          fill="#424242"
        />
      </g>
      <path
        d="M6.21,56.48c-1.81-0.11-2.24,0.47-1.46,1.71C6.83,61.5,12.33,72.53,29,78c22.34,7.34,87,5.1,87,5.1 l6.1-15.1v-6L6.21,56.48z"
        fill="#E53935"
      />
      <defs>
        <path
      ...
      <g opacity={0.2}>
        <path
          d="m7.3 58.53 112.8 5.37v3.7l-5.46 13.53c-2.98 0.09-10.8 0.28-20.62 0.28-17.99 0-50.28-0.69-64.39-5.32-14.12-4.62-19.8-13.38-22.33-17.56m-1.48-2.06c-1.47 0-1.78 0.58-1.07 1.72 2.08 3.31 7.58 14.34 24.25 19.81 13.88 4.56 44.12 5.42 65.01 5.42 12.73 0 21.99-0.32 21.99-0.32l6.1-15.1v-6l-115.89-5.52c-0.14-0.01-0.27-0.01-0.39-0.01z"
          fill="#424242"
        />
      </g>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#B3E5FC" offset={0.0423} />
        <stop stopColor="#A6E1FB" offset={0.227} />
        <stop stopColor="#83D5FA" offset={0.5708} />
