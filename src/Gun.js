  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <linearGradient
        ...
        y1={21.179}
        y2={45.167}
        gradientTransform="translate(5.4655)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FFD600" offset={0.4803} />
        <stop stopColor="#FDD835" offset={0.5419} />
        <stop stopColor="#FFE81F" offset={0.5827} />
      </linearGradient>
      <path
        d="m100.5 31.14h-6.84c-1.15-5.9-6.37-10.39-12.59-10.39h-46.7c-7.06 0-12.83 5.78-12.83 12.83 0 7.06 5.78 12.83 12.83 12.83h46.69c6.22 0 11.44-4.49 12.59-10.39h6.84v-4.88z"
        fill="url(#c)"
      />
      <path
        d="m34.72 28.97h42.5c0.73 0 1.32-0.73 1.32-1.64s-0.59-1.64-1.32-1.64h-42.5c-0.73 0-1.32 0.73-1.32 1.64s0.59 1.64 1.32 1.64z"
        fill="#fff"
        opacity={0.88}
      />
      <linearGradient
      ...
      >
        ...
        <stop stopColor="#F86A00" offset={0.2911} />
        <stop stopColor="#E56200" offset={0.7064} />
        <stop stopColor="#D45A00" offset={1} />
      </linearGradient>
      <polygon
        points="105.5 36.75 108.56 36.75 108.56 48.98 105.5 48.98 102.44 48.98 102.44 36.75"
        fill="url(#b)"
      />
      <path
        d="m100.5 39.39h10.01c1.79 0 3.26-1.47 3.26-3.26v-7.02c0-1.79-1.47-3.26-3.26-3.26h-10.01c-1.79 0-3.26 1.47-3.26 3.26v7.02c0 1.79 1.46 3.26 3.26 3.26z"
        fill="#FE7E00"
      />
      <path
        d="m5.75 53.86h4.14v7h-4.14c-0.96 0-1.75-0.79-1.75-1.75v-3.5c0-0.97 0.79-1.75 1.75-1.75z"
        fill="#00CC2C"
      />
      <g fill="#006E9C">
        <rect
          transform="matrix(-1 -4.4262e-11 4.4262e-11 -1 161.86 162.29)"
          x={78.09}
          y={77.96}
          width={5.67}
          height={6.37}
        />
        <polygon points="78.45 80.46 78.45 81.14 78.45 81.82 70.93 81.82 70.93 81.14 70.93 80.46" />
        <path d="m70.91 77.74c0.56 0 1.02 0.46 1.02 1.02v4.76c0 0.56-0.46 1.02-1.02 1.02s-1.02-0.46-1.02-1.02v-4.76c0-0.56 0.46-1.02 1.02-1.02z" />
      </g>
      <path
        d="m11.19 51.92h2.72v10.88h-2.72c-1.5 0-2.72-1.22-2.72-2.72v-5.44c0-1.5 1.22-2.72 2.72-2.72z"
        fill="#00E531"
      />
      <polygon
        points="121.28 56 121.28 57.36 121.28 58.72 118.56 58.72 118.56 57.36 118.56 56"
        fill="#FFEFDA"
      />
      <path
        d="m121.66 50.99c0.25-0.26 0.6-0.43 0.98-0.43 0.75 0 1.36 0.61 1.36 1.36v10.88c0 0.38-0.16 0.72-0.41 0.97-0.25 0.24-0.58 0.39-0.95 0.39-0.75 0-1.36-0.61-1.36-1.36v-10.88c0-0.36 0.15-0.69 0.38-0.93z"
        fill="#00E531"
      />
      <path
        d="m117.84 54.8c0.43 0.23 0.72 0.68 0.72 1.19v2.72c0 0.75-0.61 1.36-1.36 1.36v-5.44c0.23 0.01 0.45 0.07 0.64 0.17z"
        fill="#00E531"
      />
      <path
        d="m117.2 54.64v5.44c0 1.5-1.22 2.72-2.72 2.72v-10.88c1.5 0 2.72 1.22 2.72 2.72z"
        fill="#FFE225"
      />
      <linearGradient
        id="a"
        ...
        y1={47.304}
        y2={106.63}
        gradientTransform="matrix(-1 0 0 1 139.57 0)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FF8C00" offset={0.0013221} />
        <stop stopColor="#FF7500" offset={0.2772} />
        <stop stopColor="#FF5400" offset={0.7415} />
        <stop stopColor="#FF4800" offset={0.9962} />
      </linearGradient>
      <path
        d="m13.91 51.92v10.88c0 2.99 2.45 5.44 5.44 5.44h27.18c0 4.48 3.66 8.14 8.13 8.15 1.51 0 2.74 1.21 2.74 2.72v4.08c0 2.99 2.45 5.44 5.44 5.44h20.51l5.68 16.25c0 1.31 1.07 2.39 2.39 2.39h15.12c0.44 0 0.85-0.12 1.2-0.33 0.94-0.55 1.29-1.75 0.94-2.78l-10.09-27.97c5.31 0 7.74-4.07 7.74-7.96h2.72c2.99 0 5.44-2.45 5.44-5.44v-10.88c0-2.76-2.08-5.05-4.75-5.39-0.22-0.03-0.45-0.05-0.68-0.05h-89.72c-2.99 0.01-5.43 2.46-5.43 5.45zm46.21 24.46h19.16l3.17 9.51h-19.62c-1.5 0-2.72-1.22-2.72-2.72v-6.79z"
        fill="url(#a)"
      />
      <path
        d="m100.25 68.31h-47c-0.66 0-1.19-0.54-1.19-1.19s0.53-1.19 1.19-1.19h47c0.66 0 1.19 0.54 1.19 1.19s-0.53 1.19-1.19 1.19z"
        fill="#CF5D00"
        opacity={0.69}
      />
      <g
