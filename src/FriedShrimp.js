...
function FriedShrimp(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m24.93 51.63c3.67 11.09 3.66 18.31-0.31 21.11-1.57 1.1-6.93 4.25-6.93 4.25s-6.51-10.06-7.11-24.48c-0.25-6.04 0.35-10.28 0.96-12.89 0.4-1.73 2.71-2.84 4.12-1.83 2.49 1.8 6.79 6.34 9.27 13.84z"
        fill="url(#d)"
      />
      <radialGradient
        id="c"
        ...
        cy={76.729}
        r={15.691}
        gradientTransform="matrix(.6959 -.7181 .4624 .4482 -27.756 60.59)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F5803E" offset={0} />
        <stop stopColor="#EE6E24" offset={0.5646} />
        <stop stopColor="#E76A25" offset={0.6986} />
        <stop stopColor="#D86126" offset={0.8451} />
        <stop stopColor="#C35327" offset={0.9969} />
        <stop stopColor="#C25327" offset={1} />
      </radialGradient>
      <path
        d="m36.73 78.04s-1.05 2.44-6.01 7.7-9.06 6.39-9.06 6.39-3.59-3.87-5.44-10.8c-1.69-6.32 0.88-7.27 0.88-7.27l6.47-5.71s3.94-0.35 8.67 3.03c4.49 3.2 4.49 6.66 4.49 6.66z"
        fill="url(#c)"
      />
      <radialGradient
        id="b"
      ...
      <radialGradient
        ...
        cy={68.844}
        r={42.408}
        gradientTransform="matrix(1 0 0 .6311 0 25.397)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F0F0CD" offset={0.0209} />
        <stop stopColor="#EDE28E" offset={0.3779} />
      ...
      <radialGradient
        ...
        cy={11.534}
        r={56.404}
        gradientTransform="matrix(-.00715 -1 .4721 -.0033754 46.602 63.249)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#F0F0CD" offset={0.0209} />
        <stop stopColor="#EDE28E" offset={0.3779} />
      ...
      <path
        d="m65.67 53.59c0.05-2.84 0.21-5.88 1.66-8.28 1.53-2.53 5.92-34.96 5.92-34.96s0.11-3.64-13.85-2.93c-9.16 0.47-16.17 3.45-19.04 5.87-5.07 4.27-8.97 8.2-7.96 17.14 0.6 5.36 0.25 8.24 2.9 13.37 1.95 3.77 1.13 9.2 2 11.02 2.15 4.45 5.04 4.65 6.52 6.07 4.58 4.38 5.09 3.14 12.29 3.77 5.93 0.52 6.05-0.04 7.1-0.2 1.86-0.27 2.41-8.03 2.46-10.87z"
        fill="url(#f)"
      />
      <path
        d="m113.97 43.4c-1.12 1.62-3.86 2-7.21-0.16-1.65-1.07-2.02-3.33-0.91-4.95s3.33-2.02 4.95-0.91c1.63 1.12 4.29 4.4 3.17 6.02z"
        fill="#D8C027"
      />
      <path
        d="m114.12 41.97c-1.12 1.62-3.58 1.86-6.69 0.17-1.73-0.94-2.02-3.33-0.91-4.95 1.12-1.62 3.18-1.75 4.95-0.91 3.22 1.54 3.76 4.07 2.65 5.69z"
        fill="#E2CD3E"
      />
      <ellipse
        transform="matrix(.9658 -.2592 .2592 .9658 -9.5319 24.507)"
        cx={88.16}
        cy={48.4}
        rx={5.01}
        ry={3.64}
      ...
      />
      <ellipse
        transform="matrix(.3162 -.9487 .9487 .3162 -18.095 81.35)"
        cx={47.38}
        cy={53.23}
        rx={3.64}
        ry={5.01}
      ...
      />
      <ellipse
        transform="matrix(.7929 -.6093 .6093 .7929 -34.314 77.428)"
        cx={96.76}
        cy={89.2}
        rx={3.27}
        ry={4.49}
      ...
      />
      <ellipse
        transform="matrix(.6434 -.7655 .7655 .6434 -7.2635 112.07)"
        cx={116.66}
        cy={63.83}
        rx={3.57}
        ry={2.6}
      ...
      <g opacity={0.57}>
        <path
          d="m65.12 37.67c2.02 1.39 2.6 4.19-0.14 7.87-1.46 1.97-4.19 2.95-6.2 1.56-2.02-1.39-2.53-4.15-1.14-6.17 1.4-2.02 5.46-4.65 7.48-3.26z"
          fill="#F3EC9C"
        />
      </g>
      <path
        d="m118.57 54.5c-1.04 1.23-2.9 1.44-5.15-0.58-1.2-1.08-1.67-2.93-0.63-4.16s2.88-1.39 4.11-0.36 2.7 3.86 1.67 5.1z"
        fill="#D8C027"
      />
      <ellipse
        transform="matrix(.7107 -.7035 .7035 .7107 -2.5201 96.762)"
        cx={116.39}
        cy={51.45}
        rx={2.97}
        ry={3.77}
      ...
      />
      <ellipse
        transform="matrix(.3815 -.9244 .9244 .3815 -64.079 130.47)"
        cx={65.46}
        cy={113.12}
        rx={2.97}
        ry={3.77}
