...
function Emoji0x1f938(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="M58.96,124c-1.04,0-1.89-0.81-1.89-1.27c0-0.62,1.09-1.14,2-1.36l8.97-1.01 c0.26-0.03,0.46-0.03,0.45-0.29L67.68,93h6.39l-0.87,28.48c0,1.4-1.07,2.52-2.33,2.52H58.96z"
        fill="url(#e)"
      />
      <path
        d="m73.92 93-0.92 28v0.07c0 1.05-1.13 1.93-2.13 1.93h-11.91c-0.8 0-1.34-0.38-1.39-0.52 0-0.08 0.27-0.42 1.56-0.73l8.97-0.96c0.52-0.06 0.91-0.5 0.89-1.02l-0.8-26.77h5.81m0.59-1zm0 0h-7.43l0.83 27.79-9.03 0.96c-1.44 0.34-2.39 0.86-2.39 1.72s1.16 1.52 2.39 1.52h11.92c1.56 0 3.13-1.35 3.13-2.93v-0.06l0.73-29h-0.15z"
        fill="#EDA600"
      />
      <linearGradient
        id="d"
      ...
      >
        ...
        <stop stopColor="#FFCA28" offset={0.754} />
      </linearGradient>
      <ellipse cx={85.06} cy={77.56} rx={3.71} ry={3.76} fill="url(#d)" />
      <path
        d="m113.56 87.74c-0.15-0.14-0.29 0.02-0.14 0.16 0.94 0.85 1.34 2.14 1.11 3.39-0.02 0.13 0.11 0.15 0.13 0.06 0.04-0.13 0.14-0.11 0.42-0.13 0.07-1.24-0.57-2.62-1.52-3.48z"
        fill="#EDA600"
      />
      <linearGradient
        id="c"
      ...
      />
      <path
        d="m76.61 85.81c-0.88-1.06-0.75-2.64 0.29-3.53 0.44-0.38 1-0.59 1.58-0.59 0.72 0 1.41 0.32 1.88 0.89l1.43 1.72-3.75 3.22-1.43-1.71z"
        fill="#E59600"
      />
      <path
        d="m78.47 82.19c0.57 0 1.12 0.26 1.49 0.71l1.12 1.35-2.99 2.57-1.1-1.32c-0.7-0.85-0.6-2.12 0.23-2.83 0.36-0.32 0.79-0.48 1.25-0.48m0-1c-0.67 0-1.35 0.23-1.9 0.71-1.25 1.07-1.4 2.96-0.35 4.23l1.75 2.1 4.51-3.87-1.75-2.1c-0.58-0.7-1.42-1.07-2.26-1.07z"
        fill="#D18100"
      />
      <defs>
        <polygon
          id="l"
          points="69.52 93.44 88.95 76.78 105.34 96.52 85.92 113.18"
        />
      </defs>
      <clipPath id="k">
        <use xlinkHref="#l" />
      ...
      <g clipPath="url(#k)">
        <path
          d="m79.62 99.97c-0.8 0-1.56-0.37-2.09-1.01-0.96-1.15-0.88-2.82 0.17-3.72l11.63-9.97c0.42-0.37 0.95-0.56 1.53-0.56 0.8 0 1.56 0.37 2.09 1.01 0.96 1.15 0.88 2.82-0.17 3.72l-11.63 9.97c-0.42 0.37-0.95 0.56-1.53 0.56z"
          fill="#E59600"
        />
        <path
          d="m90.86 85.21c0.65 0 1.27 0.3 1.71 0.83 0.78 0.94 0.73 2.3-0.11 3.03l-1.57 1.35-8.49 7.28-1.57 1.34c-0.33 0.29-0.75 0.44-1.2 0.44-0.65 0-1.27-0.3-1.71-0.83-0.78-0.94-0.73-2.3 0.11-3.03l1.57-1.34 8.49-7.28 1.57-1.35c0.33-0.29 0.75-0.44 1.2-0.44m0-1c-0.67 0-1.32 0.22-1.85 0.68l-1.57 1.34-8.49 7.28-1.57 1.34c-1.25 1.08-1.36 3.07-0.23 4.42 0.65 0.78 1.57 1.19 2.48 1.19 0.67 0 1.32-0.22 1.85-0.68l1.57-1.34 8.49-7.28 1.57-1.34c1.25-1.08 1.36-3.07 0.23-4.42-0.65-0.78-1.57-1.19-2.48-1.19z"
          fill="#CC8600"
        />
        <linearGradient
          id="j"
          ...
          y1={-246.92}
          y2={-223.87}
          gradientTransform="matrix(-.7642 .6449 -.6449 -.7642 95.718 -221.09)"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FFB300" offset={0} />
        ...
        <path
          d="m89.52 104.77c-3.43 0-7.11-1.97-9.85-5.27-4.7-5.66-3.33-11.24-0.08-14.03 1.51-1.3 3.42-2.01 5.37-2.01 2.06 0 5.15 0.77 8.2 4.44 3.77 4.54 5.25 11.66 1.08 15.24-1.25 1.07-2.88 1.63-4.72 1.63z"
          fill="url(#j)"
        />
        <path
        ...
        <g fill="#404040">
          ...
          />
          <ellipse
            transform="matrix(.8772 -.4802 .4802 .8772 -35.909 51.196)"
            cx={82.11}
            cy={95.79}
            rx={1.38}
            ry={1.44}
        ...
        <radialGradient
          ...
          cy={-248.64}
          r={8.6005}
          gradientTransform="matrix(-.752 .6449 -.6346 -.7642 95.201 -221.09)"
          gradientUnits="userSpaceOnUse"
        >
        ...
        <path
          d="m95.57 104.9c9.75-8.36-1.75-17.98-1.75-17.98s-2.55-0.96-2.52-0.92c1.34 1.54 3.02 4.85 3.57 6.4 0.27 0.79-0.05 1.65-0.76 2.07-1.09 0.64-2.78 1.72-4.45 3.14-1.6 1.37-2.9 2.83-3.72 3.83-0.56 0.68-1.55 0.82-2.27 0.31l-5.68-4.34 0.63 2.82s7.32 12.93 16.95 4.67z"
          fill="url(#i)"
        />
        <defs>
          <path
            id="h"
            d="m95.57 104.9c9.75-8.36-1.4-17.81-1.4-17.81s-2.91-1.13-2.88-1.09c0.29 0.33 1.04 1.42 1.04 1.42l1.87 1.01 2.9 5.93-3.11 8.55-9.13 1.41-2.72-1.33-2.52-2.94-0.17-1.5-1.47-1.14 0.69 2.94c0.01-0.01 7.27 12.81 16.9 4.55z"
          />
        </defs>
        <clipPath id="g">
          <use xlinkHref="#h" />
        ...
        <g clipPath="url(#g)">
          <path
            d="m94 88.26c1.24 1.21 4.56 4.83 4.57 8.97 0 2.5-1.22 4.82-3.65 6.91-1.95 1.67-3.92 2.51-5.86 2.51-5.1 0-8.85-5.76-9.47-6.77l3.51 2.68c0.46 0.32 0.99 0.49 1.54 0.49 0.8 0 1.56-0.36 2.07-0.98 0.79-0.96 2.05-2.38 3.6-3.7 1.6-1.37 3.22-2.41 4.3-3.04 1.12-0.66 1.63-2.03 1.2-3.26-0.33-0.92-1.02-2.4-1.81-3.81m-2.71-2.27c1.34 1.54 3.02 4.85 3.57 6.4 0.27 0.79-0.05 1.65-0.76 2.07-1.09 0.64-2.78 1.72-4.45 3.14-1.6 1.37-2.9 2.83-3.72 3.83-0.33 0.4-0.81 0.62-1.3 0.62-0.33 0-0.67-0.1-0.97-0.31l-5.68-4.34 0.63 2.82s4.2 7.43 10.43 7.43c1.99 0 4.18-0.76 6.51-2.76 9.75-8.36-1.38-17.83-1.38-17.83s-2.82-1.07-2.88-1.07z"
            fill="#402821"
          />
        </g>
        <path
          d="m80.31 90.58c0.34-0.99 2.56-2.9 3.58-3.07 0.58-0.1 0.68-0.8 0.22-1.02-0.45-0.22-2.35 0-3.39 0.9-1.05 0.9-1.56 2.75-1.43 3.23 0.14 0.51 0.83 0.53 1.02-0.04z"
          fill="#795548"
        />
        <path
          d="m83.31 91.41c0.03-0.01 0.06-0.02 0.08-0.04l1.51-1.29c0.02-0.02 0.04-0.05 0.05-0.08 0.09-0.17 0.05-0.38-0.15-0.48-0.19-0.1-0.85-0.27-1.45 0.25s-0.55 1.2-0.48 1.41c0.06 0.21 0.26 0.29 0.44 0.23z"
          fill="#E59600"
        />
      </g>
      <linearGradient
      ...
      <path
        d="m55.8 69.04c-0.06-0.09-0.15-0.16-0.25-0.19l-10.79-3.65 3.73-12.33 11 3.1c0.04 0.01 0.09 0.02 0.14 0.02 0.22 0 0.42-0.14 0.48-0.36l3.42-12.09 12.32 3.23-2.33 10.18c-0.03 0.14 0 0.28 0.08 0.39l2.96 4.32-17.69 11.89-3.07-4.51z"
        fill="url(#f)"
      />
      <path
        d="m63.87 44.13 11.37 2.98-2.22 9.71c-0.06 0.27-0.01 0.56 0.15 0.79l2.67 3.9-16.84 11.35-2.78-4.11c-0.12-0.18-0.3-0.32-0.51-0.39l-10.33-3.5 3.45-11.4 10.52 2.97c0.09 0.03 0.18 0.04 0.27 0.04 0.44 0 0.84-0.29 0.96-0.73l3.29-11.61m-0.69-1.22-3.55 12.57-11.47-3.24-4.01 13.26 11.24 3.81 3.34 4.93 18.5-12.47-3.23-4.72 2.44-10.65-13.26-3.49z"
        fill="#E66400"
      />
    </svg>
  );
