...
function Minidisc(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("path", {
      d:
        "m110.33 123.93h-93.19c-7.37 0-13.34-5.97-13.34-13.34v-93.18c0-7.37 5.97-13.34 13.34-13.34h93.19c7.37 0 13.34 5.97 13.34 13.34v93.19c0 7.36-5.97 13.33-13.34 13.33z",
      fill: "#616161"
    }),
    _react2.default.createElement(
      "linearGradient",
    ...
    _react2.default.createElement("path", {
      d:
        "m63.74 7.95c-30.93 0-56.06 25.12-56.06 56.05s25.13 56.05 56.05 56.05c30.93 0 56.05-25.13 56.05-56.05 0.01-30.93-25.12-56.05-56.04-56.05zm0 70.08c-7.77 0-14.03-6.25-14.03-14.03 0-7.77 6.25-14.03 14.03-14.03 7.77 0 14.03 6.25 14.03 14.03-0.01 7.77-6.26 14.03-14.03 14.03z",
      fill: "url(#e)"
    }),
    _react2.default.createElement("path", {
      d:
        "m98.82 99.08c5.98-5.98 10.1-13.11 12.39-20.68l-33.74-17.27c0.94 4.47-0.33 9.31-3.82 12.79-3.49 3.49-8.32 4.75-12.79 3.82l17.27 33.73c7.57-2.29 14.71-6.41 20.69-12.39z",
      fill: "#fff",
      opacity: 0.7
    }),
    _react2.default.createElement("path", {
      d:
        "M28.66,28.92c-5.98,5.98-10.1,13.11-12.39,20.68L50,66.87 c-0.94-4.47,0.33-9.31,3.82-12.79c3.49-3.49,8.32-4.75,12.79-3.82L49.34,16.53C41.77,18.82,34.63,22.94,28.66,28.92z",
      fill: "#fff",
      opacity: 0.7
    }),
    _react2.default.createElement("path", {
      d:
        "m63.66 41.66c-12.43 0-22.42 9.99-22.42 22.42s9.99 22.42 22.42 22.42 22.42-9.99 22.42-22.42-9.99-22.42-22.42-22.42zm0.08 36.37c-7.77 0-14.03-6.25-14.03-14.03 0-7.77 6.25-14.03 14.03-14.03 7.77 0 14.03 6.25 14.03 14.03-0.01 7.77-6.26 14.03-14.03 14.03z",
      fill: "#BDBDBD"
    }),
    _react2.default.createElement("path", {
      d:
        "M120.62,79.02H83.27c-1.73,0-3.13-1.4-3.13-3.13V52.11c0-1.73,1.4-3.13,3.13-3.13h37.36V79.02z",
      fill: "#616161"
    }),
    _react2.default.createElement("path", {
      d:
        "M120.62,75.94H84.86c-0.83,0-1.5-0.67-1.5-1.5V53.5c0-0.83,0.67-1.5,1.5-1.5h35.77V75.94z",
      fill: "#F5F5F5"
    }),
    _react2.default.createElement(
      "g",
