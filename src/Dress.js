...
function Dress(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      <path
        d="m-101.27 25.65 2.81-19.34c0.22-1.53 1.81-2.56 3.46-2.25 1.49 0.28 2.49 1.57 2.29 2.95l-2.81 19.34c-0.22 1.53-1.81 2.56-3.46 2.25-1.49-0.28-2.5-1.57-2.29-2.95z"
        fill="#EC407A"
      />
      <path
        d="m-52.18 25.65-2.81-19.34c-0.22-1.53-1.81-2.56-3.46-2.25-1.49 0.28-2.49 1.57-2.29 2.95l2.81 19.34c0.22 1.53 1.81 2.56 3.46 2.25 1.49-0.28 2.5-1.57 2.29-2.95z"
        fill="#EC407A"
      />
      <radialGradient
        id="g"
      ...
      >
        <stop stopColor="#EC407A" offset={0.208} />
        <stop stopColor="#F48FB1" offset={0.768} />
      </radialGradient>
      <path
        d="m-21.05 96.32-36.5-50.58 8.82-27.59s-4.57-4.99-14.93-1.44c-6.93 2.37-13.18 12.84-13.18 12.84s-4.69-9.54-13.18-12.84c-10.21-3.97-15.23 1.44-15.23 1.44l9.11 27.59-36.81 50.58s21.86 27.68 56.06 27.68 55.84-27.68 55.84-27.68z"
        fill="url(#g)"
      />
      <defs>
        <path
      ...
      <g clipPath="url(#e)">
        <path
          d="m-132.31 83.65c22.33 41.15 88.53 41.15 110.86 0 1.29-2.37-2.33-4.49-3.62-2.11-20.86 38.43-82.77 38.43-103.63 0-1.28-2.38-4.9-0.26-3.61 2.11z"
          fill="#FFFDE7"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m-97.12 18.25c1.86 0 3.88 0.42 6.02 1.25 7.26 2.82 11.53 11.29 11.57 11.37 0.49 0.99 1.47 1.63 2.57 1.67h0.12c1.05 0 2.03-0.55 2.57-1.46 1.59-2.65 6.76-9.89 11.57-11.54 2.16-0.74 4.18-1.11 6.01-1.11 2.02 0 3.48 0.45 4.42 0.91l-8.14 25.48c-0.29 0.91-0.13 1.9 0.42 2.67l35.12 48.66c-5.28 5.85-24.57 24.85-52.02 24.85s-46.89-18.99-52.23-24.85l35.41-48.65c0.57-0.78 0.73-1.79 0.42-2.71l-8.43-25.5c0.99-0.51 2.51-1.04 4.6-1.04m0-3c-5.44 0-8.13 2.9-8.13 2.9l9.11 27.59-36.81 50.58s21.86 27.68 56.06 27.68 55.84-27.68 55.84-27.68l-36.5-50.58 8.82-27.59s-2.49-2.71-7.95-2.71c-1.94 0-4.26 0.34-6.98 1.27-6.93 2.37-13.18 12.84-13.18 12.84s-4.69-9.54-13.18-12.84c-2.74-1.07-5.11-1.46-7.1-1.46z"
          fill="#424242"
        />
      </g>
      <g opacity={0.2}>
        ...
        >
          ...
          <stop stopColor="#F48FB1" offset={0.5833} />
        </linearGradient>
        <path
          d="m-107.85 86.37c-2.18-1.25-2.81-4.09-1.38-6.15l21.65-31 2.41 1.42-16.73 33.92c-1.08 2.2-3.81 3.03-5.95 1.81z"
          fill="url(#d)"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m-78.41 92.32 1.61-37.31 2.79 0.1 5.11 36.76c0.39 2.81-1.74 5.34-4.58 5.44-2.77 0.09-5.05-2.21-4.93-4.99z"
          fill="#EC407A"
        />
      </g>
      <g opacity={0.2}>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#3949AB" offset={0.5612} />
        <stop stopColor="#2D3B9B" offset={0.802} />
        <stop stopColor="#283593" offset={1} />
      </linearGradient>
      <path
        d="m41.41 19.62 4.37-15.62h4.95l-4.4 16.46c-0.33 1.6-1.81 2.66-3.21 2.31-1.27-0.32-2.02-1.7-1.71-3.15z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m86.31 19.62-4.09-15.62h-4.95l4.12 16.46c0.33 1.6 1.81 2.66 3.21 2.31 1.27-0.32 2.02-1.7 1.71-3.15z"
        fill="url(#a)"
      />
      <g opacity={0.2}>
        <path
          d="m49.43 5-4.06 15.2c0 0.02-0.01 0.04-0.01 0.05-0.19 0.9-0.91 1.58-1.68 1.58-0.1 0-0.21-0.01-0.31-0.04-0.73-0.19-1.16-1.04-0.99-1.94l4.16-14.85h2.89m1.3-1h-4.95l-4.37 15.62c-0.3 1.45 0.45 2.82 1.71 3.15 0.18 0.05 0.37 0.07 0.55 0.07 1.22 0 2.37-0.98 2.66-2.37l4.4-16.47z"
          fill="#eee"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m81.45 5 3.89 14.85c0.18 0.91-0.25 1.76-0.99 1.95-0.1 0.03-0.2 0.04-0.31 0.04-0.77 0-1.49-0.68-1.69-1.62l-3.8-15.22h2.9m0.77-1h-4.95l4.12 16.46c0.29 1.39 1.44 2.37 2.66 2.37 0.18 0 0.37-0.02 0.55-0.07 1.27-0.32 2.02-1.7 1.71-3.15l-4.09-15.61z"
          fill="#eee"
        />
      </g>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#3949AB" offset={0} />
        <stop stopColor="#283593" offset={1} />
      </linearGradient>
      <path
        d="m113.85 107.43-35.07-59.27 7.38-25.88c0.96-2.79-1.14-5.86-4.09-5.82-2.26 0.03-18.15 11.41-18.15 11.41s-15.93-11.47-18.3-11.41c-2.84 0.07-4.78 3.13-3.88 5.82l7.35 25.91-34.94 59.23c-0.68 0.87-0.55 2.12 0.3 2.83 6.17 5.14 27.26 13.75 49.67 13.75 22.4 0 43.31-8.6 49.44-13.74 0.85-0.72 0.97-1.96 0.29-2.83z"
        fill="url(#h)"
      />
      <g opacity={0.2}>
        <path
          d="m58.87 114.79 5.07-68.9v0.18l5.02 68.73c0.41 5.19-1.85 9.03-4.85 9.21-2.96 0.16-5.37-4.08-5.24-9.22z"
          fill="#283593"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m27.9 107.62 29.92-60.29-0.06 0.16-20.51 63.92c-1.52 4.84-5.02 7.46-7.87 6.49-2.8-0.96-3.48-5.69-1.48-10.28z"
          fill="#283593"
        />
      </g>
      <g opacity={0.2}>
        <path
          d="m100.77 107.62-29.92-60.29 0.06 0.16 20.51 63.92c1.52 4.84 5.02 7.46 7.87 6.49 2.8-0.96 3.48-5.69 1.48-10.28z"
          fill="#283593"
        />
      </g>
      <polygon
