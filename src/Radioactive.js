  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g fill="#424242" opacity={0.2}>
        ...
        <path d="m64 57.14c3.99 0 7.23 3.24 7.23 7.23s-3.24 7.23-7.23 7.23-7.23-3.24-7.23-7.23 3.24-7.23 7.23-7.23m0-3c-5.64 0-10.23 4.59-10.23 10.23s4.59 10.23 10.23 10.23 10.23-4.59 10.23-10.23-4.59-10.23-10.23-10.23z" />
      </g>
      <linearGradient
        id="c"
        x1={90.488}
      ...
      >
        ...
        <stop stopColor="#3F3F3F" offset={0.4947} />
        <stop stopColor="#212121" offset={1} />
      </linearGradient>
      <path
        d="m76.51 64.37h32.66c1.02 0 1.83-0.86 1.79-1.88-0.63-15.93-9.19-29.82-21.85-37.83-0.87-0.55-2.02-0.29-2.53 0.6l-16.33 28.29c-0.46 0.79-0.23 1.77 0.49 2.34 2.13 1.69 3.62 4.17 4.01 7 0.11 0.86 0.89 1.48 1.76 1.48z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <path
        d="m57.75 53.55-16.33-28.29c-0.51-0.89-1.66-1.15-2.53-0.6-12.65 8.02-21.22 21.9-21.85 37.83-0.04 1.02 0.77 1.88 1.79 1.88h32.66c0.87 0 1.64-0.62 1.76-1.49 0.39-2.83 1.87-5.31 4.01-7 0.72-0.56 0.95-1.54 0.49-2.33z"
        fill="url(#b)"
      />
      <linearGradient
        id="a"
      ...
      <path
        d="m64 75.22c-1.44 0-2.81-0.28-4.06-0.79-0.81-0.33-1.75 0.01-2.19 0.77l-16.33 28.29c-0.51 0.89-0.17 2.01 0.74 2.49 6.53 3.44 13.96 5.39 21.85 5.39s15.32-1.95 21.85-5.39c0.91-0.48 1.25-1.6 0.74-2.49l-16.35-28.29c-0.44-0.76-1.37-1.11-2.19-0.77-1.25 0.5-2.62 0.79-4.06 0.79z"
        fill="url(#a)"
      />
      <circle cx={64} cy={64.37} r={7.23} fill="url(#a)" />
    </svg>
  );
}
