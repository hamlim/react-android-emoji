...
function Grimacing(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="M35.47,96.24c-6.6,0-11.98-5.37-11.98-11.98V83.6c0-6.6,5.37-11.98,11.98-11.98h57.06 c6.6,0,11.98,5.37,11.98,11.98v0.66c0,6.6-5.37,11.98-11.98,11.98H35.47z"
        fill="#fff"
      />
      <path
        d="m92.53 73.62c5.5 0 9.98 4.48 9.98 9.98v0.66c0 5.5-4.48 9.98-9.98 9.98h-57.06c-5.5 0-9.98-4.48-9.98-9.98v-0.66c0-5.5 4.48-9.98 9.98-9.98h57.06m0-4h-57.06c-7.69 0-13.98 6.29-13.98 13.98v0.66c0 7.69 6.29 13.98 13.98 13.98h57.06c7.69 0 13.98-6.29 13.98-13.98v-0.66c0-7.69-6.29-13.98-13.98-13.98z"
        fill="#EB8F00"
      />
      <defs>
        <path
          id="b"
          d="m93.86 73.67c4.76 0 8.64 4.6 8.64 10.25s-3.87 10.25-8.64 10.25h-59.72c-4.76 0-8.64-4.6-8.64-10.25s3.87-10.25 8.64-10.25h59.72"
        />
      </defs>
      <clipPath id="a">
        <use xlinkHref="#b" />
      ...
      />
      <path
        d="m44.67 37.86c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42 8-3.54 8-9.42-3.81-9.42-8-9.42z"
        fill="#242424"
      />
      <path
        d="m83.33 37.86c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42 8-3.54 8-9.42-3.81-9.42-8-9.42z"
        fill="#242424"
      />
    </svg>
  );
