...
function AthleticShoe(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m82.41 132.08c-10.36 11.05 45.59 0 45.59 0v-54.34h-42.02s18.36 30.96-3.57 54.34z"
        clipPath="url(#a)"
        fill="#E0E0E0"
      />
      <path
        d="M128,115.81c0-1.72-0.92-2.81-2.1-2.81H1.87C0.69,113,0,114.09,0,115.81 v6.79c0,1.72,0.69,3.41,1.87,3.41H125.9c1.18,0,2.1-1.69,2.1-3.41V115.81z"
        clipPath="url(#a)"
        fill="#B0BEC5"
      />
      <g clipPath="url(#a)">
        <path
          d="M0,87.04c12.78,14.06,51.66,6.9,43.09-11.65c-2.42-5.23-5.72,0.09-11.75,2.5 C24.19,80.75,0,71.5,0,71.5V87.04z"
          fill="#E0E0E0"
        />
      </g>
      <g clipPath="url(#a)">
        <path
          d="m67.87 72.56c-4.65 4.05-9.55 7.84-14.74 11.17-2.06 1.32-3.25 3.59-2.14 6 0.92 1.99 3.95 3.45 6 2.14 5.85-3.76 11.43-7.85 16.68-12.42 4.36-3.81-1.43-10.71-5.8-6.89z"
          fill="#fff"
        />
        <g opacity={0.2}>
          <path
            d="m70.64 73.44c0.97 0 2.01 0.82 2.41 1.9 0.26 0.68 0.34 1.69-0.7 2.59-4.95 4.31-10.33 8.31-16.44 12.24-0.19 0.12-0.42 0.18-0.7 0.18-0.92 0-2.04-0.69-2.4-1.47-0.83-1.79 0.71-3.03 1.4-3.48 4.98-3.2 9.88-6.91 14.97-11.34 0.47-0.41 0.96-0.62 1.46-0.62m0-2c-0.92 0-1.87 0.33-2.77 1.11-4.65 4.05-9.55 7.84-14.74 11.17-2.06 1.32-3.25 3.59-2.14 6 0.67 1.46 2.49 2.64 4.22 2.64 0.62 0 1.23-0.15 1.78-0.5 5.85-3.76 11.43-7.85 16.68-12.42 3.46-3.02 0.52-8-3.03-8z"
            fill="#424242"
          />
        </g>
      </g>
