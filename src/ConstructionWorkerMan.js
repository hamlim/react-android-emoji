  ...
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <g clipPath="url(#a)">
        ...
        >
          <stop stopColor="#448AFF" offset={0.0032478} />
          <stop stopColor="#3B7DFF" offset={0.4042} />
          <stop stopColor="#2962FF" offset={1} />
        </linearGradient>
        <path
          d="M-0.5,136.1v-15.26c0-16.23,25.36-23.53,50.5-23.56h0.13c25.03,0,50.36,8.09,50.36,23.56 v15.26H-0.5z"
          fill="url(#l)"
        />
        <path
          d="m50.13 98.78c12.9 0 25.42 2.19 34.36 6 6.62 2.83 14.51 7.91 14.51 16.05v13.76h-98v-13.76c0-15.2 24.61-22.03 49-22.06l0.13 0.01m0-3h-0.13c-25.49 0.03-52 7.28-52 25.06v16.76h104v-16.76c0-16.76-26.26-25.06-51.87-25.06z"
          fill="#4073D4"
        />
      </g>
      <g clipPath="url(#a)">
        <path
          d="m49.17 109.56c-4 0-7.26-3.22-7.26-7.17v-8.98h16.16v8.98c0 3.95-3.26 7.17-7.26 7.17h-1.64z"
          fill="#E59600"
        />
        <path
          d="m57.08 94.41v7.98c0 3.4-2.81 6.17-6.26 6.17h-1.65c-3.45 0-6.26-2.77-6.26-6.17v-7.98h14.17m2-2h-18.16v9.98c0 4.51 3.7 8.17 8.26 8.17h1.65c4.56 0 8.26-3.66 8.26-8.17v-9.98h-0.01z"
          fill="#D18100"
        />
      </g>
      <g clipPath="url(#a)">
        <defs>
          <path
            id="d"
            d="m-2 120.84v16.76h104v-16.76c0-16.79-26.35-25.09-52-25.06-25.49 0.03-52 7.28-52 25.06z"
          />
        </defs>
        <clipPath id="e">
          <use xlinkHref="#d" />
        ...
        <g clipPath="url(#e)">
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#FF9100" offset={0.0032478} />
            <stop stopColor="#FF8400" offset={0.4399} />
            <stop stopColor="#FF6D00" offset={1} />
          </linearGradient>
          <path
            d="m15.55 100.57v37.03h32.76l-12.13-43.49c-7.72 1.24-14.88 3.35-20.63 6.46z"
            fill="url(#k)"
          />
          <linearGradient
            id="j"
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#ff0" offset={0.0032478} />
            <stop stopColor="#FFF200" offset={0.6783} />
            <stop stopColor="#FFEA00" offset={1} />
          </linearGradient>
          <path
            d="m21.13 98.03 1.77 39.57h17.48l-10.58-42.22c-3.05 0.72-5.96 1.61-8.67 2.65z"
            fill="url(#j)"
          />
          <linearGradient
            id="i"
          ...
          <path
            d="m84.45 100.57v37.03h-32.76l12.12-43.48c7.73 1.23 14.89 3.34 20.64 6.45z"
            fill="url(#i)"
          />
          <linearGradient
            id="h"
          ...
          <path
            d="m78.87 98.03-1.77 39.57h-17.48l10.58-42.22c3.05 0.72 5.96 1.61 8.67 2.65z"
            fill="url(#h)"
          />
        </g>
      </g>
      ...
      />
      <path
        d="m91.38 52.49c-8.12-5.32-19.54-9.71-41.38-9.72-21.85 0.01-33.27 4.4-41.38 9.72-0.62 0.41-0.78 1.21-0.32 1.8 4.45 5.83 23.46 11.57 41.7 11.59 18.24-0.02 38-6.62 41.71-11.58 0.44-0.6 0.3-1.4-0.33-1.81z"
        clipPath="url(#a)"
        fill="#EDBF00"
      />
      <rect
      ...
      <g clipPath="url(#a)">
        ...
        <g clipPath="url(#u)">
          <path
            d="m22.67 72.34c-5.36 0-9.71-4.67-9.71-10.41s4.36-10.41 9.71-10.41h54.65c5.36 0 9.71 4.67 9.71 10.41s-4.36 10.41-9.71 10.41h-54.65z"
            fill="#E59600"
          />
          <path
            d="m77.33 52.52c4.8 0 8.71 4.22 8.71 9.41s-3.91 9.41-8.71 9.41h-54.66c-4.8 0-8.71-4.22-8.71-9.41s3.91-9.41 8.71-9.41h54.66m0-2h-54.66c-5.89 0-10.71 5.14-10.71 11.41 0 6.28 4.82 11.41 10.71 11.41h54.65c5.89 0 10.71-5.14 10.71-11.41 0.01-6.28-4.81-11.41-10.7-11.41z"
            fill="#D18100"
          />
          <linearGradient
            id="t"
      ...
      <g clipPath="url(#a)">
        ...
        >
          ...
          <stop stopColor="#FFF600" offset={0.325} />
          <stop stopColor="#FFDE00" offset={0.8535} />
          <stop stopColor="#FFD600" offset={0.9978} />
        </radialGradient>
        <path
          d="m50.41 7.92c-46.75 0-43.23 46.43-43.23 46.43s12.21-10.8 43.5-10.8 42.09 9.8 42.09 9.8 4.4-45.43-42.36-45.43z"
          fill="url(#c)"
        />
        <linearGradient
          id="q"
        ...
        >
          <stop stopColor="#ff0" offset={0} />
          <stop stopColor="#FFF900" offset={0.4462} />
          <stop stopColor="#FFEA00" offset={1} />
        </linearGradient>
        <path
          d="m60.72 42.15h-20.8v-33.1c0-2.79 2.26-5.05 5.05-5.05h10.7c2.79 0 5.05 2.26 5.05 5.05v33.1z"
          fill="url(#q)"
        />
        <defs>
          <path
        ...
        />
        <path
          d="M95.53,50.99c-0.25-0.42-0.63-0.74-1.07-0.99C76.36,39.59,50,39.93,50,39.93S23.64,39.59,5.54,50 c-0.44,0.25-0.82,0.57-1.07,0.99c-0.53,0.9-0.97,2.61,0.75,5.08c0,0,10.95-10.85,44.78-11.54c33.82,0.68,44.78,11.54,44.78,11.54 C96.5,53.6,96.06,51.89,95.53,50.99z"
          fill="#FFEA00"
        />
      </g>
      <g clipPath="url(#a)">
        ...
        >
          ...
          <stop stopColor="#FD6A3C" offset={0.3271} />
          <stop stopColor="#F75928" offset={0.8111} />
          <stop stopColor="#F4511E" offset={1} />
        </linearGradient>
        <path
          d="m99.69 132.24c-0.12 0-0.25 0-0.38-0.01-1.15-0.08-2.22-0.51-2.74-1.1-0.19-0.21-0.27-0.42-0.26-0.6l3.8-59.59 7.91 0.52-5.52 59.45c-0.04 0.63-1.21 1.33-2.81 1.33z"
          fill="url(#p)"
        />
        <path
          d="m101.05 72 5.89 0.39-5.42 58.35c-0.17 0.17-0.78 0.51-1.83 0.51-0.1 0-0.21 0-0.31-0.01-1.19-0.08-1.88-0.55-2.05-0.76l3.72-58.48m-1.87-2.13-3.86 60.58c-0.1 1.38 1.67 2.62 3.92 2.77 0.15 0.01 0.3 0.01 0.45 0.01 2.05 0 3.72-0.96 3.82-2.24l5.61-60.47-9.94-0.65z"
          fill="#E3461E"
        />
        <linearGradient
          id="o"
      ...
      <g clipPath="url(#a)">
        ...
        />
        <path
          d="m93.5 126.56v0c-0.27 1.7 0.89 3.29 2.59 3.57l4.33 0.69c1.7 0.27 3.29-0.89 3.57-2.59v0c0.27-1.7-0.89-3.29-2.59-3.57l-4.33-0.69c-1.7-0.26-3.3 0.89-3.57 2.59z"
          fill="#FFCA28"
          stroke="#EDA600"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="m94.71 122.11v0c-0.26 1.71 0.91 3.31 2.62 3.58l5.68 0.87c1.71 0.26 3.31-0.91 3.58-2.62v0c0.26-1.71-0.91-3.31-2.62-3.58l-5.68-0.87c-1.71-0.27-3.32 0.91-3.58 2.62z"
          fill="#FFCA28"
          stroke="#EDA600"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="m94.97 117.82v0c-0.17 1.68 1.05 3.19 2.74 3.36l6.95 0.71c1.68 0.17 3.19-1.05 3.36-2.74v0c0.17-1.68-1.05-3.19-2.74-3.36l-6.95-0.71c-1.69-0.17-3.19 1.06-3.36 2.74z"
          fill="#FFCA28"
          stroke="#EDA600"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="m94.89 112.34v0c-0.08 1.69 1.23 3.13 2.92 3.21l6.98 0.33c1.69 0.08 3.13-1.23 3.21-2.92v0c0.08-1.69-1.23-3.13-2.92-3.21l-6.98-0.33c-1.69-0.07-3.13 1.23-3.21 2.92z"
          fill="#FFCA28"
          stroke="#EDA600"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export default ConstructionWorkerMan;
