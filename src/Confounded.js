...
function Confounded(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      />
      <polyline
        points="35.34 88.1 44.89 97.27 54.44 88.1 63.99 97.27 73.54 88.1 83.1 97.27 92.66 88.1"
        fill="none"
        stroke="#242424"
        strokeLinecap="round"
      ...
      />
      <path
        d="m32.19 69.05 12.17-2.36-12.55-5.21c-0.14-0.07-0.28-0.15-0.42-0.23-2.61-1.6-3.06-4.89-0.72-6.93 1.81-1.58 4.76-1.6 6.88-0.3 4.98 3.05 16.7 10.24 21.27 13.04 0.82 0.5 0.7 1.58-0.22 1.93l-22.91 8.6c-0.15 0.06-0.32 0.11-0.48 0.16-3.03 0.84-6.32-0.89-6.79-3.78-0.35-2.2 1.35-4.25 3.77-4.92z"
        fill="#242424"
      />
      <path
        d="m95.81 68.8-12.17-2.36 12.55-5.21c0.14-0.07 0.28-0.15 0.42-0.23 2.61-1.6 3.06-4.89 0.72-6.93-1.81-1.58-4.76-1.6-6.88-0.3-4.98 3.05-16.7 10.24-21.27 13.04-0.82 0.5-0.7 1.58 0.22 1.93l22.91 8.6c0.15 0.06 0.32 0.11 0.48 0.16 3.03 0.84 6.32-0.89 6.79-3.78 0.35-2.2-1.35-4.25-3.77-4.92z"
        fill="#242424"
      />
    </svg>
  );
