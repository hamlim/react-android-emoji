...
function SpaceInvader(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop stopColor="#40C0E7" offset={0} />
        <stop stopColor="#40C0E7" offset={1} />
      </linearGradient>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#792D85" offset={0.0716} />
        <stop stopColor="#AC1CB3" offset={0.3055} />
        <stop stopColor="#D90DDC" offset={0.5416} />
        <stop stopColor="#F503F6" offset={0.7247} />
        <stop stopColor="#f0f" offset={0.831} />
      </linearGradient>
      <path
        d="M110.4,52.37v-11.6H98.8V29.2H87.2V17.6H75.6v11.6H52.4V17.6H40.8v11.6H29.2v11.57H17.6 v11.6H6v46.4h11.6V64h11.6v34.78h11.58l0.03,0.02v11.6h11.6V91.07H40.8v-11.6h46.4v11.6H75.6v19.33h11.6V98.8l0.03-0.02H98.8 V64h11.6v34.77H122v-46.4H110.4z M40.8,40.77h11.6v11.6H40.8V40.77z M87.2,52.37H75.6v-11.6h11.6V52.37z"
        fill="url(#c)"
      />
      <linearGradient
        id="b"
      ...
      <g stroke="#6F21A1" strokeMiterlimit={10} strokeWidth={4}>
        ...
        />
        <path
          d="M110.4,52.37v-11.6H98.8V29.2H87.2V17.6H75.6 v11.6H52.4V17.6H40.8v11.6H29.2v11.57H17.6v11.6H6v46.4h11.6V64h11.6v34.78h11.58l0.03,11.62h11.6V91.07H40.8v-11.6h46.4v11.6 H75.6v19.33h11.6V98.8l11.6-0.02V64h11.6v34.77H122v-46.4H110.4z M40.8,40.77h11.6v11.6H40.8V40.77z M87.2,52.37H75.6v-11.6 h11.6V52.37z"
          fill="none"
        />
        <rect
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#792D85" offset={0.0758} />
        <stop stopColor="#AC1CB3" offset={0.3085} />
        <stop stopColor="#D90DDC" offset={0.5432} />
        <stop stopColor="#F503F6" offset={0.7253} />
        <stop stopColor="#f0f" offset={0.831} />
      </linearGradient>
      <path
        d="m-66.01-36.05c-24.57 0-51.01-15.38-51.01-49.15s26.44-49.15 51.01-49.15c13.62 0 26.23 4.51 35.5 12.69 10.15 8.96 15.51 21.57 15.51 36.46 0 14.83-5.36 27.41-15.51 36.39-9.3 8.23-21.9 12.76-35.5 12.76z"
        fill="url(#a)"
      />
      <path
        d="m-66.01-132.35c13.13 0 25.27 4.33 34.18 12.19 9.7 8.57 14.83 20.66 14.83 34.96 0 14.24-5.13 26.31-14.83 34.89-8.93 7.9-21.07 12.26-34.18 12.26-13.17 0-25.31-4.3-34.18-12.09-9.7-8.53-14.83-20.65-14.83-35.06 0-14.47 5.13-26.62 14.82-35.12 8.85-7.75 20.99-12.03 34.19-12.03m0-4c-27.52 0-53.01 17.68-53.01 51.15 0 33.29 25.49 51.15 53.01 51.15s53.01-18.31 53.01-51.15c0-33.02-25.49-51.15-53.01-51.15z"
        fill="#6F21A1"
      />
    </svg>
  );
