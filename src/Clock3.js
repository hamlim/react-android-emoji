...
function Clock3(props) {
  return (
    <svg enableBackground="new 0 0 128 128" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="m64.2 24h-0.4c-2.1 0-3.8 1.7-3.8 3.8v32.4c0 2.1 1.7 3.8 3.8 3.8h0.4c2.1 0 3.8-1.7 3.8-3.8v-32.4c0-2.1-1.7-3.8-3.8-3.8z"
        fill="#424242"
      />
      <path
        d="m63.88 63.78v0.4c0 2.1 1.7 3.8 3.8 3.8h21.58c2.1 0 3.8-1.7 3.8-3.8v-0.4c0-2.1-1.7-3.8-3.8-3.8h-21.58c-2.1 0-3.8 1.71-3.8 3.8z"
        fill="#424242"
      />
